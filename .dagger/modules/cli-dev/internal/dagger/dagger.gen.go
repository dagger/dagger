...
func (r *AgentMiddleware) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = AgentMiddleware{query: selectNode(dag.query, id, "AgentMiddleware")}
	return nil
}
...
func (r *AgentMiddlewareGroup) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = AgentMiddlewareGroup{query: selectNode(dag.query, id, "AgentMiddlewareGroup")}
	return nil
}
...
func (r *GitBundle) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = GitBundle{query: selectNode(dag.query, id, "GitBundle")}
	return nil
}
...
func (r *GitBundleRef) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = GitBundleRef{query: selectNode(dag.query, id, "GitBundleRef")}
	return nil
}
