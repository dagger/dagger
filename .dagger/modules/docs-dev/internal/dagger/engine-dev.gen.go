...
func (r *EngineDev) ConfigSchema(filename string) *File { // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:409:1)
...
func (r *EngineDev) Generate() *Changeset { // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:424:1)
...
func (r *EngineDev) GoContainer() *Container { // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:245:1)
...
type EngineDevGraphqlSchemaOpts struct {
	Version string // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:383:2)
}

// Introspect the engine API schema, and return it as a graphql schema
func (r *EngineDev) GraphqlSchema(opts ...EngineDevGraphqlSchemaOpts) *File { // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:380:1)
...
type EngineDevInstallClientOpts struct {
	...
	//
	Service *Service // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:325:2)
...
func (r *EngineDev) InstallClient(client *Container, opts ...EngineDevInstallClientOpts) *Container { // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:319:1)
...
func (r *EngineDev) IntrospectionJSON() *File { // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:367:1)
...
func (r *EngineDev) IntrospectionTool() *File { // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:401:1)
...
type EngineDevPublishOpts struct {
	...
	Image string // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:509:2)

	DryRun bool // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:514:2)

	RegistryUsername string // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:517:2)

	RegistryPassword *Secret // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:519:2)
}

// Publish all engine images to a registry
func (r *EngineDev) Publish(ctx context.Context, tag []string, opts ...EngineDevPublishOpts) error { // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:504:1)
	if r.publish != nil {
		return nil
	}
...
func (r *EngineDev) ReleaseDryRun(ctx context.Context) error { // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:490:1)
...
type EngineDevServiceOpts struct {
	GpuSupport bool // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:266:2)

	SharedCache bool // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:268:2)

	Metrics bool // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:270:2)

	Version string // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:272:2)
}

// Create a test engine service
func (r *EngineDev) Service(name string, opts ...EngineDevServiceOpts) *Service { // engine-dev (../../../../../.dagger/modules/engine-dev/main.go:262:1)
