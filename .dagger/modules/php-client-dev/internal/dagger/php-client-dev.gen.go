...
type PhpClientDev struct { // php-client-dev (../../../../../:0:0)
...
func (r *PhpClientDev) API() *Changeset {
...
func (r *PhpClientDev) BaseContainer() *Container {
...
func (r *PhpClientDev) Changes() *Changeset {
...
func (r *PhpClientDev) DevContainer(opts ...PhpClientDevDevContainerOpts) *Container {
...
func (r *PhpClientDev) PhpCodeSniffer(ctx context.Context) error {
...
func (r *PhpClientDev) PhpStan(ctx context.Context) error {
	if r.phpStan != nil {
		return nil
	}
...
// Publish the PHP SDK
func (r *PhpClientDev) Release(ctx context.Context, sourceTag string, opts ...PhpClientDevReleaseOpts) error {
	if r.release != nil {
		return nil
	}
...
func (r *PhpClientDev) ReleaseDryRun(ctx context.Context, opts ...PhpClientDevReleaseDryRunOpts) error {
...
func (r *PhpClientDev) Source() *Directory {
...
func (r *PhpClientDev) Test(ctx context.Context) error {
	if r.test != nil {
		return nil
	}
...
func (r *PhpClientDev) VersionFromTag(ctx context.Context, tag string) (string, error) {
...
func (r *PhpClientDev) WithGeneratedClient() *PhpClientDev {
...
func (r *Query) PhpClientDev(ws *Workspace, opts ...PhpClientDevOpts) *PhpClientDev { // php-client-dev (../../../../../:0:0)
	assertNotNil("ws", ws)
