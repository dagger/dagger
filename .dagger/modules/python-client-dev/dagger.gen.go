...
import (
	...
	"dagger/python-client-dev/internal/dagger"
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "PythonClientDev":
		switch fnName {
		case "Build":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
				panic(fmt.Errorf("%s: %w", "failed to unmarshal parent object", err))
			}
			...
			return (*PythonClientDev).Build(&parent, version), nil
		case "ClientLibrary":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).ClientLibrary(&parent, ctx)
		case "Docs":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).Docs(&parent), nil
		case "Format":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).Format(&parent, paths), nil
		case "Lint":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).Lint(&parent, paths), nil
		case "LintDocsSnippets":
			...
			return (*PythonClientDev).LintDocsSnippets(&parent, workspace), nil
		case "Provision":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).Provision(&parent, ctx, cliBin, runnerHost)
		case "Publish":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).Publish(&parent, token, version, url), nil
		case "Python310":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).Python310(&parent), nil
		case "Python311":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).Python311(&parent), nil
		case "Python312":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).Python312(&parent), nil
		case "Python313":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).Python313(&parent), nil
		case "Python314":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).Python314(&parent), nil
		case "Release":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return nil, (*PythonClientDev).Release(&parent, ctx, sourceTag, dryRun, pypiRepo, pypiUrl, pypiToken)
		case "ReleaseDryRun":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return nil, (*PythonClientDev).ReleaseDryRun(&parent, ctx)
		case "TestPublish":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).TestPublish(&parent, token, version), nil
		case "Typecheck":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return nil, (*PythonClientDev).Typecheck(&parent, ctx)
		case "WithDirectory":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*PythonClientDev).WithDirectory(&parent, source), nil
		case "":
			var parent PythonClientDev
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
	...
	case "":
		return dag.Module().
			...
			WithObject(
				dag.TypeDef().WithObject("PythonClientDev", dagger.TypeDefWithObjectOpts{Description: "A toolchain to develop the Dagger Python SDK", SourceMap: dag.SourceMap("main.go", 15, 6)}).
					WithFunction(
						dag.Function("Build",
