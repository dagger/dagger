...
func (r *Query) LoadDaggerEngineFromID(id DaggerEngineID) *DaggerEngine {
...
func (r *Query) LoadDaggerEngineLoadedEngineFromID(id DaggerEngineLoadedEngineID) *DaggerEngineLoadedEngine {
...
func (r *Query) LoadDockerdFromID(id DockerdID) *Dockerd {
...
func (r *Query) LoadPytestFromID(id PytestID) *Pytest {
