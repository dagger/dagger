...
func (r *Binding) AsDocsDev() *DocsDev { // docs-dev (../../../../../.dagger/modules/docs-dev/main.go:36:6)
...
func (r *Env) WithDocsDevInput(name string, value *DocsDev, description string) *Env { // docs-dev (../../../../../.dagger/modules/docs-dev/main.go:36:6)
...
func (r *Env) WithDocsDevOutput(name string, description string) *Env { // docs-dev (../../../../../.dagger/modules/docs-dev/main.go:36:6)
