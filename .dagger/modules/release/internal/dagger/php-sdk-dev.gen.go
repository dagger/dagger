...
func (r *Binding) AsPhpSDKDev() *PhpSDKDev { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:23:6)
...
func (r *Env) WithPhpSDKDevInput(name string, value *PhpSDKDev, description string) *Env { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:23:6)
...
func (r *Env) WithPhpSDKDevOutput(name string, description string) *Env { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:23:6)
...
type PhpSDKDev struct { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:23:6)
...
func (r *PhpSDKDev) API() *Changeset { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:151:1)
...
func (r *PhpSDKDev) BaseContainer() *Container { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:61:1)
...
func (r *PhpSDKDev) Changes() *Changeset { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:162:1)
...
type PhpSDKDevDevContainerOpts struct {
	...
	//
	RunInstall bool // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:92:2)
}

// Returns the PHP SDK workspace mounted in a dev container,
// and working directory set to the SDK source
func (r *PhpSDKDev) DevContainer(opts ...PhpSDKDevDevContainerOpts) *Container { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:89:1)
...
func (r *PhpSDKDev) DoctumConfig() *File { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:115:1)
...
func (r *PhpSDKDev) PhpCodeSniffer(ctx context.Context) error { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:121:1)
...
func (r *PhpSDKDev) PhpStan(ctx context.Context) error { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:131:1)
	if r.phpStan != nil {
		return nil
	}
...
type PhpSDKDevReleaseOpts struct {
	...
	//
	SourceRepo *GitRepository // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:251:2)

	// Default: "https://github.com/dagger/dagger-php-sdk.git"
	Dest string // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:258:2)

	GithubToken *Secret // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:260:2)
}

// Publish the PHP SDK
func (r *PhpSDKDev) Release(ctx context.Context, sourceTag string, opts ...PhpSDKDevReleaseOpts) error { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:246:1)
	if r.release != nil {
		return nil
	}
...
type PhpSDKDevReleaseDryRunOpts struct {
	...
	//
	SourceRepo *GitRepository // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:219:2)
	//
	// Source git tag to fake-release
	//
	//
	// Default: "HEAD"
	SourceTag string // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:222:2)
	//
	// Target git remote to fake-release *to*
	//
	//
	// Default: "https://github.com/dagger/dagger-php-sdk.git"
	DestRemote string // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:225:2)
}

// Test the publishing process
func (r *PhpSDKDev) ReleaseDryRun(ctx context.Context, opts ...PhpSDKDevReleaseDryRunOpts) error { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:215:1)
...
func (r *PhpSDKDev) Source() *Directory { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:110:1)
...
func (r *PhpSDKDev) Test(ctx context.Context) error { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:142:1)
	if r.test != nil {
		return nil
	}
...
func (r *PhpSDKDev) VersionFromTag(ctx context.Context, tag string) (string, error) { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:240:1)
...
func (r *PhpSDKDev) WithGeneratedClient() *PhpSDKDev { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:166:1)
...
func (r *PhpSDKDev) WithGeneratedDocs() *PhpSDKDev { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:186:1)
...
type PhpSDKDevOpts struct {
	...
	//
	WorkspaceDir *Directory // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:37:2)
	//
	// The path of the SDK source in the workspace
	//
	//
	// Default: "sdk/php"
	SourcePath string // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:40:2)
	//
	// The path of the doctum config in the workspace
	//
	//
	// Default: "docs/doctum-config.php"
	DoctumConfigPath string // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:43:2)
	//
	// A docker config file with credentials to install on clients.
	//
	ClientDockerConfig *Secret // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:46:2)
	//
	...
	//
	Ws *Workspace // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:49:2)
}

// Develop the Dagger PHP SDK (experimental)
func (r *Query) PhpSDKDev(opts ...PhpSDKDevOpts) *PhpSDKDev { // php-sdk-dev (../../../../../.dagger/modules/php-sdk-dev/main.go:33:1)
