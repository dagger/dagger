...
func (r *Binding) AsRustSDKDev() *RustSDKDev { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:29:6)
...
func (r *Env) WithRustSDKDevInput(name string, value *RustSDKDev, description string) *Env { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:29:6)
...
func (r *Env) WithRustSDKDevOutput(name string, description string) *Env { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:29:6)
...
type RustSDKDevOpts struct {
	...
	//
	Workspace *Workspace // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:39:2)
	//
	// The path of the SDK source in the workspace
	//
	//
	// Default: "sdk/rust"
	SourcePath string // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:42:2)
	//
	// A docker config file with credentials to install on clients.
	//
	ClientDockerConfig *Secret // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:45:2)
}

// Develop the Dagger Rust SDK (experimental)
func (r *Query) RustSDKDev(opts ...RustSDKDevOpts) *RustSDKDev { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:37:1)
...
// Develop the Dagger Rust SDK (experimental)
type RustSDKDev struct { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:29:6)
...
func (r *RustSDKDev) Apiclient() *Changeset { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:156:1)
...
func (r *RustSDKDev) BaseContainer() *Container { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:33:2)
...
func (r *RustSDKDev) CargoCheck(ctx context.Context) error { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:135:1)
	if r.cargoCheck != nil {
		return nil
	}
...
func (r *RustSDKDev) CargoFmt(ctx context.Context) error { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:125:1)
	if r.cargoFmt != nil {
		return nil
	}
...
func (r *RustSDKDev) Changes() *Changeset { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:160:1)
...
type RustSDKDevDevContainerOpts struct {
	...
	//
	RunInstall bool // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:79:2)
}

// Return the Rust SDK workspace mounted in a dev container,
// and working directory set to the SDK source.
func (r *RustSDKDev) DevContainer(opts ...RustSDKDevDevContainerOpts) *Container { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:75:1)
...
type RustSDKDevReleaseOpts struct {
	...
	//
	CargoRegistryIndex string // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:262:2)
}

// Release the Rust SDK
func (r *RustSDKDev) Release(ctx context.Context, sourceTag string, cargoRegistryToken *Secret, opts ...RustSDKDevReleaseOpts) error { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:252:1)
...
type RustSDKDevReleaseDryRunOpts struct {
	...
	//
	// Default: "HEAD"
	SourceTag string // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:189:2)
}

// Test the publishing process
func (r *RustSDKDev) ReleaseDryRun(ctx context.Context, opts ...RustSDKDevReleaseDryRunOpts) error { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:184:1)
...
func (r *RustSDKDev) Source() *Directory { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:119:1)
...
// Test the Rust SDK
func (r *RustSDKDev) Test(ctx context.Context) error { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:145:1)
	if r.test != nil {
		return nil
	}
...
func (r *RustSDKDev) WithGeneratedClient() *RustSDKDev { // rust-sdk-dev (../../../../../.dagger/modules/rust-sdk-dev/main.go:164:1)
