...
//
// +check
func (t *RustClientDev) CompletenessIntegrity(ctx context.Context) error {
...
//
// +generate
func (t *RustClientDev) CompletenessArtifacts() *dagger.Changeset {
	freshGo := t.completenessGoOutputs()
...
func (t *RustClientDev) CompletenessHarness() *dagger.File {
...
func (t *RustClientDev) completenessGoOutputs() *dagger.Directory {
