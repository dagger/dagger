...
type DaggerEngine struct { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:97:6)
...
func (r *DaggerEngine) ClientDockerConfig() *Secret { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:113:2)
...
func (r *DaggerEngine) ConfigSchema(filename string) *File { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:764:1)
...
type DaggerEngineContainerOpts struct {
	Platform Platform // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:221:2)

	GpuSupport bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:223:2)

	Version string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:225:2)
}

// Build the engine container
func (r *DaggerEngine) Container(opts ...DaggerEngineContainerOpts) *Container { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:217:1)
...
type DaggerEngineContainerWithRustSdkcontentOpts struct {
	Platform Platform // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:236:2)

	GpuSupport bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:238:2)

	Version string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:240:2)
}
...
func (r *DaggerEngine) ContainerWithRustSdkcontent(rustSdkcontent *DaggerEngineRustEngineContent, opts ...DaggerEngineContainerWithRustSdkcontentOpts) *Container { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:232:1)
...
func (r *DaggerEngine) Generate() *Changeset { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:779:1)
...
type DaggerEngineGraphqlSchemaOpts struct {
	Version string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:738:2)
}

// Introspect the engine API schema, and return it as a graphql schema
func (r *DaggerEngine) GraphqlSchema(opts ...DaggerEngineGraphqlSchemaOpts) *File { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:735:1)
...
func (r *DaggerEngine) IncrementSubnet() *DaggerEngine { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:122:1)
...
type DaggerEngineInstallClientOpts struct {
	...
	//
	Service *Service // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:680:2)

	Version string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:682:2)
}

// Configure the given client container so that it can connect to the given engine service
func (r *DaggerEngine) InstallClient(client *Container, opts ...DaggerEngineInstallClientOpts) *Container { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:674:1)
...
func (r *DaggerEngine) IntrospectionJSON() *File { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:722:1)
...
func (r *DaggerEngine) IntrospectionTool() *File { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:756:1)
...
func (r *DaggerEngine) NetworkCidr(ctx context.Context) (string, error) { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:118:1)
...
type DaggerEnginePlaygroundOpts struct {
	...
	//
	Base *Container // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:183:2)
	//
	// Enable experimental GPU support
	//
	GpuSupport bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:186:2)
	//
	// Share cache globally
	//
	SharedCache bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:189:2)

	Metrics bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:191:2)

	Version string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:193:2)
}

// Build an ephemeral environment with the Dagger CLI and engine built from source, installed and ready to use
func (r *DaggerEngine) Playground(opts ...DaggerEnginePlaygroundOpts) *Container { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:179:1)
...
type DaggerEnginePublishOpts struct {
	...
	Image string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:864:2)

	DryRun bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:869:2)

	RegistryUsername string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:872:2)

	RegistryPassword *Secret // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:874:2)
}

// Publish all engine images to a registry
func (r *DaggerEngine) Publish(ctx context.Context, tag []string, opts ...DaggerEnginePublishOpts) error { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:859:1)
	if r.publish != nil {
		return nil
	}
...
func (r *DaggerEngine) ReleaseDryRun(ctx context.Context) error { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:845:1)
...
type DaggerEngineRustSdkcontentOpts struct {
	Platform Platform // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:344:2)

	Version string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:346:2)
	//
	// Credential-free repository containing the public dagger-sdk package.
	//
	DependencyRepository string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:349:2)
	//
	// Full reachable revision whose public dagger-sdk package matches this build.
	//
	DependencyRevision string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:352:2)
}
...
func (r *DaggerEngine) RustSdkcontent(opts ...DaggerEngineRustSdkcontentOpts) *DaggerEngineRustEngineContent { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:341:1)
...
type DaggerEngineServiceOpts struct {
	GpuSupport bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:502:2)

	SharedCache bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:504:2)

	Metrics bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:506:2)

	Version string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:508:2)
}

// Create a test engine service
func (r *DaggerEngine) Service(name string, opts ...DaggerEngineServiceOpts) *Service { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:498:1)
...
type DaggerEngineServiceWithFocusedRustSdkcontentOpts struct {
	SharedCache bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:547:2)

	Metrics bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:549:2)

	Version string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:551:2)
}
...
func (r *DaggerEngine) ServiceWithFocusedRustSdkcontent(rustSdkcontent *DaggerEngineRustEngineContent, name string, baseImage string, baseRevision string, targetRepository string, targetRevision string, opts ...DaggerEngineServiceWithFocusedRustSdkcontentOpts) *Service { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:538:1)
	assertNotNil("rustSdkcontent", rustSdkcontent)
...
type DaggerEngineServiceWithRustSdkcontentOpts struct {
	GpuSupport bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:520:2)

	SharedCache bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:522:2)

	Metrics bool // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:524:2)

	Version string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:526:2)
}
...
func (r *DaggerEngine) ServiceWithRustSdkcontent(rustSdkcontent *DaggerEngineRustEngineContent, name string, opts ...DaggerEngineServiceWithRustSdkcontentOpts) *Service { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:515:1)
	assertNotNil("rustSdkcontent", rustSdkcontent)
...
func (r *DaggerEngine) Source() *Directory { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:98:2)
...
func (r *DaggerEngine) WithEbpfprogs(names []string) *DaggerEngine { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:127:1)
...
func (r *DaggerEngine) WithEngineConfig(key string, value string) *DaggerEngine { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:132:1)
...
func (r *DaggerEngine) WithGitSource(repository string, revision string) *DaggerEngine { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:150:1)
...
func (r *DaggerEngine) WithLogLevel(level string) *DaggerEngine { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:142:1)
...
func (r *DaggerEngine) WithRace() *DaggerEngine { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:137:1)
...
func (r *DaggerEngine) WithSource(source *Directory) *DaggerEngine { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:171:1)
...
type DaggerEngineRustEngineContent struct { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:332:6)
	query *querybuilder.Selection
...
func (r *DaggerEngineRustEngineContent) Content() *Directory { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:333:2)
...
func (r *DaggerEngineRustEngineContent) DependencyDescriptor(ctx context.Context) (string, error) { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:336:2)
...
func (r *DaggerEngineRustEngineContent) DescriptorDigest(ctx context.Context) (string, error) { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:335:2)
...
func (r *DaggerEngineRustEngineContent) ManifestDigest(ctx context.Context) (string, error) { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:334:2)
...
type DaggerEngineOpts struct {
	Ws *Workspace // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:23:2)
	//
	...
	//
	// Default: 89
	SubnetNumber int // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:27:2)
	//
	// A docker config file with credentials to install on clients,
	// to ensure they can access private registries
	//
	ClientDockerConfig *Secret // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:31:2)
	//
	// Credential-free HTTPS repository that owns the source revision.
	//
	//
	// Default: "https://github.com/dagger/dagger"
	VcsRepository string // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:34:2)
}

// Creates a complete end-to-end build environment with CLI and engine for interactive testing
func (r *Query) DaggerEngine(opts ...DaggerEngineOpts) *DaggerEngine { // dagger-engine (../../../../../.dagger/modules/engine-dev/main.go:21:1)
