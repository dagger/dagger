...
func (r *Query) RustClientDev(workspace *Workspace, opts ...RustClientDevOpts) *RustClientDev { // rust-client-dev (../../../../../:0:0)
...
func (r *RustClientDev) Release(ctx context.Context, sourceTag string, cargoRegistryToken *Secret, opts ...RustClientDevReleaseOpts) error {
...
func (r *RustClientDev) ReleaseDryRun(ctx context.Context, opts ...RustClientDevReleaseDryRunOpts) error {
