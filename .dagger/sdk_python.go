...
func (t PythonSDK) LintPython(ctx context.Context) (CheckStatus, error) {
...
func (t PythonSDK) LintGo(ctx context.Context) (CheckStatus, error) {
	_, err := t.godev().Lint(ctx)
	return CheckCompleted, err
}
...
// Test the Python SDK
func (t PythonSDK) Test(ctx context.Context) (CheckStatus, error) {
