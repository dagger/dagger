...
`, config, snPath)
	...
	buildkitdArgs := []string{
		...
		"--containerd-worker-labels=org.mobyproject.buildkit.worker.sandbox=true", // Include use of --containerd-worker-labels to trigger https://github.com/dagger/dagger/buildkit/pull/603
	}
