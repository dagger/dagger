...
// The `UtilID` scalar type represents an identifier for an object of type Util.
type UtilID string

// The `UtilRepositoryID` scalar type represents an identifier for an object of type UtilRepository.
type UtilRepositoryID string

// The `UtilVersionInfoID` scalar type represents an identifier for an object of type UtilVersionInfo.
type UtilVersionInfoID string
...
// Load a Util from its ID.
func (r *Client) LoadUtilFromID(id UtilID) *Util {
	q := r.q.Select("loadUtilFromID")
	q = q.Arg("id", id)
...
// Load a UtilRepository from its ID.
func (r *Client) LoadUtilRepositoryFromID(id UtilRepositoryID) *UtilRepository {
	q := r.q.Select("loadUtilRepositoryFromID")
	q = q.Arg("id", id)
...
// Load a UtilVersionInfo from its ID.
func (r *Client) LoadUtilVersionInfoFromID(id UtilVersionInfoID) *UtilVersionInfo {
	q := r.q.Select("loadUtilVersionInfoFromID")
	q = q.Arg("id", id)
...
// A unique identifier for this Util.
func (r *Util) ID(ctx context.Context) (UtilID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.q.Select("id")
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Util) XXX_GraphQLType() string {
	return "Util"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Util) XXX_GraphQLIDType() string {
	return "UtilID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Util) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Util) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *Util) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadUtilFromID(UtilID(id))
	return nil
}

func (r *Util) Repository(source *Directory) *UtilRepository {
	assertNotNil("source", source)
...
// UtilRepositoryDaggerBinaryOpts contains options for UtilRepository.DaggerBinary
type UtilRepositoryDaggerBinaryOpts struct {
	Goos string
...
func (r *UtilRepository) DaggerBinary(opts ...UtilRepositoryDaggerBinaryOpts) *File {
	q := r.q.Select("daggerBinary")
	for i := len(opts) - 1; i >= 0; i-- {
		...
		// `goarm` optional argument
		if !querybuilder.IsZeroValue(opts[i].Goarm) {
			q = q.Arg("goarm", opts[i].Goarm)
		}
	}
...
// UtilRepositoryDaggerEngineOpts contains options for UtilRepository.DaggerEngine
type UtilRepositoryDaggerEngineOpts struct {
	Goarch string
...
func (r *UtilRepository) DaggerEngine(opts ...UtilRepositoryDaggerEngineOpts) *Container {
	q := r.q.Select("daggerEngine")
	for i := len(opts) - 1; i >= 0; i-- {
		// `goarch` optional argument
		if !querybuilder.IsZeroValue(opts[i].Goarch) {
			q = q.Arg("goarch", opts[i].Goarch)
		}
		// `entrypointArgs` optional argument
		if !querybuilder.IsZeroValue(opts[i].EntrypointArgs) {
			q = q.Arg("entrypointArgs", opts[i].EntrypointArgs)
		}
		// `configEntries` optional argument
		if !querybuilder.IsZeroValue(opts[i].ConfigEntries) {
			q = q.Arg("configEntries", opts[i].ConfigEntries)
		}
	}
...
// UtilRepositoryDaggerEngineServiceOpts contains options for UtilRepository.DaggerEngineService
type UtilRepositoryDaggerEngineServiceOpts struct {
	CloudToken *Secret
...
func (r *UtilRepository) DaggerEngineService(name string, opts ...UtilRepositoryDaggerEngineServiceOpts) *Service {
	q := r.q.Select("daggerEngineService")
	for i := len(opts) - 1; i >= 0; i-- {
...
func (r *UtilRepository) DevelVersionInfo() *UtilVersionInfo {
	q := r.q.Select("develVersionInfo")
...
func (r *UtilRepository) Directory() *Directory {
	q := r.q.Select("directory")
...
func (r *UtilRepository) DirectoryForGo() *Directory {
	q := r.q.Select("directoryForGo")
...
func (r *UtilRepository) GitDirectory() *Directory {
	q := r.q.Select("gitDirectory")
...
func (r *UtilRepository) GoBase() *Container {
	q := r.q.Select("goBase")
...
// A unique identifier for this UtilRepository.
func (r *UtilRepository) ID(ctx context.Context) (UtilRepositoryID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.q.Select("id")

	var response UtilRepositoryID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *UtilRepository) XXX_GraphQLType() string {
	return "UtilRepository"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *UtilRepository) XXX_GraphQLIDType() string {
	return "UtilRepositoryID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *UtilRepository) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *UtilRepository) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *UtilRepository) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadUtilRepositoryFromID(UtilRepositoryID(id))
	return nil
}
...
type UtilVersionInfo struct {
	...
	id            *UtilVersionInfoID
	tag           *string
	treeHash      *string
}

func (r *UtilVersionInfo) Commit(ctx context.Context) (string, error) {
	if r.commit != nil {
		return *r.commit, nil
	}
	q := r.q.Select("commit")
...
func (r *UtilVersionInfo) EngineVersion(ctx context.Context) (string, error) {
...
// A unique identifier for this UtilVersionInfo.
func (r *UtilVersionInfo) ID(ctx context.Context) (UtilVersionInfoID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.q.Select("id")

	var response UtilVersionInfoID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *UtilVersionInfo) XXX_GraphQLType() string {
	return "UtilVersionInfo"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *UtilVersionInfo) XXX_GraphQLIDType() string {
	return "UtilVersionInfoID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *UtilVersionInfo) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *UtilVersionInfo) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *UtilVersionInfo) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadUtilVersionInfoFromID(UtilVersionInfoID(id))
	return nil
}

func (r *UtilVersionInfo) Tag(ctx context.Context) (string, error) {
	if r.tag != nil {
		return *r.tag, nil
	}
	q := r.q.Select("tag")
...
func (r *UtilVersionInfo) TreeHash(ctx context.Context) (string, error) {
	if r.treeHash != nil {
		return *r.treeHash, nil
	}
	q := r.q.Select("treeHash")
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Dagger":
		...
		case "EngineService":
			...
			return (*Dagger).EngineService(&parent), nil
		case "Test":
			var parent Dagger
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
