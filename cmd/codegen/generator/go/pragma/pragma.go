...
//
// The same syntax already lives inline in the existing template-based
// codegen; this package exists so the AST-based source analyzer can
// share one parser with that path when the two are unified.
package pragma
