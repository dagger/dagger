...
func (g *RubyGenerator) Generate(_ context.Context, schema *introspection.Schema, schemaVersion string) (*generator.GeneratedState, error) {
	...
	if g.Config.ModuleConfig != nil && g.Config.ModuleConfig.ModuleName != "" {
		target = filepath.Join(g.Config.ModuleConfig.ModuleSourcePath, "sdk/dagger", ClientGenFile)
	}
...
func (g *RubyGenerator) GenerateModule(ctx context.Context, schema *introspection.Schema, schemaVersion string) (*generator.GeneratedState, error) {
	return g.Generate(ctx, schema, schemaVersion)
}

func (g *RubyGenerator) GenerateClient(ctx context.Context, schema *introspection.Schema, schemaVersion string) (*generator.GeneratedState, error) {
	return g.Generate(ctx, schema, schemaVersion)
}

func (g *RubyGenerator) GenerateLibrary(ctx context.Context, schema *introspection.Schema, schemaVersion string) (*generator.GeneratedState, error) {
	return g.Generate(ctx, schema, schemaVersion)
}

func (g *RubyGenerator) GenerateTypeDefs(ctx context.Context, schema *introspection.Schema, schemaVersion string) (*generator.GeneratedState, error) {
	return g.Generate(ctx, schema, schemaVersion)
}
