...
func (h *shellCallHandler) FunctionsList(name string, fns []*modFunction) string {
	...
	fmt.Fprintf(sb, `\nUse "%s | .help" for more details.`, name)
	fmt.Fprintf(sb, `\nUse "%s | .help <function>" for more information on a function.\n`, name)
...
func (h *shellCallHandler) DependenciesList() string {
	...
	fmt.Fprintf(sb, `\nUse "%s | .help" for more details.`, shellDepsCmdName)
	fmt.Fprintf(sb, `\nUse "%s | .help <dependency>" for more information on a dependency.\n`, shellDepsCmdName)
