...
func New() *template.Template {
	...
	templateDeps := []string{
		topLevelTemplate, "header", "objects", "object", "object_comment", "method", "method_solve", "call_args", "call_arg", "field", "return_solve", "input_args", "return", "field_comment", "types", "type", "args", "arg",
	}
