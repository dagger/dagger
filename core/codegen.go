...
type GeneratedCode struct {
	...
	// Code              dagql.ObjectInstance[*Directory] `field:"true" doc:"The directory containing the generated code."`
	Code dagql.ObjectInstance[*Directory]
...
func NewGeneratedCode(code dagql.ObjectInstance[*Directory]) *GeneratedCode {
