...
`).
	...
	t.Run("same source different clients and first disconnects", func(ctx context.Context, t *testctx.T) {
		...
		initDepCmd := hostDaggerCommand(ctx, t, depTmpdir1, "module", "init", "--source=.", "--name=dep", "--sdk=go")
	...
	t.Run("basic", func(ctx context.Context, t *testctx.T) {
		callMod := func(c *dagger.Client, rand string) (string, error) {
			return goGitBase(t, c).
				...
				With(daggerExec("module", "init", "--name=servicer", "--sdk=go", "--source=.")).
				WithNewFile("main.go", `package main
...
func (ModuleSuite) TestCrossSessionSockets(ctx context.Context, t *testctx.T) {
	...
	initModCmd := hostDaggerCommand(ctx, t, modTmpdir, "module", "init", "--source=.", "--name=test", "--sdk=go")
...
`,
	...
	t.Run("secret uris", func(ctx context.Context, t *testctx.T) {
		tmpdir := t.TempDir()
		initCmd := hostDaggerCommand(ctx, t, tmpdir, "module", "init", "--source=.", "--name=test", "--sdk=go")
		initOutput, err := initCmd.CombinedOutput()
		require.NoError(t, err, string(initOutput))
...
func (ModuleSuite) TestCrossSessionContextualDirChange(ctx context.Context, t *testctx.T) {
	...
	initCmd := hostDaggerCommand(ctx, t, modDir, "module", "init", "--source=src", "--name=test", "--sdk=go")
	initOutput, err := initCmd.CombinedOutput()
	require.NoError(t, err, string(initOutput))
...
func (InterfaceSuite) TestCrossSessionInterfaceCaching(ctx context.Context, t *testctx.T) {
	...
	initDriveCmd := hostDaggerCommand(ctx, t, driveDir, "module", "init", "--source=.", "--name=drive", "--sdk=go")
...
`), 0644)
	...
	initRollsCmd := hostDaggerCommand(ctx, t, rollsDir, "module", "init", "--source=.", "--name=rolls-royce", "--sdk=go")
