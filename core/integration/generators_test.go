...
`)
	...
	workspaceUpdated := withoutGeneratedTarget.With(daggerNonNestedExec("lock", "update"))
	...
	workspaceUpdatedWithoutGeneration := withoutClientMarker.With(daggerNonNestedExec("lock", "update", "--no-generate"))
