...
func (m *Test) Commit(ctx context.Context, name string) (string, error) {
	return dag.GitRepository("github.com/dagger/dagger").Commit(name).Tree().File("LICENSE").Contents(ctx)
}

func (m *Test) Tag(ctx context.Context, name string) (string, error) {
	return dag.GitRepository("github.com/dagger/dagger").Tag(name).Tree().File("LICENSE").Contents(ctx)
}

func (m *Test) Branch(ctx context.Context, name string) (string, error) {
	return dag.GitRepository("github.com/dagger/dagger").Branch(name).Tree().File("LICENSE").Contents(ctx)
}
`)
