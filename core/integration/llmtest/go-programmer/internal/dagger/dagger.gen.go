...
import (
	...
	"dagger/go-programmer/internal/querybuilder"
	"dagger/go-programmer/internal/telemetry"
)
...
func (r *Binding) AsToyWorkspace() *ToyWorkspace {
...
func (r *Env) WithToyWorkspaceInput(name string, value *ToyWorkspace, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithToyWorkspaceOutput(name string, description string) *Env {
...
func (r *Client) LoadToyWorkspaceFromID(id ToyWorkspaceID) *ToyWorkspace {
...
func (r *Client) ToyWorkspace() *ToyWorkspace { // toy-workspace (../../../../../../core/integration/llmtest/go-programmer/toy-workspace/main.go:15:1)
