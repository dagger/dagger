...
func (ConfigSuite) TestDepPins(ctx context.Context, t *testctx.T) {
	...
	// XXX: point to github.com/dagger/dagger-test-modules/versioned
	repo := "github.com/jedevc/dagger-test-modules/versioned"
	branch := "add-versioned"
	commit := "15ea5370f7b02a7b47110615ced551379c0e33bc"
