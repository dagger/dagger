...
// Scope: Remaining broad historical module coverage around runtime behavior, context handling, and legacy authoring flows not yet split into narrower suites.
