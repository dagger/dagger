...
// Scope: Remaining broad historical module coverage around runtime behavior, SDK plumbing, errors, and legacy authoring flows not yet split into narrower suites.
