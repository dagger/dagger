...
// Scope: Broad historical module coverage that predates the workspace split.
...
// 4. Next: peel coherent coverage slices out of this file without changing behavior.
