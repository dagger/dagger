...
import (
	...
	"dagger/hello-with-checks/internal/querybuilder"
	"dagger/hello-with-checks/internal/telemetry"
)
...
func (r HelloWithChecks) MarshalJSON() ([]byte, error) {
	var concrete struct{}
	return json.Marshal(&concrete)
}

func (r *HelloWithChecks) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
