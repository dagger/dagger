...
import (
	...
	"dagger/defaults/internal/querybuilder"
	"dagger/defaults/internal/telemetry"
)
...
func (r *Binding) AsFoobar() *Foobar {
...
func (r *Env) WithFoobarInput(name string, value *Foobar, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithFoobarOutput(name string, description string) *Env {
...
func (r *Client) Foobar() *Foobar { // foobar (../../../../../../../../core/integration/testdata/modules/go/defaults/foobar/main.go:3:6)
...
func (r *Client) LoadFoobarFromID(id FoobarID) *Foobar {
