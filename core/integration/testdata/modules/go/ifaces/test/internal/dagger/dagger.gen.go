...
func (r *Binding) AsDepCustomIface() *DepCustomIface {
...
func (r *Binding) AsDepOtherIface() *DepOtherIface {
...
func (r *Env) WithDepCustomIfaceInput(name string, value *DepCustomIface, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithDepCustomIfaceOutput(name string, description string) *Env {
...
func (r *Env) WithDepInput(name string, value *Dep, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithDepOtherIfaceInput(name string, value *DepOtherIface, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithDepOtherIfaceOutput(name string, description string) *Env {
...
func (r *Env) WithDepOutput(name string, description string) *Env {
...
func (r *Client) Dep() *Dep { // dep (../../../../../../../../../core/integration/testdata/modules/go/ifaces/test/dep/main.go:8:6)
...
// Load a DepCustomIface from its ID.
func (r *Client) LoadDepCustomIfaceFromID(id DepCustomIfaceID) *DepCustomIface {
	q := r.query.Select("loadDepCustomIfaceFromID")
	q = q.Arg("id", id)
...
// Load a DepOtherIface from its ID.
func (r *Client) LoadDepOtherIfaceFromID(id DepOtherIfaceID) *DepOtherIface {
	q := r.query.Select("loadDepOtherIfaceFromID")
	q = q.Arg("id", id)
