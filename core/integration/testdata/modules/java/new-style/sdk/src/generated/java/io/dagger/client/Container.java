...
public class Container implements Exportable,
    ...
    /**
     * <p>The combined buffered standard output and standard error stream of the last executed command<br/><br/>Returns an error if no command was executed</p>
     */
    public String combinedOutput() throws InterruptedException, ExecutionException,
            DaggerQueryException {
        if (this.combinedOutput != null) {
            return combinedOutput;
        }
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("combinedOutput");
    ...
    /**
     * <p>Retrieves this container's configured docker healthcheck.</p>
     */
    public HealthcheckConfig dockerHealthcheck() {
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("dockerHealthcheck");
    ...
    /**
     * <p>Exports the container as an image to the host's container image store.</p>
     * @param name Name of image to export to in the host's store
     * @param optArgs exportImage optional arguments
     */
    public Void exportImage(String name, ExportImageArguments optArgs) throws InterruptedException,
            ExecutionException, DaggerQueryException {
        ...
        Arguments fieldArgs = builder.build();
        fieldArgs = fieldArgs.merge(optArgs.toArguments());
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("exportImage", fieldArgs);
     ...
     * @param name Name of image to export to in the host's store
     */
    public Void exportImage(String name) throws InterruptedException, ExecutionException,
            DaggerQueryException {
        if (this.exportImage != null) {
            return exportImage;
        }
    ...
    public List<Port> exposedPorts() throws InterruptedException, ExecutionException,
        ...
        nextQueryBuilder = nextQueryBuilder.chain(List.of("id"));
        List<QueryBuilder> builders = nextQueryBuilder.executeObjectListQuery("Port");
    ...
    public List<Label> labels() throws InterruptedException, ExecutionException,
        ...
        nextQueryBuilder = nextQueryBuilder.chain(List.of("id"));
        List<QueryBuilder> builders = nextQueryBuilder.executeObjectListQuery("Label");
    ...
    /**
     * <p>Retrieves this container plus the given OCI annotation.</p>
     ...
     */
    public Container withDirectory(String path, Directory source, WithDirectoryArguments optArgs) {
        Arguments.Builder builder = Arguments.newBuilder();
        builder.add("path", path);
        builder.add("source", source);
        Arguments fieldArgs = builder.build();
     ...
     * @param source Identifier of the directory to write
     */
    public Container withDirectory(String path, Directory source) {
        Arguments.Builder builder = Arguments.newBuilder();
        builder.add("path", path);
        builder.add("source", source);
        Arguments fieldArgs = builder.build();
    ...
    /**
     * <p>Retrieves this container with the specificed docker healtcheck command set.</p>
     * @param args Healthcheck command to execute. Example: ["go", "run", "main.go"].
     * @param optArgs withDockerHealthcheck optional arguments
     */
    public Container withDockerHealthcheck(List<String> args,
            WithDockerHealthcheckArguments optArgs) {
        Arguments.Builder builder = Arguments.newBuilder();
        builder.add("args", args);
        Arguments fieldArgs = builder.build();
        fieldArgs = fieldArgs.merge(optArgs.toArguments());
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("withDockerHealthcheck", fieldArgs);
        return new Container(nextQueryBuilder);
    }
    ...
    /**
     * <p>Export environment variables from an env-file to the container.</p>
    ...
    public Container withEnvFileVariables(EnvFile source) {
        ...
        builder.add("source", source);
        Arguments fieldArgs = builder.build();
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("withEnvFileVariables", fieldArgs);
        return new Container(nextQueryBuilder);
    }
     ...
     * @param optArgs withSymlink optional arguments
     */
    public Container withSymlink(String target, String linkName, WithSymlinkArguments optArgs) {
        Arguments.Builder builder = Arguments.newBuilder();
     ...
     * @param linkName Location where the symbolic link will be created (e.g., "/new-file-link").
     */
    public Container withSymlink(String target, String linkName) {
        Arguments.Builder builder = Arguments.newBuilder();
        builder.add("target", target);
        builder.add("linkName", linkName);
        Arguments fieldArgs = builder.build();
    ...
    /**
     * <p>Retrieves this container without a configured docker healtcheck command.</p>
     */
    public Container withoutDockerHealthcheck() {
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("withoutDockerHealthcheck");
        return new Container(nextQueryBuilder);
    }
    ...
    public static class Deserializer implements JsonbDeserializer<Container> {
        ...
        public Container deserialize(JsonParser parser, DeserializationContext ctx, Type type) {
            ...
            Container o = new Container(Dagger.dag().nodeQueryBuilder("Container", new ID(id)));
            return o;
        }
    }
    ...
    /**
     * Optional arguments for {@link Container#exists}
     *
     */
    ...
    /**
     * Optional arguments for {@link Container#exportImage}
     *
     */
    public static class ExportImageArguments {
        private List<Container> platformVariants;
         ...
         * Identifiers for other platform specific containers.<br/><br/>Used for multi-platform image.
         */
        public ExportImageArguments withPlatformVariants(List<Container> platformVariants) {
            this.platformVariants = platformVariants;
            return this;
        }
         ...
         * Force each layer of the exported image to use the specified compression algorithm.<br/><br/>If this is unset, then if a layer already has a compressed blob in the engine's cache, that will be used (this can result in a mix of compression algorithms for different layers). If this is unset and a layer has no compressed blob in the engine's cache, then it will be compressed using Gzip.
         */
        public ExportImageArguments withForcedCompression(ImageLayerCompression forcedCompression) {
            this.forcedCompression = forcedCompression;
            return this;
        }
         ...
         * Use the specified media types for the exported image's layers.<br/><br/>Defaults to OCI, which is largely compatible with most recent container runtimes, but Docker may be needed for older runtimes without OCI support.
         */
        public ExportImageArguments withMediaTypes(ImageMediaTypes mediaTypes) {
            this.mediaTypes = mediaTypes;
            return this;
        }
    ...
    /**
     * Optional arguments for {@link Container#stat}
     *
     */
    ...
    /**
     * Optional arguments for {@link Container#withDockerHealthcheck}
     *
     */
    public static class WithDockerHealthcheckArguments {
         ...
         */
        public WithDockerHealthcheckArguments withShell(Boolean shell) {
            this.shell = shell;
            return this;
        }
         ...
         */
        public WithDockerHealthcheckArguments withInterval(String interval) {
         ...
         */
        public WithDockerHealthcheckArguments withTimeout(String timeout) {
         ...
         */
        public WithDockerHealthcheckArguments withStartPeriod(String startPeriod) {
         ...
         */
        public WithDockerHealthcheckArguments withStartInterval(String startInterval) {
         ...
         */
        public WithDockerHealthcheckArguments withRetries(Integer retries) {
        ...
        Arguments toArguments() {
            ...
            if (startPeriod != null) {
                builder.add("startPeriod", this.startPeriod);
            }

            if (startInterval != null) {
                builder.add("startInterval", this.startInterval);
            }

            if (retries != null) {
                builder.add("retries", this.retries);
            }
    ...
    public static class WithExecArguments {
         ...
         */
        public WithExecArguments withRedirectStdin(String redirectStdin) {
        ...
        Arguments toArguments() {
            ...
            if (redirectStdin != null) {
                builder.add("redirectStdin", this.redirectStdin);
            }
    ...
    public static class WithMountedDirectoryArguments {
         ...
         */
        public WithMountedDirectoryArguments withReadOnly(Boolean readOnly) {
    ...
    /**
     * Optional arguments for {@link Container#withSymlink}
     *
     */
    public static class WithSymlinkArguments {
        private Boolean expand;

        /**
         * Replace "${VAR}" or "$VAR" in the value of path according to the current environment variables defined in the container (e.g. "/$VAR/foo.txt").
         */
        public WithSymlinkArguments withExpand(Boolean expand) {
            this.expand = expand;
            return this;
        }
