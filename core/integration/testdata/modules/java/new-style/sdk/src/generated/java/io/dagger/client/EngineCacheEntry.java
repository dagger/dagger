...
public class EngineCacheEntry implements Node, IDAble<ID> {
    ...
    /**
     * <p>The DagQL call that produced this cache entry.</p>
     */
    public String dagqlCall() throws InterruptedException, ExecutionException,
            DaggerQueryException {
        if (this.dagqlCall != null) {
            return dagqlCall;
        }
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("dagqlCall");
    ...
    /**
     * <p>The type of the cache record (e.g. regular, internal, frontend, source.local, source.git.checkout, exec.cachemount).</p>
     */
    public String recordType() throws InterruptedException, ExecutionException,
            DaggerQueryException {
        if (this.recordType != null) {
            return recordType;
        }
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("recordType");
        return nextQueryBuilder.executeQuery(java.lang.String.class);
    }

    /**
     * <p>The storage record types represented by this cache entry.</p>
     */
    public List<String> recordTypes() throws InterruptedException, ExecutionException,
            DaggerQueryException {
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("recordTypes");
    ...
    public static class Deserializer implements JsonbDeserializer<EngineCacheEntry> {
        ...
        public EngineCacheEntry deserialize(JsonParser parser, DeserializationContext ctx,
            ...
            EngineCacheEntry o = new EngineCacheEntry(Dagger.dag().nodeQueryBuilder("EngineCacheEntry", new ID(id)));
            return o;
        }
    }
}
