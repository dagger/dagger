...
public class EnumTypeDef implements Node, IDAble<ID> {
    ...
    /**
     * <p>The members of the enum.</p>
     */
    public List<EnumValueTypeDef> members() throws InterruptedException, ExecutionException,
            DaggerQueryException {
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("members");
        nextQueryBuilder = nextQueryBuilder.chain(List.of("id"));
        List<QueryBuilder> builders = nextQueryBuilder.executeObjectListQuery("EnumValueTypeDef");
    ...
    /**
     * <p>The members of the enum.</p>@deprecated use members instead
     */
    @Deprecated
    ...
    public static class Deserializer implements JsonbDeserializer<EnumTypeDef> {
        ...
        public EnumTypeDef deserialize(JsonParser parser, DeserializationContext ctx, Type type) {
            ...
            EnumTypeDef o = new EnumTypeDef(Dagger.dag().nodeQueryBuilder("EnumTypeDef", new ID(id)));
            return o;
        }
    }
}
