...
public class EnumValueTypeDef implements Node, IDAble<ID> {
    ...
    /**
     * <p>The reason this enum member is deprecated, if any.</p>
     */
    ...
    /**
     * <p>A doc string for the enum member, if any.</p>
     */
    ...
    /**
     * <p>The name of the enum member.</p>
     */
    ...
    /**
     * <p>The location of this enum member declaration.</p>
     */
    ...
    /**
     * <p>The value of the enum member</p>
     */
    ...
    public static class Deserializer implements JsonbDeserializer<EnumValueTypeDef> {
        ...
        public EnumValueTypeDef deserialize(JsonParser parser, DeserializationContext ctx,
            ...
            EnumValueTypeDef o = new EnumValueTypeDef(Dagger.dag().nodeQueryBuilder("EnumValueTypeDef", new ID(id)));
            return o;
        }
    }
}
