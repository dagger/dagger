...
public class GitRef implements Node, IDAble<ID> {
    ...
    /**
     * <p>Find the best common ancestor between this ref and another ref.</p>
    ...
    public GitRef commonAncestor(GitRef other) {
        ...
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("commonAncestor", fieldArgs);
    ...
    public static class Deserializer implements JsonbDeserializer<GitRef> {
        ...
        public GitRef deserialize(JsonParser parser, DeserializationContext ctx, Type type) {
            ...
            GitRef o = new GitRef(Dagger.dag().nodeQueryBuilder("GitRef", new ID(id)));
            return o;
        }
    }
    ...
    public static class TreeArguments {
         ...
         */
        public TreeArguments withIncludeTags(Boolean includeTags) {
        ...
        Arguments toArguments() {
            ...
            if (includeTags != null) {
                builder.add("includeTags", this.includeTags);
            }
