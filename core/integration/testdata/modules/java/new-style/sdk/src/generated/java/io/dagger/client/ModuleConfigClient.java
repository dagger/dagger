...
public class ModuleConfigClient implements Node, IDAble<ID> {
    ...
    public static class Deserializer implements JsonbDeserializer<ModuleConfigClient> {
        ...
        public ModuleConfigClient deserialize(JsonParser parser, DeserializationContext ctx,
            ...
            ModuleConfigClient o = new ModuleConfigClient(Dagger.dag().nodeQueryBuilder("ModuleConfigClient", new ID(id)));
            return o;
        }
    }
}
