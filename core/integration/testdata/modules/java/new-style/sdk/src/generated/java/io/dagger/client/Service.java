...
public class Service implements Node, Syncer, IDAble<ID> {
    ...
    /**
     * <p>Forces evaluation of the pipeline in the engine.</p>
     */
    public Service sync() throws InterruptedException, ExecutionException, DaggerQueryException {
     ...
     */
    public Service terminal(TerminalArguments optArgs) {
        Arguments.Builder builder = Arguments.newBuilder();
        Arguments fieldArgs = builder.build();
        fieldArgs = fieldArgs.merge(optArgs.toArguments());
    ...
    public static class Deserializer implements JsonbDeserializer<Service> {
        ...
        public Service deserialize(JsonParser parser, DeserializationContext ctx, Type type) {
            ...
            Service o = new Service(Dagger.dag().nodeQueryBuilder("Service", new ID(id)));
            return o;
        }
    }
    ...
    /**
     * Optional arguments for {@link Service#terminal}
     *
     */
