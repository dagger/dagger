...
class CustomIface(typing.Protocol):
    ...
    @dagger.function
    def obj_list(self) -> list[dagger.Directory]: ...
    ...
    @dagger.function
    def static_other_iface_list(self) -> list[OtherIface]: ...

    @dagger.function
    def with_other_iface(self, other: OtherIface) -> typing.Self: ...

    @dagger.function
    def dynamic_other_iface_list(self) -> list[OtherIface]: ...

    @dagger.function
    def with_other_iface_by_iface(self, other: OtherIface) -> typing.Self: ...

    @dagger.function
    def dynamic_other_iface_by_iface_list(self) -> list[OtherIface]: ...
...
class Test:
    ...
    @dagger.function
    def void(self, iface: CustomIface):
        iface.void()

    @dagger.function
    def str_(self, iface: CustomIface) -> str:
        return iface.str_()
    ...
    @dagger.function
    def str_list(self, iface_arg: CustomIface) -> list[str]:
        return iface_arg.str_list()
    ...
    @dagger.function
    def int_(self, iface: CustomIface) -> int:
        return iface.int_()
    ...
    @dagger.function
    def int_list(self, iface_arg: CustomIface) -> list[int]:
        return iface_arg.int_list()
    ...
    @dagger.function
    def bool_(self, iface: CustomIface) -> bool:
        return iface.bool_()
    ...
    @dagger.function
    def bool_list(self, iface_arg: CustomIface) -> list[bool]:
        return iface_arg.bool_list()
    ...
    @dagger.function
    def obj_list(self, iface: CustomIface) -> list[dagger.Directory]:
        return iface.obj_list()
    ...
    @dagger.function
    def static_other_iface_list(self, iface: CustomIface) -> list[OtherIface]:
        return iface.static_other_iface_list()
    ...
    @dagger.function
    def dynamic_other_iface_list(self, iface: CustomIface) -> list[OtherIface]:
        return iface.dynamic_other_iface_list()
    ...
    @dagger.function
    def dynamic_other_iface_by_iface_list(self, iface: CustomIface) -> list[OtherIface]:
        return iface.dynamic_other_iface_by_iface_list()

    @dagger.function
    def iface_list_args(
        self, ifaces: list[CustomIface], other_ifaces: list[OtherIface]
    ) -> list[str]:
        return [iface.str_() for iface in ifaces] + [
            iface.foo() for iface in other_ifaces
        ]

    @dagger.function
    def with_iface(self, iface: CustomIface) -> typing.Self:
        self.IfaceField = iface
        return self
    ...
    @dagger.function
    def parent_iface_fields(self) -> list[str]:
        strs: list[str] = []

        if self.iface_field is not None:
            strs.append(self.iface_field.str_())

        if self.iface_private_field is not None:
            strs.append(self.iface_private_field.str_())

        strs.extend(iface.str_() for iface in self.iface_list_field)
        strs.extend(iface.foo() for iface in self.other_iface_list_field)
