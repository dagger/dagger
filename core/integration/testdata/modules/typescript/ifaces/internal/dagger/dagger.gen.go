...
import (
	...
	"dagger/caller/internal/querybuilder"
	"dagger/caller/internal/telemetry"
)
...
func (r *Binding) AsImplLocalOtherIface() *ImplLocalOtherIface {
...
func (r *Binding) AsImplOtherImpl() *ImplOtherImpl {
...
func (r *Binding) AsTestCustomIface() *TestCustomIface {
...
func (r *Binding) AsTestCustomObj() *TestCustomObj {
...
func (r *Binding) AsTestOtherCustomObj() *TestOtherCustomObj {
...
func (r *Binding) AsTestOtherIface() *TestOtherIface {
...
func (r *Env) WithImplInput(name string, value *Impl, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithImplLocalOtherIfaceInput(name string, value *ImplLocalOtherIface, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithImplLocalOtherIfaceOutput(name string, description string) *Env {
...
func (r *Env) WithImplOtherImplInput(name string, value *ImplOtherImpl, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithImplOtherImplOutput(name string, description string) *Env {
...
func (r *Env) WithImplOutput(name string, description string) *Env {
...
func (r *Env) WithTestCustomIfaceInput(name string, value *TestCustomIface, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithTestCustomIfaceOutput(name string, description string) *Env {
...
func (r *Env) WithTestCustomObjInput(name string, value *TestCustomObj, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithTestCustomObjOutput(name string, description string) *Env {
...
func (r *Env) WithTestInput(name string, value *Test, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithTestOtherCustomObjInput(name string, value *TestOtherCustomObj, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithTestOtherCustomObjOutput(name string, description string) *Env {
...
func (r *Env) WithTestOtherIfaceInput(name string, value *TestOtherIface, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithTestOtherIfaceOutput(name string, description string) *Env {
...
func (r *Env) WithTestOutput(name string, description string) *Env {
...
type ImplLocalOtherIface struct {
	query *querybuilder.Selection
...
func (r *Client) Impl(strs []string, ints []int, bools []bool, dirs []*Directory) *Impl {
...
func (r *Client) LoadImplFromID(id ImplID) *Impl {
...
// Load a ImplLocalOtherIface from its ID.
func (r *Client) LoadImplLocalOtherIfaceFromID(id ImplLocalOtherIfaceID) *ImplLocalOtherIface {
	q := r.query.Select("loadImplLocalOtherIfaceFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadImplOtherImplFromID(id ImplOtherImplID) *ImplOtherImpl {
...
// Load a TestCustomIface from its ID.
func (r *Client) LoadTestCustomIfaceFromID(id TestCustomIfaceID) *TestCustomIface {
...
func (r *Client) LoadTestCustomObjFromID(id TestCustomObjID) *TestCustomObj {
...
func (r *Client) LoadTestFromID(id TestID) *Test {
...
func (r *Client) LoadTestOtherCustomObjFromID(id TestOtherCustomObjID) *TestOtherCustomObj {
...
// Load a TestOtherIface from its ID.
func (r *Client) LoadTestOtherIfaceFromID(id TestOtherIfaceID) *TestOtherIface {
	q := r.query.Select("loadTestOtherIfaceFromID")
	q = q.Arg("id", id)
...
func (r *Client) Test() *Test { // test (../../../../../../../../core/integration/testdata/modules/typescript/ifaces/test/src/index.ts:48:14)
