...
func (r *Binding) AsHelloGreetings() *HelloGreetings {
...
func (r *Env) WithHelloGreetingsInput(name string, value *HelloGreetings, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithHelloGreetingsOutput(name string, description string) *Env {
...
func (r *Env) WithHelloInput(name string, value *Hello, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithHelloOutput(name string, description string) *Env {
...
func (r *Client) Hello() *Hello { // hello (../../../../../../../core/integration/testdata/test-blueprint/hello/main.go:9:6)
...
func (r *Client) LoadHelloFromID(id HelloID) *Hello {
...
func (r *Client) LoadHelloGreetingsFromID(id HelloGreetingsID) *HelloGreetings {
