...
// agentTypeName identifies an object-tool argument that MCP fills directly from
// the calling agent when dispatch runs inside an agent loop. It is hidden only
// from the generated tool schema; the module's GraphQL schema remains unchanged.
...
// behavior; LLM and Agent are passed directly by the object-tool adapter. This
