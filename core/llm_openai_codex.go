...
func (c *OpenAICodexClient) SendQuery(ctx context.Context, history []*ModelMessage, tools []LLMTool) (_ *LLMResponse, rerr error) {
				...
				case "function_call":
					...
					if fc.Arguments != "" {
						if err := json.Unmarshal([]byte(fc.Arguments), &args); err != nil {
							slog.Warn("failed to parse tool call args", "error", err)
						}
					}
...
func convertToCodexResponsesFormat(history []*ModelMessage) (systemPrompt string, items []responses.ResponseInputItemUnionParam) {
