...
func (src *ModuleSource) LoadContext(ctx context.Context, path string, dag *dagql.Server) (inst dagql.Instance[*Directory], err error) {
	...
	case ModuleSourceKindLocal:
		...
		ctxPath, err := src.resolveContextPath(ctx)
		if err != nil {
...
func (src *ModuleSource) resolveContextPath(ctx context.Context) (string, error) {
