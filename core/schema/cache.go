...
func (s *cacheSchema) cacheVolumeCacheKey(ctx context.Context, parent dagql.ObjectInstance[*core.Query], args cacheArgs, cacheCfg dagql.CacheConfig) (*dagql.CacheConfig, error) {
	if args.Namespace != "" {
		return &cacheCfg, nil
	}
...
func (s *cacheSchema) cacheVolume(ctx context.Context, parent dagql.ObjectInstance[*core.Query], args cacheArgs) (dagql.Instance[*core.CacheVolume], error) {
