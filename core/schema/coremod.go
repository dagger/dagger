...
func (obj *CoreModScalar) ConvertFromSDKResult(ctx context.Context, value any) (dagql.Value, error) {
...
func (obj *CoreModScalar) CollectCoreIDs(context.Context, dagql.Value, map[digest.Digest]*resource.ID) error {
	return nil
}
...
func (obj *CoreModObject) ConvertFromSDKResult(ctx context.Context, value any) (dagql.Value, error) {
	if value == nil {
...
func (obj *CoreModObject) CollectCoreIDs(ctx context.Context, value dagql.Value, ids map[digest.Digest]*resource.ID) error {
	if value == nil {
		return nil
	}
	switch x := value.(type) {
...
func (enum *CoreModEnum) ConvertFromSDKResult(ctx context.Context, value any) (dagql.Value, error) {
...
func (enum *CoreModEnum) CollectCoreIDs(ctx context.Context, value dagql.Value, ids map[digest.Digest]*resource.ID) error {
	return nil
}
