...
func (s *directorySchema) withErrorMessage(ctx context.Context, parent dagql.ObjectResult[*core.Directory], args struct{ Err string }) (dagql.ObjectResult[*core.Directory], error) {
	_ = ctx
	if args.Err == "" {
		return parent, nil
	}
