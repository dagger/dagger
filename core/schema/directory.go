...
func (s *directorySchema) withNewFile(ctx context.Context, parent dagql.Instance[*core.Directory], args WithNewFileArgs) (inst dagql.Instance[*core.Directory], err error) {
