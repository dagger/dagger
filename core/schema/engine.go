...
func (s *engineSchema) cacheEntrySet(ctx context.Context, parent dagql.ObjectInstance[*core.EngineCache], args struct {
	Key string `default:""`
	...
	return dagql.NewInstanceForCurrentID(ctx, entrySet)
}
