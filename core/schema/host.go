...
func (s *hostSchema) setSecretFile(ctx context.Context, host dagql.ObjectInstance[*core.Host], args setSecretFileArgs) (inst dagql.Instance[*core.Secret], err error) {
...
func (s *hostSchema) directory(ctx context.Context, host dagql.ObjectInstance[*core.Host], args hostDirectoryArgs) (i dagql.Instance[*core.Directory], err error) {
...
func (s *hostSchema) socketCacheKey(
	ctx context.Context,
	host dagql.ObjectInstance[*core.Host],
	args hostSocketArgs,
...
func (s *hostSchema) socket(ctx context.Context, host dagql.ObjectInstance[*core.Host], args hostSocketArgs) (inst dagql.Instance[*core.Socket], err error) {
	query, err := core.CurrentQuery(ctx)
	if err != nil {
		return inst, err
	}
...
func (s *hostSchema) file(ctx context.Context, host dagql.ObjectInstance[*core.Host], args hostFileArgs) (i dagql.Instance[*core.File], err error) {
...
func (s *hostSchema) service(ctx context.Context, parent dagql.ObjectInstance[*core.Host], args hostServiceArgs) (inst dagql.Instance[*core.Service], err error) {
	if len(args.Ports) == 0 {
