...
func (s *moduleSchema) Install(dag *dagql.Server) {
	...
	dagql.Fields[*core.Function]{
		...
		dagql.Func("withGenerator", s.functionWithGenerator).
			...
			Args(
				dagql.Arg("path").Doc(`Location of generated content`),
			),
...
func (s *moduleSchema) functionWithGenerator(ctx context.Context, fn *core.Function, args struct {
	Path string
}) (*core.Function, error) {
	return fn.WithGenerator(args.Path), nil
}
