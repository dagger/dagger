...
func (s *querySchema) Install(srv *dagql.Server) {
	...
	srv.InstallObject(dagql.NewClass[*core.RemoteGitMirror](srv).View(AfterVersion("v0.20.7")))
	srv.InstallObject(dagql.NewClass[*core.ClientFilesyncMirror](srv).View(AfterVersion("v0.20.7")))
