...
func (s *querySchema) Install(srv *dagql.Server) {
	...
	srv.InstallObject(dagql.NewClass(srv, dagql.ClassOpts[*core.RemoteGitMirror]{View: AfterVersion("v0.20.7")}))
	srv.InstallObject(dagql.NewClass(srv, dagql.ClassOpts[*core.ClientFilesyncMirror]{View: AfterVersion("v0.20.7")}))
