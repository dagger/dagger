...
func (s *secretSchema) Install() {
	dagql.Fields[*core.Query]{
		dagql.FuncWithCacheKey("setSecret", s.setSecret, core.Impure).
		...
		dagql.FuncWithCacheKey("secret", s.secret, core.Impure).
	...
	dagql.Fields[*core.Secret]{
		...
		dagql.FuncWithCacheKey("plaintext", s.plaintext, core.Impure).
			Sensitive().
