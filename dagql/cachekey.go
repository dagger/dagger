...
func CacheAsRequested[T Typed, A CacheControllableArgs](ctx context.Context, i ObjectInstance[T], a A, cc CacheConfig) (*CacheConfig, error) {
	switch a.CacheType() {
...
func CachePerSchema[P Typed, A any](srv *Server) func(context.Context, ObjectInstance[P], A, CacheConfig) (*CacheConfig, error) {
	return func(
		ctx context.Context,
		_ ObjectInstance[P],
		_ A,
...
func CachePerClientSchema[P Typed, A any](srv *Server) func(context.Context, ObjectInstance[P], A, CacheConfig) (*CacheConfig, error) {
	return func(
		ctx context.Context,
		_ ObjectInstance[P],
		_ A,
