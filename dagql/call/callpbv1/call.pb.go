...
var file_call_proto_depIdxs = []int32{
	...
	5,  // 6: dagger.Argument.value:type_name -> dagger.Literal
	6,  // 7: dagger.Literal.list:type_name -> dagger.List
	7,  // 8: dagger.Literal.object:type_name -> dagger.Object
	5,  // 9: dagger.List.values:type_name -> dagger.Literal
	4,  // 10: dagger.Object.values:type_name -> dagger.Argument
	8,  // 11: dagger.Type.elem:type_name -> dagger.Type
