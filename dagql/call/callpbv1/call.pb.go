...
type Call struct {
	...
	// XXX: marks whether this ID can be saved-and-restored over a rmeote
	// execution hook
	IsRemoteable bool `protobuf:"varint,12,opt,name=isRemoteable,proto3" json:"isRemoteable,omitempty"`
}
...
func (x *Call) GetIsRemoteable() bool {
	if x != nil {
		return x.IsRemoteable
	}
	return false
}
...
var file_call_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x22, 0xbe, 0x02, 0x0a, 0x04, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x26, 0x0a, 0x0e, 0x72,
	...
	0x22, 0x0a, 0x0c, 0x69, 0x73, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x61, 0x62, 0x6c, 0x65, 0x18,
	0x0c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x69, 0x73, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x61,
	0x62, 0x6c, 0x65, 0x22, 0x60, 0x0a, 0x06, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x12, 0x1e, 0x0a,
