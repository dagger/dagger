...
import (
	...
	"dagger/brokendep/internal/querybuilder"
	"dagger/brokendep/internal/telemetry"
)
...
// The `BrokenID` scalar type represents an identifier for an object of type Broken.
type BrokenID string
...
// Retrieve the binding value, as type Broken
func (r *Binding) AsBroken() *Broken {
	q := r.query.Select("asBroken")
...
type Broken struct { // broken (../../../../../../dagql/idtui/viztest/broken-dep/broken/main.go:3:6)
	query *querybuilder.Selection
...
func (r *Broken) WithGraphQLQuery(q *querybuilder.Selection) *Broken {
	return &Broken{
		query: q,
	}
}

func (r *Broken) Broken(ctx context.Context) error { // broken (../../../../../../dagql/idtui/viztest/broken-dep/broken/main.go:5:1)
	if r.broken != nil {
		return nil
	}
	q := r.query.Select("broken")

	return q.Execute(ctx)
}

// A unique identifier for this Broken.
func (r *Broken) ID(ctx context.Context) (BrokenID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response BrokenID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Broken) XXX_GraphQLType() string {
	return "Broken"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Broken) XXX_GraphQLIDType() string {
	return "BrokenID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Broken) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Broken) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *Broken) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadBrokenFromID(BrokenID(id))
	return nil
}
...
// Create or update a binding of type Broken in the environment
func (r *Env) WithBrokenInput(name string, value *Broken, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withBrokenInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired Broken output to be assigned in the environment
func (r *Env) WithBrokenOutput(name string, description string) *Env {
	q := r.query.Select("withBrokenOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
func (r *Client) Broken() *Broken { // broken (../../../../../../dagql/idtui/viztest/broken-dep/broken/main.go:3:6)
	q := r.query.Select("broken")
...
// Load a Broken from its ID.
func (r *Client) LoadBrokenFromID(id BrokenID) *Broken {
	q := r.query.Select("loadBrokenFromID")
	q = q.Arg("id", id)
