...
func (r *Binding) AsNestedDep() *NestedDep {
...
func (r *Env) WithNestedDepInput(name string, value *NestedDep, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithNestedDepOutput(name string, description string) *Env {
...
func (r *Client) LoadNestedDepFromID(id NestedDepID) *NestedDep {
...
func (r *Client) NestedDep() *NestedDep { // nested-dep (../../../../../../dagql/idtui/viztest/dep/nested-dep/main.go:8:6)
