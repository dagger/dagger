...
func (r *Binding) AsVersioned() *Versioned {
...
func (r *Env) WithVersionedInput(name string, value *Versioned, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithVersionedOutput(name string, description string) *Env {
...
func (r *Client) Dep() *Dep { // dep (../../../../../dagql/idtui/viztest/dep/main.go:9:6)
...
func (r *Client) LoadVersionedFromID(id VersionedID) *Versioned {
...
func (r *Client) Versioned() *Versioned { // versioned (https://github.com/dagger/dagger-test-modules/tree/73670b0338c02cdd190f56b34c6e25066c7c8875/versioned/main.go#L3)
