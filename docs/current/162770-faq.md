...
1. Remove the `dagger` sub-directory of your `$XDG_CACHE_HOME` and `$XDG_CONFIG_HOME` directories.
  ...
  - NodeJS: [https://github.com/sindresorhus/env-paths](https://github.com/sindresorhus/env-paths)
