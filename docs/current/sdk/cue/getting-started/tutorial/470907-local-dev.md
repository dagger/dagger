---
slug: /sdk/cue/470907/local-dev
pagination_next: current/sdk/cue/getting-started/tutorial/ci-environment
---
...
:::tip
[The `dagger-cue` CLI is available for install](/install) on macOS, Linux, and Windows to run locally or in CI
:::
