...
slug: /adopting/container-runtimes/
---
...
If you need to override the default you can set `_EXPERIMENTAL_DAGGER_RUNNER_HOST`, using the [connection interface](/reference/configuration/custom-runner#connection-interface).
