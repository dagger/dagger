...
Before enabling trace export broadly, review what logs and metadata your workflows emit. CI traces can include repository metadata such as branch, commit, and status. For team rollout guidance, see [Security and Operations](/adopting/security#trace-data).
