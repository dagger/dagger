...
slug: /adopting/scaling/kubernetes
---
...
- Dagger's Helm chart is continuously tested [on K3s via Go e2e tests](https://github.com/dagger/dagger/blob/main/e2e/helm/helm_test.go) in CI
