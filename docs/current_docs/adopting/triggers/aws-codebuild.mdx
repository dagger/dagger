...
:::tip
For checks with no buildspec at all, enable [Cloud Checks](./index.mdx) with `dagger cloud check on`. The buildspec below is the hybrid-mode alternative for when you want to drive Dagger from your existing AWS CodeBuild setup.
:::
