...
- `ANTHROPIC_MODEL`: if unset, defaults to latest Claude 3.5 Sonnet
- **optional extras**
	- `ANTHROPIC_BASE_URL`: if unset, defaults to `"https://api.anthropic.com"`
...
- **optional extras**
  - `GEMINI_BASE_URL`: if unset, defaults to `https://generativelanguage.googleapis.com`
