...
Toy-workspace is a Dagger module that provides a simple environment for the agent. It has a `Container` object and functions to read, write, and build the code.
