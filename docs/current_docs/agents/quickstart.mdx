...
Now that you've grasped the basics of building an agent, look at the [Dagger AI Agents](/examples#ai-agent-examples) page for more examples and ideas for your next agent.
