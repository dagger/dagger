...
```bash
dagger init --sdk {your sdk choice} --name coding-agent
```
...
Toy-workspace is a Dagger module that provides a simple workspace for the agent. It has a Container as it's state and functions to read, write, and build the code.
...
Now that you've grasped the basics of building an agent, look at the [Dagger AI Agents](/ai-agents#examples) page for more examples and ideas for your next agent.
