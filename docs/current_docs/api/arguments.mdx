...
- To set the argument to true: `--foo=true` or `--foo` (Dagger CLI), `true` (Dagger Shell)
- To set the argument to false: `--foo=false` (Dagger CLI), `false` (Dagger Shell)
...
<TabItem value="Dagger Shell">
```shell title="Type 'dagger' to start Dagger Shell in interactive mode and enter the command below."
container | from alpine:latest  | with-directory /src https://github.com/dagger/dagger | with-exec ls /src | stdout
```
</TabItem>
<TabItem value="Dagger CLI">
```shell
...
<TabItem value="Dagger Shell">
```shell title="Type 'dagger' to start Dagger Shell in interactive mode and enter the command below."
container | from alpine:latest  | with-directory /src ssh://git@github.com/dagger/dagger | with-exec ls /src | stdout
```
</TabItem>
<TabItem value="Dagger CLI">
```shell
...
Function arguments can be marked as optional. In this case, the Dagger CLI and Dagger Shell will not display an error if the argument is omitted in the function call.
