...
```go file=../cookbook/snippets/cache-volumes/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../cookbook/snippets/cache-volumes/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../cookbook/snippets/cache-volumes/typescript/index.ts
```
