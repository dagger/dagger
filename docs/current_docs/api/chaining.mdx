...
This manual contains many more examples of function chaining with the Dagger CLI. However, what's important to know is that just as you can chain Dagger Functions with the Dagger CLI, you can also chain Dagger Functions (including Dagger Functions created by others) using the programming language you're most comfortable with.
