...
Stable Dagger SDKs are currently available for Go, TypeScript and Python. There are also [SDKs contributed by the community](https://github.com/dagger/dagger/tree/main/sdk).
...
<TabItem value="PHP">
```php file=./snippets/functions/functions-complex/php/MyModule.php
```
</TabItem>
</Tabs>
...
Starting tests for PHP 8.4...
Completed tests for PHP 8.4
```
</TabItem>
</Tabs>
