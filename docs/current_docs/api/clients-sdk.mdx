...
:::note
The Dagger Python SDK requires [Python 3.11 or later](https://docs.python.org/3/using/index.html).
:::
...
Try the Go program by executing the commands below:
