...
- Dagger Functions do not have direct access to the host system resources such as directories, files, environment variables, network services. This "sandboxing" of Dagger Functions improves security, ensures reproducibility, and assists caching.
