...
- You can [call the Dagger API](./calling.mdx) from the Dagger CLI using `dagger core...`, from a custom tool created with a Dagger SDK using `dagger run ...`, or from a third-party HTTP client using `dagger query ...`.
