...
- From the [Dagger CLI](./clients-cli.mdx)
...
- From a [Dagger Function](./clients-cli.mdx#dagger-functions)
- From a [custom application created with a Dagger SDK](./clients-sdk.mdx)
- From a [command-line HTTP client](./clients-http.mdx#command-line-http-clients) or a [language-native GraphQL client](./clients-http.mdx#language-native-http-clients)
