...
- The main object must use the same name as the module, in PascalCase. For instance if the module name is `my-module`, the main object must be named `MyModule`.
