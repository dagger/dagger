...
This is why the initial `package.json` doesn't include any dependencies except TypesScript.
...
:::note
To configure the SDK as a local vendored dependency, read [configure SDK origin](#ts-configure-sdk-origin).
:::
