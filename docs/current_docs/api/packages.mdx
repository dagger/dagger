...
:::warning
Composer should not be used for Dagger modules, even those written using the PHP SDK.
[Module dependencies should always be installed through Dagger](./module-dependencies.mdx).
:::
