...
Dagger also lets you import [private Go modules](https://go.dev/ref/mod#private-modules) in your Dagger module. To do this, add the URL to your private repository(ies) in your `dagger.json` file, as shown below:
