...
To verify your credentials are properly configured, try cloning a private repository:
...
#### Common Git Credential Manager Setups
...
- **BitBucket**: Use [Git Credential Manager](https://github.com/git-ecosystem/git-credential-manager)
