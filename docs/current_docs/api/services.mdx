...
```go file=./snippets/services/create-interconnected-services/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=./snippets/services/create-interconnected-services/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=./snippets/services/create-interconnected-services/typescript/index.ts
```
