...
- Learn more about key Dagger concepts like [function chaining](extending/index.mdx#chaining), [just-in-time artifacts](extending/return-values.mdx), and [pipeline visualization](features/visualization.mdx).
