...
- Learn more about key Dagger concepts like [function chaining](extending/index.mdx#chaining), [just-in-time artifacts](extending/return-types.mdx), and [pipeline visualization](../features/visualization.mdx).
