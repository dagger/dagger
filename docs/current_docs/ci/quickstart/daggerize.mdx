...
3. Use `dagger` to run and test your pipeline locally. Once you're satisfied, transfer your Dagger module and your `dagger` commands to your CI configuration.
:::
