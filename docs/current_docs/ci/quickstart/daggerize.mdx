...
3. Use the Dagger Sehell to run and test your pipeline locally. Once you're satisfied, transfer your Dagger module to your CI configuration.
:::
...
Dagger Shell is the fastest way to interact with the Dagger API, allowing access to both core types and custom Dagger Functions using a familiar Bash-like syntax. You'll run most of the commands in this quickstart within Dagger Shell.
...
Start Dagger Shell in interactive mode:

```shell
dagger
```

At the interactive prompt, run the command below:
