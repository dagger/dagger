...
Run checks with a named [environment](./environments.mdx) overlay applied:
...
To automate checks on every push without configuring runners, see [Triggers](../adopting/triggers/index.mdx).
