...
import Directory from '../../partials/types/directory.mdx';
...
<CodeBlock
language="go" title="Mount a directory to a container" file="../../cookbook/snippets/mount-dir/go/main.go" />
</TabItem>
