...
Values that shouldn't be committed — private profiles, local paths, personal
clusters — belong in your [user configuration](./user.mdx), which can also
define environments of its own on top of the repository's.
