...
1. Configure [Docker Model Runner](https://docs.docker.com/desktop/features/model-runner/) with Docker Desktop. Enable host-side TCP support so that Dagger can connect to the endpoint
2. Pull any model from [Docker Hub](https://hub.docker.com/u/ai) such as `ai/qwen2.5`
