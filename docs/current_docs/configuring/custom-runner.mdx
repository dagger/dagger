---
slug: /configuring/custom-runner
---
...
By default, Dagger allows execs to run with root capabilities when the `InsecureRootCapabilities` field is set to true in the `WithExec` API.
