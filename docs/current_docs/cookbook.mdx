...
```typescript file=./cookbook/snippets/filesystem-operations/add-git-dir/index.mjs
```
...
```typescript file=./cookbook/snippets/filesystem-operations/add-git-dir-exclude/index.mjs
```
...
```typescript file=./cookbook/snippets/filesystem-operations/add-git-dir-include/index.mjs
```
...
```typescript file=./cookbook/snippets/filesystem-operations/add-git-dir-exclude-include/index.mjs
```
...
```typescript file=./guides/snippets/multi-builds/index.mjs
```
...
```typescript file=./quickstart/snippets/build-dockerfile/index.mjs
```
...
```typescript file=./cookbook/snippets/build-dockerfile/index.mjs
```
...
```typescript file=./cookbook/snippets/oci-annotations/index.mjs
```
...
```typescript file=./cookbook/snippets/cache-invalidation/index.mjs
```
...
```typescript file=./guides/snippets/use-services/use-db-service/index.ts
```
...
```typescript file=./guides/snippets/use-secrets/sdk/index.mjs
```
...
```typescript file=./guides/snippets/load-images-local-docker-engine/export/index.mjs
```
...
```typescript file=./cookbook/snippets/multiple-tags/index.mjs
```
...
```typescript file=./guides/snippets/use-secrets/host-env/index.mjs
```
...
```typescript file=./guides/snippets/use-secrets/host-fs/index.mjs
```
...
```typescript file=./guides/snippets/use-secrets/dockerfile/index.mjs
```
...
```typescript file=./guides/snippets/use-secrets/external/index.mjs
```
...
```typescript file=./cookbook/snippets/secrets-vault/index.mjs
```
...
```typescript file=./cookbook/snippets/mount-directories-as-secrets/index.ts
```
...
```typescript file=./cookbook/snippets/error-handling/aborting/index.mjs
```
...
```typescript file=./cookbook/snippets/error-handling/exit-code/index.mjs
```
...
```typescript file=./cookbook/snippets/error-handling/postmortem/index.mjs
```
...
```typescript file=./cookbook/snippets/cache-dependencies/index.mjs
```
...
```typescript file=./guides/snippets/use-services/persist-service-state/index.ts
```
...
```typescript file=./guides/snippets/custom-callbacks/environment-variables/index.mts
```
...
```typescript file=./cookbook/snippets/docker-engine-host/index.mjs
```
...
```typescript file=./cookbook/snippets/tailscale-networking/index.mjs
```
...
```typescript file=./guides/snippets/github-google-cloud/index.mjs
```
