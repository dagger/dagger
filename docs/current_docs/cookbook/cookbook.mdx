...
```go file=../api/snippets/custom-spans/go/main.go
```

</TabItem>
<TabItem value="Python">
```python file=../api/snippets/custom-spans/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../api/snippets/custom-spans/typescript/index.ts
```
