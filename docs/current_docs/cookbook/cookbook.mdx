...
- Use a secret from 1Password:
  ...
  [1Password service accounts](https://developer.1password.com/docs/service-accounts/) are also supported:
    ...
    ```shell
    SERVICE_ACCOUNT=user dagger call github-api --token=op://infra/github/credential
    ```
...
- Use a secret from Vault:
  ...
  [Vault AppRole authentication](https://developer.hashicorp.com/vault/docs/auth/approle) is also supported:
    ...
    ```shell
    VAULT_ADDR="https://127.0.0.1:8200" VAULT_APPROLE_ROLE_ID="900589d0-5570-46cf-b0f3-ecfbd7d51336" VAULT_APPROLE_SECRET_ID="3bf095ca-0eb9-4a35-bdfb-f550afe4ba40" dagger call github-api --token=vault://credentials.github
    ```
