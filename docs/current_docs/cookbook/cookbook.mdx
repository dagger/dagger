...
The following Dagger Function accepts a `Directory` argument, which could reference either a directory from the local filesystem or from a [remote Git repository](../api/remote-repositories.mdx). It mounts the specified directory to the `/src` path in a container and returns the modified container.
...
```java file=./snippets/mount-dir/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/copy-dir/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/copy-modify-dir/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/clone-git-repository/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```

</TabItem>
<TabItem value="Java (SSH)">

```java file=./snippets/clone-git-repository-ssh/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/mount-file/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/copy-file/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/copy-filter-dir-post/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/read-file-http/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/copy-file-runtime/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/copy-filter-dir-pre/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/set-common-default-path/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/builds/multi-stage-build/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/builds/matrix-build/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/builds/multi-arch/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/builds/multi-arch-cc/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/builds/dockerfile/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/builds/dockerfile-context/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/builds/oci-annotations/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/builds/oci-labels/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/builds/cache/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/secret-variable/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/secret-file/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/secret-dockerfile/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=../api/snippets/services/bind-services/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=../api/snippets/services/expose-dagger-services-to-host/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=../api/snippets/services/expose-host-services-to-dagger/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```go file=../api/snippets/services/use-endpoint/go/main.go
```

</TabItem>
<TabItem value="python" label="Python">

```python file=../api/snippets/services/use-endpoint/python/main.py
```

</TabItem>
<TabItem value="typescript" label="TypeScript">

```typescript file=../api/snippets/services/use-endpoint/typescript/index.ts
```
...
```java file=../api/snippets/services/test-against-db-service/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=../api/snippets/services/start-stop-services/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=../api/snippets/services/create-interdependent-services/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/publish-image/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/tag-publish-image/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/load-image-host/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/export-file-dir/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/export-container/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/cache-dependencies/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/set-env-var/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/set-env-vars/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=../api/snippets/services/persist-service-state/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=./snippets/handle-errors/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```

:::note
`ExecutionException`, `DaggerQueryException`, `InterruptedException` are the three exception you might need
to catch or throw. In the above code, it catches a `DaggerExecException`. This exception extends `DaggerQueryException`
so you don't necessarily need to catch it, but in this case it gives you more information about the error by
providing easy access to standard output and error, exit code and the failed command.
:::
...
```java file=./snippets/continue-after-errors/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
```java file=./snippets/continue-after-errors/java/src/main/java/io/dagger/modules/mymodule/TestResult.java
```
...
```java file=../api/snippets/debugging/java/terminal-container/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=../api/snippets/debugging/java/terminal-directory-1/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
...
```java file=../api/snippets/debugging/java/terminal-directory-2/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
