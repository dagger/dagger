...
The following Dagger Function demonstrates how to open interactive terminal sessions to debug a container build at different stages in a Dagger pipeline.
...
Execute a Dagger Function to build a container, and open interactive terminals at two different points in the build process. The interactive terminal enables you to inspect the container filesystem and environment "live", during the build process.

```shell
# build a container
# inspect it interactively during the build
