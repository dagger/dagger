...
```go file=../manuals/developer/snippets/secrets/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../manuals/developer/snippets/secrets/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../manuals/developer/snippets/secrets/typescript/index.ts
```
