...
- Use a secret from Vault:
  ...
  [Vault AppRole authentication](https://developer.hashicorp.com/vault/docs/auth/approle) is also supported:
    ...
    ```shell
    VAULT_ADDR="https://127.0.0.1:8200" VAULT_APPROLE_ROLE_ID="xx-role-id" VAULT_APPROLE_SECRET_ID="yy-secret-id" dagger call github-api --token=vault://credentials.github
    ```
