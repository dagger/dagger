...
:::tip
Besides helping with the final image size, mounts are more performant and resource efficient. The rule of thumb should be to always try using mounts when possible.
:::
