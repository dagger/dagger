...
```go file=../manuals/developer/snippets/services/bind-services/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../manuals/developer/snippets/services/bind-services/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../manuals/developer/snippets/services/bind-services/typescript/index.ts
```
...
```go file=../manuals/developer/snippets/services/expose-dagger-services-to-host/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../manuals/developer/snippets/services/expose-dagger-services-to-host/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../manuals/developer/snippets/services/expose-dagger-services-to-host/typescript/index.ts
```
...
```go file=../manuals/developer/snippets/services/expose-host-services-to-dagger/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../manuals/developer/snippets/services/expose-host-services-to-dagger/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../manuals/developer/snippets/services/expose-host-services-to-dagger/typescript/index.ts
```
...
```go file=../manuals/developer/snippets/services/test-against-db-service/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../manuals/developer/snippets/services/test-against-db-service/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../manuals/developer/snippets/services/test-against-db-service/typescript/index.ts
```
...
```go file=../manuals/developer/snippets/services/start-stop-services/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../manuals/developer/snippets/services/start-stop-services/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../manuals/developer/snippets/services/start-stop-services/typescript/index.ts
```
...
```go file=../manuals/developer/snippets/services/persist-service-state/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../manuals/developer/snippets/services/persist-service-state/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../manuals/developer/snippets/services/persist-service-state/typescript/index.ts
```
...
Dagger lets you open an interactive terminal session at any point in a Dagger pipeline, with all the required context available. This is similar to debugger breakpoints, and is a useful way to debug pipeline failures, as all context is available at the point of failure. Multiple terminals are supported in the same Dagger Function; they will open in sequence.
...
```go file=../manuals/developer/snippets/debugging/go/terminal-container/main.go
```

</TabItem>
<TabItem value="Python">
```python file=../manuals/developer/snippets/debugging/python/terminal-container/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../manuals/developer/snippets/debugging/typescript/terminal-container/index.ts
```
...
```go file=../manuals/developer/snippets/debugging/go/terminal-directory-1/main.go
```

</TabItem>
<TabItem value="Python">
```python file=../manuals/developer/snippets/debugging/python/terminal-directory-1/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../manuals/developer/snippets/debugging/typescript/terminal-directory-1/index.ts
```
...
```go file=../manuals/developer/snippets/debugging/go/terminal-directory-2/main.go
```

</TabItem>
<TabItem value="Python">
```python file=../manuals/developer/snippets/debugging/python/terminal-directory-2/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../manuals/developer/snippets/debugging/typescript/terminal-directory-2/index.ts
```
