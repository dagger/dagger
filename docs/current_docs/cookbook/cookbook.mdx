...
```java file=./snippets/copy-modify-dir/java/MyModule.java
```
...
```java file=./snippets/clone-git-repository/java/MyModule.java
```
...
```java file=./snippets/copy-file/java/MyModule.java
```
...
```java file=./snippets/copy-filter-dir-post/java/MyModule.java
```
...
```java file=./snippets/read-file-http/java/MyModule.java
```
...
```java file=./snippets/copy-file-runtime/java/MyModule.java
```
...
```java file=./snippets/copy-filter-dir-pre/java/MyModule.java
```
...
```java file=./snippets/set-common-default-path/java/MyModule.java
```
...
```java file=./snippets/builds/multi-stage-build/java/MyModule.java
```
...
```java file=./snippets/builds/matrix-build/java/MyModule.java
```
...
```java file=./snippets/builds/multi-arch/java/MyModule.java
```
...
```java file=./snippets/builds/multi-arch-cc/java/MyModule.java
```
...
```java file=./snippets/builds/dockerfile/java/MyModule.java
```
...
```java file=./snippets/builds/dockerfile-context/java/MyModule.java
```
...
```java file=./snippets/builds/oci-annotations/java/MyModule.java
```
...
```java file=./snippets/builds/oci-labels/java/MyModule.java
```
...
```java file=./snippets/builds/cache/java/MyModule.java
```
...
- Use a secret from 1Password:
  ...
  [1Password service accounts](https://developer.1password.com/docs/service-accounts/) are also supported:
...
- Use a secret from Vault:
  ...
  [Vault AppRole authentication](https://developer.hashicorp.com/vault/docs/auth/approle) is also supported:
...
```java file=./snippets/secret-file/java/MyModule.java
```
...
```java file=./snippets/secret-dockerfile/java/MyModule.java
```
