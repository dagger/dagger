...
### Mount a directory or remote repository in a container
...
:::note
Mounted directories or files are only available during the execution of the Dagger Function. They are not copied to, or included, in the final image. These mounts only take effect within your pipeline invocation; this means that any changes to mounted files and/or directories will only be reflected in the target directory and not in the mount sources.
:::
...
### Mount a local or remote file in a container
...
:::note
Mounted directories or files are only available during the execution of the Dagger Function. They are not copied to, or included, in the final image. Dagger uses non-directional bind mounts; this means that changes made to the mounted directory or file, either in the container filesystem or in the source, will not be reflected in the other location.
:::
