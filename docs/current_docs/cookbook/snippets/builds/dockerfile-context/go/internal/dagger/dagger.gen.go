...
// The `ContainerdID` scalar type represents an identifier for an object of type Containerd.
type ContainerdID string
...
// Retrieve the binding value, as type Containerd
func (r *Binding) AsContainerd() *Containerd {
	q := r.query.Select("asContainerd")
...
type Containerd struct { // containerd (https://github.com/levlaz/daggerverse/tree/abcd1a95cef14ad336ca21a9ab836869582617bb/containerd/dagger/main.go#L8)
	query *querybuilder.Selection

	architectureOf *string
	id             *ContainerdID
}

func (r *Containerd) WithGraphQLQuery(q *querybuilder.Selection) *Containerd {
	return &Containerd{
		query: q,
	}
}
...
func (r *Containerd) ArchitectureOf(ctx context.Context, platform Platform) (string, error) { // containerd (https://github.com/levlaz/daggerverse/tree/abcd1a95cef14ad336ca21a9ab836869582617bb/containerd/dagger/main.go#L11)
	if r.architectureOf != nil {
		return *r.architectureOf, nil
	}
	q := r.query.Select("architectureOf")
...
// A unique identifier for this Containerd.
func (r *Containerd) ID(ctx context.Context) (ContainerdID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response ContainerdID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Containerd) XXX_GraphQLType() string {
	return "Containerd"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Containerd) XXX_GraphQLIDType() string {
	return "ContainerdID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Containerd) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Containerd) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *Containerd) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadContainerdFromID(ContainerdID(id))
	return nil
}
...
// Create or update a binding of type Containerd in the environment
func (r *Env) WithContainerdInput(name string, value *Containerd, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withContainerdInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired Containerd output to be assigned in the environment
func (r *Env) WithContainerdOutput(name string, description string) *Env {
	q := r.query.Select("withContainerdOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
func (r *Client) Containerd() *Containerd { // containerd (https://github.com/levlaz/daggerverse/tree/abcd1a95cef14ad336ca21a9ab836869582617bb/containerd/dagger/main.go#L8)
	q := r.query.Select("containerd")
...
// Load a Containerd from its ID.
func (r *Client) LoadContainerdFromID(id ContainerdID) *Containerd {
	q := r.query.Select("loadContainerdFromID")
	q = q.Arg("id", id)
