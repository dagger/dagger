...
- [Filesystem operations](../cookbook/filesystem.mdx): Working with files and directories
- [Build operations](../cookbook/build.mdx): Building applications and container images
