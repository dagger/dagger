...
- [Default paths](../types/objects/directory.mdx#default-paths): Set a default directory path to use if no value is specified for the argument.
- [Filters](../types/objects/directory.mdx#filters): Control which files and directories are uploaded to a Dagger Function.
:::
...
- [Default paths](../types/objects/directory.mdx#default-paths): Set a default directory path to use if no value is specified for the argument.
- [Filters](../types/objects/directory.mdx#filters): Control which files are uploaded to a Dagger Function.
:::
...
:::note
Dagger supports [default paths](../types/objects/directory.mdx#default-paths) for `Directory` or `File` arguments. Dagger will automatically use this default path when no value is specified for the corresponding argument.
:::
