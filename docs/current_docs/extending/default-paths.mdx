---
title: "Default Paths"
description: "Learn how to use default paths in Dagger Functions to automatically resolve directories and files, including examples for Go, Python, TypeScript, and PHP."
---
