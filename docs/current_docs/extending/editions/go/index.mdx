...
For platform concepts, start with the [Module Developer Guide](/extending). This page remains available as legacy Go recipe material while standalone Go SDK docs are being designed.
...
:::tip
You can also choose to omit local Go files generated for IDE support from your version control system, as they aren't required to run the module.
:::
