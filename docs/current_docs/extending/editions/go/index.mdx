...
:::tip
You can also choose to omit local Go SDK files generated while loading the module from your version control system, as they aren't required to run the module.
:::
