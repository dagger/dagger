...
This edition is not yet available. For platform concepts, start with the [Module Developer Guide](/extending). Standalone PHP SDK docs still need a complete structure and examples.
...
The standard Dagger PHP module template is configured this way:
