...
For platform concepts, start with the [Module Developer Guide](/extending). This page remains available as legacy Python recipe material while standalone Python SDK docs are being designed.
...
The following examples show how to get a working [project environment](https://docs.astral.sh/uv/concepts/projects/#project-environments) (`.venv`) from the terminal. Make sure the module's generated `sdk` directory is present before installing it into the environment.
