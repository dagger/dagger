...
The following examples show how to get a working [project environment](https://docs.astral.sh/uv/concepts/projects/#project-environments) (`.venv`) from the terminal. Make sure to load the module first, for example with `dagger functions -m .`, to get the necessary `sdk` directory locally.
