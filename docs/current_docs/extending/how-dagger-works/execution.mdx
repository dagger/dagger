...
Steps 3 and 4 happen in the engine and a short-lived helper, not in the terminal. Your function has not started.
...
Next: [Developer workflow](../index.mdx#developer-workflow).
