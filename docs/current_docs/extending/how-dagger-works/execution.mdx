...
import HelperPrepareWalk from "@components/HelperPrepareWalk";
...
Steps 3 and 4 are prepare. The engine is already on. A short-lived helper fetches packages and builds the function list. Until that list exists, there is nothing to invoke.
