...
1. **Scaffold** a new module — the SDK writes its `dagger-module.toml` and a source skeleton, returned as a [changeset](../cli/changesets.mdx) you apply.
...
- **Generators** produce source changes as reviewable [changesets](../cli/changesets.mdx) — codegen, formatting, lockfile updates. They run with `dagger generate`.
