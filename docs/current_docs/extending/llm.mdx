...
Dagger [modules](../features/reusability.mdx) are collections of Dagger Functions. When you give a Dagger Module to the `LLM` core type, every Dagger Function is turned into a tool that the LLM can call.
