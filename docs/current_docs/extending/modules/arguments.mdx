---
slug: /extending/arguments
description: Learn how to pass arguments to Dagger Functions, including string, boolean, integer, and directory arguments.
---
...
<TabItem value="java" label="Java">
:::note
Because of the usage of `Optional`, primitive types cannot be marked as optional. You have to use the boxed types like `Integer` or `Boolean`.
