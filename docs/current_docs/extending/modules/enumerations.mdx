...
```php file=./snippets/enums/php/Severity.php
```

:::note
Please note the `#[DaggerObject]` attribute is required for Dagger to recognize the enum.
:::

```php file=./snippets/enums/php/MyModule.php
```
</TabItem>
