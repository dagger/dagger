...
:::note
The reference scheme for directory arguments is currently under discussion in [dagger/dagger#6957](https://github.com/dagger/dagger/issues/6957) and [dagger/dagger#6944](https://github.com/dagger/dagger/issues/6944) and may change in future.
:::
