...
In this approach, the module simply receives a `Directory` object and never directly accesses your SSH agent. [Refer to the cookbook for an example](../cookbook/filesystem.mdx#mount-or-copy-a-directory-or-remote-repository-to-a-container).
