...
- [Types](../../api/reference/index.mdx) — how SDK types map to the Dagger API
- [Changesets](../../cli/changesets.mdx) — how generators and tooling return diffs for you to apply
...
Like every Dagger tool that modifies your workspace, `dagger module init` returns a [changeset](../../cli/changesets.mdx) — a structured diff of the files to create — which Dagger shows you to review before anything is written to disk.
...
See [Generating Code](../../cli/generating.mdx) and [Changesets](../../cli/changesets.mdx).
...
- [Generating Code](../../cli/generating.mdx) and [Changesets](../../cli/changesets.mdx)
