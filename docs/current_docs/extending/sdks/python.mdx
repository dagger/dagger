...
This page is the standalone reference for developing modules with Python. For platform concepts that apply to every SDK, start with the [Module Developer Guide](../index.mdx), and see the [Types](../types/index.mdx), and [Checks](../how-dagger-works/checks.mdx).
...
See [Checks](../how-dagger-works/checks.mdx) and [Changesets](../../cli/changesets.mdx).
