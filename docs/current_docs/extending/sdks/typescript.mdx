...
`github.com/dagger/typescript-sdk` — and you create and maintain TypeScript
modules by calling its functions.
:::
...
does not write to disk directly — it returns a [changeset](/using-dagger/changesets)
