...
- [Changesets](../../cli/changesets.mdx) — how generated files are reviewed and applied
...
`init` returns a [changeset](../../cli/changesets.mdx) describing the files to
...
A generator produces a [changeset](../../cli/changesets.mdx) — a diff between the
