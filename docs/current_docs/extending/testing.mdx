...
cd tests
cat > dagger.json <<'EOF'
{"name":"tests","sdk":{"source":"go"},"source":"."}
EOF
dagger install ..
```
...
cd tests
cat > dagger.json <<'EOF'
{"name":"tests","sdk":{"source":"python"},"source":"."}
EOF
dagger install ..
```
...
cd tests
cat > dagger.json <<'EOF'
{"name":"tests","sdk":{"source":"typescript"},"source":"."}
EOF
dagger install ..
```
...
cd examples/go
cat > dagger.json <<'EOF'
{"name":"examples","sdk":{"source":"go"},"source":"."}
EOF
dagger install ../..
```
...
cd examples/python
cat > dagger.json <<'EOF'
{"name":"examples","sdk":{"source":"python"},"source":"."}
EOF
dagger install ../..
```
...
cat > dagger.json <<'EOF'
{"name":"examples","sdk":{"source":"typescript"},"source":"."}
EOF
dagger install ../..
```
