...
This page is legacy SDK-specific material. Platform-level quality guidance now belongs in [Module Quality and Readiness](/extending/module-quality), and SDK-specific test code belongs in the standalone SDK docs structure at [Standalone SDK Docs](/extending/sdks).
:::
