...
TODO: Coordinate this chapter with [Objects, State, and Persistence](/extending) so type design and object persistence reinforce each other without duplicating content.
