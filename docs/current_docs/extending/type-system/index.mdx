...
This section teaches type design for module authors. The [Types Reference](/extending/types) lists the fields each type exposes; this section explains how to use the type system to make modules discoverable, composable, cache-friendly, and pleasant to call. It is language-agnostic — for the syntax that maps these ideas to a specific language, see the [SDK guides](../sdks/index.mdx).
