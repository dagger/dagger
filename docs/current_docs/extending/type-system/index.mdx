...
This section teaches type design for module authors. The [Types Reference](/extending/types) remains the API reference; this section explains how to use the type system to make modules discoverable, composable, cache-friendly, and pleasant to call.
