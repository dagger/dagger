...
- **Defaults.** Do defaults encode common intent, stay narrowly scoped, appear in help, and come from [settings](../../reference/configuration/workspace.mdx) when team-wide?
