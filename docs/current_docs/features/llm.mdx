...
A key feature of Dagger's LLM integration is out-of-the-box support for *tool calling* using Dagger Functions: an LLM can automatically discover and use any available Dagger Functions in the provided environment.
