...
- **First-class monorepo support**: Dagger is agnostic to repository layout, and any number of Dagger Modules can peacefully coexist in a [monorepo](../use-cases/monorepos.mdx). It's up to you how to organize your module's source code. Some like to publish each module as a dedicated repository; others like to organize all their modules together, with the Git repository acting as a "catalog"
