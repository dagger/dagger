...
- [Use services as function arguments](../extending/arguments.mdx#service-arguments)
- [Create and return services from a function](../extending/services.mdx#expose-services-returned-by-functions-to-the-host)
- [Expose host services to a function](../extending/services.mdx#expose-host-services-to-functions)
- [Start and stop services](../extending/services.mdx#start-and-stop-services)
- [Persist service state](../extending/services.mdx#persist-service-state)
