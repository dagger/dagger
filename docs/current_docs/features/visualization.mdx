...
This quickly creates the need to visualize the pipeline to understand and measure your pipelines. Dagger includes two features for this purpose - a [Terminal UI](#terminal-ui) and traces with [Dagger Cloud](#traces) .
