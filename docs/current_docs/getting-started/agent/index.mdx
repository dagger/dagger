...
This will generate [various files that make up the Dagger Module](../../extending/module-structure.mdx), including some boilerplate Dagger Functions as examples.
...
:::tip
Learn more about [agent environments](../../extending/llm#environments).
:::
...
Now that you've grasped the basics of building an agent, look at our [agentic workflow examples](../../examples/index.mdx) for more examples and ideas for your next agent.
