...
The Dagger API is extensible and shareable by design. You can extend the API with [custom functions](../extending/functions.mdx), which are loaded via Dagger [modules](../extending/modules.mdx). You are encouraged to write your own Dagger modules and share them with others.
