...
In addition to supporting basic types (string, boolean, integer, array...), the Dagger API also provides [powerful types](../extending/types/index.mdx) for working with workflows, such as `Container`, `GitRepository`, `Directory`, `Service`, `Secret`. You can use these types as arguments to Dagger functions.
...
Functions can be chained with the CLI, or programmatically in a custom Dagger function using a Dagger SDK. The following are equivalent:

<Tabs groupId="language" queryString="sdk">
<TabItem value="go" label="Go">

```go file=../extending/editions/go/snippets/chaining/main.go
```

</TabItem>
<TabItem value="python" label="Python">

```python file=../extending/editions/python/snippets/chaining/main.py
```

</TabItem>
<TabItem value="typescript" label="TypeScript">

```typescript file=../extending/editions/typescript/snippets/chaining/index.ts
```

</TabItem>
<TabItem value="php" label="PHP">

```php file=../extending/editions/php/snippets/chaining/src/MyModule.php
```
...
As these examples illustrate, function chaining is extremely powerful.

## Modules

Dagger [modules](../extending/editions/dang) are collections of Dagger Functions, packaged together for easy sharing and consumption. They are portable and reusable across languages.
...
The Dagger API is extensible and shareable by design. You can extend the API by creating Dagger [modules](../extending/editions/dang). You are encouraged to write your own Dagger modules and share them with others.
