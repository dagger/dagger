...
- From the Dagger CLI
  - [`dagger`, `dagger core` and `dagger call`](./clients/clients-cli.mdx)
- From a custom application created with a Dagger SDK
  - [`dagger run`](../extending/custom-applications/go.mdx)
- From a [language-native GraphQL client](./clients/clients-http.mdx#language-native-http-clients)
- From a command-line HTTP or GraphQL client
  - [`curl`](./clients/clients-http.mdx#command-line-http-clients)
  - [`dagger query`](./clients/clients-http.mdx#dagger-cli)
