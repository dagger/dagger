...
sidebar_label: "HTTP/GraphQL"
slug: /getting-started/api/http
description: "Learn how to use the Dagger API with raw HTTP queries, and how to create custom applications that use the Dagger API."
---
