...
slug: /getting-started/ci-integrations/argo-workflows
...
- A running Kubernetes cluster [configured for use with Dagger](../../adopting/scaling/kubernetes.mdx) and with a pre-configured `kubectl` profile
