...
By default, the Dagger `Directory` type works with both local directories and remote Git repositories. This makes it possible to work with the directory tree at the root of a Git repository or a given branch.
