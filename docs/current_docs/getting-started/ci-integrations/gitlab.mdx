---
title: "GitLab CI"
slug: /getting-started/ci-integrations/gitlab-ci
...
The following code listings illustrate the configuration to be applied to each GitLab Runner, with taints, tolerations and pod affinity set via the `dagger-node` key. For an example of the corresponding node configuration, refer to the [OpenShift](../../adopting/scaling/openshift.mdx) integration page.
