---
title: "Tekton"
slug: /getting-started/ci-integrations/tekton
...
- A running Kubernetes cluster [configured for use with Dagger](../../reference/container-runtimes/kubernetes.mdx) and with a pre-configured `kubectl` profile
