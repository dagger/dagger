...
Learn how to use [checks](../introduction/features/checks.mdx) to automatically validate code quality, security, and standards before committing or in CI pipelines.
