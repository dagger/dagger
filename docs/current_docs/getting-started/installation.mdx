...
To update the Dagger CLI, use the same method that you originally used to install it. This will overwrite your currently-installed version with the selected version.
