...
This returns a [changeset](../cli/generating.mdx) — the reformatted files — and offers to apply it to your working tree; confirm to apply it. Run the checks again:
