...
```shell
dagger module init --sdk=go --name=coding-agent
```
</TabItem>
<TabItem value="python" label="Python">
```shell
dagger module init --sdk=python --name=coding-agent
```
</TabItem>
<TabItem value="typescript" label="TypeScript">
```shell
dagger module init --sdk=typescript --name=coding-agent
```
</TabItem>
<TabItem value="php" label="PHP">
```shell
dagger module init --sdk=php --name=coding-agent
```
</TabItem>
<TabItem value="java" label="Java">
```shell
dagger module init --sdk=java --name=coding-agent
```
</TabItem>
</Tabs>
