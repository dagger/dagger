...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Workspace":
		...
		case "ReadFile":
			...
			return (*Workspace).ReadFile(&parent, ctx, path)
		case "WriteFile":
			var parent Workspace
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Workspace).WriteFile(&parent, path, contents), nil
		case "ListFiles":
			var parent Workspace
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Workspace).ListFiles(&parent, ctx)
		case "Test":
			var parent Workspace
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Workspace).Test(&parent, ctx)
		case "":
			var parent Workspace
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
