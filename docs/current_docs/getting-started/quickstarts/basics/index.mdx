...
```shell
dagger module init --sdk=go --name=basics
```
</TabItem>
...
```shell
dagger module init --sdk=python --name=basics
```
</TabItem>
...
```shell
dagger module init --sdk=typescript --name=basics
```
</TabItem>
...
```shell
dagger module init --sdk=php --name=basics
```
</TabItem>
...
```shell
dagger module init --sdk=java --name=basics
```
</TabItem>
</Tabs>
