...
In this guide, you'll fork an example project, add automated checks, and open a pull request that runs those checks in Dagger Cloud. No CI YAML required.

## Requirements

- [Dagger CLI installed](./install.mdx)
...
Now do it on your own project. See the [Quickstart](./quickstart.mdx).
