...
```typescript file=./snippets/custom-callbacks/mounts-without-callback/index.mts
```
...
```typescript file=./snippets/custom-callbacks/mounts-with-callback/index.mts
```
...
```typescript file=./snippets/custom-callbacks/environment-variables/index.mts
```
