...
```typescript file=./snippets/use-secrets/raw/index.mjs
...
```typescript file=./snippets/use-secrets/host-env/index.mjs
...
```typescript file=./snippets/use-secrets/host-fs/index.mjs
...
```typescript file=./snippets/use-secrets/external/index.mjs
...
```typescript file=./snippets/use-secrets/sdk/index.mjs
...
```typescript file=./snippets/use-secrets/dockerfile/index.mjs
...
```typescript file=./snippets/use-secrets/security/index.mjs
