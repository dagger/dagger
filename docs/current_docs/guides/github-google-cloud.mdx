...
- You have the Dagger CLI installed in your development environment. If not, [install the Dagger CLI](../install.mdx).
...
1. Update the generated `dagger/src/main/__init__.py` file with the following code.
