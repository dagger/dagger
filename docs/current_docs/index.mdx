...
- [Run workflows in your local development environment](./use-cases.mdx#portable-ci), exactly as they run in remote CI
- [Enhance existing CI pipelines with LLMs](./use-cases.mdx#agentic-ci) for code review, tests and feedback
- Improve build times, testing and dependency management in [monorepos](./use-cases.mdx#monorepo-workflow-optimization)
...
[**Learn more about Component Types →**](./types/index.mdx)
...
[**Learn more about Custom Functions →**](./extending/functions.mdx)
