...
- **[Checks](./introduction/features/checks.mdx)** - Validate commits with automated quality, security, and standards checks
- **[Automatic caching](./introduction/features/caching.mdx)** - Speed up execution with intelligent caching
- **[Toolchains](./introduction/features/toolchains.mdx)** - Compose functionality from multiple reusable modules
