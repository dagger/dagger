...
- [Core Concepts →](./introduction/core-concepts/index.mdx) Understand toolchains, checks, and functions
...
- **[Toolchains](./introduction/core-concepts/toolchains.mdx)** - Install and use modules without writing code
- **[Checks](./introduction/core-concepts/checks.mdx)** - Validate commits with automated quality, security, and standards checks
- **[Functions](./introduction/core-concepts/functions.mdx)** - Building blocks of Dagger workflows

[**Learn core concepts →**](./introduction/core-concepts/index.mdx)
...
- **Checks**: A fully managed CI platform with integrated compute and caching. Dagger Cloud runs your [check functions](./introduction/core-concepts/checks.mdx) on managed infrastructure and reports results back to GitHub as commit statuses, with no self-hosted runners required.
...
[**Learn more about Dagger Cloud →**](./reference/configuration/cloud.mdx)
