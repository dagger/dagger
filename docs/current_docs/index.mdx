...
- Improve build times, testing and dependency management in [monorepos](./use-cases.mdx#monorepo-ci)

## Get started

- [Installation →](./getting-started/installation.mdx) Install Dagger and set up your development environment
- [Basics →](./getting-started/basics.mdx) Learn Dagger fundamentals
- [CI Quickstart →](./getting-started/ci.mdx) Build your first workflow
...
[**Learn more about Dagger Functions →**](./extending/functions.mdx)
...
[**Learn more about the Dagger Engine →**](./reference/container-runtimes/index.mdx)
...
[**Learn more about the Dagger API →**](./extending/index.mdx)
...
- [**Community**](https://dagger.io/community) - Explore the Dagger community and upcoming events
