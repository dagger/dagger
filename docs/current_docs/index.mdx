...
[Dagger Cloud](https://dagger.io/cloud) complements Dagger Functions with a production-grade control plane. Features of Dagger Cloud include pipeline visualization, operational insights, and distributed caching.
...
To use Dagger, you call Dagger Functions. Dagger Functions are regular code, written in a supported programming language, and running in containers. Dagger Functions let you encapsulate common operations or workflows into discrete units with clear inputs and outputs.
...
See the [component overview](./manual/components.mdx) for more information.
