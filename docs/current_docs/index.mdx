...
- **Want to adopt Dagger in your project?** Start with the [Quickstart](./getting-started/quickstart.mdx), then follow [Workspace Setup](./getting-started/workspace-setup.mdx).
- **Your project already uses Dagger?** See [CLI](./cli/checking.mdx) to run checks, generate code, and start services.
