...
- [Run workflows in your local development environment](use-cases/portable-ci.mdx), exactly as they run in remote CI
- [Enhance existing CI pipelines with LLMs](use-cases/agentic-ci.mdx) for code review, tests and feedback
- Improve build times, testing and dependency management in [monorepos](use-cases/monorepos.mdx)
