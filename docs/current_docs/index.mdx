...
Dagger replaces your artisanal scripts with a modern API and cross-language scripting.
...
### Dagger SDKs
Dagger SDKs contain language-native code bindings for the Dagger API, enabling you to develop Dagger Functions in your preferred programming language. Dagger SDKs are currently available for Go, TypeScript and Python. Support for other languages is available via experimental and community SDKs.
