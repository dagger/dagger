...
| a TypeScript/JavaScript developer | Use the [Typescript SDK](sdk/typescript) |
...
| looking for an excuse to learn TypeScript | Use the [Typescript SDK](sdk/typescript) |
