...
<TabItem value="macOS">
To update the Dagger CLI, use the same method that you originally used to [install](#release-type) it. This will overwrite your currently-installed version with the latest (or specified) version.
