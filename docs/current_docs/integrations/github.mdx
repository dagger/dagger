---
title: "GitHub"
slug: /getting-started/ci-integrations/github
description: "Learn how to use Dagger with GitHub."
---
...
By default, the Dagger `Directory` type works with both local directories and [remote Git repositories](../extending/remote-repositories.mdx). This makes it possible to work with the directory tree at the root of a Git repository or a given branch.
