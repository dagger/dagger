...
When working with private repositories in GitHub Actions, see our [Git Credential Helpers Guide](/guides/ci/git-credential-helpers#github) for authentication patterns.
