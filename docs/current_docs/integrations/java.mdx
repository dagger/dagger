...
Dagger can be used to perform common CI tasks - testing, containerizing, publishing and more - for any Java application. This allows Java developers to create application delivery pipelines with the same language and tooling they use for their Java applications, and also benefit from faster local runs by using Dagger to cache Maven dependencies.
...
If you have any questions about additional ways to use Java with
Dagger, join our [Discord](https://discord.gg/dagger-io) and ask your questions
in our [Java channel](https://discord.com/channels/707636530424053791/1124030182655807548).
