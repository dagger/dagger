...
Running Dagger in Kuberentes is generally a good choice for:
...
- [Kubernetes in Dagger] https://www.youtube.com/watch?v=F6-44Je5HvE by Marcos Lilljedahl - He explains how to run Kubernetes clusters using Dagger. He addresses the challenges and solutions in integrating Kubernetes within Dagger and shares a practical setup using the [k3s Dagger Module](https://daggerverse.dev/mod/github.com/marcosnils/daggerverse/k3s)
- [Kubernetes Infinity Stones: Can Dagger Complete My Set?](https://youtu.be/VIYxsc7TlhQ) - In this demo, Diego Ciangottini explores the integration of Dagger with Kubernetes to enhance the deployment and management of components across different environments. 
