...
Dagger can be used with with any OCI-compatible container runtime, including `nerdctl`.
...
[`nerdctl](https://github.com/containerd/nerdctl) is a Docker-compatible interface to [containerd](https://containerd.io/).
