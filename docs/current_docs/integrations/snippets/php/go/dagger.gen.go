...
// The `MariadbID` scalar type represents an identifier for an object of type Mariadb.
type MariadbID = dagger.MariadbID
...
type Mariadb = dagger.Mariadb

// MariadbBaseOpts contains options for Mariadb.Base
type MariadbBaseOpts = dagger.MariadbBaseOpts

// MariadbServeOpts contains options for Mariadb.Serve
type MariadbServeOpts = dagger.MariadbServeOpts
