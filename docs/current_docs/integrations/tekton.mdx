...
The following example builds the [greetings-api](https://github.com/kpenfound/greetings-api) demo project using a Dagger Function. This project uses the Dagger Go SDK for CI.
