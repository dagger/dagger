...
[See CI integration examples →](../../getting-started/ci-integrations/github-actions.mdx)

## Next Steps

- **[Use a Toolchain Quickstart](../../getting-started/quickstarts/blueprint/index.mdx)** - Get started in 5 minutes
- **[Checks](./checks.mdx)** - Learn about validation checks
- **[Building with Dagger](../../extending/index.mdx)** - Create your own toolchain
