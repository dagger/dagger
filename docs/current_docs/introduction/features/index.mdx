...
### [Checks](./checks.mdx)
Validate commits with automated checks for code quality, security, and standards. Run linters, tests, and security scans consistently across all environments.
...
Install multiple reusable modules as toolchains to extend your workflows. Compose functionality from different modules without tight coupling.
