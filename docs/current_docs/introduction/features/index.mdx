...
:::tip Looking for Core Concepts?
These fundamental concepts have their own section for easier discovery:
- [Workspaces](/core-concepts/workspaces) - Your project's Dagger configuration
- [Modules](/core-concepts/modules) - Packages of functions you install or develop
...
- [Follow the quickstart](../../getting-started/quickstart.mdx) to build your first workflow
