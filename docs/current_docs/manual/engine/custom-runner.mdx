---
slug: /manual/engine/custom-runner
---
...
If any extra CA certificates are to be included in order to - for example - push images to a private registry, they can be included under `/usr/local/share/ca-certificates` in the runner image.
