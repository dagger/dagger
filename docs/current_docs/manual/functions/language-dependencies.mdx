...
One of the key advantages of creating Dagger Functions in your usual programming language is that it opens up access to your language's existing ecosystem of packages or modules. You can easily add and use these packages/modules as dependencies in your Dagger Function via your language's package manager.
