...
2. The volumes cache: This caches the contents of a Dagger volume and is persisted across Dagger Engine sessions. It is maintained locally and, where applicable, [replicated to Dagger Cloud](../../user/visualization/572923-cloud-get-started.mdx#step-4-use-cache-volumes-with-the-experimental-dagger-cloud-cache). It is implemented by Dagger (distinct from Buildkit).
