---
slug: /manuals/administrator/engine/472258/custom-runner
---
...
To use a registry mirror, append the configuration to `/etc/dagger/engine.toml` using this format:
...
This configuration can be repeated for multiple registries and mirrors:
