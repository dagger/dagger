...
:::tip
See a specific [implementation of the above pattern using GitHub Actions, Amazon Elastic Kubernetes Service (EKS), Karpenter and Dagger Cloud](../../../tutorials/934191-eks-github-karpenter.mdx).
:::
