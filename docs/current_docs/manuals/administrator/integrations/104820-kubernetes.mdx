---
slug: /manuals/administrator/104820/kubernetes
---
...
![Kubernetes base architecture](/img/current_docs/manuals/administrator/integrations/kubernetes-pattern-base.png)
...
![Kubernetes architecture with ephmeral nodes](/img/current_docs/manuals/administrator/integrations/kubernetes-pattern-ephemeral.png)
...
![Kubernetes architecture with shared cache](/img/current_docs/manuals/administrator/integrations/kubernetes-pattern-cache.png)

:::tip
Read a detailed tutorial explaining how to implement the above pattern with [Dagger and GitHub Actions, Amazon Elastic Kubernetes Service (EKS), Karpenter and Dagger Cloud](../tutorials/934191-eks-github-karpenter.mdx).
:::
