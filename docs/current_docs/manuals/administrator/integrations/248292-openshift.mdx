---
slug: /manuals/administrator/248292/openshift
---
...
:::tip
Read a detailed tutorial explaining how to [run Dagger on OpenShift with GitLab](../tutorials/488565-openshift-gitlab.mdx).
:::
