...
```go file=./cookbook/snippets/error-handling/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=./cookbook/snippets/error-handling/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=./cookbook/snippets/error-handling/typescript/index.ts
```
