...
```go file=./snippets/secrets/secret-variable/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=./snippets/secrets/secret-variable/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=./snippets/secrets/secret-variable/typescript/index.ts
```
...
```go file=./snippets/secrets/secret-file/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=./snippets/secrets/secret-file/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=./snippets/secrets/secret-file/typescript/index.ts
```
...
dagger call github-auth \
    --secret=file:$HOME/.config/gh/hosts.yml
```
