---
slug: /manuals/developer/enumerations
...
- Enum values cannot start with digits, and can only be composed of alphabets, digits or `_`.
- Enum names are case-sensitive, and by convention should be upper-cased.
:::
