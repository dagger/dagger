---
slug: /manuals/developer/execution-environment
...
<<<<<<< HEAD:docs/current_docs/manuals/developer/execution-environment.mdx

More details can be found in [Pass arguments to a function](../../quickstart/292472-arguments.mdx).
=======
>>>>>>> 5894f16c0 (Updated content):docs/current_docs/manuals/developer/overview/942201-execution-environment.mdx
