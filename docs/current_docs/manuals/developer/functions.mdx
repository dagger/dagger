...
| --- | --- | --- | --- |
| Git repository | `/` | `dagger call read-dir` | `/` |
| Git repository | `/src` | `dagger call read-dir` | `/src` |
| Git repository | `.` | `dagger call read-dir` | `/my-module` |
| Git repository | `..` | `dagger call read-dir` | `/` |
| Non-Git directory | `/` | `dagger call read-dir` | `/` |
| Non-Git directory | `/src` | `dagger call read-dir` | `/src` |
| Non-Git directory | `.` | `dagger call read-dir` | `/my-module` |
| Non-Git directory | `..` | `dagger call read-dir` | `/` |

If an argument is explicitly passed to the Dagger Function, it always overrides the default context.

| Default context ('defaultPath`) | Dagger Function invocation | `source` resolves to |
| --- | --- | --- |
| `/` | `dagger call read-dir --source=public` | `/public` |
| `/src` | `dagger call read-dir --source=public` | `/public` |
| `.` | `dagger call read-dir --source=public` | `/public` |
| `..` | `dagger call read-dir --source=public` | `/public` |
