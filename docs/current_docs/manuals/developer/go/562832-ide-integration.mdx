---
slug: /manuals/developer/go/562832/ide-integration
...
- [Configure your `go.work` file](./go/882081-module-structure.mdx#go-workspaces) to include the path to your module.
