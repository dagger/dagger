...
This manual is intended for Go developers who want to add custom functionality to Dagger, either by creating a new Dagger Module or extending an existing one.
