---
slug: /manuals/developer/python/328492/services
...
```python file=./snippets/services/service-lifecycle-1/main.py
```
...
```python file=./snippets/services/service-lifecycle-2/main.py
```
...
```python file=./snippets/services/service-lifecycle-3/main.py
```
