...
- Document your module with [inline comments](../documentation.mdx)
- Understand [arguments and return values](../functions.mdx)
- Streamline your module with an [entrypoint function](../entrypoint-function.mdx)
