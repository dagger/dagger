...
// The `JavaID` scalar type represents an identifier for an object of type Java.
type JavaID = dagger.JavaID
...
type Java = dagger.Java

type WithJavaFunc = dagger.WithJavaFunc
