...
- You have a Dagger Module with at least one Dagger Function. If not, create one using the [quickstart](../../../quickstart/822194-daggerize.mdx) or the developer guide for [Go](../go/525021-first-module.mdx), [Python](../python/419481-first-module.mdx) or [TypeScript](../typescript/506316-first-module.mdx).
