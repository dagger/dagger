---
slug: /manuals/developer/typescript/292372/functions
...
```typescript file=./snippets/functions/functions-simple/index.ts
```
...
```typescript file=./snippets/functions/functions-complex/index.ts
```
...
```typescript file=./snippets/functions/arguments-string/index.ts
```
...
```typescript file=./snippets/functions/arguments-directory/index.ts
```
...
```typescript file=./snippets/functions/arguments-optional/index.ts
```
...
```typescript file=./snippets/functions/arguments-default/index.ts
```
...
```typescript file=./snippets/functions/return-values-container/index.ts
```
