...
:::note
Dagger Modules have only one constructor. Constructors of [custom types](./817191-custom-types.mdx) are not registered; they are constructed by the function that [chains](../chaining.mdx) them.
:::
