...
Here is an example of publishing the container returned by a Wolfi container builder function to the `ttl.sh` registry, by chaining a publish function call to the container:
