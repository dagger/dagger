---
slug: /manuals/user/472010/containers
---

# Produce Just-in-Time Containers

Just-in-time containers are produced by calling a Dagger Function that returns the `Container` type, which provides a complete API for building, running and distributing containers.
