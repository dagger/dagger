...
You can use the Dagger CLI to call any function, either from your local filesystem or straight from a Git repository. Dagger Functions can be called interactively, from a shell script, or from a CI configuration.
