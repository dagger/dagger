...
## Changes
:::info
The **Changes** views only apply to Dagger pipeline runs done with engines before version 0.11.0. This view has been replaced by the new Traces view in Dagger Cloud.
:::
