...
## Traces
:::info
You will only see runs in the Traces view if you are using Dagger 0.11.0 or later. If you are using an engine version before 0.11.0, you will see runs in the Runs view.
:::

:::note
The Trace Details page is still under development and is in Beta. We welcome your feedback on how we can improve this page. Please join the Dagger Discord to join the Dagger community and share your feedback.
:::

The *Traces* page lists runs you've kicked off from your local dev machine or in CI.
...
[ADD A LINK TO A NEW DOC THAT DETAILS HOW TO DEBUG WITH TRACES]

### All Runs page
:::info
The All Runs view only applies to Dagger pipeline runs done with engines before version 0.11.0. This view has been replaced by the new Traces view in Dagger Cloud.
:::
