...
Here is an example of passing a Boolean argument to the same "hello world" Dagger Function. The Boolean argument controls the size ("giant" or normal) of the output message returned by the Dagger Function:
