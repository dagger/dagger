...
<TabItem value="Linux">
The quickest way of installing `dagger` on Linux is to use [install.sh](https://github.com/dagger/dagger/blob/main/install.sh):
...
The quickest way of installing `dagger` on Windows is to use [install.ps1](https://github.com/dagger/dagger/blob/main/install.ps1):
