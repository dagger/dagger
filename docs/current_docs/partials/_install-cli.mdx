...
Install the current stable release of the Dagger CLI following the steps below.
...
If you do not have Homebrew installed, you can use [install.sh](https://github.com/dagger/dagger/blob/main/install.sh). Pin the version so repeated installs are reproducible:
...
<CodeBlock language="shell">
{`curl -fsSL https://dl.dagger.io/dagger/install.sh -o install.sh\n# Review install.sh before running it.\nDAGGER_VERSION=${daggerVersion} BIN_DIR=/usr/local/bin sh install.sh`}
</CodeBlock>
...
<TabItem value="Linux">
The quickest way of installing the current stable release of `dagger` on Linux is to use [install.sh](https://github.com/dagger/dagger/blob/main/install.sh). Pin the version so repeated installs are reproducible:
...
<CodeBlock language="shell">
{`curl -fsSL https://dl.dagger.io/dagger/install.sh -o install.sh\n# Review install.sh before running it.\nDAGGER_VERSION=${daggerVersion} BIN_DIR=$HOME/.local/bin sh install.sh`}
</CodeBlock>
