...
```php file=../../../getting-started/agent/snippets/part1/php/src/CodingAgent.php
```

</TabItem>
<TabItem value="java" label="Java">

```java file=../../../getting-started/agent/snippets/part1/java/src/main/java/io/dagger/modules/codingagent/CodingAgent.java
```
