---
title: "Copy subset directory"
description: "Learn how to copy a subset of a directory or remote repository to a container using filters specified at run-time."
