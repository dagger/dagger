...
The best way to understand how Dagger works is by creating a Dagger-based CI pipeline for an application - a process called "Daggerizing".

The steps to Daggerizing the CI pipeline for an existing application are:
...
This tutorial will walk you through these steps by Daggerizing a simple Go example application.
