...
- you know [the basics of Dagger](../core-concepts/index.mdx).
...
Follow the [LLM endpoint configuration instructions](../../reference/configuration/llm.mdx) to configure an LLM for use with Dagger.
