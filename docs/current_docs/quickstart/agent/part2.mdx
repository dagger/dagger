...
- You have completed the [AI Agent quickstart](./agent) to learn the basics of LLMs in Dagger
- You have completed the [CI quickstart](./ci) to a Daggerize a project

## Open the example application

This guide builds on the Daggerized project from the [CI quickstart](./ci). If you have not completed the CI quickstart, you will at least need to complete the [construct a pipeline](./ci#construct-a-pipeline) step to get the Daggerized project.

List the existing Dagger functions:
...
<Tabs groupId="language" queryString="sdk">
    ...
    <TabItem value="java" label="Java">
        ...
        Now replace the main file in the workspace with the following content.
        Edit `.dagger/workspace/src/main/java/io/dagger/modules/workspace/Workspace.java`:
    ...
    <TabItem value="php" label="PHP">
        ...
        Now replace the main file in the workspace with the following content.
        Edit `.dagger/workspace/src/Workspace.php`:
