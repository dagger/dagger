...
:::tip IDE SUPPORT
If you're writing the code above in an IDE, you can easily [configure your IDE to recognize your Dagger module](../manuals/developer/ide-integration.mdx). This can significantly speed things up, by giving you automatic type-checking, intelligent code completion, and other IDE features when writing Dagger module code.
:::
