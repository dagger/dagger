...
After going through this quickstart tutorial, you will have the tools and skills to create a CI pipeline to test, build and publish your code from the command line, and start replacing your custom CI scripts with reusable Dagger Functions from the Daggerverse or that you create yourself.
