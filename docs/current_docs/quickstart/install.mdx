...
You can use the Dagger CLI to dynamically inspect a Dagger Function and display a context-sensitive list of its supported arguments and sub-commands, simply by appending `--help` to a CLI command.
