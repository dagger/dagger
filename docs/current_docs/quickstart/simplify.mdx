...
As before, you should see the application being tested, built, and published to the [ttl.sh container registry](https://ttl.sh).

:::note PUBLISHING TO PRIVATE CONTAINER REGISTRIES
