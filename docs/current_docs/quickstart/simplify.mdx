...
To understand how this works in practice, let's refactor the pipeline you just built by using a third-party Dagger module. A good candidate here is the [Node module](https://daggerverse.dev/mod/github.com/dagger/dagger/sdk/typescript/dev/node) from the Daggerverse. This module contains tested, ready-to-use Dagger Functions for building, linting and testing Node.js applications.
