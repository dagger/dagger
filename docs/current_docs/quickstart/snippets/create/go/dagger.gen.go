...
type GolangGolangciLintOpts = dagger.GolangGolangciLintOpts

// GolangTestOpts contains options for Golang.Test
type GolangTestOpts = dagger.GolangTestOpts
...
func (r *Example) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Example":
		...
		case "ContainerEcho":
			...
			return (*Example).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent Example
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Example).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("Example").
					WithFunction(
