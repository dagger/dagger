...
- Learn more about key Dagger concepts like function chaining, just-in-time artifacts, and [observability](../../introduction/features/observability.mdx) in the [module development guide](../../extending/editions/dang).
