...
If you haven't already, make sure to [complete the Quickstart](../../getting-started/quickstart.mdx), which will teach you how to daggerize an example workflow.
...
Once your workflow is daggerized, and integrated in your development toolchain, it's time for the final step: [integrating it in CI](../../integrations/ci.mdx).
...
4. Find the [integration page for your preferred platform or runtime environment](../../integrations/index.mdx), and follow the instructions.
