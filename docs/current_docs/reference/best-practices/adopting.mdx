...
- Finally, some of these modules may be suitable to be open-sourced and shared with the entire Dagger community, by [publishing it on the Daggerverse](../../extending/modules/daggerverse.mdx).
