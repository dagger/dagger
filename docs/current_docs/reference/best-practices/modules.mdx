...
mkdir tests
cd tests
dagger module init --name=tests --sdk=go --source=.
...
mkdir tests
cd tests
dagger module init --name=tests --sdk=python --source=.
dagger module install ..
```
...
mkdir tests
cd tests
dagger module init --name=tests --sdk=typescript --source=.
dagger module install ..
```
...
mkdir -p examples/go
cd examples/go
dagger module init --name=examples/go --sdk=go --source=.
dagger module install ../..
```
...
cd examples/python
dagger module init --name=examples/python --sdk=python --source=.
dagger module install ../..
```
...
dagger module init --name=examples/typescript --sdk=typescript --source=.
dagger module install ../..
```
