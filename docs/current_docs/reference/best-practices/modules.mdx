...
In some situations, you may need to provide specific values to your test modules, such as when authenticating against an external service. In these cases, you can rely on [module constructors](../../extending/editions/dang#constructors) to inject any required inputs.
...
1. Module functions should have [descriptions](../../extending/editions/dang#documenting-your-module).
1. Modules versions should be tagged with semver.
1. Modules should have hand-crafted examples (see [Daggerverse](https://daggerverse.dev)).
