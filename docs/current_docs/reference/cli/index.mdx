...
* [dagger module init](#dagger-module-init)	 - Initialize a module in the workspace
...
```
dagger module client add [flags]
```
...
Remove a module client and regenerate its SDK scope.

```
dagger module client rm <module> [flags]
```
...
Initialize a module in the workspace

### Synopsis

Initialize a module in the workspace with an installed SDK.

```
dagger module init [flags]
```
