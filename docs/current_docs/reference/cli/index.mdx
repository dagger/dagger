...
* [dagger cloud](#dagger-cloud)	 - Manage Dagger Cloud (checks, engines, traces, billing, etc.)
...
Manage Dagger Cloud (checks, engines, traces, billing, etc.)
...
* [dagger cloud engines](#dagger-cloud-engines)	 - Manage Dagger Cloud engines
...
* [dagger cloud traces](#dagger-cloud-traces)	 - Diagnose or view a Dagger Cloud trace.
* [dagger cloud usage](#dagger-cloud-usage)	 - Show Dagger Cloud usage
* [dagger cloud workspaces](#dagger-cloud-workspaces)	 - Manage Dagger Cloud workspaces
...
* [dagger cloud billing payment](#dagger-cloud-billing-payment)	 - Enter or update the payment method for a Dagger Cloud org
...
Enter or update the payment method for a Dagger Cloud org
...
```
dagger cloud billing payment [org]
```

### Options

```
      --open   Open the payment page in a browser
```
...
```
      --start-trial   Start a free trial when a required Cloud feature is not enabled yet
```
...
Diagnose or view a Dagger Cloud trace.

### Synopsis

Stream and render a Dagger Cloud trace: the overall pass/fail verdict, the
...
```
dagger cloud traces [trace ID] [flags]
```

### Examples

```
dagger cloud traces 2f123ba77bf7bd2d4db2f70ed20613e8
```

### Options

```
      --check string   Scope and zoom the view to a check by name
      --span string    Scope and zoom the view to a span ID (fetches its subtree and logs)
      --test string    Scope and zoom the view to a test by name
```
...
## dagger cloud workspaces

Manage Dagger Cloud workspaces

```
dagger cloud workspaces [flags]
```
