...
* [dagger](#dagger)	 - A tool to run composable workflows in containers
* [dagger mod deps](#dagger-mod-deps)	 - Manage the current module's dependencies
* [dagger mod engine](#dagger-mod-engine)	 - Manage the module's required engine version
...
Manage the current module's dependencies

### Options

```
  -m, --mod string   Module to edit, a local path or remote git repo (defaults to current directory)
```
...
* [dagger mod](#dagger-mod)	 - Work with modules in your workspace
* [dagger mod deps add](#dagger-mod-deps-add)	 - Add one or more dependencies to the module
* [dagger mod deps list](#dagger-mod-deps-list)	 - List the current module's dependencies
* [dagger mod deps rm](#dagger-mod-deps-rm)	 - Remove one or more dependencies from the module
...
```
dagger mod deps add <module>... [flags]
```

### Examples

```
dagger mod deps add github.com/dagger/dagger/modules/wolfi
```
...
## dagger mod deps list

List the current module's dependencies

```
dagger mod deps list [flags]
```
...
```
dagger mod deps rm <name>... [flags]
```

### Examples

```
dagger mod deps rm wolfi
```
...
Manage the module's required engine version
...
* [dagger mod](#dagger-mod)	 - Work with modules in your workspace
* [dagger mod engine require](#dagger-mod-engine-require)	 - Set the module's required engine version
* [dagger mod engine require-current](#dagger-mod-engine-require-current)	 - Set the module's required engine version to the currently running engine version
* [dagger mod engine required](#dagger-mod-engine-required)	 - Print the module's required engine version

## dagger mod engine require

Set the module's required engine version

```
dagger mod engine require <version> [flags]
```

### Examples

```
dagger mod engine require v0.21.0
```
...
## dagger mod engine required

Print the module's required engine version

```
dagger mod engine required [flags]
```
