...
```
  ...
  -i, --interactive                  Spawn a terminal on container exec failure
      ...
      --lock string                  Lock mode for lookup resolution (strict, auto, update). Defaults to auto.
...
* [dagger module install](#dagger-module-install)	 - Add a module dependency
* [dagger module list](#dagger-module-list)	 - List workspace's modules
...
Add another module as a dependency of the current module, updating its dagger.json.
...
List workspace's modules

### Synopsis

List all the modules referenced in this workspace.
...
```
"dagger module update" or "dagger module update hello" or "dagger module update github.com/shykes/daggerverse/hello@v0.3.0"
```
...
Update git module lock entries in .dagger/lock. With no module names, updates all git modules in the workspace config.
