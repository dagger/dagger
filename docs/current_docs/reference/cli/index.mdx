...
* [dagger workspace ls](#dagger-workspace-ls)	 - List a directory or file in the selected workspace
...
List a directory or file in the selected workspace

### Synopsis

List a directory or file in the selected workspace, one entry per line.
