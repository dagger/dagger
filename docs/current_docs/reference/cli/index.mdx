...
* [dagger blueprint](#dagger-blueprint)	 - Manage blueprints
...
* [dagger blueprint install](#dagger-blueprint-install)	 - Install a blueprint to the current module
* [dagger blueprint uninstall](#dagger-blueprint-uninstall)	 - Uninstall a blueprint
* [dagger blueprint update](#dagger-blueprint-update)	 - Update blueprints

## dagger blueprint install

Install a blueprint to the current module

### Synopsis

Install another module as a blueprint to the current module.

```
dagger blueprint install [options] <module> [flags]
```

### Examples

```
dagger blueprint install github.com/example/blueprint
```
...
```
  ...
  -m, --mod string          Module reference to load, either a local path or a remote git repo (defaults to current directory)
  -n, --name string         Name to use for the blueprint in the module. Defaults to the name of the blueprint being installed.
```
...
## dagger blueprint uninstall

Uninstall a blueprint

### Synopsis

Uninstall a blueprint from the current module.

```
dagger blueprint uninstall [options] <blueprint> [flags]
```

### Examples

```
dagger blueprint uninstall myblueprint
```
...
## dagger blueprint update

Update blueprints

### Synopsis

Update all or specific blueprints of the current module.

```
dagger blueprint update [options] [<blueprint>...] [flags]
```
