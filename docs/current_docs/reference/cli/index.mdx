...
* [dagger start](#dagger-start)	 - Run your project's services for local development — databases, APIs, dev servers, etc.
...
Every Dagger command — check, start, generate, even install — ultimately
...
Examples:
  dagger start                    # Start all services
  dagger start -l                 # List all available services
  dagger start web                # Start only the 'web' service


```
dagger start [options] [pattern...]
```
