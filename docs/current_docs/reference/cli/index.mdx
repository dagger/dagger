...
* [dagger list](#dagger-list)	 - List artifacts or collection values
...
List artifacts or collection values

### Synopsis

List artifacts by plural type name, or keys by collection name. Use -a to list all artifacts.
