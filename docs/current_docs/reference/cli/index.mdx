...
* [dagger lock](#dagger-lock)	 - Manage Dagger lockfiles
...
* [dagger](#dagger)	 - A tool to run composable workflows in containers
* [dagger lock list](#dagger-lock-list)	 - List matching lockfile entries
* [dagger lock update](#dagger-lock-update)	 - Refresh selected lockfile entries

## dagger lock list

List matching lockfile entries

### Synopsis

List entries already recorded in the selected dagger.lock.
...
Refresh selected lockfile entries

### Synopsis

Refresh entries already recorded in the selected dagger.lock.
...
```
  -l, --list          List matching lock entries without resolving or updating them
