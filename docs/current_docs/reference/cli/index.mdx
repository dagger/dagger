...
* [dagger artifact](#dagger-artifact)	 - List and filter workspace artifacts
...
* [dagger workspace](#dagger-workspace)	 - Inspect workspace files, config, and artifacts
...
List and filter workspace artifacts

### Synopsis

List artifact addresses without evaluating their values.
...
```
      --dimension-key stringArray   Keep a dimension key: DIMENSION=KEY (repeat for alternatives)
  -t, --type stringArray            Keep artifacts of this GraphQL type (repeat for alternatives)
```
...
* [dagger](#dagger)	 - A tool to run composable workflows in containers
* [dagger artifact dimensions](#dagger-artifact-dimensions)	 - List dimensions of matching artifacts
* [dagger artifact keys](#dagger-artifact-keys)	 - List keys in a dimension of matching artifacts
* [dagger artifact list](#dagger-artifact-list)	 - List matching artifact addresses
* [dagger artifact types](#dagger-artifact-types)	 - List types of matching artifacts

## dagger artifact dimensions

List dimensions of matching artifacts

```
dagger artifact dimensions [address...]
```
...
## dagger artifact keys

List keys in a dimension of matching artifacts

```
dagger artifact keys DIMENSION [address...]
```
...
List matching artifact addresses

```
dagger artifact list [address...]
```
...
List types of matching artifacts

```
dagger artifact types [address...]
```
...
```
dagger generate [options] [address...]
```
...
Inspect workspace files, config, and artifacts
