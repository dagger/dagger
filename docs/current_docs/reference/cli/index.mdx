...
```
  ...
  -l, --list                    List available agents
      ...
      --source-session string   With --trace and --generation, select the archive's source session
      --trace string            Restore agents and their Workspaces from a verified trace archive; load scrollback in the background
```
