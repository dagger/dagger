...
* [dagger](#dagger)	 - A tool to run composable workflows in containers
* [dagger artifacts dimensions](#dagger-artifacts-dimensions)	 - List dimensions of matching artifacts
* [dagger artifacts keys](#dagger-artifacts-keys)	 - List keys in a dimension of matching artifacts
...
```
dagger artifacts dimensions [address...]
```
...
```
dagger artifacts keys DIMENSION [address...]
```
...
```
dagger artifacts types [address...]
```
