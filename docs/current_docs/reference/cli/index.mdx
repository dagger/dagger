...
* [dagger artifacts](#dagger-artifacts)	 - List and filter workspace artifacts
...
```
      --collection-key stringArray   Keep a collection key: COLLECTION=KEY (repeat for alternatives)
...
* [dagger](#dagger)	 - A tool to run composable workflows in containers
* [dagger artifacts collections](#dagger-artifacts-collections)	 - List collections of matching artifacts
* [dagger artifacts keys](#dagger-artifacts-keys)	 - List keys in a collection of matching artifacts
* [dagger artifacts list](#dagger-artifacts-list)	 - List matching artifact addresses
* [dagger artifacts types](#dagger-artifacts-types)	 - List types of matching artifacts

## dagger artifacts collections

List collections of matching artifacts

```
dagger artifacts collections [pattern...]
```
...
## dagger artifacts keys

List keys in a collection of matching artifacts

```
dagger artifacts keys COLLECTION [pattern...]
```
...
```
dagger artifacts types [pattern...]
```
