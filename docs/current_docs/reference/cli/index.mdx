...
* [dagger list](#dagger-list)	 - List workspace artifact dimension values
...
List workspace artifact dimension values

### Synopsis

List values for an artifact dimension.
...
```
dagger list <dimension> [--<dimension>=<value>...]
```
