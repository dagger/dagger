...
* [dagger exec](#dagger-exec)	 - Run a command with a connected Dagger session (DAGGER_SESSION_PORT/TOKEN injected)
...
```
dagger api client init <path> --sdk <sdk> --module <path-or-ref>
```

### Examples

```
dagger api client init ./lib/cli --sdk typescript --module .dagger/modules/api
```
...
```
      ...
      --option stringArray   SDK-specific option as KEY=VAL; may be repeated
      --sdk string           SDK alias or full ref (e.g., 'typescript' or 'github.com/dagger/typescript-sdk')
```
...
Run a command with a connected Dagger session (DAGGER_SESSION_PORT/TOKEN injected)
...
```
dagger module init <name> --sdk <sdk> [flags]
```

### Examples

```
dagger module init myapp --sdk go
```
...
```
      ...
      --sdk string    SDK alias or full ref (e.g., 'go' or 'github.com/dagger/go-sdk')
```
