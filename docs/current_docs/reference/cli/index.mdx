...
* [dagger billing](#dagger-billing)	 - Manage Dagger Cloud billing
...
* [dagger mod](#dagger-mod)	 - Work with modules in your workspace
* [dagger org](#dagger-org)	 - Manage Dagger Cloud organizations
...
* [dagger uninstall](#dagger-uninstall)	 - Uninstall a module
...
* [dagger billing manage](#dagger-billing-manage)	 - Open the billing portal for a Dagger Cloud org
* [dagger billing plans](#dagger-billing-plans)	 - List Dagger Cloud plans available at signup

## dagger billing manage

Open the billing portal for a Dagger Cloud org

```
dagger billing manage [org]
```
...
* [dagger](#dagger)	 - A tool to run composable workflows in containers
* [dagger mod install](#dagger-mod-install)	 - Install a module into the workspace
* [dagger mod list](#dagger-mod-list)	 - List modules installed in the workspace
* [dagger mod recommend](#dagger-mod-recommend)	 - Recommend modules based on files in your workspace
* [dagger mod search](#dagger-mod-search)	 - Search for modules you can install
* [dagger mod uninstall](#dagger-mod-uninstall)	 - Uninstall a module from the workspace
...
Install a module into the current workspace. Alias for `dagger install`.

```
dagger mod install [options] <module> [flags]
```
...
```
dagger mod search [query] [flags]
```

### Examples

```
dagger mod search wolfi
```
...
## dagger mod uninstall

Uninstall a module from the workspace

### Synopsis

Uninstall a module from the current workspace. Alias for `dagger uninstall`.

```
dagger mod uninstall [options] <module> [flags]
```
...
* [dagger](#dagger)	 - A tool to run composable workflows in containers
* [dagger org info](#dagger-org-info)	 - Show Dagger Cloud organization status
* [dagger org list](#dagger-org-list)	 - List Dagger Cloud organizations
* [dagger org use](#dagger-org-use)	 - Select the current Dagger Cloud organization
