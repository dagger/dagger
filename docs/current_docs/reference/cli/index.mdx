...
* [dagger sessions](#dagger-sessions)	 - Manage detachable sessions (experimental)
...
```
      --allow-llm strings    List of URLs of remote modules allowed to access LLM APIs, or 'all' to bypass restrictions for the entire session
      --detach               Run the final call in a detachable session
      --eager-runtime        load module runtime eagerly
...
```
dagger sdk install go && dagger module init go my-module
```
...
Install and manage SDKs that can create Dagger modules or generated API clients.
...
* [dagger sdk installed](#dagger-sdk-installed)	 - List installed SDKs
...
```
dagger sdk install typescript && dagger module init typescript --help && dagger api client init typescript --help
```
...
Manage detachable sessions (experimental)
...
* [dagger](#dagger)	 - A tool to run composable workflows in containers
* [dagger sessions attach](#dagger-sessions-attach)	 - Attach to a detachable session
* [dagger sessions inspect](#dagger-sessions-inspect)	 - Inspect a detachable session
* [dagger sessions list](#dagger-sessions-list)	 - List detachable sessions
* [dagger sessions terminate](#dagger-sessions-terminate)	 - Terminate a detachable session

## dagger sessions attach

Attach to a detachable session

```
dagger sessions attach SESSION
```
...
## dagger sessions inspect

Inspect a detachable session

```
dagger sessions inspect SESSION
```
...
## dagger sessions list

List detachable sessions
...
## dagger sessions terminate

Terminate a detachable session

```
dagger sessions terminate SESSION
```
