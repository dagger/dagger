...
description: "Learn how to configure Dagger to use custom certificate authorities for secure communication with external services."
slug: /reference/configuration/custom-ca
...
- Red Hat-based (e.g. `rhel`, `fedora`, `centos`, etc.)
