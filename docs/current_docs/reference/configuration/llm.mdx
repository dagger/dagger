...
- `ANTHROPIC_MODEL`: optional, defaults to `"claude-sonnet-4-6"`. See other [model name strings](https://docs.anthropic.com/en/docs/about-claude/models/all-models)

## OpenAI

- `OPENAI_API_KEY`: required
- `OPENAI_MODEL`: optional, defaults to `"gpt-5-mini"`. See other [model name strings](https://platform.openai.com/docs/models)
- Optional:
...
- `GEMINI_MODEL`: optional, defaults to `"gemini-2.5-flash"`. See other [model name strings](https://ai.google.dev/gemini-api/docs/models/gemini)
