...
The **Python SDK module**, `github.com/dagger/python-sdk`, supplies the generation code. Install it once, then use the CLI module commands:
...
- **`dagger init` / `dagger develop` not found.** Install the Python SDK with `dagger module install github.com/dagger/python-sdk`, then use `dagger module init python` and `dagger generate`.
