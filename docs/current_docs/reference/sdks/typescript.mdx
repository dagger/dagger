...
- [Types](../../api/reference/index.mdx) covers how language types map to the Dagger API
- [Generating code](../../cli/generating.mdx) covers how generated files are reviewed and applied
...
`init` returns a [changeset](../../cli/generating.mdx) describing the files to
...
A generator produces a [changeset](../../cli/generating.mdx), a diff between the
...
starts every service in the module. See [Services](../../cli/services.mdx).
