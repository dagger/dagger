...
`github.com/dagger/typescript-sdk`. The CLI module commands use an installed SDK
...
dagger module client add github.com/dagger/dagger/modules/go --sdk=typescript
dagger module client update --sdk=typescript
dagger module client rm github.com/dagger/dagger/modules/go --sdk=typescript
```
