---
slug: /sdk/typescript/783645/get-started
---
import Tabs from "@theme/Tabs";
import TabItem from "@theme/TabItem";

# Get Started with the Dagger Typescript SDK

## Introduction

This tutorial teaches you the basics of using Dagger in Typescript. You will learn how to:

- Install the Typescript SDK
- Create a Typescript CI tool that tests and builds a Node.js application for multiple Node.js versions using the Typescript SDK
...
## Step 1: Install the Dagger Typescript SDK

:::note
The Dagger Typescript SDK requires [NodeJS 16.x or later](https://nodejs.org/en/download/).
:::
...
This Typescript stub imports the Dagger SDK and defines an asynchronous function. This function performs the following operations:
...
Run the Typescript CI tool by executing the command below from the project directory:
...
This tutorial introduced you to the Dagger Typescript SDK. It explained how to install the SDK and use it with a Node.js application. It also provided a working example of a Node.js CI tool powered by the SDK, demonstrating how to test an application against multiple Node.js versions in parallel.

Use the [SDK Reference](./reference/modules.md) to learn more about the Dagger Typescript SDK.
