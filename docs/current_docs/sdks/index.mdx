...
Install a module into a workspace (`dagger.toml`) to make it part of a project's command surface; publish a reusable module when several projects need the same capability. See [Workspace setup](../getting-started/workspace-setup.mdx).
