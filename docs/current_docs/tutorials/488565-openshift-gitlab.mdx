---
slug: /tutorials/488565/openshift-gitlab
...
This tutorial outlines how to set up a Continuous Integration (CI) environment with the Dagger Engine on OpenShift in combination with GitLab Runners. The architecture consists of:
...
![Base architecture](/img/current_docs/tutorials/openshift-gitlab/pattern.png)
...
1. Create a new GitLab CI/CD pipeline configuration file in your repository at `.gitlab-ci.yml` with the following content. Refer to the inline comments for configuration you may wish to change.
