...
If you don't already have a GitHub repository, clone the [Dagger open source repository](https://github.com/dagger/dagger) and add the sample GitHub actions workflow shown below to it. Refer to the inline comments for configuration you may wish to change.
