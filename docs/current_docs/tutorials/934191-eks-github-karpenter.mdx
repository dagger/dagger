...
:::note
Remember to add the `ci/index.mjs` file containing the Dagger pipeline too. Alternatively, pick your preferred language and adapt the GitHub Actions workflow example above.
:::
