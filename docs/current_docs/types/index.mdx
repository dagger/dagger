...
:::tip
In addition to the default Dagger Types, you can create and add your own custom Types to Dagger. These custom Types can be used in Dagger Modules and can be composed with other core Types to create complex workflows.
