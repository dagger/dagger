...
```cue file=tests/107-kind/deployment/todoapp.cue title="todoapp/kube/todoapp.cue"
```
...
```cue file=tests/107-kind/cue-kube-manifest/deployment.cue title="todoapp/kube/deployment.cue"
```

Indeed, let's also define a re-usable `#Service` definition in `kube/service.cue`.

```cue file=tests/107-kind/cue-kube-manifest/service.cue title="todoapp/kube/service.cue"
```
...
```cue file=tests/107-kind/cue-kube-manifest/manifest.cue title="todoapp/kube/manifest.cue"
```
...
```cue file=tests/107-kind/cue-kube-manifest/todoapp.cue title="todoapp/kube/todoapp.cue"
```
