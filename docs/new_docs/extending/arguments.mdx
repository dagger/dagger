...
import { CodeTabs } from '/snippets/components/CodeTabs.jsx';
import { ShellTabs } from '/snippets/components/ShellTabs.jsx';
import { PythonTypeNote, PhpTypeNote } from '/snippets/components/LanguageNotes.jsx';
...
<CodeTabs 
  snippetPath="/snippets/code/functions/arguments-string"
  goFile="main-go.mdx"
  pythonFile="main.py"
  typescriptFile="index.ts"
  phpFile="src/MyModule.php"
  javaFile="src/main/java/io/dagger/modules/mymodule/MyModule.java"
  pythonNotes={<PythonTypeNote />}
  phpNotes={<PhpTypeNote />}
/>
