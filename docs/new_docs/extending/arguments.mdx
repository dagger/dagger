...
import { CustomCodeGroup } from '/snippets/custom-code-group.jsx';
...
<CustomCodeGroup 
  goCode="./snippets/functions/arguments-boolean/go/main.go"
  pythonCode="./snippets/functions/arguments-boolean/python/main.py"
  typescriptCode="./snippets/functions/arguments-boolean/typescript/index.ts"
  phpCode="./snippets/functions/arguments-boolean/php/src/MyModule.php"
  javaCode="./snippets/functions/arguments-boolean/java/src/main/java/io/dagger/modules/mymodule/MyModule.java"
/>
...
func main() {
  client, err := dagger.Connect(dagger.WithLogOutput(os.Stdout))
  if err != nil {
    panic(err)
  }
  defer client.Close()

  // Call the Dagger Function with a boolean argument
  result, err := client.Call("hello", map[string]any{"shout": true})
  if err != nil {
    panic(err)
  }
