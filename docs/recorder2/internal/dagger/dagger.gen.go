...
// The `DockerCliID` scalar type represents an identifier for an object of type DockerCli.
type DockerCliID string

// The `DockerID` scalar type represents an identifier for an object of type Docker.
type DockerID string

// The `DockerImageID` scalar type represents an identifier for an object of type DockerImage.
...
// The `VhsID` scalar type represents an identifier for an object of type Vhs.
type VhsID string

// The `VhsTapeID` scalar type represents an identifier for an object of type VhsTape.
type VhsTapeID string

// The `VhsTapeSettingBlockID` scalar type represents an identifier for an object of type VhsTapeSettingBlock.
type VhsTapeSettingBlockID string

// The `VhsTapeSettingID` scalar type represents an identifier for an object of type VhsTapeSetting.
type VhsTapeSettingID string

// The `VhsWithSourceID` scalar type represents an identifier for an object of type VhsWithSource.
type VhsWithSourceID string
...
// Retrieve the binding value, as type Docker
func (r *Binding) AsDocker() *Docker {
	q := r.query.Select("asDocker")
...
// Retrieve the binding value, as type DockerCli
func (r *Binding) AsDockerCli() *DockerCli {
	q := r.query.Select("asDockerCli")
...
// Retrieve the binding value, as type DockerImage
func (r *Binding) AsDockerImage() *DockerImage {
	q := r.query.Select("asDockerImage")
...
// Retrieve the binding value, as type Vhs
func (r *Binding) AsVhs() *Vhs {
	q := r.query.Select("asVhs")
...
// Retrieve the binding value, as type VhsTape
func (r *Binding) AsVhsTape() *VhsTape {
	q := r.query.Select("asVhsTape")
...
// Retrieve the binding value, as type VhsTapeSetting
func (r *Binding) AsVhsTapeSetting() *VhsTapeSetting {
	q := r.query.Select("asVhsTapeSetting")

	return &VhsTapeSetting{
		query: q,
	}
}

// Retrieve the binding value, as type VhsTapeSettingBlock
func (r *Binding) AsVhsTapeSettingBlock() *VhsTapeSettingBlock {
	q := r.query.Select("asVhsTapeSettingBlock")

	return &VhsTapeSettingBlock{
		query: q,
	}
}

// Retrieve the binding value, as type VhsWithSource
func (r *Binding) AsVhsWithSource() *VhsWithSource {
	q := r.query.Select("asVhsWithSource")

	return &VhsWithSource{
		query: q,
	}
}
...
type Docker struct { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L21)
	query *querybuilder.Selection

	id *DockerID
}

func (r *Docker) WithGraphQLQuery(q *querybuilder.Selection) *Docker {
	return &Docker{
		query: q,
	}
}

// DockerCliOpts contains options for Docker.Cli
type DockerCliOpts struct {
	//
	// Version of the Docker CLI to run.
	//
	//
	// Default: "24.0"
	Version string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L71)
	//
	// Specify the Docker Engine to connect to.
	// By default, run an ephemeral engine.
	//
	Engine *Service // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L75)
}

// A Docker CLI ready to query this engine.
// Entrypoint is set to `docker`
func (r *Docker) Cli(opts ...DockerCliOpts) *DockerCli { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L67)
	...
	for i := len(opts) - 1; i >= 0; i-- {
		...
		// `engine` optional argument
		if !querybuilder.IsZeroValue(opts[i].Engine) {
			q = q.Arg("engine", opts[i].Engine)
		}
	}
...
// DockerEngineOpts contains options for Docker.Engine
type DockerEngineOpts struct {
	//
	// Docker Engine version
	//
	//
	// Default: "24.0"
	Version string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L29)
	//
	// Persist the state of the engine in a cache volume
	//
	//
	// Default: true
	Persist bool // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L33)
	//
	// Namespace for persisting the engine state.
	// Use in combination with `persist`
	//
	Namespace string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L37)
}

// Spawn an ephemeral Docker Engine in a container
func (r *Docker) Engine(opts ...DockerEngineOpts) *Service { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L25)
	...
	for i := len(opts) - 1; i >= 0; i-- {
		...
		// `persist` optional argument
		if !querybuilder.IsZeroValue(opts[i].Persist) {
			q = q.Arg("persist", opts[i].Persist)
		}
...
// A unique identifier for this Docker.
func (r *Docker) ID(ctx context.Context) (DockerID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response DockerID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Docker) XXX_GraphQLType() string {
	return "Docker"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Docker) XXX_GraphQLIDType() string {
	return "DockerID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Docker) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Docker) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadDockerFromID(DockerID(id))
	return nil
}

// A Docker client
type DockerCli struct { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L86)
	query *querybuilder.Selection
...
type WithDockerCliFunc func(r *DockerCli) *DockerCli

// With calls the provided function with current DockerCli.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *DockerCli) With(f WithDockerCliFunc) *DockerCli {
	return f(r)
}

func (r *DockerCli) WithGraphQLQuery(q *querybuilder.Selection) *DockerCli {
	return &DockerCli{
		query: q,
	}
}
...
func (r *DockerCli) Container() *Container { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L91)
	q := r.query.Select("container")
...
func (r *DockerCli) Engine() *Service { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L87)
	q := r.query.Select("engine")
...
// A unique identifier for this DockerCli.
func (r *DockerCli) ID(ctx context.Context) (DockerCliID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response DockerCliID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *DockerCli) XXX_GraphQLType() string {
	return "DockerCli"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *DockerCli) XXX_GraphQLIDType() string {
	return "DockerCliID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *DockerCli) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *DockerCli) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *DockerCli) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadDockerCliFromID(DockerCliID(id))
	return nil
}

// DockerCliImageOpts contains options for DockerCli.Image
type DockerCliImageOpts struct {
	//
	// Filter by image repository
	//
	Repository string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L212)
	//
	// Filter by image tag
	//
	//
	// Default: "latest"
	Tag string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L216)
	//
	// Filter by image local ID (short IDs are allowed)
	//
	LocalID string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L219)
}

// Look up an image in the local Docker Engine cache
// If exactly one image matches the filters, return it.
// Otherwise, return an error.
func (r *DockerCli) Image(opts ...DockerCliImageOpts) *DockerImage { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L208)
	...
	for i := len(opts) - 1; i >= 0; i-- {
		...
		// `localId` optional argument
		if !querybuilder.IsZeroValue(opts[i].LocalID) {
			q = q.Arg("localId", opts[i].LocalID)
		}
	}
...
// DockerCliImagesOpts contains options for DockerCli.Images
type DockerCliImagesOpts struct {
	//
	// Filter by repository
	//
	Repository string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L260)
	//
	// Filter by tag
	//
	Tag string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L263)
	//
	// Filter by image ID
	//
	LocalID string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L266)
}

// List images on the local Docker Engine cache
func (r *DockerCli) Images(ctx context.Context, opts ...DockerCliImagesOpts) ([]DockerImage, error) { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L256)
	q := r.query.Select("images")
	for i := len(opts) - 1; i >= 0; i-- {
		// `repository` optional argument
		if !querybuilder.IsZeroValue(opts[i].Repository) {
			q = q.Arg("repository", opts[i].Repository)
	...
	convert := func(fields []images) []DockerImage {
		out := []DockerImage{}

		for i := range fields {
			val := DockerImage{id: &fields[i].Id}
			val.query = q.Root().Select("loadDockerImageFromID").Arg("id", fields[i].Id)
			out = append(out, val)
		}
...
func (r *DockerCli) Import(container *Container) *DockerImage { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L162)
...
// DockerCliPullOpts contains options for DockerCli.Pull
type DockerCliPullOpts struct {
	//
	// The docker image tag to pull
	//
	//
	// Default: "latest"
	Tag string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L108)
}

// Execute 'docker pull'
func (r *DockerCli) Pull(repository string, opts ...DockerCliPullOpts) *DockerImage { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L101)
	q := r.query.Select("pull")
	for i := len(opts) - 1; i >= 0; i-- {
		// `tag` optional argument
		if !querybuilder.IsZeroValue(opts[i].Tag) {
			q = q.Arg("tag", opts[i].Tag)
...
// DockerCliPushOpts contains options for DockerCli.Push
type DockerCliPushOpts struct {
	//
	// The tag to push to.
	//
	//
	// Default: "latest"
	Tag string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L120)
}

// Execute 'docker push'
func (r *DockerCli) Push(ctx context.Context, repository string, opts ...DockerCliPushOpts) (string, error) { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L113)
	if r.push != nil {
		return *r.push, nil
	}
...
// DockerCliRunOpts contains options for DockerCli.Run
type DockerCliRunOpts struct {
	//
	// Tag of the image to run.
	//
	//
	// Default: "latest"
	Tag string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L243)
	//
	// Additional arguments
	//
	Args []string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L246)
}

// Run a container with the docker CLI
func (r *DockerCli) Run(ctx context.Context, name string, opts ...DockerCliRunOpts) (string, error) { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L235)
	if r.run != nil {
		return *r.run, nil
	}
	q := r.query.Select("run")
...
// DockerCliWithPullOpts contains options for DockerCli.WithPull
type DockerCliWithPullOpts struct {
	//
	// The tag to pull from
	//
	//
	// Default: "latest"
	Tag string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L137)
}

// Execute 'docker pull' and return the CLI state, for chaining.
func (r *DockerCli) WithPull(repository string, opts ...DockerCliWithPullOpts) *DockerCli { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L130)
	q := r.query.Select("withPull")
	for i := len(opts) - 1; i >= 0; i-- {
		// `tag` optional argument
		if !querybuilder.IsZeroValue(opts[i].Tag) {
			q = q.Arg("tag", opts[i].Tag)
...
// DockerCliWithPushOpts contains options for DockerCli.WithPush
type DockerCliWithPushOpts struct {
	//
	// The tag to push to.
	//
	//
	// Default: "latest"
	Tag string // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L151)
}

// Execute 'docker push' and return the CLI state, for chaining.
func (r *DockerCli) WithPush(repository string, opts ...DockerCliWithPushOpts) *DockerCli { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L144)
	q := r.query.Select("withPush")
	for i := len(opts) - 1; i >= 0; i-- {
		// `tag` optional argument
		if !querybuilder.IsZeroValue(opts[i].Tag) {
			q = q.Arg("tag", opts[i].Tag)
...
type DockerImage struct { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L313)
	query *querybuilder.Selection
...
type WithDockerImageFunc func(r *DockerImage) *DockerImage

// With calls the provided function with current DockerImage.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *DockerImage) With(f WithDockerImageFunc) *DockerImage {
	return f(r)
}

func (r *DockerImage) WithGraphQLQuery(q *querybuilder.Selection) *DockerImage {
	return &DockerImage{
		query: q,
	}
}
...
func (r *DockerImage) Duplicate(repository string, tag string) *DockerImage { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L337)
	q := r.query.Select("duplicate")
	q = q.Arg("repository", repository)
	q = q.Arg("tag", tag)
...
func (r *DockerImage) Export() *Container { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L322)
	q := r.query.Select("export")
...
// A unique identifier for this DockerImage.
func (r *DockerImage) ID(ctx context.Context) (DockerImageID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response DockerImageID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *DockerImage) XXX_GraphQLType() string {
	return "DockerImage"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *DockerImage) XXX_GraphQLIDType() string {
	return "DockerImageID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *DockerImage) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *DockerImage) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadDockerImageFromID(DockerImageID(id))
	return nil
}

// The local identifer of the docker image. Can't call it ID...
func (r *DockerImage) LocalID(ctx context.Context) (string, error) { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L316)
	if r.localId != nil {
		return *r.localId, nil
	}
	q := r.query.Select("localId")
...
func (r *DockerImage) Push(ctx context.Context) (string, error) { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L365)
	if r.push != nil {
		return *r.push, nil
	}
	q := r.query.Select("push")
...
func (r *DockerImage) Ref(ctx context.Context) (string, error) { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L370)
	if r.ref != nil {
		return *r.ref, nil
	}
...
func (r *DockerImage) Repository(ctx context.Context) (string, error) { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L318)
	if r.repository != nil {
...
func (r *DockerImage) Tag(ctx context.Context) (string, error) { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L317)
	if r.tag != nil {
		return *r.tag, nil
	}
	q := r.query.Select("tag")
...
// Create or update a binding of type DockerCli in the environment
func (r *Env) WithDockerCliInput(name string, value *DockerCli, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withDockerCliInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired DockerCli output to be assigned in the environment
func (r *Env) WithDockerCliOutput(name string, description string) *Env {
	q := r.query.Select("withDockerCliOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
// Create or update a binding of type DockerImage in the environment
func (r *Env) WithDockerImageInput(name string, value *DockerImage, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withDockerImageInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired DockerImage output to be assigned in the environment
func (r *Env) WithDockerImageOutput(name string, description string) *Env {
	q := r.query.Select("withDockerImageOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
// Create or update a binding of type Docker in the environment
func (r *Env) WithDockerInput(name string, value *Docker, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withDockerInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired Docker output to be assigned in the environment
func (r *Env) WithDockerOutput(name string, description string) *Env {
	q := r.query.Select("withDockerOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
// Create or update a binding of type Vhs in the environment
func (r *Env) WithVhsInput(name string, value *Vhs, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withVhsInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired Vhs output to be assigned in the environment
func (r *Env) WithVhsOutput(name string, description string) *Env {
	q := r.query.Select("withVhsOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
// Create or update a binding of type VhsTape in the environment
func (r *Env) WithVhsTapeInput(name string, value *VhsTape, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withVhsTapeInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired VhsTape output to be assigned in the environment
func (r *Env) WithVhsTapeOutput(name string, description string) *Env {
	q := r.query.Select("withVhsTapeOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
// Create or update a binding of type VhsTapeSettingBlock in the environment
func (r *Env) WithVhsTapeSettingBlockInput(name string, value *VhsTapeSettingBlock, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withVhsTapeSettingBlockInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired VhsTapeSettingBlock output to be assigned in the environment
func (r *Env) WithVhsTapeSettingBlockOutput(name string, description string) *Env {
	q := r.query.Select("withVhsTapeSettingBlockOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
// Create or update a binding of type VhsTapeSetting in the environment
func (r *Env) WithVhsTapeSettingInput(name string, value *VhsTapeSetting, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withVhsTapeSettingInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired VhsTapeSetting output to be assigned in the environment
func (r *Env) WithVhsTapeSettingOutput(name string, description string) *Env {
	q := r.query.Select("withVhsTapeSettingOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
// Create or update a binding of type VhsWithSource in the environment
func (r *Env) WithVhsWithSourceInput(name string, value *VhsWithSource, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withVhsWithSourceInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired VhsWithSource output to be assigned in the environment
func (r *Env) WithVhsWithSourceOutput(name string, description string) *Env {
	q := r.query.Select("withVhsWithSourceOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
func (r *Client) Docker() *Docker { // docker (https://github.com/shykes/x/tree/36ad35ca2d917b7fe965fa3aeb2b5f74f6dda106/docker/main.go#L21)
	q := r.query.Select("docker")
...
// Load a DockerCli from its ID.
func (r *Client) LoadDockerCliFromID(id DockerCliID) *DockerCli {
	q := r.query.Select("loadDockerCliFromID")
	q = q.Arg("id", id)
...
// Load a Docker from its ID.
func (r *Client) LoadDockerFromID(id DockerID) *Docker {
	q := r.query.Select("loadDockerFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadDockerImageFromID(id DockerImageID) *DockerImage {
...
// Load a Vhs from its ID.
func (r *Client) LoadVhsFromID(id VhsID) *Vhs {
	q := r.query.Select("loadVhsFromID")
	q = q.Arg("id", id)
...
// Load a VhsTape from its ID.
func (r *Client) LoadVhsTapeFromID(id VhsTapeID) *VhsTape {
	q := r.query.Select("loadVhsTapeFromID")
	q = q.Arg("id", id)
...
// Load a VhsTapeSettingBlock from its ID.
func (r *Client) LoadVhsTapeSettingBlockFromID(id VhsTapeSettingBlockID) *VhsTapeSettingBlock {
	q := r.query.Select("loadVhsTapeSettingBlockFromID")
	q = q.Arg("id", id)
...
// Load a VhsTapeSetting from its ID.
func (r *Client) LoadVhsTapeSettingFromID(id VhsTapeSettingID) *VhsTapeSetting {
	q := r.query.Select("loadVhsTapeSettingFromID")
	q = q.Arg("id", id)
...
// Load a VhsWithSource from its ID.
func (r *Client) LoadVhsWithSourceFromID(id VhsWithSourceID) *VhsWithSource {
	q := r.query.Select("loadVhsWithSourceFromID")
	q = q.Arg("id", id)
...
// VhsOpts contains options for Client.Vhs
type VhsOpts struct {
	//
	// Version (image tag) to use from the official image repository as a base container.
	//
	Version string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L21)
	//
	// Custom container to use as a base container.
	//
	Container *Container // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L26)
}

func (r *Client) Vhs(opts ...VhsOpts) *Vhs { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L17)
	q := r.query.Select("vhs")
	for i := len(opts) - 1; i >= 0; i-- {
		// `version` optional argument
		if !querybuilder.IsZeroValue(opts[i].Version) {
			q = q.Arg("version", opts[i].Version)
...
type Vhs struct { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L13)
	query *querybuilder.Selection

	id *VhsID
}
type WithVhsFunc func(r *Vhs) *Vhs

// With calls the provided function with current Vhs.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *Vhs) With(f WithVhsFunc) *Vhs {
	return f(r)
}

func (r *Vhs) WithGraphQLQuery(q *querybuilder.Selection) *Vhs {
	return &Vhs{
		query: q,
	}
}

func (r *Vhs) Container() *Container { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L14)
	q := r.query.Select("container")
...
// A unique identifier for this Vhs.
func (r *Vhs) ID(ctx context.Context) (VhsID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Vhs) XXX_GraphQLType() string {
	return "Vhs"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Vhs) XXX_GraphQLIDType() string {
	return "VhsID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Vhs) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Vhs) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *Vhs) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadVhsFromID(VhsID(id))
	return nil
}

// VhsNewTapeOpts contains options for Vhs.NewTape
type VhsNewTapeOpts struct {
	//
	// Name of the tape file to create.
	//
	//
	// Default: "cassette.tape"
	Name string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L47)
}

// Create a new tape file with example tape file contents and documentation.
func (r *Vhs) NewTape(opts ...VhsNewTapeOpts) *File { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L42)
	q := r.query.Select("newTape")
	for i := len(opts) - 1; i >= 0; i-- {
		// `name` optional argument
		if !querybuilder.IsZeroValue(opts[i].Name) {
			q = q.Arg("name", opts[i].Name)
...
// VhsRenderOpts contains options for Vhs.Render
type VhsRenderOpts struct {
	//
	// Publish your GIF to vhs.charm.sh and get a shareable URL.
	//
	Publish bool // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L69)
}

// Runs a given tape file and generates its outputs.
//
// If you have source commands in your tape file, use withSource instead.
func (r *Vhs) Render(tape *File, opts ...VhsRenderOpts) *Directory { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L61)
	assertNotNil("tape", tape)
...
func (r *Vhs) Tape() *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L11)
	q := r.query.Select("tape")
...
// VhsWithEnvVariableOpts contains options for Vhs.WithEnvVariable
type VhsWithEnvVariableOpts struct {
	//
	// Replace `${VAR}` or $VAR in the value according to the current environment
	// variables defined in the container (e.g., "/opt/bin:$PATH").
	//
	Expand bool // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/container.go#L17)
}

// Set an environment variable.
func (r *Vhs) WithEnvVariable(name string, value string, opts ...VhsWithEnvVariableOpts) *Vhs { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/container.go#L6)
	q := r.query.Select("withEnvVariable")
	for i := len(opts) - 1; i >= 0; i-- {
		// `expand` optional argument
		if !querybuilder.IsZeroValue(opts[i].Expand) {
...
func (r *Vhs) WithSecretVariable(name string, secret *Secret) *Vhs { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/container.go#L41)
	assertNotNil("secret", secret)
	q := r.query.Select("withSecretVariable")
	q = q.Arg("name", name)
	q = q.Arg("secret", secret)
...
func (r *Vhs) WithServiceBinding(alias string, service *Service) *Vhs { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/container.go#L64)
	assertNotNil("service", service)
	q := r.query.Select("withServiceBinding")
	q = q.Arg("alias", alias)
	q = q.Arg("service", service)
...
func (r *Vhs) WithSource(source *Directory) *VhsWithSource { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L79)
	assertNotNil("source", source)
...
func (r *Vhs) WithoutEnvVariable(name string) *Vhs { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/container.go#L31)
	q := r.query.Select("withoutEnvVariable")
	q = q.Arg("name", name)
...
func (r *Vhs) WithoutSecretVariable(name string) *Vhs { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/container.go#L54)
	q := r.query.Select("withoutSecretVariable")
	q = q.Arg("name", name)
...
type VhsTape struct { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L17)
	query *querybuilder.Selection

	id *VhsTapeID
}
type WithVhsTapeFunc func(r *VhsTape) *VhsTape

// With calls the provided function with current VhsTape.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *VhsTape) With(f WithVhsTapeFunc) *VhsTape {
	return f(r)
}

func (r *VhsTape) WithGraphQLQuery(q *querybuilder.Selection) *VhsTape {
	return &VhsTape{
		query: q,
	}
}

// VhsTapeBackspaceOpts contains options for VhsTape.Backspace
type VhsTapeBackspaceOpts struct {
	//
	// Override the standard typing speed.
	//
	Time string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L26)
	//
	// Repeat the key press.
	//
	Count int // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L31)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L36)
}

// Press the backspace key.
func (r *VhsTape) Backspace(opts ...VhsTapeBackspaceOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L22)
	q := r.query.Select("backspace")
	for i := len(opts) - 1; i >= 0; i-- {
		...
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
		}
	}
...
func (r *VhsTape) Comment(comment string) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L136)
	q := r.query.Select("comment")
	q = q.Arg("comment", comment)
...
// VhsTapeCopyOpts contains options for VhsTape.Copy
type VhsTapeCopyOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L319)
}

// The Copy command copies a value to the clipboard.
func (r *VhsTape) Copy(value string, opts ...VhsTapeCopyOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L313)
...
// VhsTapeCtrlOpts contains options for VhsTape.Ctrl
type VhsTapeCtrlOpts struct {
	//
	// Press the "alt" key.
	//
	Alt bool // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L49)
	//
	// Press the "shift" key.
	//
	Shift bool // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L55)
	//
	// Override the standard typing speed.
	//
	Time string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L60)
	//
	// Repeat the key press.
	//
	Count int // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L65)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L70)
}

// Access the control modifier and send control sequences.
func (r *VhsTape) Ctrl(char string, opts ...VhsTapeCtrlOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L42)
	q := r.query.Select("ctrl")
	for i := len(opts) - 1; i >= 0; i-- {
		// `alt` optional argument
		if !querybuilder.IsZeroValue(opts[i].Alt) {
			q = q.Arg("alt", opts[i].Alt)
		}
		// `shift` optional argument
		if !querybuilder.IsZeroValue(opts[i].Shift) {
			q = q.Arg("shift", opts[i].Shift)
		}
		// `time` optional argument
		if !querybuilder.IsZeroValue(opts[i].Time) {
			q = q.Arg("time", opts[i].Time)
...
// VhsTapeDownOpts contains options for VhsTape.Down
type VhsTapeDownOpts struct {
	//
	// Override the standard typing speed.
	//
	Time string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L132)
	//
	// Repeat the key press.
	//
	Count int // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L137)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L142)
}

// Press the down arrow key.
func (r *VhsTape) Down(opts ...VhsTapeDownOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L128)
	q := r.query.Select("down")
	for i := len(opts) - 1; i >= 0; i-- {
		// `time` optional argument
		if !querybuilder.IsZeroValue(opts[i].Time) {
			q = q.Arg("time", opts[i].Time)
...
func (r *VhsTape) EmptyLine() *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L152)
	q := r.query.Select("emptyLine")
...
// VhsTapeEnterOpts contains options for VhsTape.Enter
type VhsTapeEnterOpts struct {
	//
	// Override the standard typing speed.
	//
	Time string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L92)
	//
	// Repeat the key press.
	//
	Count int // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L97)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L102)
}

// Press the enter key.
func (r *VhsTape) Enter(opts ...VhsTapeEnterOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L88)
	q := r.query.Select("enter")
	for i := len(opts) - 1; i >= 0; i-- {
		// `time` optional argument
		if !querybuilder.IsZeroValue(opts[i].Time) {
			q = q.Arg("time", opts[i].Time)
...
// VhsTapeEnvOpts contains options for VhsTape.Env
type VhsTapeEnvOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L342)
}

// The Env command sets the environment variable via key-value pair.
func (r *VhsTape) Env(key string, value string, opts ...VhsTapeEnvOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L335)
	q := r.query.Select("env")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeFileOpts contains options for VhsTape.File
type VhsTapeFileOpts struct {
	//
	// Name of the tape file to create.
	//
	//
	// Default: "cassette.tape"
	Name string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L31)
}

// Get the final tape file.
func (r *VhsTape) File(opts ...VhsTapeFileOpts) *File { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L26)
	q := r.query.Select("file")
	for i := len(opts) - 1; i >= 0; i-- {
		// `name` optional argument
		if !querybuilder.IsZeroValue(opts[i].Name) {
...
// VhsTapeHideOpts contains options for VhsTape.Hide
type VhsTapeHideOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L284)
}

// The Hide command instructs VHS to stop capturing frames.
// It's useful to pause a recording to perform hidden commands.
func (r *VhsTape) Hide(opts ...VhsTapeHideOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L280)
	q := r.query.Select("hide")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// A unique identifier for this VhsTape.
func (r *VhsTape) ID(ctx context.Context) (VhsTapeID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response VhsTapeID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *VhsTape) XXX_GraphQLType() string {
	return "VhsTape"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *VhsTape) XXX_GraphQLIDType() string {
	return "VhsTapeID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *VhsTape) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *VhsTape) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *VhsTape) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadVhsTapeFromID(VhsTapeID(id))
	return nil
}

// VhsTapeLeftOpts contains options for VhsTape.Left
type VhsTapeLeftOpts struct {
	//
	// Override the standard typing speed.
	//
	Time string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L152)
	//
	// Repeat the key press.
	//
	Count int // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L157)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L162)
}

// Press the left arrow key.
func (r *VhsTape) Left(opts ...VhsTapeLeftOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L148)
	q := r.query.Select("left")
	for i := len(opts) - 1; i >= 0; i-- {
		// `time` optional argument
		if !querybuilder.IsZeroValue(opts[i].Time) {
			q = q.Arg("time", opts[i].Time)
...
// VhsTapeOutputOpts contains options for VhsTape.Output
type VhsTapeOutputOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L164)
}
...
func (r *VhsTape) Output(path string, opts ...VhsTapeOutputOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L158)
	q := r.query.Select("output")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapePageDownOpts contains options for VhsTape.PageDown
type VhsTapePageDownOpts struct {
	//
	// Override the standard typing speed.
	//
	Time string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L252)
	//
	// Repeat the key press.
	//
	Count int // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L257)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L262)
}

// Press the page down key.
func (r *VhsTape) PageDown(opts ...VhsTapePageDownOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L248)
	q := r.query.Select("pageDown")
	for i := len(opts) - 1; i >= 0; i-- {
		// `time` optional argument
		if !querybuilder.IsZeroValue(opts[i].Time) {
			q = q.Arg("time", opts[i].Time)
...
// VhsTapePageUpOpts contains options for VhsTape.PageUp
type VhsTapePageUpOpts struct {
	//
	// Override the standard typing speed.
	//
	Time string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L232)
	//
	// Repeat the key press.
	//
	Count int // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L237)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L242)
}

// Press the page up key.
func (r *VhsTape) PageUp(opts ...VhsTapePageUpOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L228)
	q := r.query.Select("pageUp")
	for i := len(opts) - 1; i >= 0; i-- {
		// `time` optional argument
		if !querybuilder.IsZeroValue(opts[i].Time) {
			q = q.Arg("time", opts[i].Time)
...
// VhsTapePasteOpts contains options for VhsTape.Paste
type VhsTapePasteOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L329)
}

// The Paste command pastes the value from clipboard.
func (r *VhsTape) Paste(opts ...VhsTapePasteOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L325)
	q := r.query.Select("paste")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeRenderOpts contains options for VhsTape.Render
type VhsTapeRenderOpts struct {
	//
	// Publish your GIF to vhs.charm.sh and get a shareable URL.
	//
	Publish bool // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L50)
}

// Runs the tape file and generates its outputs.
//
// Do not use source commands in your tape file.
func (r *VhsTape) Render(opts ...VhsTapeRenderOpts) *Directory { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L45)
	q := r.query.Select("render")
	for i := len(opts) - 1; i >= 0; i-- {
		// `publish` optional argument
		if !querybuilder.IsZeroValue(opts[i].Publish) {
...
// VhsTapeRequireOpts contains options for VhsTape.Require
type VhsTapeRequireOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L179)
}
...
func (r *VhsTape) Require(program string, opts ...VhsTapeRequireOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L173)
	q := r.query.Select("require")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeRightOpts contains options for VhsTape.Right
type VhsTapeRightOpts struct {
	//
	// Override the standard typing speed.
	//
	Time string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L172)
	//
	// Repeat the key press.
	//
	Count int // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L177)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L182)
}

// Press the right arrow key.
func (r *VhsTape) Right(opts ...VhsTapeRightOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L168)
	q := r.query.Select("right")
	for i := len(opts) - 1; i >= 0; i-- {
		// `time` optional argument
		if !querybuilder.IsZeroValue(opts[i].Time) {
			q = q.Arg("time", opts[i].Time)
...
// VhsTapeScreenshotOpts contains options for VhsTape.Screenshot
type VhsTapeScreenshotOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L307)
}

// The Screenshot command captures the current frame (png format).
func (r *VhsTape) Screenshot(path string, opts ...VhsTapeScreenshotOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L301)
	q := r.query.Select("screenshot")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
func (r *VhsTape) Set() *VhsTapeSetting { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L40)
...
// Setting must be administered at the top of the tape file.
// Any setting (except TypingSpeed) applied after a non-setting or non-output command will be ignored.
func (r *VhsTape) SetBlock() *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L60)
	q := r.query.Select("setBlock")
...
// VhsTapeShowOpts contains options for VhsTape.Show
type VhsTapeShowOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L295)
}
...
func (r *VhsTape) Show(opts ...VhsTapeShowOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L291)
...
// VhsTapeSleepOpts contains options for VhsTape.Sleep
type VhsTapeSleepOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L273)
}
...
func (r *VhsTape) Sleep(seconds string, opts ...VhsTapeSleepOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L267)
	q := r.query.Select("sleep")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSourceOpts contains options for VhsTape.Source
type VhsTapeSourceOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L354)
}

// The Source command allows you to execute commands from another tape.
func (r *VhsTape) Source(tape string, opts ...VhsTapeSourceOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L348)
	q := r.query.Select("source")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSpaceOpts contains options for VhsTape.Space
type VhsTapeSpaceOpts struct {
	//
	// Override the standard typing speed.
	//
	Time string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L212)
	//
	// Repeat the key press.
	//
	Count int // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L217)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L222)
}

// Press the space key.
func (r *VhsTape) Space(opts ...VhsTapeSpaceOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L208)
	q := r.query.Select("space")
	for i := len(opts) - 1; i >= 0; i-- {
		// `time` optional argument
		if !querybuilder.IsZeroValue(opts[i].Time) {
			q = q.Arg("time", opts[i].Time)
...
// VhsTapeTabOpts contains options for VhsTape.Tab
type VhsTapeTabOpts struct {
	//
	// Override the standard typing speed.
	//
	Time string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L192)
	//
	// Repeat the key press.
	//
	Count int // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L197)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L202)
}

// Press the tab key.
func (r *VhsTape) Tab(opts ...VhsTapeTabOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L188)
	q := r.query.Select("tab")
	for i := len(opts) - 1; i >= 0; i-- {
		// `time` optional argument
		if !querybuilder.IsZeroValue(opts[i].Time) {
			q = q.Arg("time", opts[i].Time)
...
// VhsTapeTypeOpts contains options for VhsTape.Type
type VhsTapeTypeOpts struct {
	//
	// Override the standard typing speed.
	//
	Time string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L194)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L199)
}
...
func (r *VhsTape) Type(characters string, opts ...VhsTapeTypeOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L188)
...
// VhsTapeUpOpts contains options for VhsTape.Up
type VhsTapeUpOpts struct {
	//
	// Override the standard typing speed.
	//
	Time string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L112)
	//
	// Repeat the key press.
	//
	Count int // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L117)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L122)
}

// Press the up arrow key.
func (r *VhsTape) Up(opts ...VhsTapeUpOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_key.go#L108)
	q := r.query.Select("up")
	for i := len(opts) - 1; i >= 0; i-- {
		// `time` optional argument
		if !querybuilder.IsZeroValue(opts[i].Time) {
...
// VhsTapeWaitOpts contains options for VhsTape.Wait
type VhsTapeWaitOpts struct {
	//
	// Regular expression to wait for.
	//
	Regexp string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L228)
	//
	// Scope to wait for the regular expression to appear (whole screen or just the last line).
	//
	Scope VhsWaitScope // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L233)
	//
	// Duration to wait for the regular expression to appear.
	//
	Timeout string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L238)
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L243)
}
...
func (r *VhsTape) Wait(opts ...VhsTapeWaitOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L224)
	...
	for i := len(opts) - 1; i >= 0; i-- {
		...
		if !querybuilder.IsZeroValue(opts[i].Scope) {
			q = q.Arg("scope", opts[i].Scope)
		}
...
type VhsTapeSetting struct { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L46)
	query *querybuilder.Selection

	id *VhsTapeSettingID
}

func (r *VhsTapeSetting) WithGraphQLQuery(q *querybuilder.Selection) *VhsTapeSetting {
	return &VhsTapeSetting{
		query: q,
	}
}

// VhsTapeSettingBorderRadiusOpts contains options for VhsTapeSetting.BorderRadius
type VhsTapeSettingBorderRadiusOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L424)
}

// Set the border radius (in pixels) of the terminal window.
func (r *VhsTapeSetting) BorderRadius(pixels int, opts ...VhsTapeSettingBorderRadiusOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L418)
	q := r.query.Select("borderRadius")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingCursorBlinkOpts contains options for VhsTapeSetting.CursorBlink
type VhsTapeSettingCursorBlinkOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L522)
}

// Set whether the cursor should blink. Enabled by default.
func (r *VhsTapeSetting) CursorBlink(blink bool, opts ...VhsTapeSettingCursorBlinkOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L516)
	q := r.query.Select("cursorBlink")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingFontFamilyOpts contains options for VhsTapeSetting.FontFamily
type VhsTapeSettingFontFamilyOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L151)
}

// Set the font family.
func (r *VhsTapeSetting) FontFamily(font string, opts ...VhsTapeSettingFontFamilyOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L145)
	q := r.query.Select("fontFamily")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingFontSizeOpts contains options for VhsTapeSetting.FontSize
type VhsTapeSettingFontSizeOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L127)
}

// Set the font size.
func (r *VhsTapeSetting) FontSize(size int, opts ...VhsTapeSettingFontSizeOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L121)
	q := r.query.Select("fontSize")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingFramerateOpts contains options for VhsTapeSetting.Framerate
type VhsTapeSettingFramerateOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L448)
}

// Set the rate at which VHS captures frames.
func (r *VhsTapeSetting) Framerate(rate int, opts ...VhsTapeSettingFramerateOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L442)
	q := r.query.Select("framerate")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingHeightOpts contains options for VhsTapeSetting.Height
type VhsTapeSettingHeightOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L199)
}

// Set the height of the terminal.
func (r *VhsTapeSetting) Height(height int, opts ...VhsTapeSettingHeightOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L193)
	q := r.query.Select("height")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// A unique identifier for this VhsTapeSetting.
func (r *VhsTapeSetting) ID(ctx context.Context) (VhsTapeSettingID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response VhsTapeSettingID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *VhsTapeSetting) XXX_GraphQLType() string {
	return "VhsTapeSetting"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *VhsTapeSetting) XXX_GraphQLIDType() string {
	return "VhsTapeSettingID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *VhsTapeSetting) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *VhsTapeSetting) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *VhsTapeSetting) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadVhsTapeSettingFromID(VhsTapeSettingID(id))
	return nil
}

// VhsTapeSettingLetterSpacingOpts contains options for VhsTapeSetting.LetterSpacing
type VhsTapeSettingLetterSpacingOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L223)
}

// Set the spacing between letters (tracking).
func (r *VhsTapeSetting) LetterSpacing(spacing int, opts ...VhsTapeSettingLetterSpacingOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L217)
	q := r.query.Select("letterSpacing")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingLineHeightOpts contains options for VhsTapeSetting.LineHeight
type VhsTapeSettingLineHeightOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L247)
}

// Set the spacing between lines.
func (r *VhsTapeSetting) LineHeight(spacing float64, opts ...VhsTapeSettingLineHeightOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L241)
	q := r.query.Select("lineHeight")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingLoopOffsetOpts contains options for VhsTapeSetting.LoopOffset
type VhsTapeSettingLoopOffsetOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L497)
}
...
func (r *VhsTapeSetting) LoopOffset(offset string, opts ...VhsTapeSettingLoopOffsetOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L491)
	q := r.query.Select("loopOffset")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingMarginOpts contains options for VhsTapeSetting.Margin
type VhsTapeSettingMarginOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L343)
}

// Set the margin (in pixels) of the video.
func (r *VhsTapeSetting) Margin(pixels int, opts ...VhsTapeSettingMarginOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L337)
	q := r.query.Select("margin")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingMarginFillOpts contains options for VhsTapeSetting.MarginFill
type VhsTapeSettingMarginFillOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L367)
}

// Set the margin fill color of the video.
func (r *VhsTapeSetting) MarginFill(color string, opts ...VhsTapeSettingMarginFillOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L361)
	q := r.query.Select("marginFill")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingPaddingOpts contains options for VhsTapeSetting.Padding
type VhsTapeSettingPaddingOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L319)
}

// Set the padding (in pixels) of the terminal frame.
func (r *VhsTapeSetting) Padding(pixels int, opts ...VhsTapeSettingPaddingOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L313)
	q := r.query.Select("padding")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingPlaybackSpeedOpts contains options for VhsTapeSetting.PlaybackSpeed
type VhsTapeSettingPlaybackSpeedOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L472)
}

// Set the playback speed of the final render.
func (r *VhsTapeSetting) PlaybackSpeed(speed float64, opts ...VhsTapeSettingPlaybackSpeedOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L466)
	q := r.query.Select("playbackSpeed")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingShellOpts contains options for VhsTapeSetting.Shell
type VhsTapeSettingShellOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L103)
}

// Set the shell.
func (r *VhsTapeSetting) Shell(shell string, opts ...VhsTapeSettingShellOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L97)
...
// VhsTapeSettingThemeOpts contains options for VhsTapeSetting.Theme
type VhsTapeSettingThemeOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L295)
}

// Set the theme of the terminal.
func (r *VhsTapeSetting) Theme(theme string, opts ...VhsTapeSettingThemeOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L289)
	q := r.query.Select("theme")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingTypingSpeedOpts contains options for VhsTapeSetting.TypingSpeed
type VhsTapeSettingTypingSpeedOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L271)
}

// Set the typing speed of seconds per key press.
func (r *VhsTapeSetting) TypingSpeed(speed string, opts ...VhsTapeSettingTypingSpeedOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L265)
	q := r.query.Select("typingSpeed")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingWidthOpts contains options for VhsTapeSetting.Width
type VhsTapeSettingWidthOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L175)
}

// Set the width of the terminal.
func (r *VhsTapeSetting) Width(width int, opts ...VhsTapeSettingWidthOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L169)
	q := r.query.Select("width")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
// VhsTapeSettingWindowBarOpts contains options for VhsTapeSetting.WindowBar
type VhsTapeSettingWindowBarOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L400)
}

// Set the type of window bar.
func (r *VhsTapeSetting) WindowBar(windowBar VhsWindowBarType, opts ...VhsTapeSettingWindowBarOpts) *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L394)
	q := r.query.Select("windowBar")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
			q = q.Arg("comment", opts[i].Comment)
...
type VhsTapeSettingBlock struct { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L66)
	query *querybuilder.Selection

	id *VhsTapeSettingBlockID
}
type WithVhsTapeSettingBlockFunc func(r *VhsTapeSettingBlock) *VhsTapeSettingBlock

// With calls the provided function with current VhsTapeSettingBlock.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *VhsTapeSettingBlock) With(f WithVhsTapeSettingBlockFunc) *VhsTapeSettingBlock {
	return f(r)
}

func (r *VhsTapeSettingBlock) WithGraphQLQuery(q *querybuilder.Selection) *VhsTapeSettingBlock {
	return &VhsTapeSettingBlock{
		query: q,
	}
}

// VhsTapeSettingBlockBorderRadiusOpts contains options for VhsTapeSettingBlock.BorderRadius
type VhsTapeSettingBlockBorderRadiusOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L436)
}

// Set the border radius (in pixels) of the terminal window.
func (r *VhsTapeSettingBlock) BorderRadius(pixels int, opts ...VhsTapeSettingBlockBorderRadiusOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L430)
	q := r.query.Select("borderRadius")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// Append a single or multiline comment to the tape.
func (r *VhsTapeSettingBlock) Comment(comment string) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L78)
	q := r.query.Select("comment")
	q = q.Arg("comment", comment)
...
// VhsTapeSettingBlockCursorBlinkOpts contains options for VhsTapeSettingBlock.CursorBlink
type VhsTapeSettingBlockCursorBlinkOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L534)
}

// Set whether the cursor should blink. Enabled by default.
func (r *VhsTapeSettingBlock) CursorBlink(blink bool, opts ...VhsTapeSettingBlockCursorBlinkOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L528)
	q := r.query.Select("cursorBlink")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// Append a single empty line to the tape. Useful for separating commands.
func (r *VhsTapeSettingBlock) EmptyLine() *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L85)
	q := r.query.Select("emptyLine")
...
func (r *VhsTapeSettingBlock) EndSet() *VhsTape { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L92)
	q := r.query.Select("endSet")
...
// VhsTapeSettingBlockFontFamilyOpts contains options for VhsTapeSettingBlock.FontFamily
type VhsTapeSettingBlockFontFamilyOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L163)
}

// Set the font family.
func (r *VhsTapeSettingBlock) FontFamily(font string, opts ...VhsTapeSettingBlockFontFamilyOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L157)
	q := r.query.Select("fontFamily")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockFontSizeOpts contains options for VhsTapeSettingBlock.FontSize
type VhsTapeSettingBlockFontSizeOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L139)
}

// Set the font size.
func (r *VhsTapeSettingBlock) FontSize(size int, opts ...VhsTapeSettingBlockFontSizeOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L133)
	q := r.query.Select("fontSize")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockFramerateOpts contains options for VhsTapeSettingBlock.Framerate
type VhsTapeSettingBlockFramerateOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L460)
}

// Set the rate at which VHS captures frames.
func (r *VhsTapeSettingBlock) Framerate(rate int, opts ...VhsTapeSettingBlockFramerateOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L454)
	q := r.query.Select("framerate")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockHeightOpts contains options for VhsTapeSettingBlock.Height
type VhsTapeSettingBlockHeightOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L211)
}

// Set the height of the terminal.
func (r *VhsTapeSettingBlock) Height(height int, opts ...VhsTapeSettingBlockHeightOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L205)
	q := r.query.Select("height")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// A unique identifier for this VhsTapeSettingBlock.
func (r *VhsTapeSettingBlock) ID(ctx context.Context) (VhsTapeSettingBlockID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response VhsTapeSettingBlockID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *VhsTapeSettingBlock) XXX_GraphQLType() string {
	return "VhsTapeSettingBlock"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *VhsTapeSettingBlock) XXX_GraphQLIDType() string {
	return "VhsTapeSettingBlockID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *VhsTapeSettingBlock) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *VhsTapeSettingBlock) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *VhsTapeSettingBlock) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadVhsTapeSettingBlockFromID(VhsTapeSettingBlockID(id))
	return nil
}

// VhsTapeSettingBlockLetterSpacingOpts contains options for VhsTapeSettingBlock.LetterSpacing
type VhsTapeSettingBlockLetterSpacingOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L235)
}

// Set the spacing between letters (tracking).
func (r *VhsTapeSettingBlock) LetterSpacing(spacing int, opts ...VhsTapeSettingBlockLetterSpacingOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L229)
	q := r.query.Select("letterSpacing")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockLineHeightOpts contains options for VhsTapeSettingBlock.LineHeight
type VhsTapeSettingBlockLineHeightOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L259)
}

// Set the spacing between lines.
func (r *VhsTapeSettingBlock) LineHeight(spacing float64, opts ...VhsTapeSettingBlockLineHeightOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L253)
	q := r.query.Select("lineHeight")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockLoopOffsetOpts contains options for VhsTapeSettingBlock.LoopOffset
type VhsTapeSettingBlockLoopOffsetOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L510)
}

// Set the offset for when the GIF loop should begin.
// This allows you to make the first frame of the GIF (generally used for previews) more interesting..
func (r *VhsTapeSettingBlock) LoopOffset(offset string, opts ...VhsTapeSettingBlockLoopOffsetOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L504)
	q := r.query.Select("loopOffset")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockMarginOpts contains options for VhsTapeSettingBlock.Margin
type VhsTapeSettingBlockMarginOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L355)
}

// Set the margin (in pixels) of the video.
func (r *VhsTapeSettingBlock) Margin(pixels int, opts ...VhsTapeSettingBlockMarginOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L349)
	q := r.query.Select("margin")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockMarginFillOpts contains options for VhsTapeSettingBlock.MarginFill
type VhsTapeSettingBlockMarginFillOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L379)
}

// Set the margin fill color of the video.
func (r *VhsTapeSettingBlock) MarginFill(color string, opts ...VhsTapeSettingBlockMarginFillOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L373)
	q := r.query.Select("marginFill")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockPaddingOpts contains options for VhsTapeSettingBlock.Padding
type VhsTapeSettingBlockPaddingOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L331)
}

// Set the padding (in pixels) of the terminal frame.
func (r *VhsTapeSettingBlock) Padding(pixels int, opts ...VhsTapeSettingBlockPaddingOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L325)
	q := r.query.Select("padding")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockPlaybackSpeedOpts contains options for VhsTapeSettingBlock.PlaybackSpeed
type VhsTapeSettingBlockPlaybackSpeedOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L484)
}

// Set the playback speed of the final render.
func (r *VhsTapeSettingBlock) PlaybackSpeed(speed float64, opts ...VhsTapeSettingBlockPlaybackSpeedOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L478)
	q := r.query.Select("playbackSpeed")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockShellOpts contains options for VhsTapeSettingBlock.Shell
type VhsTapeSettingBlockShellOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L115)
}

// Set the shell.
func (r *VhsTapeSettingBlock) Shell(shell string, opts ...VhsTapeSettingBlockShellOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L109)
	q := r.query.Select("shell")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockThemeOpts contains options for VhsTapeSettingBlock.Theme
type VhsTapeSettingBlockThemeOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L307)
}

// Set the theme of the terminal.
func (r *VhsTapeSettingBlock) Theme(theme string, opts ...VhsTapeSettingBlockThemeOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L301)
	q := r.query.Select("theme")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockTypingSpeedOpts contains options for VhsTapeSettingBlock.TypingSpeed
type VhsTapeSettingBlockTypingSpeedOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L283)
}

// Set the typing speed of seconds per key press.
func (r *VhsTapeSettingBlock) TypingSpeed(speed string, opts ...VhsTapeSettingBlockTypingSpeedOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L277)
	q := r.query.Select("typingSpeed")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockWidthOpts contains options for VhsTapeSettingBlock.Width
type VhsTapeSettingBlockWidthOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L187)
}

// Set the width of the terminal.
func (r *VhsTapeSettingBlock) Width(width int, opts ...VhsTapeSettingBlockWidthOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L181)
	q := r.query.Select("width")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
// VhsTapeSettingBlockWindowBarOpts contains options for VhsTapeSettingBlock.WindowBar
type VhsTapeSettingBlockWindowBarOpts struct {
	//
	// Inline comment to add to the command.
	//
	Comment string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L412)
}

// Set the type of window bar.
func (r *VhsTapeSettingBlock) WindowBar(windowBar VhsWindowBarType, opts ...VhsTapeSettingBlockWindowBarOpts) *VhsTapeSettingBlock { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L406)
	q := r.query.Select("windowBar")
	for i := len(opts) - 1; i >= 0; i-- {
		// `comment` optional argument
		if !querybuilder.IsZeroValue(opts[i].Comment) {
...
type VhsWithSource struct { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L89)
	query *querybuilder.Selection

	id *VhsWithSourceID
}
type WithVhsWithSourceFunc func(r *VhsWithSource) *VhsWithSource

// With calls the provided function with current VhsWithSource.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *VhsWithSource) With(f WithVhsWithSourceFunc) *VhsWithSource {
	return f(r)
}

func (r *VhsWithSource) WithGraphQLQuery(q *querybuilder.Selection) *VhsWithSource {
	return &VhsWithSource{
		query: q,
	}
}

// A unique identifier for this VhsWithSource.
func (r *VhsWithSource) ID(ctx context.Context) (VhsWithSourceID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response VhsWithSourceID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *VhsWithSource) XXX_GraphQLType() string {
	return "VhsWithSource"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *VhsWithSource) XXX_GraphQLIDType() string {
	return "VhsWithSourceID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *VhsWithSource) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *VhsWithSource) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *VhsWithSource) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadVhsWithSourceFromID(VhsWithSourceID(id))
	return nil
}

// VhsWithSourceRenderOpts contains options for VhsWithSource.Render
type VhsWithSourceRenderOpts struct {
	//
	// Publish your GIF to vhs.charm.sh and get a shareable URL.
	//
	Publish bool // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L105)
}

// Runs a given tape file and generates its outputs.
func (r *VhsWithSource) Render(tape string, opts ...VhsWithSourceRenderOpts) *Directory { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L97)
	q := r.query.Select("render")
	for i := len(opts) - 1; i >= 0; i-- {
		// `publish` optional argument
		if !querybuilder.IsZeroValue(opts[i].Publish) {
...
func (r *VhsWithSource) Source() *Directory { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/main.go#L90)
	q := r.query.Select("source")
...
// VhsWithSourceWithEnvVariableOpts contains options for VhsWithSource.WithEnvVariable
type VhsWithSourceWithEnvVariableOpts struct {
	//
	// Replace `${VAR}` or $VAR in the value according to the current environment
	// variables defined in the container (e.g., "/opt/bin:$PATH").
	//
	Expand bool // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/container.go#L88)
}

// Set an environment variable.
func (r *VhsWithSource) WithEnvVariable(name string, value string, opts ...VhsWithSourceWithEnvVariableOpts) *VhsWithSource { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/container.go#L77)
	q := r.query.Select("withEnvVariable")
	for i := len(opts) - 1; i >= 0; i-- {
		// `expand` optional argument
		if !querybuilder.IsZeroValue(opts[i].Expand) {
...
// Set an environment variable containing the given secret.
func (r *VhsWithSource) WithSecretVariable(name string, secret *Secret) *VhsWithSource { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/container.go#L106)
	assertNotNil("secret", secret)
	q := r.query.Select("withSecretVariable")
	q = q.Arg("name", name)
	q = q.Arg("secret", secret)
...
// Establish a runtime dependency on a service.
func (r *VhsWithSource) WithServiceBinding(alias string, service *Service) *VhsWithSource { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/container.go#L129)
	assertNotNil("service", service)
	q := r.query.Select("withServiceBinding")
	q = q.Arg("alias", alias)
	q = q.Arg("service", service)
...
// Unset an environment variable.
func (r *VhsWithSource) WithoutEnvVariable(name string) *VhsWithSource { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/container.go#L96)
	q := r.query.Select("withoutEnvVariable")
	q = q.Arg("name", name)
...
// Unset an environment variable containing a secret.
func (r *VhsWithSource) WithoutSecretVariable(name string) *VhsWithSource { // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/container.go#L119)
	q := r.query.Select("withoutSecretVariable")
	q = q.Arg("name", name)
...
type VhsWaitScope string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L210)

func (VhsWaitScope) IsEnum() {}

func (v VhsWaitScope) Name() string {
	switch v {
	case VhsWaitScopeLine:
		return "Line"
	case VhsWaitScopeScreen:
		return "Screen"
	default:
		return ""
	}
...
func (v VhsWaitScope) Value() string {
	return string(v)
}

func (v *VhsWaitScope) MarshalJSON() ([]byte, error) {
	if *v == "" {
		return []byte(`""`), nil
	}
	name := v.Name()
...
func (v *VhsWaitScope) UnmarshalJSON(dt []byte) error {
	var s string
	if err := json.Unmarshal(dt, &s); err != nil {
		return err
	}
...
const (
	VhsWaitScopeLine VhsWaitScope = "Line" // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L213)

	VhsWaitScopeScreen VhsWaitScope = "Screen" // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape.go#L214)

)

type VhsWindowBarType string // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L384)

func (VhsWindowBarType) IsEnum() {}

func (v VhsWindowBarType) Name() string {
	switch v {
	case VhsWindowBarTypeColorful:
		return "Colorful"
	case VhsWindowBarTypeColorfulRight:
		return "ColorfulRight"
	case VhsWindowBarTypeRings:
		return "Rings"
	case VhsWindowBarTypeRingsRight:
		return "RingsRight"
	default:
		return ""
	}
...
func (v VhsWindowBarType) Value() string {
	return string(v)
}

func (v *VhsWindowBarType) MarshalJSON() ([]byte, error) {
	if *v == "" {
		return []byte(`""`), nil
	}
	name := v.Name()
...
func (v *VhsWindowBarType) UnmarshalJSON(dt []byte) error {
	var s string
	if err := json.Unmarshal(dt, &s); err != nil {
		return err
	}
	...
	case "":
		*v = ""
	case "Colorful":
		*v = VhsWindowBarTypeColorful
	case "ColorfulRight":
		*v = VhsWindowBarTypeColorfulRight
	case "Rings":
		*v = VhsWindowBarTypeRings
	case "RingsRight":
		*v = VhsWindowBarTypeRingsRight
	default:
		return fmt.Errorf("invalid enum value %q", s)
	}
	return nil
...
const (
	VhsWindowBarTypeColorful VhsWindowBarType = "Colorful" // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L387)

	VhsWindowBarTypeColorfulRight VhsWindowBarType = "ColorfulRight" // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L388)

	VhsWindowBarTypeRings VhsWindowBarType = "Rings" // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L389)

	VhsWindowBarTypeRingsRight VhsWindowBarType = "RingsRight" // vhs (https://github.com/sagikazarmark/daggerverse/tree/0a18e45ba3bb64deb5f57b0d94f10ae45f8a6538/vhs/tape_set.go#L390)
