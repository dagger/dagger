...
| `#Export`     | [image.cue](https://github.com/dagger/dagger/blob/v0.2.11/pkg/dagger.io/dagger/core/image.cue) | Export a docker image as a tar archive             |
...
| `#Set`        | [image.cue](https://github.com/dagger/dagger/blob/v0.2.11/pkg/dagger.io/dagger/core/image.cue) | Modify a docker image config                       |
