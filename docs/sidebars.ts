        ...
        { type: "doc", id: "reference/cli/index", label: "CLI" },
        {
          ...
          items: [
            "reference/modules/go",
            {
              ...
              collapsed: true,
              items: [
                "reference/modules/js/deno",
                "reference/modules/js/jest",
                "reference/modules/js/vitest",
                "reference/modules/js/playwright",
                "reference/modules/js/eslint",
                "reference/modules/js/prettier",
                "reference/modules/js/biome",
              ],
            },
            {
              type: "category",
              ...
              collapsible: true,
              collapsed: true,
              items: ["reference/modules/python/pytest"],
            },
            "reference/modules/shellcheck",
            {
              ...
              collapsible: true,
              collapsed: true,
              items: ["reference/modules/dotnet/PsScriptAnalyzer"],
            },
            {
              type: "category",
              label: "Kubernetes",
              collapsible: true,
              collapsed: true,
              items: ["reference/modules/kubernetes/helm"],
            },
          ],
        },
        {
