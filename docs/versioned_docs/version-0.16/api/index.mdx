...
- From the Dagger CLI
  - [`dagger core`](./clients-cli.mdx#core-dagger-api-functions) for core functions
  - [`dagger call`](./clients-cli.mdx#custom-dagger-functions) for [custom functions](./custom-functions.mdx)
