...
description: "Install Dagger and set up your environment"
---

import PartialInstallCli from '../partials/_install-cli.mdx';
import { daggerVersion } from '../partials/version.js';

To use Dagger, you must have a container runtime installed and running. This can be [Docker](https://docs.docker.com/engine/install/), [Podman](https://podman.io/docs/installation), [nerdctl](https://github.com/containerd/nerdctl), Apple's `container`, or other Docker-like systems.
