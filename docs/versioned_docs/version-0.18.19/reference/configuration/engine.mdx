...
description: "Learn how to configure the Dagger Engine for your workflows, including logging, security, garbage collection, and more."
slug: /reference/configuration/engine
