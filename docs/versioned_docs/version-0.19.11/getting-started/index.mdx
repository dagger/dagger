...
Learn how to use [checks](../introduction/core-concepts/checks.mdx) to automatically validate code quality, security, and standards before committing or in CI pipelines.
