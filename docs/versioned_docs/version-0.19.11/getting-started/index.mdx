...
Learn how to use [checks](/0.19.11/core-concepts/checks) to automatically validate code quality, security, and standards before committing or in CI pipelines.
