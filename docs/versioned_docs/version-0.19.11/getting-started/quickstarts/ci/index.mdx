...
:::tip
Learn more about creating advanced checks, filtering, and ignoring checks in the [Checks guide](../../../introduction/core-concepts/checks.mdx).
:::
...
The guide [Use a Toolchain](../blueprint/index.mdx) will show you how to use a toolchain instead of writing code for every single project.
