...
[See CI integration examples →](/0.19.11/getting-started/ci-integrations/github-actions)

## Next Steps

- **[Use a Toolchain Quickstart](/0.19.11/getting-started/quickstarts/toolchain)** - Get started in 5 minutes
- **[Checks](/0.19.11/core-concepts/checks)** - Learn about validation checks
- **[Building with Dagger](/0.19.11/extending)** - Create your own toolchain
