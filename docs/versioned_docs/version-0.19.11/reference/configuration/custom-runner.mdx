---
title: "Custom Runner"
description: "Learn how to set up and configure a custom Dagger runner for executing workflows in your environment."
slug: /reference/configuration/custom-runner
sidebar_label: "Custom Runner"
---
...
1. `container://<container name>` - Connect to the runner inside the given host container.
    - Requires a local [container runtime](/0.19.11/reference/container-runtimes/).
