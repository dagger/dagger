...
- [Core Concepts →](/0.19/core-concepts) Understand toolchains, checks, and functions
...
- **[Toolchains](/0.19/core-concepts/toolchains)** - Install and use modules without writing code
- **[Checks](/0.19/core-concepts/checks)** - Validate commits with automated quality, security, and standards checks
- **[Functions](/0.19/core-concepts/functions)** - Building blocks of Dagger workflows

[**Learn core concepts →**](/0.19/core-concepts)
