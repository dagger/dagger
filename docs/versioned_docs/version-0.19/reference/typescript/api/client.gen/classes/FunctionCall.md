...
[@dagger.io/dagger](../../../modules.md) / [api/client.gen](../README.md) / FunctionCall
...
> **id**(): `Promise`\<[`FunctionCallID`](../type-aliases/FunctionCallID.md)\>

A unique identifier for this FunctionCall.

#### Returns

`Promise`\<[`FunctionCallID`](../type-aliases/FunctionCallID.md)\>
