...
[Learn more about toolchains →](/0.20.2/core-concepts/toolchains)
:::
...
- **[Run checks](/0.20.2/core-concepts/checks)** - Most toolchains include validation checks
- **[Use in CI](/0.20.2/getting-started/quickstarts/ci)** - Run the same commands in your CI pipeline
- **[Daggerverse](https://daggerverse.dev)** - Discover more toolchains for your stack
- **[Customize](/0.20.2/core-concepts/toolchains#customizing-toolchains)** - Add your own functions or modify behavior
- **[Build your own](/0.20.2/extending)** - Create toolchains for your organization
