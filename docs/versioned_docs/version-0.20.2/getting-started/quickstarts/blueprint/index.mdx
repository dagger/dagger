...
[Learn more about toolchains →](../../../introduction/core-concepts/toolchains.mdx)
:::
...
- **[Run checks](../../../introduction/core-concepts/checks.mdx)** - Most toolchains include validation checks
- **[Use in CI](../ci/index.mdx)** - Run the same commands in your CI pipeline
- **[Daggerverse](https://daggerverse.dev)** - Discover more toolchains for your stack
- **[Customize](../../../introduction/core-concepts/toolchains.mdx#customizing-toolchains)** - Add your own functions or modify behavior
- **[Build your own](../../../extending/index.mdx)** - Create toolchains for your organization
