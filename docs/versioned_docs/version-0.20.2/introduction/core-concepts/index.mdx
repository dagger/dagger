...
## [Toolchains](/0.20.2/core-concepts/toolchains)
...
[Learn about Toolchains →](/0.20.2/core-concepts/toolchains)

---

## [Checks](/0.20.2/core-concepts/checks)
...
[Learn about Checks →](/0.20.2/core-concepts/checks)

---

## [Functions](/0.20.2/core-concepts/functions)
...
[Learn about Functions →](/0.20.2/core-concepts/functions)
...
- **[Use a Toolchain](/0.20.2/getting-started/quickstarts/toolchain)** - Get started in 5 minutes
- **[Daggerverse](https://daggerverse.dev)** - Discover toolchains for your stack
- **[Types](/0.20.2/getting-started/types)** - Learn about data types in Dagger
- **[Building with Dagger](/0.20.2/extending)** - Create your own functions and toolchains
