...
These fundamental concepts have been elevated to [Core Concepts](/0.20.2/core-concepts) for easier discovery. Check out:
- [Toolchains](/0.20.2/core-concepts/toolchains) - Install and use modules without writing code
- [Checks](/0.20.2/core-concepts/checks) - Validate commits with automated quality checks
