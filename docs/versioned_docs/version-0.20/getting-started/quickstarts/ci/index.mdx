...
:::tip
Learn more about creating advanced checks, filtering, and ignoring checks in the [Checks guide](/0.20/core-concepts/checks).
:::
...
The guide [Use a Toolchain](/0.20/getting-started/quickstarts/toolchain) will show you how to use a toolchain instead of writing code for every single project.
