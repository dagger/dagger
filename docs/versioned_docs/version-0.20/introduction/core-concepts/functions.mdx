...
- **[Toolchains](/0.20/core-concepts/toolchains)** - Use pre-built functions without writing code
- **[Checks](/0.20/core-concepts/checks)** - Special functions for validation
- **[Module Development](/0.20/extending/functions)** - Deep dive into creating functions
- **[Use a Toolchain Quickstart](/0.20/getting-started/quickstarts/toolchain)** - Get started with functions
