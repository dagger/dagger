...
[Learn about Toolchains →](./toolchains.mdx)
...
[Learn about Functions →](./functions.mdx)
...
- **[Use a Toolchain](../../getting-started/quickstarts/blueprint/index.mdx)** - Get started in 5 minutes
- **[Daggerverse](https://daggerverse.dev)** - Discover toolchains for your stack
- **[Types](../../getting-started/types/index.mdx)** - Learn about data types in Dagger
- **[Building with Dagger](../../extending/index.mdx)** - Create your own functions and toolchains
