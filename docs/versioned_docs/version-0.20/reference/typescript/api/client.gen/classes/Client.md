...
[@dagger.io/dagger](../../../modules.md) / [api/client.gen](../README.md) / Client
...
> **cacheVolume**(`key`): [`CacheVolume`](CacheVolume.md)
...
> **currentTypeDefs**(): `Promise`\<[`TypeDef`](TypeDef.md)[]\>
...
> **currentWorkspace**(`opts?`): [`Workspace`](Workspace.md)
