...
[@dagger.io/dagger](../../../modules.md) / [api/client.gen](../README.md) / CurrentModule
...
> **id**(): `Promise`\<[`CurrentModuleID`](../type-aliases/CurrentModuleID.md)\>

A unique identifier for this CurrentModule.

#### Returns

`Promise`\<[`CurrentModuleID`](../type-aliases/CurrentModuleID.md)\>
