...
[@dagger.io/dagger](../../../modules.md) / [api/client.gen](../README.md) / Function\_
...
> **id**(): `Promise`\<[`FunctionID`](../type-aliases/FunctionID.md)\>

A unique identifier for this Function.

#### Returns

`Promise`\<[`FunctionID`](../type-aliases/FunctionID.md)\>
