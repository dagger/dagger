...
[@dagger.io/dagger](../../../modules.md) / [api/client.gen](../README.md) / FunctionArg
...
> **id**(): `Promise`\<[`FunctionArgID`](../type-aliases/FunctionArgID.md)\>

A unique identifier for this FunctionArg.

#### Returns

`Promise`\<[`FunctionArgID`](../type-aliases/FunctionArgID.md)\>
