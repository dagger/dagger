...
[@dagger.io/dagger](../../../modules.md) / [api/client.gen](../README.md) / HealthcheckConfig
...
> **id**(): `Promise`\<[`HealthcheckConfigID`](../type-aliases/HealthcheckConfigID.md)\>

A unique identifier for this HealthcheckConfig.

#### Returns

`Promise`\<[`HealthcheckConfigID`](../type-aliases/HealthcheckConfigID.md)\>
