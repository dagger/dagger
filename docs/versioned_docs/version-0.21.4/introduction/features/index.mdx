...
These fundamental concepts have been elevated to [Core Concepts](../core-concepts/index.mdx) for easier discovery. Check out:
- [Toolchains](../core-concepts/toolchains.mdx) - Install and use modules without writing code
- [Checks](../core-concepts/checks.mdx) - Validate commits with automated quality checks
- [Functions](../core-concepts/functions.mdx) - Building blocks of Dagger workflows
:::
