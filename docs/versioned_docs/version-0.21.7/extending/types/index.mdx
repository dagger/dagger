...
import DirectoryType from "../../partials/types/_directory.mdx";
...
import CurrentModuleType from "../../partials/types/_current-module.mdx";
...
:::note
The types listed on this page are indicative and not exhaustive. For a complete list of supported types and their fields, refer to the [Dagger API reference](pathname:///api/reference).
:::
