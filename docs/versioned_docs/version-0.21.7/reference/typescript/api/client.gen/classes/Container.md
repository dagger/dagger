...
[`ContainerFromOpts`](../type-aliases/ContainerFromOpts.md)
...
> **withoutVolatileVariable**(`name`): `Container`
...
> **withVolatileVariable**(`name`, `value`): `Container`
