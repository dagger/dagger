...
> **withDiffStatInput**(`name`, `value`, `description`): `Env`
...
> **withDiffStatOutput**(`name`, `description`): `Env`
...
> **withHTTPStateInput**(`name`, `value`, `description`): `Env`
...
> **withHTTPStateOutput**(`name`, `description`): `Env`
...
> **withUpGroupInput**(`name`, `value`, `description`): `Env`
...
> **withUpGroupOutput**(`name`, `description`): `Env`
...
> **withUpInput**(`name`, `value`, `description`): `Env`
...
> **withUpOutput**(`name`, `description`): `Env`
