...
[Cloud Engines](https://dagger.cloud) (tech preview) is managed scaled-out execution. Dagger runs your workflows on an elastic engine pool with [shared cache](../../extending/how-dagger-works/cache.mdx) across your organization — nothing to configure:
