...
[Cloud Engines](https://dagger.cloud) (tech preview) is managed scaled-out execution. Dagger runs your workflows on an elastic engine pool with [shared cache](/1.0-beta/extending/how-dagger-works/cache) across your organization — nothing to configure:
...
Self-hosted engines give you full control over provisioning, scheduling, and cache placement — with the operational cost that implies. See [Custom runners](/1.0-beta/reference/configuration/custom-runner) for the connection interface.
