...
- [Module Developer Guide](/1.0-beta/extending) — what a module is and how it runs
- [Type System](/1.0-beta/extending/type-system) — how language types map to the Dagger API
- [Checks](/1.0-beta/extending/how-dagger-works/checks) — how `dagger check` discovers and runs checks
- [Changesets](/1.0-beta/using-dagger/changesets) — how generated files are reviewed and applied
...
does not write to disk directly — it returns a [changeset](/1.0-beta/using-dagger/changesets)
...
the Dagger type system (see [Type System](/1.0-beta/extending/type-system)):
...
module. See [Checks](/1.0-beta/extending/how-dagger-works/checks).
...
A generator produces a [changeset](/1.0-beta/using-dagger/changesets) — a diff between the
...
starts every service in the module. See [Services](/1.0-beta/using-dagger/services).
