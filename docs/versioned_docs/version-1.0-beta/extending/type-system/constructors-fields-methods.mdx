...
TODO: Coordinate this chapter with [Objects, State, and Persistence](/1.0-beta/extending) so type design and object persistence reinforce each other without duplicating content.
