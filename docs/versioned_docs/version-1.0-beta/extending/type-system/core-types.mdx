...
This chapter should teach how module authors think with core types. It should not duplicate every field from the [Types Reference](/1.0-beta/extending/types).
