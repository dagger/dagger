...
- [Dagger CLI installed](/1.0-beta/getting-started/installation)
...
This returns a [changeset](/1.0-beta/using-dagger/changesets) — the reformatted files — and applies it to your working tree. Run the checks again:
...
Now do it on your own project — see [Workspace Setup](/1.0-beta/adopting/workspace-setup).
