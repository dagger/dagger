...
- **Want to adopt Dagger in your project?** Start with the [Quickstart](/1.0-beta/quickstart), then follow [Workspace Setup](/1.0-beta/adopting/workspace-setup).
- **Your project already uses Dagger?** See [Using Dagger](/1.0-beta/using-dagger/checking) to run checks, generate code, and start services.
- **Migrating to workspaces?** See [Upgrading to Workspaces](/1.0-beta/reference/upgrade-to-workspaces).
