...
Run checks with a named [environment](/1.0-beta/using-dagger/environments) overlay applied:
...
To automate checks on every push without configuring runners, see [Triggers](/1.0-beta/adopting/triggers).
