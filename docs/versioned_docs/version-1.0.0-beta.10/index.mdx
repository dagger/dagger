...
- **Want to adopt Dagger in your project?** Start with the [Quickstart](./getting-started/quickstart.mdx), then follow [Workspace Setup](./adopting/workspace-setup.mdx).
- **Your project already uses Dagger?** See [Using Dagger](./using-dagger/checking.mdx) to run checks, generate code, and start services.
- **Migrating to workspaces?** See [Upgrading to Workspaces](./reference/upgrade-to-workspaces.mdx).
