...
This edition is not yet available. See the [Base Edition](/1.0.0-beta.2/extending/editions/dang) for the complete guide — the patterns are the same across all SDKs.
