...
- **Want to adopt Dagger in your project?** Start with the [Quickstart](/1.0.0-beta.2/quickstart), then follow [Workspace Setup](/1.0.0-beta.2/adopting/workspace-setup).
- **Your project already uses Dagger?** See [Using Dagger](/1.0.0-beta.2/using-dagger/checking) to run checks, generate code, and start services.
- **Migrating to workspaces?** See [Upgrading to Workspaces](/1.0.0-beta.2/reference/upgrade-to-workspaces).
