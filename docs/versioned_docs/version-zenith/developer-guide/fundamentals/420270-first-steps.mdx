...
1. Let's replace the auto-generated template with something simpler:
    ...
    ```go file=../go/snippets/first-steps/step2/main.go
    ```
    ...
    ```python file=../python/snippets/first-steps/step2/main.py
    ```

    </TabItem>
    <TabItem value="TypeScript">

    ```typescript file=../typescript/snippets/first-steps/step2/index.ts
    ```
...
1. Update the function to accept multiple parameters (some of which are optional):
    ...
    ```go file=../go/snippets/first-steps/step3a/main.go
    ```
    ...
    ```python file=../python/snippets/first-steps/step3a/main.py
    ```
    ...
    ```typescript file=../typescript/snippets/first-steps/step3a/index.ts
    ```
...
2. Update the function to return a custom `PotatoMessage` type:
    ...
    ```go file=../go/snippets/first-steps/step3b/main.go
    ```

    </TabItem>
    <TabItem value="Python">

    ```python file=../python/snippets/first-steps/step3b/main.py
    ```
    ...
    ```typescript file=../typescript/snippets/first-steps/step3b/index.ts
    ```
...
1. Replace the generated `dagger/main.go` file with the following code:
    ...
    ```go file=../go/snippets/first-steps/trivy/main.go
    ```
...
1. Replace the generated `dagger/src/main.py` file with the following code:
    ...
    ```python file=../python/snippets/first-steps/trivy/main.py
    ```
...
1. Replace the generated `dagger/src/index.ts` file with the following code:
    ...
    ```typescript file=../typescript/snippets/first-steps/trivy/index.ts
    ```
