---
slug: /developer-guide/go/191108/advanced-programming
...
- You have a Dagger module. If not, create a module using the [Go](../../developer-guide/go/525021-quickstart.mdx) quickstart.
