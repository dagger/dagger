...
```go file=./snippets/arguments-return-values/functions-simple/main.go
```
...
```go file=./snippets/arguments-return-values/functions-complex/main.go
```
...
```go file=./snippets/arguments-return-values/arguments-string/main.go
```
...
```go file=./snippets/arguments-return-values/arguments-directory/main.go
```
...
```go file=./snippets/arguments-return-values/arguments-optional/main.go
```
...
```go file=./snippets/arguments-return-values/arguments-default/main.go
```
...
```go file=./snippets/arguments-return-values/return-values-container/main.go
```
