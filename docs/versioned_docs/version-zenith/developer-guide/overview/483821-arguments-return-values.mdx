...
```go file=../go/snippets/arguments-return-values/functions-simple/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../python/snippets/arguments-return-values/functions-simple/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../typescript/snippets/arguments-return-values/functions-simple/index.ts
```
...
```go file=../go/snippets/arguments-return-values/functions-complex/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../python/snippets/arguments-return-values/functions-complex/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../typescript/snippets/arguments-return-values/functions-complex/index.ts
```
...
```go file=../go/snippets/arguments-return-values/arguments-string/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../python/snippets/arguments-return-values/arguments-string/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../typescript/snippets/arguments-return-values/arguments-string/index.ts
```
...
```go file=../go/snippets/arguments-return-values/arguments-directory/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../python/snippets/arguments-return-values/arguments-directory/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../typescript/snippets/arguments-return-values/arguments-directory/index.ts
```
...
```go file=../go/snippets/arguments-return-values/arguments-optional/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../python/snippets/arguments-return-values/arguments-optional/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../typescript/snippets/arguments-return-values/arguments-optional/index.ts
```
...
```go file=../go/snippets/arguments-return-values/arguments-default/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../python/snippets/arguments-return-values/arguments-default/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../typescript/snippets/arguments-return-values/arguments-default/index.ts
```
...
```go file=../go/snippets/arguments-return-values/return-values-container/main.go
```

</TabItem>
<TabItem value="Python">

```python file=../python/snippets/arguments-return-values/return-values-container/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=../typescript/snippets/arguments-return-values/return-values-container/index.ts
```
...
For Dagger Functions written in Go:
