---
slug: /developer-guide/typescript/506316/first-steps
...
1. Let's replace the auto-generated template with something simpler:
    ...
    ```typescript file=./snippets/first-steps/step2/index.ts
    ```
...
1. Update the function to accept multiple parameters (some of which are optional):
    ...
    ```typescript file=./snippets/first-steps/step3a/index.ts
    ```
...
1. Update the function to return a custom `PotatoMessage` type:
    ...
    ```typescript file=./snippets/first-steps/step3b/index.ts
    ```
...
1. Replace the generated `dagger/src/index.ts` file with the following code:
    ...
    ```typescript file=./snippets/first-steps/trivy/index.ts
    ```
