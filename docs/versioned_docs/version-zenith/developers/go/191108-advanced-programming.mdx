---
slug: /developers/go/191108/advanced-programming
...
- You have a Dagger module. If not, create a module using the [Go](../../developers/go/525021-quickstart.mdx) quickstart.
