---
slug: /developers/typescript/5063016/quickstart
...
- You have a good understanding of the Dagger TypeScript SDK. If not, refer to the [TypeScript SDK reference](../../reference/typescript/modules).
