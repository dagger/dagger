...
Refer to the documentation for information on how to install the [Dagger CLI](./user/329058-install.mdx).
...
Yes. It's possible to use the Dagger GraphQL API from any language that [supports GraphQL](https://graphql.org/code/)  or from the [Dagger CLI](./user/329058-install.mdx).
