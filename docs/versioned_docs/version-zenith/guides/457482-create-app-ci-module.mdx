...
This will generate a `dagger.json` module file, an initial `dagger/main.go` source file, as well as a generated file `dagger/dagger.gen.go` and directory `dagger/internal/`.
