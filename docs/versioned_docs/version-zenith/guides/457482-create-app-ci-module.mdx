...
This will generate a `dagger.json` module file, an initial `dagger/main.go` source file, as well as a generated files `dagger/dagger.gen.go` and `dagger/internal/`
