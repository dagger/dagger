...
func (r *ModuleConfig) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadModuleConfigFromID(ModuleConfigID(id))
	return nil
}
...
func (r *Node) Install(pkgs []string) *Node {
...
func (r *Node) Lint(ctx context.Context) (string, error) {
	if r.lint != nil {
		return *r.lint, nil
	}
	q := r.q.Select("lint")
...
func (r *Node) Publish(ctx context.Context, tokenSecret *Secret, version string, opts ...NodePublishOpts) (string, error) {
	assertNotNil("tokenSecret", tokenSecret)
	if r.publish != nil {
		return *r.publish, nil
	}
	q := r.q.Select("publish")
	...
	q = q.Arg("tokenSecret", tokenSecret)
...
func (r *Node) Run(args []string) *Container {
	q := r.q.Select("run")
	q = q.Arg("args", args)
...
func (r *Node) Start(ctx context.Context) (string, error) {
	if r.start != nil {
		return *r.start, nil
	}
	q := r.q.Select("start")
...
// Lint returns the output of the lint command.
func (r *Node) Test(ctx context.Context) (string, error) {
	if r.test != nil {
		return *r.test, nil
	}
	q := r.q.Select("test")
...
func (r *Node) WithContainer(ctr *Container) *Node {
...
func (r *Node) WithNpm() *Node {
	q := r.q.Select("withNpm")
...
func (r *Node) WithSource(source *Directory) *Node {
	assertNotNil("source", source)
	q := r.q.Select("withSource")
	q = q.Arg("source", source)
...
func (r *Node) WithVersion(version string) *Node {
...
func (r *Node) WithYarn() *Node {
	q := r.q.Select("withYarn")
