---
slug: /quickstart/292472/primitives
hide_table_of_contents: true
title: "Understand function primitives"
---
...
## Understand function primitives

Module functions can accept arguments and return both basic and custom types. Dagger introduces valuable new primitives such as `Directory`, `Container`, and `Service`, and Dagger functions can use these as both inputs and outputs (in addition to your own custom types). This quickstart uses the `Directory` and `Container` primitives.
...
```shell
dagger call -m github.com/shykes/daggerverse/wolfi base container
```

This example uses a Wolfi container builder module. It returns a Dagger `Container` representing the built container. You should see the output below:

```shell
✔ dagger call base container [2.07s]
┃ Container evaluated. Use "dagger call base container --help" to see available sub-commands.
```
