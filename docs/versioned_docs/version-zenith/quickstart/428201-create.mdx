...
A better approach here is to create and program your own Dagger module, which can then call other Dagger modules and functions to achieve the required results. Creating your own Dagger module enables you to transform your workflows into structured, discrete and composable units with clear inputs and outputs, with all the benefits of using a native programming language.
