...
This means that the build succeeded, and the build directory was returned. But how do we use it?
...
```shell
dagger -m github.com/kpenfound/dagger-modules/golang --proj https://github.com/dagger/dagger call build --args ./cmd/dagger entries
```
...
```shell
dagger -m github.com/kpenfound/dagger-modules/golang --proj https://github.com/dagger/dagger call build --args ./cmd/dagger export --path ./my-dagger-build
```
