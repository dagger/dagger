...
```shell
dagger -m github.com/kpenfound/dagger-modules/golang@v0.1.5 --proj https://github.com/dagger/dagger call build --args ./cmd/dagger
```
...
```shell
dagger -m github.com/kpenfound/dagger-modules/golang@v0.1.5 --proj https://github.com/dagger/dagger call build --args ./cmd/dagger entries
```
...
```shell
dagger -m github.com/kpenfound/dagger-modules/golang@v0.1.5 --proj https://github.com/dagger/dagger call build --args ./cmd/dagger export --path ./my-dagger-build
```
