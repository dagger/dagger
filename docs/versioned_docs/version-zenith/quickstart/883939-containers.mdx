...
```shell
dagger call -m github.com/shykes/daggerverse/wolfi@7884cbc1941f85a7c714fc7f1bcc5c148842c21e base with-package --name cowsay container
```
...
```shell
dagger call -m github.com/shykes/daggerverse/wolfi@7884cbc1941f85a7c714fc7f1bcc5c148842c21e base with-package --name cowsay container terminal --cmd sh
```
...
```shell
dagger call -m github.com/shykes/daggerverse/wolfi@7884cbc1941f85a7c714fc7f1bcc5c148842c21e base with-package --name=cowsay container with-exec --args "cowsay" --args "dagger" stdout
```
...
```shell
dagger call -m github.com/shykes/daggerverse/wolfi@7884cbc1941f85a7c714fc7f1bcc5c148842c21e base with-package --name=cowsay container publish --address ttl.sh/my-wolfi
```
