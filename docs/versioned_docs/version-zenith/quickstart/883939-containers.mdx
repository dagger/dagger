...
```shell
dagger call -m github.com/shykes/daggerverse/wolfi@v0.1.2 base with-package --name cowsay container
```
...
```shell
dagger call -m github.com/shykes/daggerverse/wolfi@v0.1.2 base with-package --name cowsay container terminal --cmd sh
```
...
```shell
dagger call -m github.com/shykes/daggerverse/wolfi@v0.1.2 base with-package --name=cowsay container with-exec --args "cowsay" --args "dagger" stdout
```
...
```shell
dagger call -m github.com/shykes/daggerverse/wolfi@v0.1.2 base with-package --name=cowsay container publish --address ttl.sh/my-wolfi
```
