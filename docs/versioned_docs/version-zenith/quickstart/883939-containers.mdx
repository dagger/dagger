...
The example above chains these various functions together and returns a special Dagger `Container` type representing the base image plus additional packages. You should see the container being built and the packages being added, as shown below:
...
```shell
docker run --rm -it ttl.sh/my-wolfi:10m@sha256:1da9eea134000de6b9afef7d812ced0d6f4ebe45db50c0f1afdac5864862ae56 cowsay "hello"
```
