...
![Run with metadata](/img/versioned_docs/version-zenith/user-guide/cloud/get-started/run-git-metadata.png)
...
![Run, no metadata](/img/versioned_docs/version-zenith/user-guide/cloud/get-started/run-no-metadata.png)
