---
slug: /user-guide/cloud/741031/user-interface
---
...
![View runs](/img/versioned_docs/version-zenith/user-guide/cloud/user-interface/all-runs.png)
...
![View run details](/img/versioned_docs/version-zenith/user-guide/cloud/user-interface/run-details.png)
...
![View step details](/img/versioned_docs/version-zenith/user-guide/cloud/user-interface/step-details.png)
...
![View changes](/img/versioned_docs/version-zenith/user-guide/cloud/user-interface/all-changes.png)
...
![View change details](/img/versioned_docs/version-zenith/user-guide/cloud/user-interface/change-details.png)
