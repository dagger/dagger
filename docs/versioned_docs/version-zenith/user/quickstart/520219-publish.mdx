...
At this point, your Dagger module has functions to test and build the application. However, the Dagger API has built-in support to publish container images to remote registries.
