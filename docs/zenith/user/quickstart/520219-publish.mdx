---
slug: /zenith/user/quickstart/292472/publish
...
At this point, your Dagger module has functions to test and build the application. However, all Dagger SDKs have built-in support to publish container images to remote registries.
