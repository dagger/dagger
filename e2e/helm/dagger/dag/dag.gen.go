...
func DaggerCli(opts ...dagger.DaggerCliOpts) *dagger.DaggerCli {
	client := initClient()
	return client.DaggerCli(opts...)
}
...
func LoadDaggerCliFromID(id dagger.DaggerCliID) *dagger.DaggerCli {
	client := initClient()
	return client.LoadDaggerCliFromID(id)
}
