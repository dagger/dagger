...
import (
	...
	"github.com/dagger/dagger/engine/buildkit/exporter/attestation"
	"github.com/dagger/dagger/engine/buildkit/exporter/containerimage/exptypes"
	"github.com/dagger/dagger/engine/buildkit/exporter/util/epoch"
...
func (ic *ImageWriter) exportLayers(ctx context.Context, refCfg cacheconfig.RefConfig, s session.Group, refs ...cache.ImmutableRef) ([]cache.Remote, error) {
	...
	out := make([]cache.Remote, len(refs))
...
func (ic *ImageWriter) rewriteRemoteWithEpoch(ctx context.Context, opts *ImageCommitOpts, remote *cache.Remote, baseImg *dockerspec.DockerOCIImage) (*cache.Remote, error) {
	if opts.Epoch == nil {
...
func normalizeLayersAndHistory(ctx context.Context, remote *cache.Remote, history []ocispecs.History, ref cache.ImmutableRef, oci bool) (*cache.Remote, []ocispecs.History) {
