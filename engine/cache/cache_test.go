...
func TestCacheConcurrent(t *testing.T) {
	...
	for i := range 100 {
		...
		go func() {
			defer wg.Done()
			res, err := c.GetOrInitialize(ctx, CacheKey[string]{ResultKey: commonKey, ConcurrencyKey: commonKey}, func(_ context.Context) (int, error) {
				initialized[i] = true
				return i, nil
			})
			assert.NilError(t, err)
...
func TestCacheErrors(t *testing.T) {
	...
	_, err = c.GetOrInitialize(ctx, CacheKey[string]{ResultKey: commonKey}, func(_ context.Context) (int, error) {
		return 0, myErr
	})
	...
	res, err := c.GetOrInitialize(ctx, CacheKey[string]{ResultKey: commonKey}, func(_ context.Context) (int, error) {
		return 1, nil
	})
	assert.NilError(t, err)
...
func TestCacheRecursiveCall(t *testing.T) {
	...
	_, err = c.GetOrInitialize(ctx, CacheKey[string]{ResultKey: "1"}, func(ctx context.Context) (int, error) {
		_, err := c.GetOrInitialize(ctx, CacheKey[string]{ResultKey: "1"}, func(ctx context.Context) (int, error) {
			return 2, nil
		})
		return 0, err
	...
	v, err := c.GetOrInitialize(ctx, CacheKey[string]{ResultKey: "10"}, func(ctx context.Context) (int, error) {
		res, err := c.GetOrInitialize(ctx, CacheKey[string]{ResultKey: "11"}, func(ctx context.Context) (int, error) {
			return 12, nil
		})
	...
	assert.NilError(t, err)
	v, err = c.GetOrInitialize(ctx, CacheKey[string]{ResultKey: "100"}, func(ctx context.Context) (int, error) {
		res, err := c2.GetOrInitialize(ctx, CacheKey[string]{ResultKey: "100"}, func(ctx context.Context) (int, error) {
			return 101, nil
		})
		return res.Result(), err
	})
...
func TestCacheContextCancel(t *testing.T) {
	t.Run("cancels after all are canceled", func(t *testing.T) {
		...
		go func() {
			defer close(errCh1)
			_, err := c.GetOrInitialize(ctx1, CacheKey[string]{ResultKey: "1", ConcurrencyKey: "1"}, func(ctx context.Context) (int, error) {
				close(started1)
				<-ctx.Done()
		...
		go func() {
			defer close(errCh2)
			_, err := c.GetOrInitialize(ctx2, CacheKey[string]{ResultKey: "1", ConcurrencyKey: "1"}, func(ctx context.Context) (int, error) {
				<-ctx.Done()
		...
		go func() {
			defer close(errCh3)
			_, err := c.GetOrInitialize(ctx3, CacheKey[string]{ResultKey: "1", ConcurrencyKey: "1"}, func(ctx context.Context) (int, error) {
	...
	t.Run("succeeds if others are canceled", func(t *testing.T) {
		...
		go func() {
			defer close(resCh1)
			defer close(errCh1)
			res, err := c.GetOrInitialize(ctx1, CacheKey[string]{ResultKey: "1"}, func(ctx context.Context) (int, error) {
				close(started1)
				<-stop1
				return 0, nil
			})
		...
		go func() {
			defer close(errCh2)
			_, err := c.GetOrInitialize(ctx2, CacheKey[string]{ResultKey: "1"}, func(ctx context.Context) (int, error) {
				<-ctx.Done()
...
func TestCacheResultRelease(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		res1A, err := c.GetOrInitialize(ctx, CacheKey[string]{ResultKey: "1"}, func(_ context.Context) (int, error) {
			return 1, nil
		})
		assert.NilError(t, err)
		res1B, err := c.GetOrInitialize(ctx, CacheKey[string]{ResultKey: "1"}, func(_ context.Context) (int, error) {
			return 1, nil
		})
		assert.NilError(t, err)

		res2, err := c.GetOrInitialize(ctx, CacheKey[string]{ResultKey: "2"}, func(_ context.Context) (int, error) {
			return 2, nil
		})
		assert.NilError(t, err)
	...
	t.Run("onRelease", func(t *testing.T) {
		...
		res1A, err := c.GetOrInitializeWithCallbacks(ctx, CacheKey[string]{ResultKey: "1", ConcurrencyKey: "1"}, func(_ context.Context) (*ValueWithCallbacks[int], error) {
		...
		res2, err := c.GetOrInitializeWithCallbacks(ctx, CacheKey[string]{ResultKey: "2", ConcurrencyKey: "1"}, func(_ context.Context) (*ValueWithCallbacks[int], error) {
...
func TestSkipDedupe(t *testing.T) {
	...
	stop1 := make(chan struct{})
	eg.Go(func() error {
		_, err := c.GetOrInitializeWithCallbacks(ctx, CacheKey[string]{ResultKey: "1"}, func(_ context.Context) (*ValueWithCallbacks[int], error) {
			defer close(valCh1)
			close(started1)
			valCh1 <- 1
			<-stop1
