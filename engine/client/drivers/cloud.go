...
func (d *daggerCloudDriver) create(ctx context.Context, client *cloud.Client, u *url.URL) (*daggerCloudConnector, error) {
	engineSpec, err := client.Engine(ctx, u.Query().Get("image"))
	if err != nil {
