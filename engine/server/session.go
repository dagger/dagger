...
func (srv *Server) removeDaggerSession(ctx context.Context, sess *daggerSession) error {
	...
	if sess.archiveManifest != nil {
		...
		if err := srv.finalizeSessionArchive(telemetryCtx, sess); err != nil {
...
func (s *callPayloadDeliveryStore) RequireCallPayloadLogs() bool {
	return s.session.archiveManifest != nil
}
