...
func (srv *Server) ensureModulesLoadedMode(ctx context.Context, client *clientRuntime, filter func([]pendingModule) []pendingModule, bestEffort bool) (loadFailures []string, _ error) {
...
func (srv *Server) ensureModulesLoadedModeWithSuccess(ctx context.Context, client *clientRuntime, filter func([]pendingModule) []pendingModule, bestEffort bool, onSuccessLocked func()) (loadFailures []string, rerr error) {
