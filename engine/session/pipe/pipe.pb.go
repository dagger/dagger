...
type Data struct {
	...
	// eof marks the end of the sender's input. The client sends it once its
	// stdin is closed, so the engine's reader observes io.EOF while the stream
	// stays open for the engine's remaining output.
...
var fileDescriptor_d1979e1a5fdc07ed = []byte{
	...
	0x09, 0x29, 0xe9, 0x70, 0xb1, 0xb8, 0x24, 0x96, 0x24, 0x0a, 0x09, 0x71, 0xb1, 0xa4, 0x24, 0x96,
	0x24, 0x4a, 0x30, 0x2a, 0x30, 0x6a, 0xf0, 0x04, 0x81, 0xd9, 0x42, 0x02, 0x5c, 0xcc, 0xa9, 0xf9,
	0x69, 0x12, 0x4c, 0x0a, 0x8c, 0x1a, 0x1c, 0x41, 0x20, 0xa6, 0x91, 0x19, 0x17, 0x4b, 0x40, 0x66,
	0x41, 0xaa, 0x90, 0x1e, 0x17, 0x93, 0xa7, 0xbf, 0x90, 0xa0, 0x1e, 0x92, 0x49, 0x7a, 0x20, 0x63,
	...
	0x44, 0xb1, 0x80, 0x0c, 0x49, 0x62, 0x03, 0xbb, 0xda, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x57,
	0xb0, 0x7f, 0xba, 0xc3, 0x00, 0x00, 0x00,
}
