...
func (c *tracesSourceClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (TracesSource_SubscribeClient, error) {
	...
	stream, err := c.cc.NewStream(ctx, &TracesSource_ServiceDesc.Streams[0], TracesSource_Subscribe_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &tracesSourceSubscribeClient{ClientStream: stream}
...
func _TracesSource_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TracesSourceServer).Subscribe(m, &tracesSourceSubscribeServer{ServerStream: stream})
}
...
func (c *logsSourceClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (LogsSource_SubscribeClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LogsSource_ServiceDesc.Streams[0], LogsSource_Subscribe_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &logsSourceSubscribeClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _LogsSource_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(LogsSourceServer).Subscribe(m, &logsSourceSubscribeServer{ServerStream: stream})
}
...
func (c *metricsSourceClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (MetricsSource_SubscribeClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &MetricsSource_ServiceDesc.Streams[0], MetricsSource_Subscribe_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &metricsSourceSubscribeClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _MetricsSource_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MetricsSourceServer).Subscribe(m, &metricsSourceSubscribeServer{ServerStream: stream})
}
