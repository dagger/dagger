...
const (
	...
	// not. Packets that cannot be classified as IP traffic are reported
	// separately.
	...
	NetworkUnknownRxBytes  = "dagger.io/metrics.network.unknown.rx.bytes"
	NetworkUnknownTxBytes  = "dagger.io/metrics.network.unknown.tx.bytes"
