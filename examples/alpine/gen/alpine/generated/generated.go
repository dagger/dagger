...
import (
	...
	"github.com/dagger/cloak/examples/alpine/gen/alpine/model"
...
type QueryResolver interface {
	Build(ctx context.Context, pkgs []string) (dagger.FS, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Dummy.foo":
		if e.complexity.Dummy.Foo == nil {
			break
		}

		return e.complexity.Dummy.Foo(childComplexity), true
...
func (ec *executionContext) _Dummy_foo(ctx context.Context, field graphql.CollectedField, obj *model.Dummy) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Dummy_foo(ctx, field)
	if err != nil {
		return graphql.Null
	}
...
func (ec *executionContext) fieldContext_Dummy_foo(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
...
func (ec *executionContext) _Query_build(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(dagger.FS)
	fc.Result = res
	return ec.marshalNFS2githubᚗcomᚋdaggerᚋcloakᚋsdkᚋgoᚋdaggerᚐFS(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Query_build(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		IsResolver: true,
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return nil, errors.New("field of type FS does not have child fields")
		},
	}
	defer func() {
		if r := recover(); r != nil {
...
func (ec *executionContext) _Dummy(ctx context.Context, sel ast.SelectionSet, obj *model.Dummy) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "foo":
			...
			out.Values[i] = ec._Dummy_foo(ctx, field, obj)
