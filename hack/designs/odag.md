...
- UI includes:
  ...
  - event stream panel includes all non-internal call events (including hidden inner-function objects) with columns for raw/derived operation and `visible` object status
