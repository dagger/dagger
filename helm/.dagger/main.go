...
// Lint the helm chart
func (h *Helm) Lint(ctx context.Context) (CheckStatus, error) {
	_, err := h.chart().
...
func (h *Helm) Test(ctx context.Context) (CheckStatus, error) {
...
func (h *Helm) ReleaseDryRun(ctx context.Context) (CheckStatus, error) {
