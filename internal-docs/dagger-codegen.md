...
| SDK libraries | Repo SDK generation | Shipped SDK packages such as `sdk/go/core/core.gen.go` | Go: `dagger-go-sdk-codegen core` from `github.com/dagger/go-sdk`, run by `sdk/go/core/generate.go`; other SDKs: `cmd/codegen generate-library` |
...
- `generate-module`
- `generate-client`
- `generate-library` (TypeScript only; Go core bindings come from
  `dagger-go-sdk-codegen core` in `github.com/dagger/go-sdk`)
- `generate-typedefs`
- `generate-entrypoint`
