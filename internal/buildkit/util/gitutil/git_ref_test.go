...
func TestParseGitRef(t *testing.T) {
	cases := []struct {
		...
		{
			ref: "github.com/dagger/dagger/buildkit",
			expected: &GitRef{
				Remote:                     "github.com/dagger/dagger/buildkit",
				ShortName:                  "buildkit",
		...
		{
			ref:      "https://github.com/dagger/dagger/buildkit",
			expected: nil,
		},
		{
			ref: "https://github.com/dagger/dagger/buildkit.git",
			expected: &GitRef{
				Remote:    "https://github.com/dagger/dagger/buildkit.git",
				ShortName: "buildkit",
			},
		},
		{
			ref: "https://foo:bar@github.com/dagger/dagger/buildkit.git",
			expected: &GitRef{
				Remote:    "https://foo:bar@github.com/dagger/dagger/buildkit.git",
				ShortName: "buildkit",
			},
		},
		{
