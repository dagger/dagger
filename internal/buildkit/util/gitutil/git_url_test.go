...
func TestParseURL(t *testing.T) {
	tests := []struct {
		...
		{
			url: "https://github.com/dagger/dagger/buildkit",
			result: GitURL{
		...
		{
			url: "http://github.com/dagger/dagger/buildkit#v1.0.0",
			result: GitURL{
				Scheme:   HTTPProtocol,
				Host:     "github.com",
				Path:     "/moby/buildkit",
		...
		{
			url: "http://github.com/dagger/dagger/buildkit#v1.0.0:subdir",
			result: GitURL{
				Scheme:   HTTPProtocol,
				Host:     "github.com",
				Path:     "/moby/buildkit",
		...
		{
			url: "http://foo:bar@github.com/dagger/dagger/buildkit#v1.0.0",
			result: GitURL{
				Scheme:   HTTPProtocol,
				Host:     "github.com",
				Path:     "/moby/buildkit",
		...
		{
			url: "ssh://git@github.com/dagger/dagger/buildkit.git",
			result: GitURL{
				Scheme: SSHProtocol,
				Host:   "github.com",
		...
		{
			url: "httpx://github.com/dagger/dagger/buildkit",
			err: true,
		},
		{
			url: "HTTP://github.com/dagger/dagger/buildkit",
