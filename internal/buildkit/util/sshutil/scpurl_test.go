...
func TestIsImplicitSSHTransport(t *testing.T) {
	require.False(t, IsImplicitSSHTransport("http://github.com/dagger/dagger/buildkit"))
	require.False(t, IsImplicitSSHTransport("github.com/dagger/dagger/buildkit"))
...
func TestParseSCPStyleURL(t *testing.T) {
	tests := []struct {
		...
		{
			url: "http://github.com/dagger/dagger/buildkit",
			err: true,
		},
		{
