...
func (t Python) Bump(ctx context.Context, version string) error {
	...
	if strings.Contains(version, "@") {
		lines = strings.SplitN(version, "@", 2)
		lines[0] += "@"
	}

	versionFile := "# Code generated by dagger. DO NOT EDIT.\n\nENGINE_IMAGE_REF = (\n"
	for _, l := range lines {
		versionFile += fmt.Sprintf("    %q\n", l)
	}
	versionFile += ")\n"

	return os.WriteFile("sdk/python/src/dagger/connectors/engine_version.py", []byte(versionFile), 0600)
}
