...
func (r *Binding) AsChangelog() *Changelog {
...
func (r *Changelog) Generate() *Changeset {
...
func (r *Changelog) LookupEntry(component string, version string) *File {
...
// DaggerDevChangelogOpts contains options for DaggerDev.Changelog
type DaggerDevChangelogOpts struct {
	Source *Directory
}

func (r *DaggerDev) Changelog(opts ...DaggerDevChangelogOpts) *Changelog {
...
// DaggerDevCliOpts contains options for DaggerDev.Cli
...
func (r *DaggerDev) Docs(opts ...DaggerDevDocsOpts) *Docs { // docs (../../toolchains/docs-dev/main.go:17:1)
...
// DaggerDevElixirSDKOpts contains options for DaggerDev.ElixirSDK
type DaggerDevElixirSDKOpts struct {
	BaseImage string
...
func (r *DaggerDev) ElixirSDK(opts ...DaggerDevElixirSDKOpts) *ElixirSDK {
...
// DaggerDevEngineDevOpts contains options for DaggerDev.EngineDev
type DaggerDevEngineDevOpts struct {
...
func (r *DaggerDev) EngineDev(opts ...DaggerDevEngineDevOpts) *EngineDev { // engine-dev (../../toolchains/engine-dev/main.go:19:1)
...
type DaggerDevGoOpts struct {
	...
	//
	ExtraPackages []string // go (../../toolchains/go/main.go:69:2)
}

func (r *DaggerDev) Go(opts ...DaggerDevGoOpts) *Go { // go (../../toolchains/go/main.go:24:1)
	q := r.query.Select("go")
	for i := len(opts) - 1; i >= 0; i-- {
		// `source` optional argument
		if !querybuilder.IsZeroValue(opts[i].Source) {
...
// DaggerDevGoSDKOpts contains options for DaggerDev.GoSDK
type DaggerDevGoSDKOpts struct {
	Workspace *Directory

	SourcePath string
}

func (r *DaggerDev) GoSDK(opts ...DaggerDevGoSDKOpts) *GoSDK {
...
// DaggerDevHelmOpts contains options for DaggerDev.Helm
type DaggerDevHelmOpts struct {
	//
	// The dagger helm chart directory
	//
	Chart *Directory // helm (../../toolchains/helm-dev/main.go:20:2)
}

func (r *DaggerDev) Helm(opts ...DaggerDevHelmOpts) *Helm { // helm (../../toolchains/helm-dev/main.go:16:1)
...
func (r *DaggerDev) ID(ctx context.Context) (DaggerDevID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response DaggerDevID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *DaggerDev) XXX_GraphQLType() string {
	return "DaggerDev"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *DaggerDev) XXX_GraphQLIDType() string {
	return "DaggerDevID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *DaggerDev) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *DaggerDev) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *DaggerDev) Installers() *Installers {
...
// DaggerDevJavaSDKOpts contains options for DaggerDev.JavaSDK
type DaggerDevJavaSDKOpts struct {
	Workspace *Directory

	SourcePath string
}

func (r *DaggerDev) JavaSDK(opts ...DaggerDevJavaSDKOpts) *JavaSDK {
...
// DaggerDevPhpSDKOpts contains options for DaggerDev.PhpSDK
type DaggerDevPhpSDKOpts struct {
	//
...
func (r *DaggerDev) PhpSDK(opts ...DaggerDevPhpSDKOpts) *PhpSDK { // php-sdk (../../toolchains/php-sdk-dev/main.go:33:1)
...
// DaggerDevPythonSDKOpts contains options for DaggerDev.PythonSDK
type DaggerDevPythonSDKOpts struct {
	//
...
func (r *DaggerDev) Release() *Release {
...
// DaggerDevRustSDKOpts contains options for DaggerDev.RustSDK
type DaggerDevRustSDKOpts struct {
	//
	// A directory with all the files needed to develop the SDK
	//
...
func (r *DaggerDev) RustSDK(opts ...DaggerDevRustSDKOpts) *RustSDK { // rust-sdk (../../toolchains/rust-sdk-dev/main.go:38:1)
...
func (r *DaggerDev) Security() *Security {
...
// DaggerDevTypescriptSDKOpts contains options for DaggerDev.TypescriptSDK
type DaggerDevTypescriptSDKOpts struct {
...
func (r *DaggerDev) TypescriptSDK(opts ...DaggerDevTypescriptSDKOpts) *TypescriptSDK {
...
func (r *Env) WithChangelogInput(name string, value *Changelog, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithChangelogOutput(name string, description string) *Env {
...
// A Go project
type Go struct { // go (../../toolchains/go/main.go:128:6)
	query *querybuilder.Selection
...
func (r *Go) Base() *Container { // go (../../toolchains/go/main.go:142:2)
...
type GoBinaryOpts struct {
	...
	//
	NoSymbols bool // go (../../toolchains/go/main.go:310:2)
	//
	// Disable DWARF generation
	//
	NoDwarf bool // go (../../toolchains/go/main.go:313:2)
	//
	// Target build platform
	//
	Platform Platform // go (../../toolchains/go/main.go:316:2)
}

// Build a single main package, and return the compiled binary
func (r *Go) Binary(pkg string, opts ...GoBinaryOpts) *File { // go (../../toolchains/go/main.go:304:1)
	q := r.query.Select("binary")
	for i := len(opts) - 1; i >= 0; i-- {
...
type GoBuildOpts struct {
	...
	//
	// Default: ["./..."]
	Pkgs []string // go (../../toolchains/go/main.go:252:2)
	//
	// Disable symbol table
	//
	NoSymbols bool // go (../../toolchains/go/main.go:255:2)
	//
	// Disable DWARF generation
	//
	NoDwarf bool // go (../../toolchains/go/main.go:258:2)
	//
	// Target build platform
	//
	Platform Platform // go (../../toolchains/go/main.go:261:2)
	//
	// Output directory
	//
	//
	// Default: "./bin/"
	Output string // go (../../toolchains/go/main.go:265:2)
}

// Build the given main packages, and return the build directory
func (r *Go) Build(opts ...GoBuildOpts) *Directory { // go (../../toolchains/go/main.go:247:1)
...
// Go build cache
func (r *Go) BuildCache() *CacheVolume { // go (../../toolchains/go/main.go:139:2)
...
// Enable CGO
func (r *Go) Cgo(ctx context.Context) (bool, error) { // go (../../toolchains/go/main.go:151:2)
	if r.cgo != nil {
		return *r.cgo, nil
	}
...
type GoCheckTidyOpts struct {
	Include []string // go (../../toolchains/go/main.go:540:2)

	Exclude []string // go (../../toolchains/go/main.go:541:2)
}

// Check if 'go mod tidy' is up-to-date
func (r *Go) CheckTidy(ctx context.Context, opts ...GoCheckTidyOpts) error { // go (../../toolchains/go/main.go:538:1)
	if r.checkTidy != nil {
		return nil
	}
...
func (r *Go) Download() *Go { // go (../../toolchains/go/main.go:171:1)
...
type GoEnvOpts struct {
	Platform Platform // go (../../toolchains/go/main.go:192:2)
}
...
func (r *Go) Env(opts ...GoEnvOpts) *Container { // go (../../toolchains/go/main.go:190:1)
...
func (r *Go) Exclude(ctx context.Context) ([]string, error) { // go (../../toolchains/go/main.go:161:2)
...
func (r *Go) Experiment(ctx context.Context) ([]string, error) { // go (../../toolchains/go/main.go:157:2)
...
func (r *Go) GenerateDaggerRuntime(start string) *Go { // go (../../toolchains/go/main.go:669:1)
...
func (r *Go) Include(ctx context.Context) ([]string, error) { // go (../../toolchains/go/main.go:159:2)
...
// Pass arguments to 'go build -ldflags”
func (r *Go) Ldflags(ctx context.Context) ([]string, error) { // go (../../toolchains/go/main.go:145:2)
...
type GoLintOpts struct {
	Include []string // go (../../toolchains/go/main.go:610:2)

	Exclude []string // go (../../toolchains/go/main.go:611:2)
}

// Lint the project
func (r *Go) Lint(ctx context.Context, opts ...GoLintOpts) error { // go (../../toolchains/go/main.go:608:1)
	if r.lint != nil {
		return nil
	}
	q := r.query.Select("lint")
...
func (r *Go) LintModule(ctx context.Context, mod string) error { // go (../../toolchains/go/main.go:636:1)
	if r.lintModule != nil {
		return nil
	}
...
type GoListPackagesOpts struct {
	...
	//
	// Default: ["./..."]
	Pkgs []string // go (../../toolchains/go/main.go:400:2)
	//
	// Only list main packages
	//
	OnlyMain bool // go (../../toolchains/go/main.go:403:2)
}

// List packages matching the specified criteria
func (r *Go) ListPackages(ctx context.Context, opts ...GoListPackagesOpts) ([]string, error) { // go (../../toolchains/go/main.go:395:1)
...
// Go module cache
func (r *Go) ModuleCache() *CacheVolume { // go (../../toolchains/go/main.go:136:2)
...
type GoModulesOpts struct {
	Include []string // go (../../toolchains/go/main.go:471:2)

	Exclude []string // go (../../toolchains/go/main.go:472:2)
}

// Scan the source for go modules, and return their paths
func (r *Go) Modules(ctx context.Context, opts ...GoModulesOpts) ([]string, error) { // go (../../toolchains/go/main.go:469:1)
...
func (r *Go) Race(ctx context.Context) (bool, error) { // go (../../toolchains/go/main.go:154:2)
	if r.race != nil {
		return *r.race, nil
	}
...
// Project source directory
func (r *Go) Source() *Directory { // go (../../toolchains/go/main.go:133:2)
	q := r.query.Select("source")
...
type GoTestOpts struct {
	...
	// Only run these tests
	//
	Run string // go (../../toolchains/go/main.go:346:2)
	//
	// Skip these tests
	//
	Skip string // go (../../toolchains/go/main.go:349:2)
	//
	// Abort test run on first failure
	//
	Failfast bool // go (../../toolchains/go/main.go:352:2)
	//
	// How many tests to run in parallel - defaults to the number of CPUs
	//
	Parallel int // go (../../toolchains/go/main.go:356:2)
	//
	// How long before timing out the test run
	//
	//
	// Default: "30m"
	Timeout string // go (../../toolchains/go/main.go:360:2)

	// Default: 1
	Count int // go (../../toolchains/go/main.go:363:2)
	//
	// Which packages to test
	//
	//
	// Default: ["./..."]
	Pkgs []string // go (../../toolchains/go/main.go:367:2)
}

// Run tests for the given packages
func (r *Go) Test(ctx context.Context, opts ...GoTestOpts) error { // go (../../toolchains/go/main.go:342:1)
	if r.test != nil {
		return nil
	}
	q := r.query.Select("test")
...
type GoTestsOpts struct {
	...
	//
	// Default: ["./..."]
	Pkgs []string // go (../../toolchains/go/main.go:237:2)
}

// List tests
func (r *Go) Tests(ctx context.Context, opts ...GoTestsOpts) (string, error) { // go (../../toolchains/go/main.go:232:1)
	if r.tests != nil {
		return *r.tests, nil
	}
	q := r.query.Select("tests")
...
type GoTidyOpts struct {
	Include []string // go (../../toolchains/go/main.go:498:2)

	Exclude []string // go (../../toolchains/go/main.go:499:2)
}

func (r *Go) Tidy(opts ...GoTidyOpts) *Changeset { // go (../../toolchains/go/main.go:496:1)
...
func (r *Go) TidyModule(mod string) *Changeset { // go (../../toolchains/go/main.go:481:1)
...
// Add string value definition of the form importpath.name=value
func (r *Go) Values(ctx context.Context) ([]string, error) { // go (../../toolchains/go/main.go:148:2)
	q := r.query.Select("values")
...
// Go version
func (r *Go) Version(ctx context.Context) (string, error) { // go (../../toolchains/go/main.go:130:2)
	if r.version != nil {
		return *r.version, nil
	}
	q := r.query.Select("version")
...
// Lint the helm chart
func (r *Helm) Lint(ctx context.Context) error { // helm (../../toolchains/helm-dev/main.go:33:1)
	if r.lint != nil {
		return nil
	}
	q := r.query.Select("lint")
...
// HelmPublishOpts contains options for Helm.Publish
type HelmPublishOpts struct {
	GithubToken *Secret // helm (../../toolchains/helm-dev/main.go:260:2)
	//
	// Test as much as possible without actually publishing anything
	//
	DryRun bool // helm (../../toolchains/helm-dev/main.go:264:2)
}

// Package & publish chart to our registry + github release
func (r *Helm) Publish(ctx context.Context, target string, opts ...HelmPublishOpts) error { // helm (../../toolchains/helm-dev/main.go:253:1)
	if r.publish != nil {
		return nil
	}
	q := r.query.Select("publish")
...
func (r *Helm) ReleaseDryRun(ctx context.Context) error { // helm (../../toolchains/helm-dev/main.go:243:1)
	if r.releaseDryRun != nil {
		return nil
	}
	q := r.query.Select("releaseDryRun")
...
func (r *Helm) SetVersion(version string) *File { // helm (../../toolchains/helm-dev/main.go:206:1)
...
func (r *Helm) Test(ctx context.Context) error { // helm (../../toolchains/helm-dev/main.go:44:1)
	if r.test != nil {
		return nil
	}
	q := r.query.Select("test")
...
// ChangelogOpts contains options for Client.Changelog
type ChangelogOpts struct {
	Source *Directory
}

func (r *Client) Changelog(opts ...ChangelogOpts) *Changelog {
	q := r.query.Select("changelog")
	for i := len(opts) - 1; i >= 0; i-- {
		// `source` optional argument
		if !querybuilder.IsZeroValue(opts[i].Source) {
...
// CliOpts contains options for Client.Cli
type CliOpts struct {
	RunnerHost string // cli (../../toolchains/cli-dev/main.go:16:2)
...
// DocsOpts contains options for Client.Docs
...
func (r *Client) Docs(opts ...DocsOpts) *Docs { // docs (../../toolchains/docs-dev/main.go:17:1)
	q := r.query.Select("docs")
	for i := len(opts) - 1; i >= 0; i-- {
		// `source` optional argument
		if !querybuilder.IsZeroValue(opts[i].Source) {
...
func (r *Client) EngineDev(opts ...EngineDevOpts) *EngineDev { // engine-dev (../../toolchains/engine-dev/main.go:19:1)
	q := r.query.Select("engineDev")
	for i := len(opts) - 1; i >= 0; i-- {
		// `source` optional argument
		if !querybuilder.IsZeroValue(opts[i].Source) {
...
func (r *Client) Helm(opts ...HelmOpts) *Helm { // helm (../../toolchains/helm-dev/main.go:16:1)
	q := r.query.Select("helm")
	for i := len(opts) - 1; i >= 0; i-- {
		// `chart` optional argument
		if !querybuilder.IsZeroValue(opts[i].Chart) {
...
func (r *Client) LoadChangelogFromID(id ChangelogID) *Changelog {
...
// Develop the Dagger PHP SDK (experimental)
func (r *Client) PhpSDK(opts ...PhpSDKOpts) *PhpSDK { // php-sdk (../../toolchains/php-sdk-dev/main.go:33:1)
	q := r.query.Select("phpSdk")
	for i := len(opts) - 1; i >= 0; i-- {
		// `workspace` optional argument
		if !querybuilder.IsZeroValue(opts[i].Workspace) {
...
// Test Provision
func (r *TestSplit) TestProvision(ctx context.Context) error {
...
// Test Telemetry
func (r *TestSplit) TestTelemetry(ctx context.Context) error {
