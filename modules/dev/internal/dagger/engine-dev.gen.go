...
type EngineDevContainerOpts struct {
	Platform Platform // engine-dev (../../../../toolchains/engine-dev/main.go:150:2)

	GpuSupport bool // engine-dev (../../../../toolchains/engine-dev/main.go:152:2)

	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:154:2)

	Tag string // engine-dev (../../../../toolchains/engine-dev/main.go:156:2)
}

// Build the engine container
func (r *EngineDev) Container(opts ...EngineDevContainerOpts) *Container { // engine-dev (../../../../toolchains/engine-dev/main.go:146:1)
...
type EngineDevPlaygroundOpts struct {
	...
	//
	ExtraPackages []string // engine-dev (../../../../toolchains/engine-dev/main.go:122:2)
}
