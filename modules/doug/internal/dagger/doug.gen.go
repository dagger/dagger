...
func (r *Doug) Agent(base *LLM) *LLM {
...
func (r *Doug) Dev(source *Directory, opts ...DougDevOpts) *LLM {
...
func (r *Doug) EditFile(filePath string, oldString string, newString string, opts ...DougEditFileOpts) *Changeset {
...
func (r *Doug) Glob(ctx context.Context, pattern string) error {
	if r.glob != nil {
		return nil
	}
...
func (r *Doug) Grep(ctx context.Context, pattern string, paths []string, glob []string, opts ...DougGrepOpts) (string, error) {
	if r.grep != nil {
		return *r.grep, nil
	}
...
func (r *Doug) ReadFile(ctx context.Context, filePath string, opts ...DougReadFileOpts) (string, error) {
	if r.readFile != nil {
...
func (r *Doug) Task(ctx context.Context, description string, prompt string) (string, error) {
	if r.task != nil {
		return *r.task, nil
	}
...
func (r *Doug) TodoWrite(pending []string, inProgress []string, completed []string) *Env {
...
func (r *Doug) Write(filePath string, contents string) *Changeset {
...
func (r *Query) Doug(opts ...DougOpts) *Doug { // doug (../../../../:0:0)
