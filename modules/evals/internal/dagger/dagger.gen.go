...
// more insights.
func (r *Evaluator) Explore(ctx context.Context) ([]string, error) { // evaluator (../../../../modules/evaluator/main.go:411:1)
...
func (r *Evaluator) GenerateSystemPrompt(ctx context.Context) (string, error) { // evaluator (../../../../modules/evaluator/main.go:435:1)
...
// course-correct.
func (r *Evaluator) Iterate(ctx context.Context) (string, error) { // evaluator (../../../../modules/evaluator/main.go:452:1)
	if r.iterate != nil {
...
type EvaluatorEvalResult struct { // evaluator (../../../../modules/evaluator/main.go:295:6)
	query *querybuilder.Selection
...
func (r *EvaluatorEvalResult) Check(ctx context.Context) error { // evaluator (../../../../modules/evaluator/main.go:306:1)
	if r.check != nil {
		return nil
	}
	q := r.query.Select("check")
...
func (r *EvaluatorEvalResult) Error(ctx context.Context) (string, error) { // evaluator (../../../../modules/evaluator/main.go:298:2)
	if r.error != nil {
		return *r.error, nil
	}
...
func (r *EvaluatorEvalResult) InputTokens(ctx context.Context) (int, error) { // evaluator (../../../../modules/evaluator/main.go:302:2)
...
func (r *EvaluatorEvalResult) Name(ctx context.Context) (string, error) { // evaluator (../../../../modules/evaluator/main.go:296:2)
	if r.name != nil {
		return *r.name, nil
	}
	q := r.query.Select("name")
...
func (r *EvaluatorEvalResult) OutputTokens(ctx context.Context) (int, error) { // evaluator (../../../../modules/evaluator/main.go:303:2)
...
func (r *EvaluatorEvalResult) Report(ctx context.Context) (string, error) { // evaluator (../../../../modules/evaluator/main.go:299:2)
	if r.report != nil {
		return *r.report, nil
	}
	q := r.query.Select("report")
...
func (r *EvaluatorEvalResult) SpanID(ctx context.Context) (string, error) { // evaluator (../../../../modules/evaluator/main.go:297:2)
	if r.spanId != nil {
		return *r.spanId, nil
	}
...
func (r *EvaluatorEvalResult) SuccessRate(ctx context.Context) (float64, error) { // evaluator (../../../../modules/evaluator/main.go:300:2)
...
func (r *EvaluatorEvalResult) TotalAttempts(ctx context.Context) (int, error) { // evaluator (../../../../modules/evaluator/main.go:301:2)
...
type EvaluatorEvalsAcrossModels struct { // evaluator (../../../../modules/evaluator/main.go:279:6)
	query *querybuilder.Selection
...
// test cases.
func (r *EvaluatorEvalsAcrossModels) AnalyzeAndGenerateSystemPrompt(ctx context.Context) (string, error) { // evaluator (../../../../modules/evaluator/main.go:362:1)
...
func (r *EvaluatorEvalsAcrossModels) Check(ctx context.Context) error { // evaluator (../../../../modules/evaluator/main.go:326:1)
	if r.check != nil {
		return nil
	}
	q := r.query.Select("check")
...
func (r *EvaluatorEvalsAcrossModels) ModelResults(ctx context.Context) ([]EvaluatorModelResult, error) { // evaluator (../../../../modules/evaluator/main.go:281:2)
...
func (r *EvaluatorEvalsAcrossModels) TraceID(ctx context.Context) (string, error) { // evaluator (../../../../modules/evaluator/main.go:280:2)
	if r.traceId != nil {
...
type EvaluatorModelResult struct { // evaluator (../../../../modules/evaluator/main.go:288:6)
	query *querybuilder.Selection
...
func (r *EvaluatorModelResult) Check(ctx context.Context) error { // evaluator (../../../../modules/evaluator/main.go:313:1)
	if r.check != nil {
		return nil
	}
	q := r.query.Select("check")
...
func (r *EvaluatorModelResult) EvalReports(ctx context.Context) ([]EvaluatorEvalResult, error) { // evaluator (../../../../modules/evaluator/main.go:291:2)
...
func (r *EvaluatorModelResult) ModelName(ctx context.Context) (string, error) { // evaluator (../../../../modules/evaluator/main.go:289:2)
	if r.modelName != nil {
...
func (r *EvaluatorModelResult) SpanID(ctx context.Context) (string, error) { // evaluator (../../../../modules/evaluator/main.go:290:2)
	if r.spanId != nil {
		return *r.spanId, nil
	}
	q := r.query.Select("spanId")
...
func (r *Client) Evaluator(opts ...EvaluatorOpts) *Evaluator { // evaluator (../../../../modules/evaluator/main.go:51:1)
...
func (r *Client) Workspace(buster string) *Workspace { // workspace (../../../../modules/evals/workspace/main.go:9:1)
	q := r.query.Select("workspace")
...
type Workspace struct { // workspace (../../../../modules/evals/workspace/main.go:5:6)
	query *querybuilder.Selection
...
func (r *Workspace) Facts(ctx context.Context) ([]string, error) { // workspace (../../../../modules/evals/workspace/main.go:6:2)
...
func (r *Workspace) NextFact(ctx context.Context) (string, error) { // workspace (../../../../modules/evals/workspace/main.go:30:1)
	if r.nextFact != nil {
...
func (r *Workspace) Record(fact string) *Workspace { // workspace (../../../../modules/evals/workspace/main.go:17:1)
