...
import (
	...
	"dagger/nested-context-middle/internal/querybuilder"
	"dagger/nested-context-middle/internal/telemetry"
)
...
type NestedContextLeafID string
...
func (r *Binding) AsNestedContextLeaf() *NestedContextLeaf {
...
func (r *Env) WithNestedContextLeafInput(name string, value *NestedContextLeaf, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithNestedContextLeafOutput(name string, description string) *Env {
...
func (r *Client) LoadNestedContextLeafFromID(id NestedContextLeafID) *NestedContextLeaf {
...
// NestedContextLeafOpts contains options for Client.NestedContextLeaf
...
func (r *Client) NestedContextLeaf(opts ...NestedContextLeafOpts) *NestedContextLeaf { // nested-context-leaf (../../../../../../modules/evals/testdata/nested-context-middle/nested-context-leaf/main.go:14:1)
