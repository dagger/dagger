...
// The `WorkspaceAttemptsReportID` scalar type represents an identifier for an object of type WorkspaceAttemptsReport.
type WorkspaceAttemptsReportID string

// The `WorkspaceEvalID` scalar type represents an identifier for an object of type WorkspaceEval.
type WorkspaceEvalID string
...
// Retrieve the binding value, as type WorkspaceAttemptsReport
func (r *Binding) AsWorkspaceAttemptsReport() *WorkspaceAttemptsReport {
	q := r.query.Select("asWorkspaceAttemptsReport")

	return &WorkspaceAttemptsReport{
		query: q,
	}
}

// Retrieve the binding value, as type WorkspaceEval
func (r *Binding) AsWorkspaceEval() *WorkspaceEval {
	q := r.query.Select("asWorkspaceEval")
...
// Create or update a binding of type WorkspaceAttemptsReport in the environment
func (r *Env) WithWorkspaceAttemptsReportInput(name string, value *WorkspaceAttemptsReport, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withWorkspaceAttemptsReportInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired WorkspaceAttemptsReport output to be assigned in the environment
func (r *Env) WithWorkspaceAttemptsReportOutput(name string, description string) *Env {
	q := r.query.Select("withWorkspaceAttemptsReportOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
// Create or update a binding of type WorkspaceEval in the environment
func (r *Env) WithWorkspaceEvalInput(name string, value *WorkspaceEval, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withWorkspaceEvalInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired WorkspaceEval output to be assigned in the environment
func (r *Env) WithWorkspaceEvalOutput(name string, description string) *Env {
	q := r.query.Select("withWorkspaceEvalOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
// Load a WorkspaceAttemptsReport from its ID.
func (r *Client) LoadWorkspaceAttemptsReportFromID(id WorkspaceAttemptsReportID) *WorkspaceAttemptsReport {
	q := r.query.Select("loadWorkspaceAttemptsReportFromID")
	q = q.Arg("id", id)
...
// Load a WorkspaceEval from its ID.
func (r *Client) LoadWorkspaceEvalFromID(id WorkspaceEvalID) *WorkspaceEval {
	q := r.query.Select("loadWorkspaceEvalFromID")
	q = q.Arg("id", id)
...
func (r *Client) Workspace() *Workspace { // workspace (../../../../modules/evaluator/workspace/main.go:23:6)
	q := r.query.Select("workspace")
...
type Workspace struct { // workspace (../../../../modules/evaluator/workspace/main.go:23:6)
	query *querybuilder.Selection
...
func (r *Workspace) Backoff(seconds int) *Workspace { // workspace (../../../../modules/evaluator/workspace/main.go:92:1)
...
func (r *Workspace) DisableDefaultSystemPrompt(ctx context.Context) (bool, error) { // workspace (../../../../modules/evaluator/workspace/main.go:31:2)
...
func (r *Workspace) EvalNames(ctx context.Context) ([]string, error) { // workspace (../../../../modules/evaluator/workspace/main.go:119:1)
...
func (r *Workspace) Evals(ctx context.Context) ([]WorkspaceEval, error) { // workspace (../../../../modules/evaluator/workspace/main.go:34:2)
	...
	convert := func(fields []evals) []WorkspaceEval {
		out := []WorkspaceEval{}

		for i := range fields {
			val := WorkspaceEval{id: &fields[i].Id}
			val.query = q.Root().Select("loadWorkspaceEvalFromID").Arg("id", fields[i].Id)
			out = append(out, val)
		}
...
// WorkspaceEvaluateOpts contains options for Workspace.Evaluate
type WorkspaceEvaluateOpts struct {
	//
	// The model to evaluate.
	//
	Model string // workspace (../../../../modules/evaluator/workspace/main.go:184:2)
	//
	// The number of attempts to evaluate across. Has a sane default per-provider.
	//
	Attempts int // workspace (../../../../modules/evaluator/workspace/main.go:187:2)
}

// Run an evaluation and return its report.
func (r *Workspace) Evaluate(name string, opts ...WorkspaceEvaluateOpts) *WorkspaceAttemptsReport { // workspace (../../../../modules/evaluator/workspace/main.go:178:1)
...
func (r *Workspace) Findings(ctx context.Context) ([]string, error) { // workspace (../../../../modules/evaluator/workspace/main.go:37:2)
...
func (r *Workspace) KnownModels(ctx context.Context) ([]string, error) { // workspace (../../../../modules/evaluator/workspace/main.go:133:1)
...
func (r *Workspace) SystemPrompt(ctx context.Context) (string, error) { // workspace (../../../../modules/evaluator/workspace/main.go:28:2)
...
func (r *Workspace) WithEval(eval *WorkspaceEval) *Workspace { // workspace (../../../../modules/evaluator/workspace/main.go:101:1)
...
func (r *Workspace) WithEvals(evals []*WorkspaceEval) *Workspace { // workspace (../../../../modules/evaluator/workspace/main.go:110:1)
...
func (r *Workspace) WithFinding(finding string) *Workspace { // workspace (../../../../modules/evaluator/workspace/main.go:138:1)
...
func (r *Workspace) WithSystemPrompt(prompt string) *Workspace { // workspace (../../../../modules/evaluator/workspace/main.go:67:1)
	q := r.query.Select("withSystemPrompt")
	q = q.Arg("prompt", prompt)
...
// Set the system prompt for future evaluations.
func (r *Workspace) WithSystemPromptFile(file *File) *Workspace { // workspace (../../../../modules/evaluator/workspace/main.go:76:1)
	assertNotNil("file", file)
...
// Set the system prompt for future evaluations.
func (r *Workspace) WithoutDefaultSystemPrompt() *Workspace { // workspace (../../../../modules/evaluator/workspace/main.go:61:1)
	q := r.query.Select("withoutDefaultSystemPrompt")
...
type WorkspaceAttemptsReport struct { // workspace (../../../../modules/evaluator/workspace/main.go:166:6)
	query *querybuilder.Selection

	cachedTokenReads  *int
	cachedTokenWrites *int
	id                *WorkspaceAttemptsReportID
	inputTokens       *int
	outputTokens      *int
	report            *string
...
func (r *WorkspaceAttemptsReport) WithGraphQLQuery(q *querybuilder.Selection) *WorkspaceAttemptsReport {
	return &WorkspaceAttemptsReport{
		query: q,
	}
}

func (r *WorkspaceAttemptsReport) CachedTokenReads(ctx context.Context) (int, error) { // workspace (../../../../modules/evaluator/workspace/main.go:173:2)
	if r.cachedTokenReads != nil {
		return *r.cachedTokenReads, nil
	}
	q := r.query.Select("cachedTokenReads")
...
func (r *WorkspaceAttemptsReport) CachedTokenWrites(ctx context.Context) (int, error) { // workspace (../../../../modules/evaluator/workspace/main.go:174:2)
	if r.cachedTokenWrites != nil {
		return *r.cachedTokenWrites, nil
	}
	q := r.query.Select("cachedTokenWrites")
...
// A unique identifier for this WorkspaceAttemptsReport.
func (r *WorkspaceAttemptsReport) ID(ctx context.Context) (WorkspaceAttemptsReportID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response WorkspaceAttemptsReportID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *WorkspaceAttemptsReport) XXX_GraphQLType() string {
	return "WorkspaceAttemptsReport"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *WorkspaceAttemptsReport) XXX_GraphQLIDType() string {
	return "WorkspaceAttemptsReportID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *WorkspaceAttemptsReport) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *WorkspaceAttemptsReport) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *WorkspaceAttemptsReport) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadWorkspaceAttemptsReportFromID(WorkspaceAttemptsReportID(id))
	return nil
}

func (r *WorkspaceAttemptsReport) InputTokens(ctx context.Context) (int, error) { // workspace (../../../../modules/evaluator/workspace/main.go:171:2)
	if r.inputTokens != nil {
		return *r.inputTokens, nil
	}
	q := r.query.Select("inputTokens")
...
func (r *WorkspaceAttemptsReport) OutputTokens(ctx context.Context) (int, error) { // workspace (../../../../modules/evaluator/workspace/main.go:172:2)
	if r.outputTokens != nil {
		return *r.outputTokens, nil
	}
	q := r.query.Select("outputTokens")
...
func (r *WorkspaceAttemptsReport) Report(ctx context.Context) (string, error) { // workspace (../../../../modules/evaluator/workspace/main.go:167:2)
	if r.report != nil {
		return *r.report, nil
	}
	q := r.query.Select("report")
...
func (r *WorkspaceAttemptsReport) SucceededAttempts(ctx context.Context) (int, error) { // workspace (../../../../modules/evaluator/workspace/main.go:169:2)
...
func (r *WorkspaceAttemptsReport) SuccessRate(ctx context.Context) (float64, error) { // workspace (../../../../modules/evaluator/workspace/main.go:168:2)
...
func (r *WorkspaceAttemptsReport) TotalAttempts(ctx context.Context) (int, error) { // workspace (../../../../modules/evaluator/workspace/main.go:170:2)
...
type WorkspaceEval struct { // workspace (../../../../modules/evaluator/workspace/main.go:44:6)
	query *querybuilder.Selection
...
func (r *WorkspaceEval) WithGraphQLQuery(q *querybuilder.Selection) *WorkspaceEval {
	return &WorkspaceEval{
		query: q,
	}
}

func (r *WorkspaceEval) Check(ctx context.Context, prompt *LLM) error { // workspace (../../../../modules/evaluator/workspace/main.go:47:7)
...
// A unique identifier for this WorkspaceEval.
func (r *WorkspaceEval) ID(ctx context.Context) (WorkspaceEvalID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response WorkspaceEvalID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *WorkspaceEval) XXX_GraphQLType() string {
	return "WorkspaceEval"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *WorkspaceEval) XXX_GraphQLIDType() string {
	return "WorkspaceEvalID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *WorkspaceEval) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *WorkspaceEval) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *WorkspaceEval) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadWorkspaceEvalFromID(WorkspaceEvalID(id))
	return nil
}

func (r *WorkspaceEval) Name(ctx context.Context) (string, error) { // workspace (../../../../modules/evaluator/workspace/main.go:45:6)
	if r.name != nil {
		return *r.name, nil
	}
	q := r.query.Select("name")
...
func (r *WorkspaceEval) Prompt(base *LLM) *LLM { // workspace (../../../../modules/evaluator/workspace/main.go:46:8)
