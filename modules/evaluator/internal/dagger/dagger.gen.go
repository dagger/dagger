...
// A unique identifier for an object.
type EvalWorkspaceAttemptsReportID string

// A unique identifier for an object.
type EvalWorkspaceEvalID string

// A unique identifier for an object.
type EvalWorkspaceID string
...
func (r *Query) LoadEvalWorkspaceAttemptsReportFromID(id EvalWorkspaceAttemptsReportID) *EvalWorkspaceAttemptsReport {
...
// Load a EvalWorkspaceEval from its ID.
func (r *Query) LoadEvalWorkspaceEvalFromID(id EvalWorkspaceEvalID) EvalWorkspaceEval {
	q := r.query.Select("loadEvalWorkspaceEvalFromID")
	q = q.Arg("id", id)
...
func (r *Query) LoadEvalWorkspaceFromID(id EvalWorkspaceID) *EvalWorkspace {
