...
type Evaluator struct { // evaluator (../../../../:0:0)
...
func (r *Evaluator) Compare(ctx context.Context, before *File, after *File) (string, error) {
...
func (r *Evaluator) DisableDefaultSystemPrompt(ctx context.Context) (bool, error) {
...
// parallel.
func (r *Evaluator) EvalsAcrossModels(opts ...EvaluatorEvalsAcrossModelsOpts) *EvaluatorEvalsAcrossModels {
...
func (r *Evaluator) EvaluatorModel(ctx context.Context) (string, error) {
...
// more insights.
func (r *Evaluator) Explore(ctx context.Context) ([]string, error) {
...
func (r *Evaluator) GenerateSystemPrompt(ctx context.Context) (string, error) {
...
// course-correct.
func (r *Evaluator) Iterate(ctx context.Context) (string, error) {
	if r.iterate != nil {
...
func (r *Evaluator) SystemPrompt() *File {
...
func (r *Evaluator) WithDocs(prompt string) *Evaluator {
...
func (r *Evaluator) WithDocsFile(file *File) *Evaluator {
...
func (r *Evaluator) WithEval(eval EvaluatorEval) *Evaluator {
...
func (r *Evaluator) WithEvals(evals []EvaluatorEval) *Evaluator {
...
func (r *Evaluator) WithSystemPrompt(prompt string) *Evaluator {
...
// from your code.
func (r *Evaluator) WithSystemPromptFile(file *File) *Evaluator {
	assertNotNil("file", file)
...
// prompt itself.
func (r *Evaluator) WithoutDefaultSystemPrompt() *Evaluator {
...
type EvaluatorEvalResult struct { // evaluator (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *EvaluatorEvalResult) Check(ctx context.Context) error {
	if r.check != nil {
		return nil
	}
...
func (r *EvaluatorEvalResult) Error(ctx context.Context) (string, error) {
	if r.error != nil {
		return *r.error, nil
	}
...
func (r *EvaluatorEvalResult) InputTokens(ctx context.Context) (int, error) {
...
func (r *EvaluatorEvalResult) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
...
func (r *EvaluatorEvalResult) OutputTokens(ctx context.Context) (int, error) {
...
func (r *EvaluatorEvalResult) Report(ctx context.Context) (string, error) {
	if r.report != nil {
		return *r.report, nil
	}
...
func (r *EvaluatorEvalResult) SpanID(ctx context.Context) (string, error) {
	if r.spanId != nil {
		return *r.spanId, nil
	}
...
func (r *EvaluatorEvalResult) SuccessRate(ctx context.Context) (float64, error) {
...
func (r *EvaluatorEvalResult) TotalAttempts(ctx context.Context) (int, error) {
...
type EvaluatorEvalsAcrossModels struct { // evaluator (../../../../:0:0)
	query *querybuilder.Selection
...
// test cases.
func (r *EvaluatorEvalsAcrossModels) AnalyzeAndGenerateSystemPrompt(ctx context.Context) (string, error) {
...
func (r *EvaluatorEvalsAcrossModels) Check(ctx context.Context) error {
	if r.check != nil {
		return nil
	}
	q := r.query.Select("check")
...
func (r *EvaluatorEvalsAcrossModels) Csv(ctx context.Context, opts ...EvaluatorEvalsAcrossModelsCsvOpts) (string, error) {
	if r.csv != nil {
		return *r.csv, nil
	}
...
func (r *EvaluatorEvalsAcrossModels) ModelResults(ctx context.Context) ([]EvaluatorModelResult, error) {
...
func (r *EvaluatorEvalsAcrossModels) TraceID(ctx context.Context) (string, error) {
	if r.traceId != nil {
...
type EvaluatorModelResult struct { // evaluator (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *EvaluatorModelResult) Check(ctx context.Context) error {
	if r.check != nil {
		return nil
	}
	q := r.query.Select("check")
...
func (r *EvaluatorModelResult) EvalReports(ctx context.Context) ([]EvaluatorEvalResult, error) {
...
func (r *EvaluatorModelResult) ModelName(ctx context.Context) (string, error) {
	if r.modelName != nil {
...
func (r *EvaluatorModelResult) SpanID(ctx context.Context) (string, error) {
	if r.spanId != nil {
		return *r.spanId, nil
	}
	q := r.query.Select("spanId")
...
func (r *Query) Evaluator(opts ...EvaluatorOpts) *Evaluator { // evaluator (../../../../:0:0)
...
type EvaluatorEval interface { // evaluator (../../../../:0:0)
	DaggerObject
...
func (r *EvaluatorEvalClient) Check(ctx context.Context, prompt *LLM) error {
...
func (r *EvaluatorEvalClient) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
	q := r.query.Select("name")
...
func (r *EvaluatorEvalClient) Prompt(base *LLM) *LLM {
