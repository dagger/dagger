...
func (r *Query) LoadGhaFromID(id GhaID) *Gha {
...
func (r *Query) LoadGhaJobFromID(id GhaJobID) *GhaJob {
...
func (r *Query) LoadGhaWorkflowFromID(id GhaWorkflowID) *GhaWorkflow {
