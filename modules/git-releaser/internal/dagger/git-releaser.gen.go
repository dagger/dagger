...
type GitReleaser struct { // git-releaser (../../../../:0:0)
...
func (r *GitReleaser) DryRun(ctx context.Context, sourceRepo *GitRepository, sourceTag string, destRemote string, opts ...GitReleaserDryRunOpts) error {
...
func (r *GitReleaser) Release(ctx context.Context, sourceRepo *GitRepository, sourceTag string, destRemote string, opts ...GitReleaserReleaseOpts) error {
	assertNotNil("sourceRepo", sourceRepo)
	if r.release != nil {
		return nil
	}
...
func (r *Query) GitReleaser(opts ...GitReleaserOpts) *GitReleaser { // git-releaser (../../../../:0:0)
