...
type DaggerEngineID string // dagger-engine (../../../../toolchains/engine-dev/main.go:58:6)
...
func (r *Binding) AsDaggerEngine() *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:58:6)
...
func (r *DaggerEngine) ClientDockerConfig() *Secret { // dagger-engine (../../../../toolchains/engine-dev/main.go:67:2)
...
func (r *DaggerEngine) IncrementSubnet() *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:74:1)
...
func (r *DaggerEngine) NetworkCidr(ctx context.Context) (string, error) { // dagger-engine (../../../../toolchains/engine-dev/main.go:70:1)
...
type DaggerEnginePublishOpts struct {
	...
	Image string // dagger-engine (../../../../toolchains/engine-dev/main.go:467:2)

	DryRun bool // dagger-engine (../../../../toolchains/engine-dev/main.go:472:2)

	RegistryUsername string // dagger-engine (../../../../toolchains/engine-dev/main.go:475:2)

	RegistryPassword *Secret // dagger-engine (../../../../toolchains/engine-dev/main.go:477:2)
}

// Publish all engine images to a registry
func (r *DaggerEngine) Publish(ctx context.Context, tag []string, opts ...DaggerEnginePublishOpts) error { // dagger-engine (../../../../toolchains/engine-dev/main.go:462:1)
	if r.publish != nil {
		return nil
	}
...
func (r *DaggerEngine) ReleaseDryRun(ctx context.Context) error { // dagger-engine (../../../../toolchains/engine-dev/main.go:448:1)
...
type DaggerEngineServiceOpts struct {
	GpuSupport bool // dagger-engine (../../../../toolchains/engine-dev/main.go:211:2)

	SharedCache bool // dagger-engine (../../../../toolchains/engine-dev/main.go:213:2)

	Metrics bool // dagger-engine (../../../../toolchains/engine-dev/main.go:215:2)

	Version string // dagger-engine (../../../../toolchains/engine-dev/main.go:217:2)
}

// Create a test engine service
func (r *DaggerEngine) Service(name string, opts ...DaggerEngineServiceOpts) *Service { // dagger-engine (../../../../toolchains/engine-dev/main.go:207:1)
...
func (r *DaggerEngine) WithBuildkitConfig(key string, value string) *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:84:1)
...
func (r *DaggerEngine) WithEbpfprogs(names []string) *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:79:1)
...
func (r *DaggerEngine) WithLogLevel(level string) *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:94:1)
...
func (r *DaggerEngine) WithRace() *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:89:1)
...
func (r *Env) WithDaggerEngineInput(name string, value *DaggerEngine, description string) *Env { // dagger-engine (../../../../toolchains/engine-dev/main.go:58:6)
...
func (r *Env) WithDaggerEngineOutput(name string, description string) *Env { // dagger-engine (../../../../toolchains/engine-dev/main.go:58:6)
...
func (r *Query) LoadDaggerEngineFromID(id DaggerEngineID) *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:58:6)
