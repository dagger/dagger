...
func (r *Binding) AsDaggerEngine() *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:69:6)
...
type DaggerEngine struct { // dagger-engine (../../../../toolchains/engine-dev/main.go:69:6)
...
func (r *DaggerEngine) ClientDockerConfig() *Secret { // dagger-engine (../../../../toolchains/engine-dev/main.go:79:2)
...
func (r *DaggerEngine) ConfigSchema(filename string) *File { // dagger-engine (../../../../toolchains/engine-dev/main.go:360:1)
...
type DaggerEngineContainerOpts struct {
	Platform Platform // dagger-engine (../../../../toolchains/engine-dev/main.go:154:2)

	GpuSupport bool // dagger-engine (../../../../toolchains/engine-dev/main.go:156:2)

	Version string // dagger-engine (../../../../toolchains/engine-dev/main.go:158:2)
}

// Build the engine container
func (r *DaggerEngine) Container(opts ...DaggerEngineContainerOpts) *Container { // dagger-engine (../../../../toolchains/engine-dev/main.go:150:1)
...
func (r *DaggerEngine) Generate() *Changeset { // dagger-engine (../../../../toolchains/engine-dev/main.go:375:1)
...
type DaggerEngineGraphqlSchemaOpts struct {
	Version string // dagger-engine (../../../../toolchains/engine-dev/main.go:334:2)
}

// Introspect the engine API schema, and return it as a graphql schema
func (r *DaggerEngine) GraphqlSchema(opts ...DaggerEngineGraphqlSchemaOpts) *File { // dagger-engine (../../../../toolchains/engine-dev/main.go:331:1)
...
func (r *DaggerEngine) IncrementSubnet() *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:86:1)
...
type DaggerEngineInstallClientOpts struct {
	...
	//
	Service *Service // dagger-engine (../../../../toolchains/engine-dev/main.go:276:2)

	Version string // dagger-engine (../../../../toolchains/engine-dev/main.go:278:2)
}

// Configure the given client container so that it can connect to the given engine service
func (r *DaggerEngine) InstallClient(client *Container, opts ...DaggerEngineInstallClientOpts) *Container { // dagger-engine (../../../../toolchains/engine-dev/main.go:270:1)
...
func (r *DaggerEngine) IntrospectionJSON() *File { // dagger-engine (../../../../toolchains/engine-dev/main.go:318:1)
...
func (r *DaggerEngine) IntrospectionTool() *File { // dagger-engine (../../../../toolchains/engine-dev/main.go:352:1)
...
func (r *DaggerEngine) NetworkCidr(ctx context.Context) (string, error) { // dagger-engine (../../../../toolchains/engine-dev/main.go:82:1)
...
type DaggerEnginePlaygroundOpts struct {
	...
	//
	Base *Container // dagger-engine (../../../../toolchains/engine-dev/main.go:116:2)
	//
	// Enable experimental GPU support
	//
	GpuSupport bool // dagger-engine (../../../../toolchains/engine-dev/main.go:119:2)
	//
	// Share cache globally
	//
	SharedCache bool // dagger-engine (../../../../toolchains/engine-dev/main.go:122:2)

	Metrics bool // dagger-engine (../../../../toolchains/engine-dev/main.go:124:2)

	Version string // dagger-engine (../../../../toolchains/engine-dev/main.go:126:2)
}

// Build an ephemeral environment with the Dagger CLI and engine built from source, installed and ready to use
func (r *DaggerEngine) Playground(opts ...DaggerEnginePlaygroundOpts) *Container { // dagger-engine (../../../../toolchains/engine-dev/main.go:112:1)
...
type DaggerEnginePublishOpts struct {
	...
	Image string // dagger-engine (../../../../toolchains/engine-dev/main.go:458:2)

	DryRun bool // dagger-engine (../../../../toolchains/engine-dev/main.go:463:2)

	RegistryUsername string // dagger-engine (../../../../toolchains/engine-dev/main.go:466:2)

	RegistryPassword *Secret // dagger-engine (../../../../toolchains/engine-dev/main.go:468:2)
}

// Publish all engine images to a registry
func (r *DaggerEngine) Publish(ctx context.Context, tag []string, opts ...DaggerEnginePublishOpts) error { // dagger-engine (../../../../toolchains/engine-dev/main.go:453:1)
	if r.publish != nil {
		return nil
	}
...
func (r *DaggerEngine) ReleaseDryRun(ctx context.Context) error { // dagger-engine (../../../../toolchains/engine-dev/main.go:439:1)
...
type DaggerEngineServiceOpts struct {
	GpuSupport bool // dagger-engine (../../../../toolchains/engine-dev/main.go:217:2)

	SharedCache bool // dagger-engine (../../../../toolchains/engine-dev/main.go:219:2)

	Metrics bool // dagger-engine (../../../../toolchains/engine-dev/main.go:221:2)

	Version string // dagger-engine (../../../../toolchains/engine-dev/main.go:223:2)
}

// Create a test engine service
func (r *DaggerEngine) Service(name string, opts ...DaggerEngineServiceOpts) *Service { // dagger-engine (../../../../toolchains/engine-dev/main.go:213:1)
...
func (r *DaggerEngine) Source() *Directory { // dagger-engine (../../../../toolchains/engine-dev/main.go:70:2)
...
func (r *DaggerEngine) WithEbpfprogs(names []string) *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:91:1)
...
func (r *DaggerEngine) WithEngineConfig(key string, value string) *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:96:1)
...
func (r *DaggerEngine) WithLogLevel(level string) *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:106:1)
...
func (r *DaggerEngine) WithRace() *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:101:1)
...
func (r *Env) WithDaggerEngineInput(name string, value *DaggerEngine, description string) *Env { // dagger-engine (../../../../toolchains/engine-dev/main.go:69:6)
...
func (r *Env) WithDaggerEngineOutput(name string, description string) *Env { // dagger-engine (../../../../toolchains/engine-dev/main.go:69:6)
...
type DaggerEngineOpts struct {
	...
	//
	Ws *Workspace // dagger-engine (../../../../toolchains/engine-dev/main.go:59:2)
}
