...
import (
	...
	"dagger/metrics/internal/querybuilder"
	"dagger/metrics/internal/telemetry"
)
...
func (r *Binding) AsDaggerEngine() *DaggerEngine {
...
func (r *Binding) AsDaggerEngineLoadedEngine() *DaggerEngineLoadedEngine {
...
type DaggerEngine struct { // dagger-engine (../../../../toolchains/engine-dev/main.go:58:6)
	query *querybuilder.Selection
...
func (r *DaggerEngine) ClientDockerConfig() *Secret { // dagger-engine (../../../../toolchains/engine-dev/main.go:66:2)
...
func (r *DaggerEngine) ConfigSchema(filename string) *File { // dagger-engine (../../../../toolchains/engine-dev/main.go:334:1)
...
type DaggerEngineContainerOpts struct {
	Platform Platform // dagger-engine (../../../../toolchains/engine-dev/main.go:131:2)

	GpuSupport bool // dagger-engine (../../../../toolchains/engine-dev/main.go:133:2)

	Version string // dagger-engine (../../../../toolchains/engine-dev/main.go:135:2)

	Tag string // dagger-engine (../../../../toolchains/engine-dev/main.go:137:2)
}

// Build the engine container
func (r *DaggerEngine) Container(opts ...DaggerEngineContainerOpts) *Container { // dagger-engine (../../../../toolchains/engine-dev/main.go:127:1)
	q := r.query.Select("container")
	for i := len(opts) - 1; i >= 0; i-- {
...
func (r *DaggerEngine) Generate() *Changeset { // dagger-engine (../../../../toolchains/engine-dev/main.go:348:1)
...
type DaggerEngineGraphqlSchemaOpts struct {
	Version string // dagger-engine (../../../../toolchains/engine-dev/main.go:308:2)
}

// Introspect the engine API schema, and return it as a graphql schema
func (r *DaggerEngine) GraphqlSchema(opts ...DaggerEngineGraphqlSchemaOpts) *File { // dagger-engine (../../../../toolchains/engine-dev/main.go:305:1)
...
func (r *DaggerEngine) IncrementSubnet() *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:73:1)
...
type DaggerEngineInstallClientOpts struct {
	...
	//
	Service *Service // dagger-engine (../../../../toolchains/engine-dev/main.go:253:2)
}

// Configure the given client container so that it can connect to the given engine service
func (r *DaggerEngine) InstallClient(client *Container, opts ...DaggerEngineInstallClientOpts) *Container { // dagger-engine (../../../../toolchains/engine-dev/main.go:247:1)
...
func (r *DaggerEngine) IntrospectionJSON() *File { // dagger-engine (../../../../toolchains/engine-dev/main.go:292:1)
...
func (r *DaggerEngine) IntrospectionTool() *File { // dagger-engine (../../../../toolchains/engine-dev/main.go:326:1)
...
func (r *DaggerEngine) NetworkCidr(ctx context.Context) (string, error) { // dagger-engine (../../../../toolchains/engine-dev/main.go:69:1)
...
type DaggerEnginePlaygroundOpts struct {
	...
	//
	Base *Container // dagger-engine (../../../../toolchains/engine-dev/main.go:98:2)
	//
	// Enable experimental GPU support
	//
	GpuSupport bool // dagger-engine (../../../../toolchains/engine-dev/main.go:101:2)
	//
	// Share cache globally
	//
	SharedCache bool // dagger-engine (../../../../toolchains/engine-dev/main.go:104:2)

	Metrics bool // dagger-engine (../../../../toolchains/engine-dev/main.go:106:2)
}

// Build an ephemeral environment with the Dagger CLI and engine built from source, installed and ready to use
func (r *DaggerEngine) Playground(opts ...DaggerEnginePlaygroundOpts) *Container { // dagger-engine (../../../../toolchains/engine-dev/main.go:94:1)
...
type DaggerEnginePublishOpts struct {
	...
	Image string // dagger-engine (../../../../toolchains/engine-dev/main.go:421:2)

	DryRun bool // dagger-engine (../../../../toolchains/engine-dev/main.go:426:2)

	RegistryUsername string // dagger-engine (../../../../toolchains/engine-dev/main.go:429:2)

	RegistryPassword *Secret // dagger-engine (../../../../toolchains/engine-dev/main.go:431:2)
}

// Publish all engine images to a registry
func (r *DaggerEngine) Publish(ctx context.Context, tag []string, opts ...DaggerEnginePublishOpts) error { // dagger-engine (../../../../toolchains/engine-dev/main.go:416:1)
	if r.publish != nil {
		return nil
	}
	q := r.query.Select("publish")
...
func (r *DaggerEngine) ReleaseDryRun(ctx context.Context) error { // dagger-engine (../../../../toolchains/engine-dev/main.go:402:1)
...
type DaggerEngineServiceOpts struct {
	...
	SharedCache bool // dagger-engine (../../../../toolchains/engine-dev/main.go:193:2)

	Metrics bool // dagger-engine (../../../../toolchains/engine-dev/main.go:195:2)
}

// Create a test engine service
func (r *DaggerEngine) Service(name string, opts ...DaggerEngineServiceOpts) *Service { // dagger-engine (../../../../toolchains/engine-dev/main.go:187:1)
	q := r.query.Select("service")
	for i := len(opts) - 1; i >= 0; i-- {
		// `gpuSupport` optional argument
		if !querybuilder.IsZeroValue(opts[i].GpuSupport) {
...
func (r *DaggerEngine) Source() *Directory { // dagger-engine (../../../../toolchains/engine-dev/main.go:59:2)
	q := r.query.Select("source")
...
type DaggerEngineTestTelemetryOpts struct {
	...
	// Only run these tests
	//
	Run string // dagger-engine (../../../../toolchains/engine-dev/test.go:84:2)
	//
	// Skip these tests
	//
	Skip string // dagger-engine (../../../../toolchains/engine-dev/test.go:87:2)

	Update bool // dagger-engine (../../../../toolchains/engine-dev/test.go:89:2)

	Failfast bool // dagger-engine (../../../../toolchains/engine-dev/test.go:91:2)

	Parallel int // dagger-engine (../../../../toolchains/engine-dev/test.go:93:2)

	Timeout string // dagger-engine (../../../../toolchains/engine-dev/test.go:95:2)

	Race bool // dagger-engine (../../../../toolchains/engine-dev/test.go:97:2)

	// Default: 1
	Count int // dagger-engine (../../../../toolchains/engine-dev/test.go:99:2)

	EnvFile *Secret // dagger-engine (../../../../toolchains/engine-dev/test.go:101:2)

	TestVerbose bool // dagger-engine (../../../../toolchains/engine-dev/test.go:103:2)
}

// Run telemetry tests
func (r *DaggerEngine) TestTelemetry(opts ...DaggerEngineTestTelemetryOpts) *Directory { // dagger-engine (../../../../toolchains/engine-dev/test.go:80:1)
...
func (r *DaggerEngine) WithBuildkitConfig(key string, value string) *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:78:1)
...
func (r *DaggerEngine) WithLogLevel(level string) *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:88:1)
...
func (r *DaggerEngine) WithRace() *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:83:1)
...
func (r *Env) WithDaggerEngineInput(name string, value *DaggerEngine, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithDaggerEngineLoadedEngineInput(name string, value *DaggerEngineLoadedEngine, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithDaggerEngineLoadedEngineOutput(name string, description string) *Env {
...
func (r *Env) WithDaggerEngineOutput(name string, description string) *Env {
...
// DaggerEngineOpts contains options for Client.DaggerEngine
type DaggerEngineOpts struct {
	Source *Directory // dagger-engine (../../../../toolchains/engine-dev/main.go:41:2)
	//
	...
	//
	// Default: 89
	SubnetNumber int // dagger-engine (../../../../toolchains/engine-dev/main.go:45:2)
	//
	// A docker config file with credentials to install on clients,
	// to ensure they can access private registries
	//
	ClientDockerConfig *Secret // dagger-engine (../../../../toolchains/engine-dev/main.go:49:2)
}

func (r *Client) DaggerEngine(opts ...DaggerEngineOpts) *DaggerEngine { // dagger-engine (../../../../toolchains/engine-dev/main.go:19:1)
...
func (r *Client) LoadDaggerEngineLoadedEngineFromID(id DaggerEngineLoadedEngineID) *DaggerEngineLoadedEngine {
