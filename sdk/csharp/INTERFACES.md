...
```csharp
InterfaceTypeRegistry[typeof(IProcessor)] = "Processor"  // Local interface (IProcessor -> Processor)
InterfaceTypeRegistry[typeof(ICustomInterface)] = "InterfaceExampleCustomInterface"  // Cross-module
```

**Name transformations:**

- Local interfaces: Strip 'I' prefix (`IProcessor` → `Processor`)
- Can be overridden with `[Interface(Name = "...")]` attribute
