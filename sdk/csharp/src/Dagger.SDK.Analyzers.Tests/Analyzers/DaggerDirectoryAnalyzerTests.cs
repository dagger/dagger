...
using VerifyCS = CSharpAnalyzerVerifier<DaggerDirectoryAnalyzer>;
...
public class DaggerDirectoryAnalyzerTests
{
    ...
    public async Task DirectoryParameter_WithDefaultPath_StillRequiresIgnore()
    {
        ...
        var expected = VerifyCS.Diagnostic(DirectoryParameterShouldHaveIgnore)
            .WithSpan(7, 54, 7, 60)
    ...
    public async Task DirectoryParameter_WithIgnore_StillRequiresDefaultPath()
    {
        ...
        var expected = VerifyCS.Diagnostic(DirectoryParameterShouldHaveDefaultPath)
            .WithSpan(7, 44, 7, 50)
            .WithArguments("source");
