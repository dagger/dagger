...
using VerifyCS = CSharpAnalyzerVerifier<EnumValueAnalyzer>;
...
public class EnumValueAnalyzerTests
{
    ...
    public async Task EnumMemberWithoutEnumValueAttribute_ReportsDiagnostic()
    {
        ...
        var expected = new[]
        {
            VerifyCS.Diagnostic(EnumMemberMissingEnumValueAttribute)
                .WithLocation(0)
    ...
    public async Task SingleMemberEnum_ReportsDiagnostic()
    {
        ...
        var expected = VerifyCS.Diagnostic(EnumMemberMissingEnumValueAttribute)
            .WithLocation(0)
