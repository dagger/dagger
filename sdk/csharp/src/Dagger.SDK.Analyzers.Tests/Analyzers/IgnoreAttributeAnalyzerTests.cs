...
using VerifyCS = CSharpAnalyzerVerifier<IgnoreAttributeAnalyzer>;
...
public class IgnoreAttributeAnalyzerTests
{
    ...
    public async Task IgnoreAttribute_OnNonDirectoryParameter_ReportsDiagnostic()
    {
        ...
        var expected = VerifyCS.Diagnostic(IgnoreAttributeOnInvalidParameterType)
            .WithLocation(0)
    ...
    public async Task DefaultPathAttribute_OnStringParameter_ReportsDiagnostic()
    {
        ...
        var expected = VerifyCS.Diagnostic(DefaultPathAttributeOnInvalidParameterType)
            .WithLocation(0)
            .WithArguments("source", "String");
