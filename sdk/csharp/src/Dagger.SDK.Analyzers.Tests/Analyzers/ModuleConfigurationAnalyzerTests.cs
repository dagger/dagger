...
using VerifyCS = CSharpAnalyzerVerifier<ModuleConfigurationAnalyzer>;
...
public class ModuleConfigurationAnalyzerTests
{
    ...
    public async Task MissingDaggerJson_ReportsDiagnostic()
    {
        ...
        var expected = VerifyCS.Diagnostic(MissingDaggerJson)
            .WithSpan(4, 14, 4, 22)
            .WithArguments("/0");
    ...
    public async Task DaggerJsonPresent_NoDiagnostic()
    {
        ...
        var expected = VerifyCS.Diagnostic(ProjectFileNameMismatch)
            .WithSpan(4, 14, 4, 22)
    ...
    [TestMethod]
    public async Task MultipleObjectClasses_AllMustMatch()
    {
        var test = """
            using Dagger;
