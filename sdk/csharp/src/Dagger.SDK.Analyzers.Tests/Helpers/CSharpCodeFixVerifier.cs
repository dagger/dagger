    ...
    where TCodeFix : CodeFixProvider, new()
{
    ...
    /// <summary>
    /// Normalizes line endings to <see cref="Environment.NewLine"/> to ensure consistent behavior
    /// across platforms. Roslyn code fixes generate trivia using the platform's line ending
    /// convention, so test strings must match.
    /// </summary>
