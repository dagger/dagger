...
public class CustomReturnTypeAnalyzer : DiagnosticAnalyzer
{
    ...
    private void AnalyzeMethod(SyntaxNodeAnalysisContext context)
    {
        ...
        var hasFunctionAttribute = methodSymbol.GetAttributes().Any(attr =>
        ...
        {
            if (namedReturnType.OriginalDefinition.ToDisplayString() == "System.Collections.Generic.List<T>" ||
                namedReturnType.OriginalDefinition.ToDisplayString() == "System.Collections.Generic.IEnumerable<T>")
            {
        ...
        var hasObjectAttribute = returnType.GetAttributes().Any(attr =>
