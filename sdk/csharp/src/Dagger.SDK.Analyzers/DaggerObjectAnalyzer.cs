...
{
    private static readonly Regex CacheValueRegex = new(
        @"^(\d+[smhd])+$",
    ...
    public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics =>
        [
            ...
            DiagnosticDescriptors.MultiplePublicConstructors,
            DiagnosticDescriptors.FieldPropertyMustHaveSetter,
        ];
    ...
    private void AnalyzeClassDeclaration(SyntaxNodeAnalysisContext context)
    {
        ...
        // Check for multiple public constructors
        var publicConstructors = classSymbol
            .Constructors.Where(c => c.DeclaredAccessibility == Accessibility.Public && !c.IsStatic)
            .ToList();
    ...
    )
    {
        ...
        // Check if property has [Function] attribute
        var hasFunctionAttribute = propertySymbol
            .GetAttributes()
            .Any(attr =>
                IsAttributeType(attr, "Dagger", "FunctionAttribute")
                || IsAttributeType(attr, "Dagger", "Function")
        ...
        if (hasFunctionAttribute)
        {
            ...
            // Check for setter (required for Dagger serialization)
    ...
    private static bool IsValidCacheValue(string cacheValue)
    {
        ...
        return CacheValueRegex.IsMatch(cacheValue);
    }
