...
public static class DiagnosticDescriptors
{
    ...
    public static readonly DiagnosticDescriptor FieldPropertyMustHaveSetter = new(
        ...
        messageFormat: "Property '{0}' marked with [Field] must have a setter (can be private) for Dagger serialization to work correctly",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true,
        description: "Properties marked with [Field] require a setter (can be 'private set') for Dagger's serialization/deserialization to work when objects are passed between function calls. Without a setter, you'll get 'Property set method not found' runtime errors."
    );
}
