...
public static class ModuleRuntime
{
    ...
    /// <remarks>
    /// To enable debugging:
    ///   1. Add <c>ModuleRuntime.ConfigureLogging(true)</c> in your Program.cs before RunAsync
    ...
    public static void ConfigureLogging(bool enabled)
    {
        ...
        if (enabled)
        {
            Console.Error.WriteLine("[DEBUG] Dagger.Runtime: Debug logging ENABLED");
        }
    }
    ...
    private static void DebugLog(string message)
    {
        if (_debugEnabled)
        {
            ...
            Console.Error.WriteLine($"[DEBUG] Dagger.Runtime: {message}");
            try
            {
