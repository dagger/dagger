...
internal static class TracePropagation
{
    ...
    /// <summary>
    /// Parses the TRACEPARENT value into an ActivityContext for OpenTelemetry SDK integration.
    /// </summary>
    /// <returns>An ActivityContext if TRACEPARENT is set and valid, null otherwise.</returns>
    public static ActivityContext? ParseActivityContext()
    {
        Initialize();
        return TelemetryExtensions.ParseTraceParent(_traceParent);
    }
