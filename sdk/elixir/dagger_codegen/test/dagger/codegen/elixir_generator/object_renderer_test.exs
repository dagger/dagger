defmodule Dagger.Codegen.ElixirGenerator.ObjectRendererTest do
  ...
  test "id handle loads its expected type" do
    auto_assert(
      """
      # This file generated by `dagger_codegen`. Please DO NOT EDIT.
      defmodule Dagger.LLM do
        ...
        @doc \"""
        Spawn the conversation as an agent.
        \"""
        @spec spawn(t()) :: {:ok, Dagger.Agent.t()} | {:error, term()}
        def spawn(%__MODULE__{} = llm) do
          query_builder =
            llm.query_builder |> QB.select("spawn")
      ...
      """ <- render_type(ObjectRenderer, "test/fixtures/objects/id-handle.json")
    )
  end

  test "id handle keeps the raw id before the cutover" do
    auto_assert(
      """
      # This file generated by `dagger_codegen`. Please DO NOT EDIT.
      defmodule Dagger.LLM do
        ...
        Spawn the conversation as an agent.
        \"""
        @spec spawn(t()) :: {:ok, String.t()} | {:error, term()}
        def spawn(%__MODULE__{} = llm) do
          query_builder =
            llm.query_builder |> QB.select("spawn")
