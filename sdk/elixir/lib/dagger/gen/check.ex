...
defmodule Dagger.Check do
  ...
  """
  @spec context(t()) :: {:ok, String.t()} | {:error, term()}
  def context(%__MODULE__{} = check) do
    query_builder =
      check.query_builder |> QB.select("context")
  ...
  """
  @spec full_name(t()) :: {:ok, String.t()} | {:error, term()}
  def full_name(%__MODULE__{} = check) do
    query_builder =
      check.query_builder |> QB.select("fullName")

    Client.execute(check.client, query_builder)
  end

  @spec function_name(t()) :: {:ok, String.t()} | {:error, term()}
  def function_name(%__MODULE__{} = check) do
    query_builder =
      check.query_builder |> QB.select("functionName")
  ...
  def module_name(%__MODULE__{} = check) do
    query_builder =
      check.query_builder |> QB.select("moduleName")
