...
defmodule Dagger.Check do
  ...
  """
  @spec id(t(), [{:recipe, boolean()}]) :: {:ok, Dagger.CheckID.t()} | {:error, term()}
  def id(%__MODULE__{} = check, optional_args \\ []) do
    query_builder =
      check.query_builder |> QB.select("id") |> QB.maybe_put_arg("recipe", optional_args[:recipe])
