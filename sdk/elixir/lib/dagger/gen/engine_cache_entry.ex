...
defmodule Dagger.EngineCacheEntry do
  ...
  """
  @spec id(t(), [{:recipe, boolean()}]) :: {:ok, Dagger.EngineCacheEntryID.t()} | {:error, term()}
  def id(%__MODULE__{} = engine_cache_entry, optional_args \\ []) do
    query_builder =
      engine_cache_entry.query_builder
      |> QB.select("id")
