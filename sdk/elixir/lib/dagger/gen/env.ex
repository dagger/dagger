...
defmodule Dagger.Env do
  ...
  """
  @spec with_module_codegen_config_input(
          t(),
          String.t(),
          Dagger.ModuleCodegenConfig.t(),
          String.t()
        ) :: Dagger.Env.t()
  def with_module_codegen_config_input(%__MODULE__{} = env, name, value, description) do
    query_builder =
      env.query_builder
      |> QB.select("withModuleCodegenConfigInput")
      |> QB.put_arg("name", name)
      |> QB.put_arg("value", Dagger.ID.id!(value))
      |> QB.put_arg("description", description)
  ...
  """
  @spec with_module_codegen_config_output(t(), String.t(), String.t()) :: Dagger.Env.t()
  def with_module_codegen_config_output(%__MODULE__{} = env, name, description) do
    query_builder =
      env.query_builder
      |> QB.select("withModuleCodegenConfigOutput")
      |> QB.put_arg("name", name)
      |> QB.put_arg("description", description)
