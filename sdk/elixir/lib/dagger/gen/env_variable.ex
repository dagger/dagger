...
defmodule Dagger.EnvVariable do
  ...
  """
  @spec id(t(), boolean()) :: {:ok, Dagger.EnvVariableID.t()} | {:error, term()}
  def id(%__MODULE__{} = env_variable, recipe) do
    query_builder =
      env_variable.query_builder |> QB.select("id") |> QB.put_arg("recipe", recipe)
