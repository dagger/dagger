...
defmodule Dagger.Generator do
  ...
  """
  @spec id(t(), boolean()) :: {:ok, Dagger.GeneratorID.t()} | {:error, term()}
  def id(%__MODULE__{} = generator, recipe) do
    query_builder =
      generator.query_builder |> QB.select("id") |> QB.put_arg("recipe", recipe)
