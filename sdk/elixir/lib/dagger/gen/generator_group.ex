...
defmodule Dagger.GeneratorGroup do
  ...
  """
  @spec id(t(), [{:recipe, boolean()}]) :: {:ok, Dagger.GeneratorGroupID.t()} | {:error, term()}
  def id(%__MODULE__{} = generator_group, optional_args \\ []) do
    query_builder =
      generator_group.query_builder
      |> QB.select("id")
...
defimpl Nestru.Decoder, for: Dagger.GeneratorGroup do
  def decode_fields_hint(_struct, _context, id) do
    {:ok, Dagger.Client.load_generator_group_from_id(Dagger.Global.dag(), id)}
  end
end
