...
defmodule Dagger.HealthcheckConfig do
  ...
  @spec id(t(), [{:recipe, boolean()}]) ::
          {:ok, Dagger.HealthcheckConfigID.t()} | {:error, term()}
  def id(%__MODULE__{} = healthcheck_config, optional_args \\ []) do
    query_builder =
      healthcheck_config.query_builder
      |> QB.select("id")
...
defimpl Nestru.Decoder, for: Dagger.HealthcheckConfig do
  def decode_fields_hint(_struct, _context, id) do
    {:ok, Dagger.Client.load_healthcheck_config_from_id(Dagger.Global.dag(), id)}
  end
end
