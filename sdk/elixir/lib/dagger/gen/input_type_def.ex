...
defmodule Dagger.InputTypeDef do
  ...
  """
  @spec id(t(), boolean()) :: {:ok, Dagger.InputTypeDefID.t()} | {:error, term()}
  def id(%__MODULE__{} = input_type_def, recipe) do
    query_builder =
      input_type_def.query_builder |> QB.select("id") |> QB.put_arg("recipe", recipe)
