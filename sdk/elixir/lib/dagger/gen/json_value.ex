...
defmodule Dagger.JSONValue do
  ...
  """
  @spec bytes(t(), [{:pretty, boolean() | nil}, {:indent, integer() | nil}]) ::
          {:ok, Dagger.JSON.t()} | {:error, term()}
  def bytes(%__MODULE__{} = json_value, optional_args \\ []) do
    query_builder =
  ...
  """
  @spec with_bytes(t(), Dagger.JSON.t()) :: Dagger.JSONValue.t()
  def with_bytes(%__MODULE__{} = json_value, bytes) do
    query_builder =
      json_value.query_builder |> QB.select("withBytes") |> QB.put_arg("bytes", bytes)
