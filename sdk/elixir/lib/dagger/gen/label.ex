...
defmodule Dagger.Label do
  ...
  """
  @spec id(t(), [{:recipe, boolean()}]) :: {:ok, Dagger.LabelID.t()} | {:error, term()}
  def id(%__MODULE__{} = label, optional_args \\ []) do
    query_builder =
      label.query_builder |> QB.select("id") |> QB.maybe_put_arg("recipe", optional_args[:recipe])
