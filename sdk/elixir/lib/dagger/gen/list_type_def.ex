...
defmodule Dagger.ListTypeDef do
  ...
  """
  @spec id(t(), boolean()) :: {:ok, Dagger.ListTypeDefID.t()} | {:error, term()}
  def id(%__MODULE__{} = list_type_def, recipe) do
    query_builder =
      list_type_def.query_builder |> QB.select("id") |> QB.put_arg("recipe", recipe)
