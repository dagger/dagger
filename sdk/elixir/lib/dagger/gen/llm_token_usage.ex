...
defmodule Dagger.LLMTokenUsage do
  ...
  """
  @spec id(t(), boolean()) :: {:ok, Dagger.LLMTokenUsageID.t()} | {:error, term()}
  def id(%__MODULE__{} = llm_token_usage, recipe) do
    query_builder =
      llm_token_usage.query_builder |> QB.select("id") |> QB.put_arg("recipe", recipe)
