  ...
  (
    ...
    def dependencies(%__MODULE__{} = module) do
      ...
      selection =
        select(
          selection,
          "dependencies dependencyConfig description generatedSourceDirectory id initialize interfaces name objects sdk serve source withDependencies withInterface withName withObject withSDK withSource"
        )
