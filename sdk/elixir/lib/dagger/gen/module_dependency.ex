...
defimpl Jason.Encoder, for: Dagger.ModuleDependency do
  def encode(module_dependency, opts) do
    {:ok, id} = Dagger.ModuleDependency.id(module_dependency)
    Jason.Encode.string(id, opts)
  end
end

defimpl Nestru.Decoder, for: Dagger.ModuleDependency do
  def decode_fields_hint(_struct, _context, id) do
    {:ok, Dagger.Client.load_module_dependency_from_id(Dagger.Global.dag(), id)}
  end
end
