...
defmodule Dagger.SourceMap do
  ...
  """
  @spec id(t(), boolean()) :: {:ok, Dagger.SourceMapID.t()} | {:error, term()}
  def id(%__MODULE__{} = source_map, recipe) do
    query_builder =
      source_map.query_builder |> QB.select("id") |> QB.put_arg("recipe", recipe)
