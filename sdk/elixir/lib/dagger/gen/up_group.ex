...
defmodule Dagger.UpGroup do
  ...
  """
  @spec id(t(), boolean()) :: {:ok, Dagger.UpGroupID.t()} | {:error, term()}
  def id(%__MODULE__{} = up_group, recipe) do
    query_builder =
      up_group.query_builder |> QB.select("id") |> QB.put_arg("recipe", recipe)
...
defimpl Nestru.Decoder, for: Dagger.UpGroup do
  def decode_fields_hint(_struct, _context, id) do
    {:ok, Dagger.Client.load_up_group_from_id(Dagger.Global.dag(), id)}
  end
end
