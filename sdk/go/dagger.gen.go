...
// SshfsVolumeOpts contains options for Client.SshfsVolume
...
func (r *Client) SshfsVolume(endpoint string, privateKey *Secret, publicKey *Secret, opts ...SshfsVolumeOpts) *Volume {
