...
func (v ChangesetMergeConflict) Name() string {
	...
	case ChangesetMergeConflictSkip:
		return "SKIP"
	case ChangesetMergeConflictPreferSelf:
		return "PREFER_SELF"
	case ChangesetMergeConflictPreferOther:
		return "PREFER_OTHER"
	default:
		return ""
	}
...
func (v *ChangesetMergeConflict) UnmarshalJSON(dt []byte) error {
	...
	case "PREFER_OTHER":
		*v = ChangesetMergeConflictPreferOther
	case "PREFER_SELF":
		*v = ChangesetMergeConflictPreferSelf
	case "SKIP":
...
const (
	...
	ChangesetMergeConflictPreferSelf ChangesetMergeConflict = "PREFER_SELF"

	// The conflict is resolved by applying the version of the other changeset
	ChangesetMergeConflictPreferOther ChangesetMergeConflict = "PREFER_OTHER"
)
