...
func (r *Container) OriginalAddress() *Address {
	q := r.query.Select("originalAddress")
...
func (r *Directory) OriginalAddress() *Address {
	q := r.query.Select("originalAddress")
...
// The address this directory was originally loaded from, if any
func (r *File) OriginalAddress() *Address {
	q := r.query.Select("originalAddress")
...
func (r *GitRef) OriginalAddress() *Address {
	q := r.query.Select("originalAddress")
...
func (r *GitRepository) OriginalAddress() *Address {
	q := r.query.Select("originalAddress")
...
// The address this directory was originally loaded from, if any
func (r *Secret) OriginalAddress() *Address {
	q := r.query.Select("originalAddress")
...
func (r *Service) OriginalAddress() *Address {
	q := r.query.Select("originalAddress")
