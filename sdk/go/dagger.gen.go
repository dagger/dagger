...
func (r *Query) LoadLLMContentBlockFromID(id LLMContentBlockID) *LLMContentBlock {
...
func (r *Query) LoadLLMMessageFromID(id LLMMessageID) *LLMMessage {
...
func (r *Query) LoadLLMToolCallFromID(id LLMToolCallID) *LLMToolCall {
