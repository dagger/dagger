...
func (r *EnvFile) Variable(ctx context.Context, name string) (string, error) {
	if r.variable != nil {
		return *r.variable, nil
	}
	q := r.query.Select("variable")
	q = q.Arg("name", name)
