...
func serveBoundModule(ctx context.Context, client *Client) error {
	return client.
		CurrentWorkspace().
		ModuleSource("/toolchains/cli-dev").
		AsModule().
		Serve(ctx)
}
