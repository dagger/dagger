...
// GoMod contains the embedded go.mod file of the Go SDK.
var GoMod = []byte(`module dagger.io/dagger
...
// GoSum contains the embedded go.sum file of the Go SDK.
var GoSum = []byte(`github.com/99designs/gqlgen v0.17.89 h1:KzEcxPiMgQoMw3m/E85atUEHyZyt0PbAflMia5Kw8z8=
