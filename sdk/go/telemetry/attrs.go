...
const (
	...
	// Optional serialized object state payload for the object referenced by
	// DagOutputAttr.
	//
	// Encoding is defined by DagOutputStateVersionAttr. Receivers should treat
	// this as optional and tolerate missing payloads.
