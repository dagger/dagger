        ...
        + " set to null.")
                ...
                .withConstructor(
                    dag.function("New",
                        ...
                        .withArg("version", dag.typeDef().withKind(TypeDefKind.STRING_KIND).withOptional(true), new Function.WithArgArguments().withDescription("Go version").withDefaultValue(JSON.from("\"1.23.2\"")))));
    return module.id();
  }
    ...
    try (var jsonb = JsonbBuilder.create()) {
      if (parentName.equals("DaggerJava")) {
        if (fnName.equals("containerEcho")) {
          ...
          DaggerJava res = new DaggerJava(dag, source, version);
          return JsonConverter.toJSON(res);
