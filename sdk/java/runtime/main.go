	...
	return m.finalJar(ctx,
		ctr.
			WithExec(append([]string{
				"javac",
				"-cp", "/root/.m2/repository/io/dagger/dagger-java-annotation-processor/0.18.9-self-test-module/dagger-java-annotation-processor-0.18.9-self-test-module-all.jar",
