...
final class PhpSdkDev
{
    ...
    public function test(
        ...
        return $this->base($this->source)->withExec(
    ...
    {
        return $this->base($this->source)->withExec(['phpcs']);
    }
    ...
    {
        $result = $this->base($this->source)->withExec(
            args: ['phpcbf'],
        ...
        $original = $this->base($this->source)->directory(self::SDK_ROOT);
    ...
    {
        $result = dag()->alwaysExec()->exec($this->base($this->source), ['phpcbf']);
