...
class GeneratorGroup extends Client\AbstractObject implements Client\IdAble
{
     ...
     */
    public function changes(?bool $continueOnConflicts = false): Changeset
    {
     ...
     */
    public function isEmpty(?bool $continueOnConflicts = false): bool
    {
        $leafQueryBuilder = new \Dagger\Client\QueryBuilder('isEmpty');
        if (null !== $continueOnConflicts) {
        $leafQueryBuilder->setArgument('continueOnConflicts', $continueOnConflicts);
        }
