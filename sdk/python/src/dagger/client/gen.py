...
class JSONValue(Type):
    ...
    async def get_bool(self, path: str) -> bool:
        ...
        _ctx = self._select("getBool", _args)
        return await _ctx.execute(bool)

    async def get_int(self, path: str) -> int:
        ...
        _ctx = self._select("getInt", _args)
        return await _ctx.execute(int)

    async def get_json(self, path: str) -> JSON:
        ...
        _ctx = self._select("getJSON", _args)
        return await _ctx.execute(JSON)
    ...
    def set_boolean(self, path: str, value: bool) -> Self:
        """Set a boolean value at the specified path."""
        _args = [
            Arg("path", path),
            Arg("value", value),
        ]
        _ctx = self._select("setBoolean", _args)
        return JSONValue(_ctx)

    def set_integer(self, path: str, value: int) -> Self:
        """Set an integer value at the specified path."""
        _args = [
            Arg("path", path),
            Arg("value", value),
        ]
        _ctx = self._select("setInteger", _args)
        return JSONValue(_ctx)

    def set_json(self, path: str, value: JSON) -> Self:
        """Set a value as raw JSON at the specified path"""
        _args = [
            Arg("path", path),
            Arg("value", value),
        ]
        _ctx = self._select("setJSON", _args)
        return JSONValue(_ctx)

    def set_string(self, path: str, value: str) -> Self:
