...
class EnvironmentFunctionID(Scalar):
...
class EnvironmentShellID(Scalar):
...
class Environment(Type):
    ...
    def shell(self, name: str) -> "EnvironmentShell":
        ...
        return EnvironmentShell(_ctx)

    @typecheck
    async def shells(self) -> list["EnvironmentShell"]:
        """TODO"""
        _args: list[Arg] = []
        _ctx = self._select("shells", _args)
        _ctx = EnvironmentShell(_ctx)._select_multiple(
            _description="description",
            _endpoint="endpoint",
            _name="name",
        )
    ...
    @typecheck
    def with_function(self, id: "EnvironmentFunction") -> "Environment":
        """TODO"""
        _args = [
            Arg("id", id),
        ]
    ...
    @typecheck
    def with_shell(self, id: "EnvironmentShell") -> "Environment":
        """TODO"""
        _args = [
            Arg("id", id),
        ]
...
class EnvironmentFunction(Type):
    """TODO"""

    @typecheck
    async def args(self) -> list["EnvironmentFunctionArg"]:
        """TODO"""
        _args: list[Arg] = []
        _ctx = self._select("args", _args)
        _ctx = EnvironmentFunctionArg(_ctx)._select_multiple(
            _arg_type="argType",
            _description="description",
            _is_list="isList",
            _name="name",
        )
        return await _ctx.execute(list[EnvironmentFunctionArg])
    ...
    @typecheck
    async def id(self) -> EnvironmentFunctionID:
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(EnvironmentFunctionID)
    ...
    def with_arg(
        ...
        *,
        ...
        return EnvironmentFunction(_ctx)

    @typecheck
    def with_description(self, description: str) -> "EnvironmentFunction":
        """TODO"""
        _args = [
            Arg("description", description),
        ]
    ...
    @typecheck
    def with_name(self, name: str) -> "EnvironmentFunction":
        """TODO"""
        _args = [
            Arg("name", name),
        ]
    ...
    @typecheck
    def with_result_type(self, name: str) -> "EnvironmentFunction":
        """TODO"""
        _args = [
            Arg("name", name),
        ]
    ...
    def with_(
        self, cb: Callable[["EnvironmentFunction"], "EnvironmentFunction"]
    ) -> "EnvironmentFunction":
        """Call the provided callable with current EnvironmentFunction.
...
class EnvironmentFunctionArg(Type):
    """TODO"""
    ...
    _arg_type: Optional[str]
    _description: Optional[str]
    _is_list: Optional[bool]
    _name: Optional[str]

    @typecheck
    async def arg_type(self) -> str:
        """TODO, should be enum
        ...
        QueryError
            If the API returns an error.
        """
        if hasattr(self, "_arg_type"):
            return self._arg_type
        _args: list[Arg] = []
        _ctx = self._select("argType", _args)
        return await _ctx.execute(str)
...
class EnvironmentShell(Type):
    ...
    @typecheck
    async def flags(self) -> list["EnvironmentShellFlag"]:
        """Flags accepted by this shell."""
        _args: list[Arg] = []
        _ctx = self._select("flags", _args)
        _ctx = EnvironmentShellFlag(_ctx)._select_multiple(
            _description="description",
            _name="name",
        )
        return await _ctx.execute(list[EnvironmentShellFlag])

    @typecheck
    async def id(self) -> EnvironmentShellID:
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(EnvironmentShellID)
    ...
    @typecheck
    def set_string_flag(self, name: str, value: str) -> "EnvironmentShell":
        """TODO"""
        _args = [
            Arg("name", name),
            Arg("value", value),
    ...
    @typecheck
    def with_description(self, description: str) -> "EnvironmentShell":
        """TODO"""
        _args = [
            Arg("description", description),
        ]
    ...
    @typecheck
    def with_name(self, name: str) -> "EnvironmentShell":
        """TODO"""
        _args = [
            Arg("name", name),
        ]
    ...
    def with_(
        self, cb: Callable[["EnvironmentShell"], "EnvironmentShell"]
    ) -> "EnvironmentShell":
        """Call the provided callable with current EnvironmentShell.
...
class EnvironmentShellFlag(Type):
...
class Client(Root):
    ...
    def environment_function(
        self,
        *,
        id: Optional[EnvironmentFunctionID] = None,
    ) -> EnvironmentFunction:
        """Load a environment function from ID."""
        _args = [
            Arg("id", id, None),
        ]
        _ctx = self._select("environmentFunction", _args)
        return EnvironmentFunction(_ctx)
    ...
    def environment_shell(
        self,
        *,
        id: Optional[EnvironmentShellID] = None,
    ) -> EnvironmentShell:
        """Load a environment shell from ID."""
        _args = [
            Arg("id", id, None),
        ]
        _ctx = self._select("environmentShell", _args)
        return EnvironmentShell(_ctx)
    ...
    @typecheck
    async def load_universe(self) -> bool:
        """TODO: temp hack, should make each env load lazily (with some cache
        backend too)
        ...
        """
        _args: list[Arg] = []
        _ctx = self._select("loadUniverse", _args)
        return await _ctx.execute(bool)
...
__all__ = [
    ...
    "EnvironmentCommandID",
    "EnvironmentFunction",
    "EnvironmentFunctionArg",
    "EnvironmentFunctionID",
    "EnvironmentID",
    "EnvironmentShell",
    "EnvironmentShellFlag",
    "EnvironmentShellID",
    "Extensions",
    "File",
    "FileID",
