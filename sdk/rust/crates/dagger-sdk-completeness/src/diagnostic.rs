...
diagnostic_codes! {
    ...
    CapabilityBindingMissing => "CAPABILITY_BINDING_MISSING",
    CapabilityBindingDuplicate => "CAPABILITY_BINDING_DUPLICATE",
    CapabilityMappingInvalid => "CAPABILITY_MAPPING_INVALID",
    CapabilityEvidenceIncomplete => "CAPABILITY_EVIDENCE_INCOMPLETE",
    ...
    ConformanceCoverageIncomplete => "CONFORMANCE_COVERAGE_INCOMPLETE",
