...
impl Binding {
    ...
    pub async fn as_string(&self) -> Result<Option<String>, DaggerError> {
...
impl Container {
    ...
    ) -> Result<Option<String>, DaggerError> {
    ...
    pub async fn label(&self, name: impl Into<String>) -> Result<Option<String>, DaggerError> {
    ...
    ///
    /// * `opt` - optional argument, see inner type for documentation, use <func>_opts to use
    pub async fn up(&self) -> Result<Option<Void>, DaggerError> {
    ...
    ///
    /// * `opt` - optional argument, see inner type for documentation, use <func>_opts to use
    pub async fn up_opts<'a>(
        &self,
        opts: ContainerUpOpts<'a>,
    ) -> Result<Option<Void>, DaggerError> {
        let mut query = self.selection.select("up");
...
impl EngineCache {
    ...
    ///
    /// * `opt` - optional argument, see inner type for documentation, use <func>_opts to use
    pub async fn prune(&self) -> Result<Option<Void>, DaggerError> {
...
impl EnumValueTypeDef {
    ...
    pub async fn deprecated(&self) -> Result<Option<String>, DaggerError> {
...
impl FunctionCall {
    ...
    pub async fn return_value(&self, value: Json) -> Result<Option<Void>, DaggerError> {
...
impl GitRepository {
    ...
    pub async fn url(&self) -> Result<Option<String>, DaggerError> {
...
impl Host {
    ...
    /// * `opt` - optional argument, see inner type for documentation, use <func>_opts to use
    pub async fn find_up(&self, name: impl Into<String>) -> Result<Option<String>, DaggerError> {
        let mut query = self.selection.select("findUp");
...
impl Module {
    ...
    ///
    /// * `opt` - optional argument, see inner type for documentation, use <func>_opts to use
    pub async fn serve(&self) -> Result<Option<Void>, DaggerError> {
    ...
    ///
    /// * `opt` - optional argument, see inner type for documentation, use <func>_opts to use
    pub async fn serve_opts(&self, opts: ModuleServeOpts) -> Result<Option<Void>, DaggerError> {
        let mut query = self.selection.select("serve");
...
impl Port {
    ...
    pub async fn description(&self) -> Result<Option<String>, DaggerError> {
        let mut query = self.selection.select("description");
...
impl Service {
    ...
    ///
    /// * `opt` - optional argument, see inner type for documentation, use <func>_opts to use
    pub async fn up_opts(&self, opts: ServiceUpOpts) -> Result<Option<Void>, DaggerError> {
        let mut query = self.selection.select("up");
...
impl Stat {
    /// file type
    pub async fn file_type(&self) -> Result<Option<FileType>, DaggerError> {
