...
export type ContainerWithVolumeMountOpts = {
  /**
 ...
 * A unique identifier for an object.
 */
export type WorkspaceModuleSettingID = string & {
  __WorkspaceModuleSettingID: never
}
...
export class Container extends BaseClient {
  ...
  withVolumeMount = (
    ...
    const ctx = this._ctx.select("withVolumeMount", { path, volume, ...opts })
    return new Container(ctx)
  }
...
export class Client extends BaseClient {
   ...
   */
  loadWorkspaceModuleSettingFromID = (
    id: WorkspaceModuleSettingID,
  ): WorkspaceModuleSetting => {
    const ctx = this._ctx.select("loadWorkspaceModuleSettingFromID", { id })
    return new WorkspaceModuleSetting(ctx)
  }
   ...
   * @param privateKey The private key secret to use for authentication.
   * @param publicKey The public key secret to use for authentication.
