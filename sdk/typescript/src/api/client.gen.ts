...
function ChangesetMergeConflictValueToName(
  ...
  switch (value) {
    case ChangesetMergeConflict.Fail:
      return "FAIL"
    case ChangesetMergeConflict.PreferOther:
      return "PREFER_OTHER"
    case ChangesetMergeConflict.PreferSelf:
      return "PREFER_SELF"
...
function ChangesetMergeConflictNameToValue(
  ...
  switch (name) {
    ...
    case "PREFER_OTHER":
      return ChangesetMergeConflict.PreferOther
    case "PREFER_SELF":
      return ChangesetMergeConflict.PreferSelf
    case "SKIP":
