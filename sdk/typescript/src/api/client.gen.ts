...
// Re-exported so consumers that previously did
// `import { BaseClient } from "./client.gen.js"` keep working. The class
// itself now lives in the SDK runtime (../common/context.ts) to avoid
// ESM cycles when per-dep generated files extend it.
export { BaseClient }
