...
type FlusherClient interface {
	Flush(ctx context.Context, in *TelemetryRequest, opts ...grpc.CallOption) (*FlushResponse, error)
}
...
func (c *flusherClient) Flush(ctx context.Context, in *TelemetryRequest, opts ...grpc.CallOption) (*FlushResponse, error) {
...
type FlusherServer interface {
	Flush(context.Context, *TelemetryRequest) (*FlushResponse, error)
...
func (UnimplementedFlusherServer) Flush(context.Context, *TelemetryRequest) (*FlushResponse, error) {
...
func _Flusher_Flush_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FlusherServer).Flush(ctx, req.(*TelemetryRequest))
	}
