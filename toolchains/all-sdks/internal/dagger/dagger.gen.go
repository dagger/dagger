...
import (
	...
	"dagger/all-sdks/internal/querybuilder"
	"dagger/all-sdks/internal/telemetry"
)
...
func (r *Binding) AsJavaSDKDev() *JavaSDKDev {
...
func (r *Env) WithJavaSDKDevInput(name string, value *JavaSDKDev, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithJavaSDKDevOutput(name string, description string) *Env {
...
func (r *JavaSDKDev) Bump(version string) *Changeset {
	q := r.query.Select("bump")
	q = q.Arg("version", version)
...
func (r *JavaSDKDev) BumpDeps() *Changeset {
...
func (r *JavaSDKDev) CheckDeps(ctx context.Context) error {
	if r.checkDeps != nil {
		return nil
	}
...
// Format the Java SDK
func (r *JavaSDKDev) Fmt() *Changeset {
...
// Lint the Java SDK
func (r *JavaSDKDev) Lint(ctx context.Context) error {
	if r.lint != nil {
		return nil
	}
	q := r.query.Select("lint")
...
func (r *JavaSDKDev) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
	q := r.query.Select("name")
...
func (r *JavaSDKDev) Release(ctx context.Context, sourceTag string) error {
	if r.release != nil {
		return nil
	}
	q := r.query.Select("release")
...
// Check that releasing works, without actually releasing
func (r *JavaSDKDev) ReleaseDryRun(ctx context.Context, opts ...JavaSDKDevReleaseDryRunOpts) error {
	if r.releaseDryRun != nil {
		return nil
	}
	q := r.query.Select("releaseDryRun")
...
func (r *JavaSDKDev) Source() *Directory {
	q := r.query.Select("source")
...
// The path of the SDK in the workspace
func (r *JavaSDKDev) SourcePath(ctx context.Context) (string, error) {
	if r.sourcePath != nil {
		return *r.sourcePath, nil
	}
	q := r.query.Select("sourcePath")
...
// Test the Java SDK
func (r *JavaSDKDev) Test(ctx context.Context) error {
	if r.test != nil {
		return nil
	}
	q := r.query.Select("test")
...
// Workspace with all the files needed to develop the SDK.
func (r *JavaSDKDev) Workspace() *Directory {
	q := r.query.Select("workspace")
...
// JavaSDKDevOpts contains options for Client.JavaSDKDev
...
func (r *Client) JavaSDKDev(opts ...JavaSDKDevOpts) *JavaSDKDev {
...
func (r *Client) LoadJavaSDKDevFromID(id JavaSDKDevID) *JavaSDKDev {
