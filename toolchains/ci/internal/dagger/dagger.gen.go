...
func (r *Binding) AsGhaJob() *GhaJob {
...
func (r *Binding) AsGhaWorkflow() *GhaWorkflow {
...
func (r *Env) WithGhaInput(name string, value *Gha, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithGhaJobInput(name string, value *GhaJob, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithGhaJobOutput(name string, description string) *Env {
...
func (r *Env) WithGhaOutput(name string, description string) *Env {
...
func (r *Env) WithGhaWorkflowInput(name string, value *GhaWorkflow, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithGhaWorkflowOutput(name string, description string) *Env {
...
func (r *Client) LoadGhaFromID(id GhaID) *Gha {
...
func (r *Client) LoadGhaJobFromID(id GhaJobID) *GhaJob {
...
func (r *Client) LoadGhaWorkflowFromID(id GhaWorkflowID) *GhaWorkflow {
