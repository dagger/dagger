...
func (r *Binding) AsDocusaurus() *Docusaurus {
...
func (r *Env) WithDocusaurusInput(name string, value *Docusaurus, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithDocusaurusOutput(name string, description string) *Env {
...
// DocusaurusOpts contains options for Client.Docusaurus
...
func (r *Client) Docusaurus(src *Directory, opts ...DocusaurusOpts) *Docusaurus { // docusaurus (../../../../toolchains/docs-dev/docusaurus/dagger/main.go:27:1)
...
func (r *Client) LoadDocusaurusFromID(id DocusaurusID) *Docusaurus {
