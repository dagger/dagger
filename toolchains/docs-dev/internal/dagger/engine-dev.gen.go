...
func (r *EngineDev) ConfigSchema(filename string) *File { // engine-dev (../../../../toolchains/engine-dev/main.go:364:1)
...
type EngineDevContainerOpts struct {
	Platform Platform // engine-dev (../../../../toolchains/engine-dev/main.go:151:2)

	GpuSupport bool // engine-dev (../../../../toolchains/engine-dev/main.go:153:2)

	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:155:2)

	Tag string // engine-dev (../../../../toolchains/engine-dev/main.go:157:2)
}

// Build the engine container
func (r *EngineDev) Container(opts ...EngineDevContainerOpts) *Container { // engine-dev (../../../../toolchains/engine-dev/main.go:147:1)
...
func (r *EngineDev) Generate() *Changeset { // engine-dev (../../../../toolchains/engine-dev/main.go:379:1)
...
type EngineDevGraphqlSchemaOpts struct {
	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:338:2)
}

// Introspect the engine API schema, and return it as a graphql schema
func (r *EngineDev) GraphqlSchema(opts ...EngineDevGraphqlSchemaOpts) *File { // engine-dev (../../../../toolchains/engine-dev/main.go:335:1)
...
type EngineDevInstallClientOpts struct {
	...
	//
	Service *Service // engine-dev (../../../../toolchains/engine-dev/main.go:280:2)

	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:282:2)
}

// Configure the given client container so that it can connect to the given engine service
func (r *EngineDev) InstallClient(client *Container, opts ...EngineDevInstallClientOpts) *Container { // engine-dev (../../../../toolchains/engine-dev/main.go:274:1)
...
func (r *EngineDev) IntrospectionJSON() *File { // engine-dev (../../../../toolchains/engine-dev/main.go:322:1)
...
func (r *EngineDev) IntrospectionTool() *File { // engine-dev (../../../../toolchains/engine-dev/main.go:356:1)
...
type EngineDevPlaygroundOpts struct {
	...
	//
	Base *Container // engine-dev (../../../../toolchains/engine-dev/main.go:113:2)
	//
	// Enable experimental GPU support
	//
	GpuSupport bool // engine-dev (../../../../toolchains/engine-dev/main.go:116:2)
	//
	// Share cache globally
	//
	SharedCache bool // engine-dev (../../../../toolchains/engine-dev/main.go:119:2)

	Metrics bool // engine-dev (../../../../toolchains/engine-dev/main.go:121:2)

	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:123:2)
}

// Build an ephemeral environment with the Dagger CLI and engine built from source, installed and ready to use
func (r *EngineDev) Playground(opts ...EngineDevPlaygroundOpts) *Container { // engine-dev (../../../../toolchains/engine-dev/main.go:109:1)
...
type EngineDevPublishOpts struct {
	...
	Image string // engine-dev (../../../../toolchains/engine-dev/main.go:472:2)

	DryRun bool // engine-dev (../../../../toolchains/engine-dev/main.go:477:2)

	RegistryUsername string // engine-dev (../../../../toolchains/engine-dev/main.go:480:2)

	RegistryPassword *Secret // engine-dev (../../../../toolchains/engine-dev/main.go:482:2)
}

// Publish all engine images to a registry
func (r *EngineDev) Publish(ctx context.Context, tag []string, opts ...EngineDevPublishOpts) error { // engine-dev (../../../../toolchains/engine-dev/main.go:467:1)
	if r.publish != nil {
		return nil
	}
...
func (r *EngineDev) ReleaseDryRun(ctx context.Context) error { // engine-dev (../../../../toolchains/engine-dev/main.go:453:1)
...
type EngineDevServiceOpts struct {
	GpuSupport bool // engine-dev (../../../../toolchains/engine-dev/main.go:216:2)

	SharedCache bool // engine-dev (../../../../toolchains/engine-dev/main.go:218:2)

	Metrics bool // engine-dev (../../../../toolchains/engine-dev/main.go:220:2)

	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:222:2)
}

// Create a test engine service
func (r *EngineDev) Service(name string, opts ...EngineDevServiceOpts) *Service { // engine-dev (../../../../toolchains/engine-dev/main.go:212:1)
