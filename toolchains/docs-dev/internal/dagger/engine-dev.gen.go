...
func (r *EngineDev) ClientDockerConfig() *Secret { // engine-dev (../../../../toolchains/engine-dev/main.go:78:2)
...
type EngineDevContainerOpts struct {
	Platform Platform // engine-dev (../../../../toolchains/engine-dev/main.go:153:2)

	GpuSupport bool // engine-dev (../../../../toolchains/engine-dev/main.go:155:2)

	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:157:2)

	Tag string // engine-dev (../../../../toolchains/engine-dev/main.go:159:2)
}

// Build the engine container
func (r *EngineDev) Container(opts ...EngineDevContainerOpts) *Container { // engine-dev (../../../../toolchains/engine-dev/main.go:149:1)
...
func (r *EngineDev) Generate() *Changeset { // engine-dev (../../../../toolchains/engine-dev/main.go:383:1)
...
type EngineDevGraphqlSchemaOpts struct {
	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:342:2)
}

// Introspect the engine API schema, and return it as a graphql schema
func (r *EngineDev) GraphqlSchema(opts ...EngineDevGraphqlSchemaOpts) *File { // engine-dev (../../../../toolchains/engine-dev/main.go:339:1)
...
func (r *EngineDev) IncrementSubnet() *EngineDev { // engine-dev (../../../../toolchains/engine-dev/main.go:85:1)
...
type EngineDevInstallClientOpts struct {
	...
	//
	Service *Service // engine-dev (../../../../toolchains/engine-dev/main.go:284:2)

	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:286:2)
}

// Configure the given client container so that it can connect to the given engine service
func (r *EngineDev) InstallClient(client *Container, opts ...EngineDevInstallClientOpts) *Container { // engine-dev (../../../../toolchains/engine-dev/main.go:278:1)
...
func (r *EngineDev) IntrospectionJSON() *File { // engine-dev (../../../../toolchains/engine-dev/main.go:326:1)
...
func (r *EngineDev) IntrospectionTool() *File { // engine-dev (../../../../toolchains/engine-dev/main.go:360:1)
...
func (r *EngineDev) NetworkCidr(ctx context.Context) (string, error) { // engine-dev (../../../../toolchains/engine-dev/main.go:81:1)
...
type EngineDevPlaygroundOpts struct {
	...
	//
	Base *Container // engine-dev (../../../../toolchains/engine-dev/main.go:115:2)
	//
	// Enable experimental GPU support
	//
	GpuSupport bool // engine-dev (../../../../toolchains/engine-dev/main.go:118:2)
	//
	// Share cache globally
	//
	SharedCache bool // engine-dev (../../../../toolchains/engine-dev/main.go:121:2)

	Metrics bool // engine-dev (../../../../toolchains/engine-dev/main.go:123:2)

	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:125:2)
}

// Build an ephemeral environment with the Dagger CLI and engine built from source, installed and ready to use
func (r *EngineDev) Playground(opts ...EngineDevPlaygroundOpts) *Container { // engine-dev (../../../../toolchains/engine-dev/main.go:111:1)
...
type EngineDevPublishOpts struct {
	...
	Image string // engine-dev (../../../../toolchains/engine-dev/main.go:465:2)

	DryRun bool // engine-dev (../../../../toolchains/engine-dev/main.go:470:2)

	RegistryUsername string // engine-dev (../../../../toolchains/engine-dev/main.go:473:2)

	RegistryPassword *Secret // engine-dev (../../../../toolchains/engine-dev/main.go:475:2)
}

// Publish all engine images to a registry
func (r *EngineDev) Publish(ctx context.Context, tag []string, opts ...EngineDevPublishOpts) error { // engine-dev (../../../../toolchains/engine-dev/main.go:460:1)
	if r.publish != nil {
		return nil
	}
...
func (r *EngineDev) ReleaseDryRun(ctx context.Context) error { // engine-dev (../../../../toolchains/engine-dev/main.go:446:1)
...
type EngineDevServiceOpts struct {
	GpuSupport bool // engine-dev (../../../../toolchains/engine-dev/main.go:221:2)

	SharedCache bool // engine-dev (../../../../toolchains/engine-dev/main.go:223:2)

	Metrics bool // engine-dev (../../../../toolchains/engine-dev/main.go:225:2)

	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:227:2)
}

// Create a test engine service
func (r *EngineDev) Service(name string, opts ...EngineDevServiceOpts) *Service { // engine-dev (../../../../toolchains/engine-dev/main.go:217:1)
...
func (r *EngineDev) WithEbpfprogs(names []string) *EngineDev { // engine-dev (../../../../toolchains/engine-dev/main.go:90:1)
...
func (r *EngineDev) WithEngineConfig(key string, value string) *EngineDev { // engine-dev (../../../../toolchains/engine-dev/main.go:95:1)
...
func (r *EngineDev) WithLogLevel(level string) *EngineDev { // engine-dev (../../../../toolchains/engine-dev/main.go:105:1)
...
func (r *EngineDev) WithRace() *EngineDev { // engine-dev (../../../../toolchains/engine-dev/main.go:100:1)
...
type EngineDevOpts struct {
	Source *Directory // engine-dev (../../../../toolchains/engine-dev/main.go:52:2)
	//
	...
	//
	// Default: 89
	SubnetNumber int // engine-dev (../../../../toolchains/engine-dev/main.go:56:2)
	//
	// A docker config file with credentials to install on clients,
	// to ensure they can access private registries
	//
	ClientDockerConfig *Secret // engine-dev (../../../../toolchains/engine-dev/main.go:60:2)
}
