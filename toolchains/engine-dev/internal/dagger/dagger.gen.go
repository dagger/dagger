...
type Alpine struct { // alpine (../../../../modules/alpine/main.go:77:6)
	query *querybuilder.Selection
...
func (r *Alpine) Arch(ctx context.Context) (string, error) { // alpine (../../../../modules/alpine/main.go:81:2)
	if r.arch != nil {
		return *r.arch, nil
	}
...
func (r *Alpine) Branch(ctx context.Context) (string, error) { // alpine (../../../../modules/alpine/main.go:83:2)
	if r.branch != nil {
		return *r.branch, nil
	}
...
func (r *Alpine) Container() *Container { // alpine (../../../../modules/alpine/main.go:93:1)
	q := r.query.Select("container")
...
// The distro to use
func (r *Alpine) Distro(ctx context.Context) (AlpineDistro, error) { // alpine (../../../../modules/alpine/main.go:79:2)
	if r.distro != nil {
		return *r.distro, nil
	}
...
func (r *Alpine) Packages(ctx context.Context) ([]string, error) { // alpine (../../../../modules/alpine/main.go:85:2)
...
func (r *Binding) AsAlpine() *Alpine {
...
func (r *Binding) AsCodegen() *Codegen {
...
func (r *Binding) AsDaggerCli() *DaggerCli {
...
func (r *Binding) AsNotify() *Notify {
...
func (r *Codegen) Source() *Directory {
...
func (r *Env) WithAlpineInput(name string, value *Alpine, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithAlpineOutput(name string, description string) *Env {
...
func (r *Env) WithCodegenInput(name string, value *Codegen, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithCodegenOutput(name string, description string) *Env {
...
func (r *Env) WithDaggerCliInput(name string, value *DaggerCli, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithDaggerCliOutput(name string, description string) *Env {
...
func (r *Env) WithNotifyInput(name string, value *Notify, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithNotifyOutput(name string, description string) *Env {
...
// AlpineOpts contains options for Client.Alpine
type AlpineOpts struct {
	...
	//
	// Default: ALPINE
	Distro AlpineDistro // alpine (../../../../modules/alpine/main.go:44:2)
}

func (r *Client) Alpine(opts ...AlpineOpts) *Alpine { // alpine (../../../../modules/alpine/main.go:29:1)
...
// CodegenOpts contains options for Client.Codegen
type CodegenOpts struct {
	Source *Directory
}

func (r *Client) Codegen(opts ...CodegenOpts) *Codegen {
...
// DaggerCliOpts contains options for Client.DaggerCli
type DaggerCliOpts struct {
	RunnerHost string // dagger-cli (../../../../toolchains/cli-dev/main.go:16:2)

	Source *Directory // dagger-cli (../../../../toolchains/cli-dev/main.go:36:2)
	//
	// Base image for go build environment
	//
	Base *Container // dagger-cli (../../../../toolchains/cli-dev/main.go:40:2)
}

func (r *Client) DaggerCli(opts ...DaggerCliOpts) *DaggerCli { // dagger-cli (../../../../toolchains/cli-dev/main.go:12:1)
...
func (r *Client) LoadAlpineFromID(id AlpineID) *Alpine {
...
func (r *Client) LoadCodegenFromID(id CodegenID) *Codegen {
...
func (r *Client) LoadDaggerCliFromID(id DaggerCliID) *DaggerCli {
...
func (r *Client) Notify() *Notify { // notify (../../../../toolchains/engine-dev/notify/main.go:18:6)
...
type VersionOpts struct {
	...
	GitDir *Directory // version (../../../../version/main.go:35:2)
	//
	// .changes file used to extract version information
	//
	Changes *Directory // version (../../../../version/main.go:40:2)
}

func (r *Client) Version(opts ...VersionOpts) *Version { // version (../../../../version/main.go:20:1)
	q := r.query.Select("version")
	for i := len(opts) - 1; i >= 0; i-- {
...
func (r *Client) Wolfi() *Wolfi { // wolfi (../../../../modules/wolfi/main.go:10:6)
...
type Version struct { // version (../../../../version/main.go:65:6)
	query *querybuilder.Selection
...
func (r *Version) ImageTag(ctx context.Context) (string, error) { // version (../../../../version/main.go:133:1)
	if r.imageTag != nil {
...
func (r *Version) LastReleaseVersion(ctx context.Context) (string, error) { // version (../../../../version/main.go:178:1)
...
func (r *Version) NextReleaseVersion(ctx context.Context) (string, error) { // version (../../../../version/main.go:194:1)
...
func (r *Version) Version(ctx context.Context) (string, error) { // version (../../../../version/main.go:77:1)
	if r.version != nil {
		return *r.version, nil
	}
	q := r.query.Select("version")
...
type WolfiContainerOpts struct {
	...
	//
	Overlays []*Container // wolfi (../../../../modules/wolfi/main.go:23:2)
}
