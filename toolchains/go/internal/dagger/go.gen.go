...
func (r *Go) Binary(pkg string, opts ...GoBinaryOpts) *File {
...
func (r *Go) Build(opts ...GoBuildOpts) *Directory {
...
// Go build cache
func (r *Go) BuildCache() *CacheVolume {
...
// Enable CGO
func (r *Go) Cgo(ctx context.Context) (bool, error) {
	if r.cgo != nil {
		return *r.cgo, nil
	}
...
func (r *Go) CheckTidy(ctx context.Context, opts ...GoCheckTidyOpts) error {
	if r.checkTidy != nil {
		return nil
	}
...
func (r *Go) Env(opts ...GoEnvOpts) *Container {
...
func (r *Go) Exclude(ctx context.Context) ([]string, error) {
...
func (r *Go) Experiment(ctx context.Context) ([]string, error) {
...
func (r *Go) Include(ctx context.Context) ([]string, error) {
...
func (r *Go) Ldflags(ctx context.Context) ([]string, error) {
...
func (r *Go) Limit(ctx context.Context) (int, error) {
	if r.limit != nil {
		return *r.limit, nil
	}
...
func (r *Go) ListPackages(ctx context.Context, opts ...GoListPackagesOpts) ([]string, error) {
...
// Go module cache
func (r *Go) ModuleCache() *CacheVolume {
...
func (r *Go) Modules(ctx context.Context, opts ...GoModulesOpts) ([]string, error) {
...
func (r *Go) Race(ctx context.Context) (bool, error) {
	if r.race != nil {
		return *r.race, nil
	}
...
func (r *Go) Tags(ctx context.Context) ([]string, error) {
...
// List tests
func (r *Go) Tests(ctx context.Context, opts ...GoTestsOpts) (string, error) {
	if r.tests != nil {
		return *r.tests, nil
	}
...
func (r *Go) Tidy(opts ...GoTidyOpts) *Changeset {
...
func (r *Go) TidyModule(module string) *Changeset {
...
func (r *Go) Values(ctx context.Context) ([]string, error) {
...
// Go version
func (r *Go) Version(ctx context.Context) (string, error) {
	if r.version != nil {
