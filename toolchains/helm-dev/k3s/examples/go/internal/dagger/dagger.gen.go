...
import (
	...
	"dagger/examples/internal/querybuilder"
	"dagger/examples/internal/telemetry"
)
...
func (r *Client) K3S(name string, opts ...K3SOpts) *K3S { // k3s (../../../../../../../toolchains/helm-dev/k3s/main.go:53:1)
