				...
				dag.TypeDef().WithObject("PhpSdkDev", dagger.TypeDefWithObjectOpts{SourceMap: dag.SourceMap("main.go", 23, 6)}).
					...
					WithFunction(
						dag.Function("DevContainer",
							...
							WithArg("runInstall", dag.TypeDef().WithKind(dagger.TypeDefKindBooleanKind), dagger.FunctionWithArgOpts{Description: "Run composer install before returning the container", SourceMap: dag.SourceMap("main.go", 86, 2), DefaultValue: dagger.JSON("\"false\"")})).
					WithFunction(
					...
					WithFunction(
						dag.Function("Release",
							...
							WithArg("sourceRepo", dag.TypeDef().WithObject("GitRepository").WithOptional(true), dagger.FunctionWithArgOpts{Description: "The source git repository to release", SourceMap: dag.SourceMap("main.go", 245, 2), DefaultPath: "/"}).
							WithArg("sourceTag", dag.TypeDef().WithKind(dagger.TypeDefKindStringKind), dagger.FunctionWithArgOpts{Description: "The source git tag to release", SourceMap: dag.SourceMap("main.go", 248, 2)}).
							WithArg("dest", dag.TypeDef().WithKind(dagger.TypeDefKindStringKind).WithOptional(true), dagger.FunctionWithArgOpts{SourceMap: dag.SourceMap("main.go", 252, 2), DefaultValue: dagger.JSON("\"https://github.com/dagger/dagger-php-sdk.git\"")}).
							WithArg("githubToken", dag.TypeDef().WithObject("Secret").WithOptional(true), dagger.FunctionWithArgOpts{SourceMap: dag.SourceMap("main.go", 254, 2)})).
					WithFunction(
						dag.Function("ReleaseDryRun",
							dag.TypeDef().WithKind(dagger.TypeDefKindVoidKind).WithOptional(true)).
							WithDescription("Test the publishing process").
							WithSourceMap(dag.SourceMap("main.go", 209, 1)).
							WithArg("sourceRepo", dag.TypeDef().WithObject("GitRepository").WithOptional(true), dagger.FunctionWithArgOpts{Description: "Source git repository to fake-release", SourceMap: dag.SourceMap("main.go", 213, 2), DefaultPath: "/"}).
							WithArg("sourceTag", dag.TypeDef().WithKind(dagger.TypeDefKindStringKind), dagger.FunctionWithArgOpts{Description: "Source git tag to fake-release", SourceMap: dag.SourceMap("main.go", 216, 2), DefaultValue: dagger.JSON("\"HEAD\"")}).
							WithArg("destRemote", dag.TypeDef().WithKind(dagger.TypeDefKindStringKind), dagger.FunctionWithArgOpts{Description: "Target git remote to fake-release *to*", SourceMap: dag.SourceMap("main.go", 219, 2), DefaultValue: dagger.JSON("\"https://github.com/dagger/dagger-php-sdk.git\"")})).
					WithFunction(
						dag.Function("Source",
					...
					WithFunction(
						dag.Function("VersionFromTag",
							...
							WithArg("tag", dag.TypeDef().WithKind(dagger.TypeDefKindStringKind), dagger.FunctionWithArgOpts{SourceMap: dag.SourceMap("main.go", 234, 35)})).
					WithFunction(
					...
					WithConstructor(
						dag.Function("New",
							...
							WithArg("workspaceDir", dag.TypeDef().WithObject("Directory").WithOptional(true), dagger.FunctionWithArgOpts{Description: "A directory with all the files needed to develop the SDK", SourceMap: dag.SourceMap("main.go", 36, 2), DefaultPath: "/", Ignore: []string{"*", "!sdk/php", "!docs/doctum-config.php", "!docs/static/reference/php", "sdk/php/.changes"}}).
							WithArg("sourcePath", dag.TypeDef().WithKind(dagger.TypeDefKindStringKind), dagger.FunctionWithArgOpts{Description: "The path of the SDK source in the workspace", SourceMap: dag.SourceMap("main.go", 39, 2), DefaultValue: dagger.JSON("\"sdk/php\"")}).
							WithArg("doctumConfigPath", dag.TypeDef().WithKind(dagger.TypeDefKindStringKind), dagger.FunctionWithArgOpts{Description: "The path of the doctum config in the workspace", SourceMap: dag.SourceMap("main.go", 42, 2), DefaultValue: dagger.JSON("\"docs/doctum-config.php\"")}).
