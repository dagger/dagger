...
import (
	...
	"dagger/php-sdk-dev/internal/querybuilder"
	"dagger/php-sdk-dev/internal/telemetry"
)
...
func (r *Binding) AsGitReleaser() *GitReleaser {
...
func (r *Env) WithGitReleaserInput(name string, value *GitReleaser, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithGitReleaserOutput(name string, description string) *Env {
...
// GitReleaserOpts contains options for Client.GitReleaser
...
func (r *Client) GitReleaser(opts ...GitReleaserOpts) *GitReleaser { // git-releaser (../../../../modules/git-releaser/main.go:17:1)
...
func (r *Client) LoadGitReleaserFromID(id GitReleaserID) *GitReleaser {
