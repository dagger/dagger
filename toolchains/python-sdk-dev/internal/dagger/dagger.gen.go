...
func (r *Binding) AsDockerd() *Dockerd {
...
func (r *Env) WithDockerdInput(name string, value *Dockerd, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithDockerdOutput(name string, description string) *Env {
...
func (r *Client) Dockerd() *Dockerd { // dockerd (../../../../toolchains/python-sdk-dev/dockerd/main.go:14:6)
...
func (r *Client) LoadDockerdFromID(id DockerdID) *Dockerd {
