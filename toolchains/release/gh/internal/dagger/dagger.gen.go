...
func (r *Binding) AsApkoBuildResult() *ApkoBuildResult {
...
func (r *Binding) AsApkoConfig() *ApkoConfig {
...
func (r *Env) WithApkoBuildResultInput(name string, value *ApkoBuildResult, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithApkoBuildResultOutput(name string, description string) *Env {
...
func (r *Env) WithApkoConfigInput(name string, value *ApkoConfig, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithApkoConfigOutput(name string, description string) *Env {
...
func (r *Env) WithApkoInput(name string, value *Apko, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithApkoOutput(name string, description string) *Env {
...
// ApkoOpts contains options for Client.Apko
...
func (r *Client) Apko(opts ...ApkoOpts) *Apko { // apko (../../../../../toolchains/release/apko/main.go:24:1)
...
func (r *Client) LoadApkoBuildResultFromID(id ApkoBuildResultID) *ApkoBuildResult {
...
func (r *Client) LoadApkoConfigFromID(id ApkoConfigID) *ApkoConfig {
...
func (r *Client) LoadApkoFromID(id ApkoID) *Apko {
