...
// The `PythonSdkDevTestSuiteID` scalar type represents an identifier for an object of type PythonSdkDevTestSuite.
type PythonSDKDevTestSuiteID string
...
func (r *Binding) AsCliDev() *CliDev {
...
func (r *Binding) AsDocsDev() *DocsDev {
...
func (r *Binding) AsDotnetSDKDev() *DotnetSDKDev {
...
func (r *Binding) AsGoSDKDev() *GoSDKDev {
...
func (r *Binding) AsHelmDev() *HelmDev {
...
func (r *Binding) AsPhpSDKDev() *PhpSDKDev {
...
func (r *Binding) AsPythonSDKDev() *PythonSDKDev {
...
func (r *Binding) AsPythonSDKDevDocs() *PythonSDKDevDocs {
...
// Retrieve the binding value, as type PythonSdkDevTestSuite
func (r *Binding) AsPythonSDKDevTestSuite() *PythonSDKDevTestSuite {
	q := r.query.Select("asPythonSdkDevTestSuite")

	return &PythonSDKDevTestSuite{
		query: q,
	}
}

// Retrieve the binding value, as type RustSdkDev
func (r *Binding) AsRustSDKDev() *RustSDKDev {
...
func (r *Binding) AsTypescriptSDKDev() *TypescriptSDKDev {
...
func (r *DocsDev) Bump(engineVersion string) *Changeset { // docs-dev (../../../../toolchains/docs-dev/main.go:145:1)
...
func (r *DocsDev) Deploy(ctx context.Context, message string, netlifyToken *Secret) (string, error) { // docs-dev (../../../../toolchains/docs-dev/main.go:160:1)
...
// DocsDevGenerateOpts contains options for DocsDev.Generate
type DocsDevGenerateOpts struct {
	//
	// Dagger version to generate API docs for
	//
	Version string // docs-dev (../../../../toolchains/docs-dev/main.go:100:2)
}

// Regenerate the API schema and CLI reference docs
func (r *DocsDev) Generate(opts ...DocsDevGenerateOpts) *Changeset { // docs-dev (../../../../toolchains/docs-dev/main.go:97:1)
	q := r.query.Select("generate")
	for i := len(opts) - 1; i >= 0; i-- {
...
// DocsDevLintMarkdownOpts contains options for DocsDev.LintMarkdown
type DocsDevLintMarkdownOpts struct {
	MarkdownFiles *Directory // docs-dev (../../../../toolchains/docs-dev/main.go:85:2)
}

// Lint documentation files
func (r *DocsDev) LintMarkdown(ctx context.Context, opts ...DocsDevLintMarkdownOpts) error { // docs-dev (../../../../toolchains/docs-dev/main.go:76:1)
...
type DocsDevPublishOpts struct {
	Deployment string // docs-dev (../../../../toolchains/docs-dev/main.go:193:2)
}

// Publish a previous deployment to production - defaults to the latest deployment on the main branch.
func (r *DocsDev) Publish(ctx context.Context, netlifyToken *Secret, opts ...DocsDevPublishOpts) error { // docs-dev (../../../../toolchains/docs-dev/main.go:189:1)
	assertNotNil("netlifyToken", netlifyToken)
	if r.publish != nil {
		return nil
	}
...
func (r *DocsDev) Server() *Container { // docs-dev (../../../../toolchains/docs-dev/main.go:63:1)
...
func (r *DocsDev) Site() *Directory { // docs-dev (../../../../toolchains/docs-dev/main.go:54:1)
...
func (r *DotnetSDKDev) Bump() *Changeset {
	q := r.query.Select("bump")
...
func (r *DotnetSDKDev) Changes() *Changeset {
	q := r.query.Select("changes")
...
func (r *DotnetSDKDev) Csharpier(ctx context.Context) error {
	if r.csharpier != nil {
		return nil
	}
...
func (r *DotnetSDKDev) DevContainer() *Container {
...
func (r *DotnetSDKDev) Install() *Changeset {
...
func (r *DotnetSDKDev) SourcePath(ctx context.Context) (string, error) {
	if r.sourcePath != nil {
...
func (r *DotnetSDKDev) Test(ctx context.Context) error {
	if r.test != nil {
		return nil
	}
...
func (r *DotnetSDKDev) WithFormat() *DotnetSDKDev {
...
func (r *DotnetSDKDev) WithInstall() *DotnetSDKDev {
...
func (r *EngineDev) ClientDockerConfig() *Secret { // engine-dev (../../../../toolchains/engine-dev/main.go:66:2)
...
func (r *EngineDev) ConfigSchema(filename string) *File { // engine-dev (../../../../toolchains/engine-dev/main.go:334:1)
...
type EngineDevContainerOpts struct {
	Platform Platform // engine-dev (../../../../toolchains/engine-dev/main.go:131:2)

	GpuSupport bool // engine-dev (../../../../toolchains/engine-dev/main.go:133:2)

	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:135:2)

	Tag string // engine-dev (../../../../toolchains/engine-dev/main.go:137:2)
}

// Build the engine container
func (r *EngineDev) Container(opts ...EngineDevContainerOpts) *Container { // engine-dev (../../../../toolchains/engine-dev/main.go:127:1)
	q := r.query.Select("container")
	for i := len(opts) - 1; i >= 0; i-- {
		// `platform` optional argument
		if !querybuilder.IsZeroValue(opts[i].Platform) {
...
func (r *EngineDev) Generate() *Changeset { // engine-dev (../../../../toolchains/engine-dev/main.go:348:1)
	q := r.query.Select("generate")
...
type EngineDevGraphqlSchemaOpts struct {
	Version string // engine-dev (../../../../toolchains/engine-dev/main.go:308:2)
}

// Introspect the engine API schema, and return it as a graphql schema
func (r *EngineDev) GraphqlSchema(opts ...EngineDevGraphqlSchemaOpts) *File { // engine-dev (../../../../toolchains/engine-dev/main.go:305:1)
...
func (r *EngineDev) IncrementSubnet() *EngineDev { // engine-dev (../../../../toolchains/engine-dev/main.go:73:1)
...
type EngineDevInstallClientOpts struct {
	...
	//
	Service *Service // engine-dev (../../../../toolchains/engine-dev/main.go:253:2)
}

// Configure the given client container so that it can connect to the given engine service
func (r *EngineDev) InstallClient(client *Container, opts ...EngineDevInstallClientOpts) *Container { // engine-dev (../../../../toolchains/engine-dev/main.go:247:1)
...
func (r *EngineDev) IntrospectionJSON() *File { // engine-dev (../../../../toolchains/engine-dev/main.go:292:1)
...
func (r *EngineDev) IntrospectionTool() *File { // engine-dev (../../../../toolchains/engine-dev/main.go:326:1)
...
func (r *EngineDev) NetworkCidr(ctx context.Context) (string, error) { // engine-dev (../../../../toolchains/engine-dev/main.go:69:1)
...
type EngineDevPlaygroundOpts struct {
	...
	//
	Base *Container // engine-dev (../../../../toolchains/engine-dev/main.go:98:2)
	//
	// Enable experimental GPU support
	//
	GpuSupport bool // engine-dev (../../../../toolchains/engine-dev/main.go:101:2)
	//
	// Share cache globally
	//
	SharedCache bool // engine-dev (../../../../toolchains/engine-dev/main.go:104:2)

	Metrics bool // engine-dev (../../../../toolchains/engine-dev/main.go:106:2)
}

// Build an ephemeral environment with the Dagger CLI and engine built from source, installed and ready to use
func (r *EngineDev) Playground(opts ...EngineDevPlaygroundOpts) *Container { // engine-dev (../../../../toolchains/engine-dev/main.go:94:1)
...
type EngineDevPublishOpts struct {
	...
	Image string // engine-dev (../../../../toolchains/engine-dev/main.go:421:2)

	DryRun bool // engine-dev (../../../../toolchains/engine-dev/main.go:426:2)

	RegistryUsername string // engine-dev (../../../../toolchains/engine-dev/main.go:429:2)

	RegistryPassword *Secret // engine-dev (../../../../toolchains/engine-dev/main.go:431:2)
}

// Publish all engine images to a registry
func (r *EngineDev) Publish(ctx context.Context, tag []string, opts ...EngineDevPublishOpts) error { // engine-dev (../../../../toolchains/engine-dev/main.go:416:1)
	if r.publish != nil {
		return nil
	}
	q := r.query.Select("publish")
...
func (r *EngineDev) ReleaseDryRun(ctx context.Context) error { // engine-dev (../../../../toolchains/engine-dev/main.go:402:1)
	if r.releaseDryRun != nil {
		return nil
	}
	q := r.query.Select("releaseDryRun")
...
type EngineDevServiceOpts struct {
	GpuSupport bool // engine-dev (../../../../toolchains/engine-dev/main.go:191:2)

	SharedCache bool // engine-dev (../../../../toolchains/engine-dev/main.go:193:2)

	Metrics bool // engine-dev (../../../../toolchains/engine-dev/main.go:195:2)
}

// Create a test engine service
func (r *EngineDev) Service(name string, opts ...EngineDevServiceOpts) *Service { // engine-dev (../../../../toolchains/engine-dev/main.go:187:1)
	q := r.query.Select("service")
	for i := len(opts) - 1; i >= 0; i-- {
		// `gpuSupport` optional argument
		if !querybuilder.IsZeroValue(opts[i].GpuSupport) {
...
type EngineDevTestTelemetryOpts struct {
	...
	// Only run these tests
	//
	Run string // engine-dev (../../../../toolchains/engine-dev/test.go:84:2)
	//
	// Skip these tests
	//
	Skip string // engine-dev (../../../../toolchains/engine-dev/test.go:87:2)

	Update bool // engine-dev (../../../../toolchains/engine-dev/test.go:89:2)

	Failfast bool // engine-dev (../../../../toolchains/engine-dev/test.go:91:2)

	Parallel int // engine-dev (../../../../toolchains/engine-dev/test.go:93:2)

	Timeout string // engine-dev (../../../../toolchains/engine-dev/test.go:95:2)

	Race bool // engine-dev (../../../../toolchains/engine-dev/test.go:97:2)

	// Default: 1
	Count int // engine-dev (../../../../toolchains/engine-dev/test.go:99:2)

	EnvFile *Secret // engine-dev (../../../../toolchains/engine-dev/test.go:101:2)

	TestVerbose bool // engine-dev (../../../../toolchains/engine-dev/test.go:103:2)
}

// Run telemetry tests
func (r *EngineDev) TestTelemetry(opts ...EngineDevTestTelemetryOpts) *Directory { // engine-dev (../../../../toolchains/engine-dev/test.go:80:1)
...
func (r *EngineDev) WithBuildkitConfig(key string, value string) *EngineDev { // engine-dev (../../../../toolchains/engine-dev/main.go:78:1)
...
func (r *EngineDev) WithLogLevel(level string) *EngineDev { // engine-dev (../../../../toolchains/engine-dev/main.go:88:1)
...
func (r *EngineDev) WithRace() *EngineDev { // engine-dev (../../../../toolchains/engine-dev/main.go:83:1)
...
func (r *Env) WithCliDevInput(name string, value *CliDev, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithCliDevOutput(name string, description string) *Env {
...
func (r *Env) WithDocsDevInput(name string, value *DocsDev, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithDocsDevOutput(name string, description string) *Env {
...
func (r *Env) WithDotnetSDKDevInput(name string, value *DotnetSDKDev, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithGoSDKDevInput(name string, value *GoSDKDev, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithGoSDKDevOutput(name string, description string) *Env {
...
func (r *Env) WithHelmDevInput(name string, value *HelmDev, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithHelmDevOutput(name string, description string) *Env {
...
func (r *Env) WithPhpSDKDevInput(name string, value *PhpSDKDev, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithPhpSDKDevOutput(name string, description string) *Env {
...
func (r *Env) WithPythonSDKDevDocsInput(name string, value *PythonSDKDevDocs, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithPythonSDKDevDocsOutput(name string, description string) *Env {
...
func (r *Env) WithPythonSDKDevInput(name string, value *PythonSDKDev, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithPythonSDKDevOutput(name string, description string) *Env {
...
// Create or update a binding of type PythonSdkDevTestSuite in the environment
func (r *Env) WithPythonSDKDevTestSuiteInput(name string, value *PythonSDKDevTestSuite, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withPythonSdkDevTestSuiteInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired PythonSdkDevTestSuite output to be assigned in the environment
func (r *Env) WithPythonSDKDevTestSuiteOutput(name string, description string) *Env {
	q := r.query.Select("withPythonSdkDevTestSuiteOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
func (r *Env) WithRustSDKDevInput(name string, value *RustSDKDev, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithRustSDKDevOutput(name string, description string) *Env {
...
func (r *Env) WithTypescriptSDKDevInput(name string, value *TypescriptSDKDev, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithTypescriptSDKDevOutput(name string, description string) *Env {
...
// Bump the Go SDK's Engine dependency
func (r *GoSDKDev) Bump(version string) *Changeset {
	q := r.query.Select("bump")
	q = q.Arg("version", version)
...
func (r *GoSDKDev) DevContainer() *Container {
	q := r.query.Select("devContainer")
...
func (r *GoSDKDev) Generate() *Changeset {
	q := r.query.Select("generate")
...
// Publish the Go SDK
func (r *GoSDKDev) Release(ctx context.Context, sourceTag string, opts ...GoSDKDevReleaseOpts) error {
	if r.release != nil {
		return nil
	}
	q := r.query.Select("release")
...
func (r *GoSDKDev) ReleaseDryRun(ctx context.Context, opts ...GoSDKDevReleaseDryRunOpts) error {
	if r.releaseDryRun != nil {
		return nil
	}
	q := r.query.Select("releaseDryRun")
...
func (r *GoSDKDev) Source() *Directory {
	q := r.query.Select("source")
...
func (r *GoSDKDev) SourcePath(ctx context.Context) (string, error) {
	if r.sourcePath != nil {
		return *r.sourcePath, nil
	}
	q := r.query.Select("sourcePath")
...
// Test the Go SDK
func (r *GoSDKDev) Test(ctx context.Context) error {
	if r.test != nil {
		return nil
	}
	q := r.query.Select("test")
...
func (r *GoSDKDev) Workspace() *Directory {
	q := r.query.Select("workspace")
...
type HelmDevPublishOpts struct {
	GithubToken *Secret // helm-dev (../../../../toolchains/helm-dev/main.go:260:2)
	//
	// Test as much as possible without actually publishing anything
	//
	DryRun bool // helm-dev (../../../../toolchains/helm-dev/main.go:264:2)
}

// Package & publish chart to our registry + github release
func (r *HelmDev) Publish(ctx context.Context, target string, opts ...HelmDevPublishOpts) error { // helm-dev (../../../../toolchains/helm-dev/main.go:253:1)
	if r.publish != nil {
		return nil
	}
	q := r.query.Select("publish")
...
func (r *HelmDev) ReleaseDryRun(ctx context.Context) error { // helm-dev (../../../../toolchains/helm-dev/main.go:243:1)
	if r.releaseDryRun != nil {
		return nil
	}
	q := r.query.Select("releaseDryRun")
...
func (r *HelmDev) SetVersion(version string) *File { // helm-dev (../../../../toolchains/helm-dev/main.go:206:1)
...
func (r *HelmDev) Test(ctx context.Context) error { // helm-dev (../../../../toolchains/helm-dev/main.go:44:1)
	if r.test != nil {
		return nil
	}
	q := r.query.Select("test")
...
type PhpSDKDev struct { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:24:6)
	query *querybuilder.Selection
...
func (r *PhpSDKDev) BaseContainer() *Container { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:52:1)
...
func (r *PhpSDKDev) Bump(version string) *Changeset { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:263:1)
	q := r.query.Select("bump")
	q = q.Arg("version", version)
...
func (r *PhpSDKDev) Changes() *Changeset { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:149:1)
	q := r.query.Select("changes")
...
type PhpSDKDevDevContainerOpts struct {
	...
	//
	RunInstall bool // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:80:2)
}

// Returns the PHP SDK workspace mounted in a dev container,
// and working directory set to the SDK source
func (r *PhpSDKDev) DevContainer(opts ...PhpSDKDevDevContainerOpts) *Container { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:77:1)
	q := r.query.Select("devContainer")
	for i := len(opts) - 1; i >= 0; i-- {
...
func (r *PhpSDKDev) DoctumConfig() *File { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:103:1)
...
func (r *PhpSDKDev) Generate() *Changeset { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:138:1)
	q := r.query.Select("generate")
...
func (r *PhpSDKDev) PhpCodeSniffer(ctx context.Context) error { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:109:1)
...
func (r *PhpSDKDev) PhpStan(ctx context.Context) error { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:119:1)
	if r.phpStan != nil {
		return nil
	}
...
type PhpSDKDevReleaseOpts struct {
	...
	//
	SourceRepo *GitRepository // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:238:2)

	// Default: "https://github.com/dagger/dagger-php-sdk.git"
	Dest string // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:245:2)

	GithubToken *Secret // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:247:2)
}

// Publish the PHP SDK
func (r *PhpSDKDev) Release(ctx context.Context, sourceTag string, opts ...PhpSDKDevReleaseOpts) error { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:233:1)
	if r.release != nil {
		return nil
	}
	q := r.query.Select("release")
...
type PhpSDKDevReleaseDryRunOpts struct {
	...
	//
	SourceRepo *GitRepository // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:206:2)
	//
	// Source git tag to fake-release
	//
	//
	// Default: "HEAD"
	SourceTag string // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:209:2)
	//
	// Target git remote to fake-release *to*
	//
	//
	// Default: "https://github.com/dagger/dagger-php-sdk.git"
	DestRemote string // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:212:2)
}

// Test the publishing process
func (r *PhpSDKDev) ReleaseDryRun(ctx context.Context, opts ...PhpSDKDevReleaseDryRunOpts) error { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:202:1)
	if r.releaseDryRun != nil {
		return nil
	}
	q := r.query.Select("releaseDryRun")
...
func (r *PhpSDKDev) Source() *Directory { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:98:1)
	q := r.query.Select("source")
...
func (r *PhpSDKDev) Test(ctx context.Context) error { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:130:1)
	if r.test != nil {
		return nil
	}
	q := r.query.Select("test")
...
func (r *PhpSDKDev) VersionFromTag(ctx context.Context, tag string) (string, error) { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:227:1)
...
func (r *PhpSDKDev) WithGeneratedClient() *PhpSDKDev { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:153:1)
...
func (r *PhpSDKDev) WithGeneratedDocs() *PhpSDKDev { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:173:1)
...
type PythonSDKDevBuildOpts struct {
	...
	//
	// Default: "0.0.0"
	Version string // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:279:2)
}

// Build the Python SDK client library package for distribution
func (r *PythonSDKDev) Build(opts ...PythonSDKDevBuildOpts) *Container { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:276:1)
...
func (r *PythonSDKDev) Bump(version string) *Changeset { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:264:1)
	q := r.query.Select("bump")
	q = q.Arg("version", version)
...
func (r *PythonSDKDev) Docs() *PythonSDKDevDocs { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:317:1)
...
type PythonSDKDevFormatOpts struct {
	...
	//
	Paths []string // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:109:2)
}

// Format source files
func (r *PythonSDKDev) Format(opts ...PythonSDKDevFormatOpts) *Changeset { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:106:1)
...
func (r *PythonSDKDev) Generate() *Changeset { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:171:1)
	q := r.query.Select("generate")
...
type PythonSDKDevLintOpts struct {
	...
	// List of files or directories to check
	//
	Paths []string // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:95:2)
}

// Check for linting errors
func (r *PythonSDKDev) Lint(ctx context.Context, opts ...PythonSDKDevLintOpts) error { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:91:1)
	if r.lint != nil {
		return nil
	}
	q := r.query.Select("lint")
...
type PythonSDKDevLintDocsSnippetsOpts struct {
	Workspace *Directory // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:83:2)
}

// Lint the Python snippets in the documentation
func (r *PythonSDKDev) LintDocsSnippets(ctx context.Context, opts ...PythonSDKDevLintDocsSnippetsOpts) error { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:75:1)
...
type PythonSDKDevPublishOpts struct {
	...
	//
	URL string // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:296:2)
}

// Publish Python SDK client library to PyPI
func (r *PythonSDKDev) Publish(token *Secret, opts ...PythonSDKDevPublishOpts) *Container { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:288:1)
	assertNotNil("token", token)
	q := r.query.Select("publish")
	for i := len(opts) - 1; i >= 0; i-- {
		// `version` optional argument
...
type PythonSDKDevReleaseOpts struct {
	DryRun bool // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:235:2)

	PypiRepo string // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:238:2)

	PypiToken *Secret // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:241:2)
}

// Release the Python SDK
func (r *PythonSDKDev) Release(ctx context.Context, sourceTag string, opts ...PythonSDKDevReleaseOpts) error { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:228:1)
	if r.release != nil {
		return nil
	}
	q := r.query.Select("release")
...
// Test the publishing process
func (r *PythonSDKDev) ReleaseDryRun(ctx context.Context) error { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:217:1)
	if r.releaseDryRun != nil {
		return nil
	}
	q := r.query.Select("releaseDryRun")
...
// Test the Python SDK
func (r *PythonSDKDev) Test(ctx context.Context) error { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:140:1)
	if r.test != nil {
		return nil
	}
	q := r.query.Select("test")
...
type PythonSDKDevTestPublishOpts struct {
	...
	//
	// Default: "0.0.0"
	Version string // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:311:2)
}

// Test the publishing of the Python SDK client library to TestPyPI
func (r *PythonSDKDev) TestPublish(token *Secret, opts ...PythonSDKDevTestPublishOpts) *Container { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:306:1)
	assertNotNil("token", token)
...
// PythonSDKDevTestSuiteOpts contains options for PythonSDKDev.TestSuite
type PythonSDKDevTestSuiteOpts struct {
	//
	// Python version
	//
	Version string // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:158:2)
}

// TestSuite to run unit and other tests
func (r *PythonSDKDev) TestSuite(disableNestedExec bool, opts ...PythonSDKDevTestSuiteOpts) *PythonSDKDevTestSuite { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:155:1)
...
func (r *PythonSDKDev) Typecheck(ctx context.Context) error { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:121:1)
	if r.typecheck != nil {
		return nil
	}
...
func (r *PythonSDKDev) WithDirectory(source *Directory) *PythonSDKDev { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:130:1)
	assertNotNil("source", source)
	q := r.query.Select("withDirectory")
	q = q.Arg("source", source)
...
// Run the test suite.
type PythonSDKDevTestSuite struct { // python-sdk-dev (../../../../toolchains/python-sdk-dev/test.go:12:6)
	query *querybuilder.Selection

	id *PythonSDKDevTestSuiteID
}

func (r *PythonSDKDevTestSuite) WithGraphQLQuery(q *querybuilder.Selection) *PythonSDKDevTestSuite {
	return &PythonSDKDevTestSuite{
		query: q,
	}
}
...
// Run python tests.
func (r *PythonSDKDevTestSuite) Default() *Container { // python-sdk-dev (../../../../toolchains/python-sdk-dev/test.go:40:1)
...
// A unique identifier for this PythonSdkDevTestSuite.
func (r *PythonSDKDevTestSuite) ID(ctx context.Context) (PythonSDKDevTestSuiteID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response PythonSDKDevTestSuiteID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *PythonSDKDevTestSuite) XXX_GraphQLType() string {
	return "PythonSdkDevTestSuite"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *PythonSDKDevTestSuite) XXX_GraphQLIDType() string {
	return "PythonSDKDevTestSuiteID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *PythonSDKDevTestSuite) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *PythonSDKDevTestSuite) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *PythonSDKDevTestSuite) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadPythonSDKDevTestSuiteFromID(PythonSDKDevTestSuiteID(id))
	return nil
}

// PythonSDKDevTestSuiteProvisionOpts contains options for PythonSDKDevTestSuite.Provision
type PythonSDKDevTestSuiteProvisionOpts struct {
	//
	// _EXPERIMENTAL_DAGGER_RUNNER_HOST value
	//
	RunnerHost string // python-sdk-dev (../../../../toolchains/python-sdk-dev/test.go:59:2)
}
...
func (r *PythonSDKDevTestSuite) Provision(cliBin *File, opts ...PythonSDKDevTestSuiteProvisionOpts) *Container { // python-sdk-dev (../../../../toolchains/python-sdk-dev/test.go:53:1)
...
func (r *PythonSDKDevTestSuite) Run(args []string) *Container { // python-sdk-dev (../../../../toolchains/python-sdk-dev/test.go:25:1)
	q := r.query.Select("run")
	q = q.Arg("args", args)
...
// Run unit tests.
func (r *PythonSDKDevTestSuite) Unit() *Container { // python-sdk-dev (../../../../toolchains/python-sdk-dev/test.go:45:1)
...
// CliDevOpts contains options for Client.CliDev
type CliDevOpts struct {
	RunnerHost string // cli-dev (../../../../toolchains/cli-dev/main.go:16:2)

	Source *Directory // cli-dev (../../../../toolchains/cli-dev/main.go:36:2)
	//
	// Base image for go build environment
	//
	Base *Container // cli-dev (../../../../toolchains/cli-dev/main.go:40:2)
}

func (r *Client) CliDev(opts ...CliDevOpts) *CliDev { // cli-dev (../../../../toolchains/cli-dev/main.go:12:1)
...
// DocsDevOpts contains options for Client.DocsDev
...
func (r *Client) DocsDev(opts ...DocsDevOpts) *DocsDev { // docs-dev (../../../../toolchains/docs-dev/main.go:17:1)
...
// DotnetSDKDevOpts contains options for Client.DotnetSDKDev
...
func (r *Client) DotnetSDKDev(opts ...DotnetSDKDevOpts) *DotnetSDKDev {
...
func (r *Client) Gh(opts ...GhOpts) *Gh { // gh (../../../../toolchains/release/gh/main.go:27:1)
	q := r.query.Select("gh")
	for i := len(opts) - 1; i >= 0; i-- {
		// `token` optional argument
		if !querybuilder.IsZeroValue(opts[i].Token) {
...
// GoSDKDevOpts contains options for Client.GoSDKDev
...
func (r *Client) GoSDKDev(opts ...GoSDKDevOpts) *GoSDKDev {
...
// HelmDevOpts contains options for Client.HelmDev
...
func (r *Client) HelmDev(opts ...HelmDevOpts) *HelmDev { // helm-dev (../../../../toolchains/helm-dev/main.go:16:1)
...
func (r *Client) LoadCliDevFromID(id CliDevID) *CliDev {
...
func (r *Client) LoadDocsDevFromID(id DocsDevID) *DocsDev {
...
func (r *Client) LoadDotnetSDKDevFromID(id DotnetSDKDevID) *DotnetSDKDev {
...
func (r *Client) LoadGoSDKDevFromID(id GoSDKDevID) *GoSDKDev {
...
func (r *Client) LoadHelmDevFromID(id HelmDevID) *HelmDev {
...
func (r *Client) LoadPhpSDKDevFromID(id PhpSDKDevID) *PhpSDKDev {
...
func (r *Client) LoadPythonSDKDevDocsFromID(id PythonSDKDevDocsID) *PythonSDKDevDocs {
...
func (r *Client) LoadPythonSDKDevFromID(id PythonSDKDevID) *PythonSDKDev {
...
// Load a PythonSdkDevTestSuite from its ID.
func (r *Client) LoadPythonSDKDevTestSuiteFromID(id PythonSDKDevTestSuiteID) *PythonSDKDevTestSuite {
	q := r.query.Select("loadPythonSdkDevTestSuiteFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadRustSDKDevFromID(id RustSDKDevID) *RustSDKDev {
...
func (r *Client) LoadTypescriptSDKDevFromID(id TypescriptSDKDevID) *TypescriptSDKDev {
...
// PhpSDKDevOpts contains options for Client.PhpSDKDev
type PhpSDKDevOpts struct {
	//
	// A directory with all the files needed to develop the SDK
	//
	Workspace *Directory // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:36:2)
	//
...
func (r *Client) PhpSDKDev(opts ...PhpSDKDevOpts) *PhpSDKDev { // php-sdk-dev (../../../../toolchains/php-sdk-dev/main.go:32:1)
...
// PythonSDKDevOpts contains options for Client.PythonSDKDev
...
func (r *Client) PythonSDKDev(opts ...PythonSDKDevOpts) *PythonSDKDev { // python-sdk-dev (../../../../toolchains/python-sdk-dev/main.go:25:1)
...
// RustSDKDevOpts contains options for Client.RustSDKDev
...
func (r *Client) RustSDKDev(opts ...RustSDKDevOpts) *RustSDKDev { // rust-sdk-dev (../../../../toolchains/rust-sdk-dev/main.go:38:1)
...
// TypescriptSDKDevOpts contains options for Client.TypescriptSDKDev
...
func (r *Client) TypescriptSDKDev(opts ...TypescriptSDKDevOpts) *TypescriptSDKDev {
...
func (r *RustSDKDev) Bump(version string) *Changeset { // rust-sdk-dev (../../../../toolchains/rust-sdk-dev/main.go:274:1)
	q := r.query.Select("bump")
	q = q.Arg("version", version)
...
func (r *RustSDKDev) Changes() *Changeset { // rust-sdk-dev (../../../../toolchains/rust-sdk-dev/main.go:151:1)
	q := r.query.Select("changes")
...
func (r *RustSDKDev) Generate() *Changeset { // rust-sdk-dev (../../../../toolchains/rust-sdk-dev/main.go:147:1)
	q := r.query.Select("generate")
...
func (r *RustSDKDev) Release(ctx context.Context, sourceTag string, cargoRegistryToken *Secret) error { // rust-sdk-dev (../../../../toolchains/rust-sdk-dev/main.go:243:1)
...
type RustSDKDevReleaseDryRunOpts struct {
	...
	//
	// Default: "HEAD"
	SourceTag string // rust-sdk-dev (../../../../toolchains/rust-sdk-dev/main.go:180:2)
}

// Test the publishing process
func (r *RustSDKDev) ReleaseDryRun(ctx context.Context, opts ...RustSDKDevReleaseDryRunOpts) error { // rust-sdk-dev (../../../../toolchains/rust-sdk-dev/main.go:175:1)
	if r.releaseDryRun != nil {
		return nil
	}
	q := r.query.Select("releaseDryRun")
...
func (r *RustSDKDev) WithGeneratedClient() *RustSDKDev { // rust-sdk-dev (../../../../toolchains/rust-sdk-dev/main.go:155:1)
	q := r.query.Select("withGeneratedClient")
...
func (r *TypescriptSDKDev) Binary() *File {
	q := r.query.Select("binary")
...
func (r *TypescriptSDKDev) Bump(version string) *Changeset {
	q := r.query.Select("bump")
	q = q.Arg("version", version)
...
func (r *TypescriptSDKDev) BunVersion(ctx context.Context) (string, error) {
	if r.bunVersion != nil {
...
func (r *TypescriptSDKDev) BunjsDevContainer() *Container {
...
func (r *TypescriptSDKDev) Generate() *Changeset {
	q := r.query.Select("generate")
...
func (r *TypescriptSDKDev) IsSemver(ctx context.Context, version string) (bool, error) {
	if r.isSemver != nil {
...
func (r *TypescriptSDKDev) LintDocsSnippets(ctx context.Context, opts ...TypescriptSDKDevLintDocsSnippetsOpts) error {
	if r.lintDocsSnippets != nil {
		return nil
	}
	q := r.query.Select("lintDocsSnippets")
...
func (r *TypescriptSDKDev) LintTypescript(ctx context.Context) error {
...
func (r *TypescriptSDKDev) NodeVersionLts(ctx context.Context) (string, error) {
...
func (r *TypescriptSDKDev) NodeVersionPrevLts(ctx context.Context) (string, error) {
...
func (r *TypescriptSDKDev) NodejsBase(opts ...TypescriptSDKDevNodejsBaseOpts) *Container {
...
func (r *TypescriptSDKDev) NodejsDevContainer(opts ...TypescriptSDKDevNodejsDevContainerOpts) *Container {
...
func (r *TypescriptSDKDev) Release(ctx context.Context, sourceTag string, npmToken *Secret, opts ...TypescriptSDKDevReleaseOpts) error {
...
func (r *TypescriptSDKDev) ReleaseDryRun(ctx context.Context) error {
	if r.releaseDryRun != nil {
		return nil
	}
	q := r.query.Select("releaseDryRun")
...
func (r *TypescriptSDKDev) Source() *Directory {
	q := r.query.Select("source")
...
func (r *TypescriptSDKDev) SourcePath(ctx context.Context) (string, error) {
	if r.sourcePath != nil {
		return *r.sourcePath, nil
	}
	q := r.query.Select("sourcePath")
...
func (r *TypescriptSDKDev) TestBunjs(ctx context.Context) error {
	if r.testBunjs != nil {
		return nil
	}
...
func (r *TypescriptSDKDev) TestNodejs(ctx context.Context, nodeVersion string) error {
	if r.testNodejs != nil {
		return nil
	}
...
func (r *TypescriptSDKDev) TestNodejsLts(ctx context.Context) error {
...
func (r *TypescriptSDKDev) TestNodejsPrevLts(ctx context.Context) error {
...
func (r *TypescriptSDKDev) Workspace() *Directory {
	q := r.query.Select("workspace")
