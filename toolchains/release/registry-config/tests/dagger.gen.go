...
import (
	...
	"dagger/registry-config/tests/internal/querybuilder"
	"dagger/registry-config/tests/internal/telemetry"
)
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Tests":
		...
		case "WithRegistryAuth":
			...
			return nil, (*Tests).WithRegistryAuth(&parent, ctx)
		case "WithRegistryAuthMultipleCredentials":
			var parent Tests
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
				panic(fmt.Errorf("%s: %w", "failed to unmarshal parent object", err))
			}
			return nil, (*Tests).WithRegistryAuthMultipleCredentials(&parent, ctx)
