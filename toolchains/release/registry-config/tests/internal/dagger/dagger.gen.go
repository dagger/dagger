...
func (r *Binding) AsRegistryConfig() *RegistryConfig {
...
func (r *Binding) AsRegistryConfigSecretMount() *RegistryConfigSecretMount {
...
func (r *Env) WithRegistryConfigInput(name string, value *RegistryConfig, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithRegistryConfigOutput(name string, description string) *Env {
...
func (r *Env) WithRegistryConfigSecretMountInput(name string, value *RegistryConfigSecretMount, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithRegistryConfigSecretMountOutput(name string, description string) *Env {
...
func (r *Client) LoadRegistryConfigFromID(id RegistryConfigID) *RegistryConfig {
...
func (r *Client) LoadRegistryConfigSecretMountFromID(id RegistryConfigSecretMountID) *RegistryConfigSecretMount {
...
func (r *Client) RegistryConfig() *RegistryConfig { // registry-config (../../../../../../toolchains/release/registry-config/main.go:22:6)
