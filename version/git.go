...
func git(ctx context.Context, repo *dagger.GitRepository, dir *dagger.Directory) (*Git, error) {
	...
	if repo != nil {
		ctr = ctr.WithDirectory(".", repo.Head().Tree(dagger.GitRefTreeOpts{Depth: -1}))
	}
	if dir != nil {
