...
module.exports = {
  ...
  plugins: ["docusaurus-plugin-sass", "docusaurus2-dotenv", ["@graphql-markdown/docusaurus",  {loaders: {UrlLoader: "@graphql-tools/url-loader", options: { subscription: ""}}, schema: "http://localhost:8080/query", rootPath: "../docs", baseURL: "reference/api"}]],
};
