 ...
 *
 * @param {string} type - The type of guides to display. Can be "current" or "zenith".
 * @returns {JSX.Element}
 * @example
 * <GuidesIndex type="current" />
 * <GuidesIndex type="zenith" />
 * <GuidesIndex />
 */

export default function GuidesIndex({type = "current"}) {
  const guides = type === "current" ? guidesJSON.currentGuides : guidesJSON.zenithGuides;
